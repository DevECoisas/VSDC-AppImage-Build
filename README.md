...
wget https://github.com/mmtrt/WINE_AppImage/releases/download/continuous-stable/wine-stable_10.0-x86_64.AppImagesudo chmod +x wine-devel_10.20-x86_64.AppImage
cd ../../
