/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/vmr9.idl - Do not edit ***/
...
typedef struct __WIDL_vmr9_generated_name_0000000B {
    char dummy;
} AM_MEDIA_TYPE;
...
/*** IVMRVideoStreamControl9 methods ***/
static inline HRESULT IVMRVideoStreamControl9_SetStreamActiveState(IVMRVideoStreamControl9* This,BOOL active) {
    return This->lpVtbl->SetStreamActiveState(This,active);
}
static inline HRESULT IVMRVideoStreamControl9_GetStreamActiveState(IVMRVideoStreamControl9* This,BOOL *active) {
...
static inline HRESULT IVMRImageCompositor9_SetStreamMediaType(IVMRImageCompositor9* This,DWORD stream,AM_MEDIA_TYPE *mt,BOOL texture) {
