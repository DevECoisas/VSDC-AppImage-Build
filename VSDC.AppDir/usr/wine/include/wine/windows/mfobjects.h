/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/mfobjects.idl - Do not edit ***/
...
typedef struct __WIDL_mfobjects_generated_name_00000021 *PWAVEFORMATEXTENSIBLE;
...
static inline HRESULT IMFAttributes_CompareItem(IMFAttributes* This,REFGUID guidKey,REFPROPVARIANT Value,BOOL *pbResult) {
    return This->lpVtbl->CompareItem(This,guidKey,Value,pbResult);
}
static inline HRESULT IMFAttributes_Compare(IMFAttributes* This,IMFAttributes *pTheirs,MF_ATTRIBUTES_MATCH_TYPE MatchType,BOOL *pbResult) {
...
static inline HRESULT IMFSample_CompareItem(IMFSample* This,REFGUID guidKey,REFPROPVARIANT Value,BOOL *pbResult) {
    return This->lpVtbl->CompareItem(This,guidKey,Value,pbResult);
}
static inline HRESULT IMFSample_Compare(IMFSample* This,IMFAttributes *pTheirs,MF_ATTRIBUTES_MATCH_TYPE MatchType,BOOL *pbResult) {
    return This->lpVtbl->Compare(This,pTheirs,MatchType,pbResult);
}
...
/*** IMF2DBuffer methods ***/
static inline HRESULT IMF2DBuffer_Lock2D(IMF2DBuffer* This,BYTE **pbScanline0,LONG *plPitch) {
...
static inline HRESULT IMF2DBuffer_IsContiguousFormat(IMF2DBuffer* This,BOOL *pfIsContiguous) {
...
/*** IMF2DBuffer methods ***/
#define IMF2DBuffer2_Lock2D(This,pbScanline0,plPitch) (This)->lpVtbl->Lock2D(This,pbScanline0,plPitch)
...
/*** IMF2DBuffer2 methods ***/
#define IMF2DBuffer2_Lock2DSize(This,flags,scanline0,pitch,buffer_start,buffer_length) (This)->lpVtbl->Lock2DSize(This,flags,scanline0,pitch,buffer_start,buffer_length)
#define IMF2DBuffer2_Copy2DTo(This,dest_buffer) (This)->lpVtbl->Copy2DTo(This,dest_buffer)
#else
/*** IUnknown methods ***/
...
/*** IMF2DBuffer methods ***/
static inline HRESULT IMF2DBuffer2_Lock2D(IMF2DBuffer2* This,BYTE **pbScanline0,LONG *plPitch) {
    return This->lpVtbl->Lock2D(This,pbScanline0,plPitch);
}
...
static inline HRESULT IMF2DBuffer2_IsContiguousFormat(IMF2DBuffer2* This,BOOL *pfIsContiguous) {
    return This->lpVtbl->IsContiguousFormat(This,pfIsContiguous);
}
...
/*** IMF2DBuffer2 methods ***/
static inline HRESULT IMF2DBuffer2_Lock2DSize(IMF2DBuffer2* This,MF2DBuffer_LockFlags flags,BYTE **scanline0,LONG *pitch,BYTE **buffer_start,DWORD *buffer_length) {
    return This->lpVtbl->Lock2DSize(This,flags,scanline0,pitch,buffer_start,buffer_length);
}
static inline HRESULT IMF2DBuffer2_Copy2DTo(IMF2DBuffer2* This,IMF2DBuffer2 *dest_buffer) {
    return This->lpVtbl->Copy2DTo(This,dest_buffer);
}
#endif
#endif
...
/*** IMFDXGIBuffer methods ***/
#define IMFDXGIBuffer_GetResource(This,riid,object) (This)->lpVtbl->GetResource(This,riid,object)
#define IMFDXGIBuffer_GetSubresourceIndex(This,index) (This)->lpVtbl->GetSubresourceIndex(This,index)
#define IMFDXGIBuffer_GetUnknown(This,guid,riid,object) (This)->lpVtbl->GetUnknown(This,guid,riid,object)
#define IMFDXGIBuffer_SetUnknown(This,guid,data) (This)->lpVtbl->SetUnknown(This,guid,data)
#else
/*** IUnknown methods ***/
...
/*** IMFDXGIBuffer methods ***/
static inline HRESULT IMFDXGIBuffer_GetResource(IMFDXGIBuffer* This,REFIID riid,void **object) {
    return This->lpVtbl->GetResource(This,riid,object);
}
static inline HRESULT IMFDXGIBuffer_GetSubresourceIndex(IMFDXGIBuffer* This,UINT *index) {
    return This->lpVtbl->GetSubresourceIndex(This,index);
}
static inline HRESULT IMFDXGIBuffer_GetUnknown(IMFDXGIBuffer* This,REFIID guid,REFIID riid,void **object) {
    return This->lpVtbl->GetUnknown(This,guid,riid,object);
}
static inline HRESULT IMFDXGIBuffer_SetUnknown(IMFDXGIBuffer* This,REFIID guid,IUnknown *data) {
    return This->lpVtbl->SetUnknown(This,guid,data);
}
#endif
#endif
...
static inline HRESULT IMFMediaType_CompareItem(IMFMediaType* This,REFGUID guidKey,REFPROPVARIANT Value,BOOL *pbResult) {
    return This->lpVtbl->CompareItem(This,guidKey,Value,pbResult);
}
static inline HRESULT IMFMediaType_Compare(IMFMediaType* This,IMFAttributes *pTheirs,MF_ATTRIBUTES_MATCH_TYPE MatchType,BOOL *pbResult) {
    return This->lpVtbl->Compare(This,pTheirs,MatchType,pbResult);
}
...
static inline HRESULT IMFMediaType_IsCompressedFormat(IMFMediaType* This,BOOL *pfCompressed) {
...
static inline HRESULT IMFAudioMediaType_CompareItem(IMFAudioMediaType* This,REFGUID guidKey,REFPROPVARIANT Value,BOOL *pbResult) {
    return This->lpVtbl->CompareItem(This,guidKey,Value,pbResult);
}
static inline HRESULT IMFAudioMediaType_Compare(IMFAudioMediaType* This,IMFAttributes *pTheirs,MF_ATTRIBUTES_MATCH_TYPE MatchType,BOOL *pbResult) {
    return This->lpVtbl->Compare(This,pTheirs,MatchType,pbResult);
}
...
static inline HRESULT IMFAudioMediaType_IsCompressedFormat(IMFAudioMediaType* This,BOOL *pfCompressed) {
    return This->lpVtbl->IsCompressedFormat(This,pfCompressed);
}
...
static inline HRESULT IMFVideoMediaType_CompareItem(IMFVideoMediaType* This,REFGUID guidKey,REFPROPVARIANT Value,BOOL *pbResult) {
    return This->lpVtbl->CompareItem(This,guidKey,Value,pbResult);
}
static inline HRESULT IMFVideoMediaType_Compare(IMFVideoMediaType* This,IMFAttributes *pTheirs,MF_ATTRIBUTES_MATCH_TYPE MatchType,BOOL *pbResult) {
    return This->lpVtbl->Compare(This,pTheirs,MatchType,pbResult);
}
...
static inline HRESULT IMFVideoMediaType_IsCompressedFormat(IMFVideoMediaType* This,BOOL *pfCompressed) {
    return This->lpVtbl->IsCompressedFormat(This,pfCompressed);
}
...
static inline HRESULT IMFMediaEvent_CompareItem(IMFMediaEvent* This,REFGUID guidKey,REFPROPVARIANT Value,BOOL *pbResult) {
    return This->lpVtbl->CompareItem(This,guidKey,Value,pbResult);
}
static inline HRESULT IMFMediaEvent_Compare(IMFMediaEvent* This,IMFAttributes *pTheirs,MF_ATTRIBUTES_MATCH_TYPE MatchType,BOOL *pbResult) {
    return This->lpVtbl->Compare(This,pTheirs,MatchType,pbResult);
}
...
static inline HRESULT IMFByteStream_IsEndOfStream(IMFByteStream* This,BOOL *pfEndOfStream) {
...
/*** IMFSampleOutputStream methods ***/
#define IMFSampleOutputStream_BeginWriteSample(This,sample,callback,state) (This)->lpVtbl->BeginWriteSample(This,sample,callback,state)
#define IMFSampleOutputStream_EndWriteSample(This,result) (This)->lpVtbl->EndWriteSample(This,result)
...
/*** IMFSampleOutputStream methods ***/
static inline HRESULT IMFSampleOutputStream_BeginWriteSample(IMFSampleOutputStream* This,IMFSample *sample,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginWriteSample(This,sample,callback,state);
}
static inline HRESULT IMFSampleOutputStream_EndWriteSample(IMFSampleOutputStream* This,IMFAsyncResult *result) {
    return This->lpVtbl->EndWriteSample(This,result);
}
...
static inline HRESULT IMFActivate_CompareItem(IMFActivate* This,REFGUID guidKey,REFPROPVARIANT Value,BOOL *pbResult) {
    return This->lpVtbl->CompareItem(This,guidKey,Value,pbResult);
}
static inline HRESULT IMFActivate_Compare(IMFActivate* This,IMFAttributes *pTheirs,MF_ATTRIBUTES_MATCH_TYPE MatchType,BOOL *pbResult) {
    return This->lpVtbl->Compare(This,pTheirs,MatchType,pbResult);
}
...
static inline HRESULT IMFPluginControl_SetDisabled(IMFPluginControl* This,DWORD pluginType,REFCLSID clsid,BOOL disabled) {
...
/*** IMFMediaEventQueue methods ***/
static inline HRESULT IMFMediaEventQueue_GetEvent(IMFMediaEventQueue* This,DWORD flags,IMFMediaEvent **event) {
    return This->lpVtbl->GetEvent(This,flags,event);
}
static inline HRESULT IMFMediaEventQueue_BeginGetEvent(IMFMediaEventQueue* This,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginGetEvent(This,callback,state);
}
static inline HRESULT IMFMediaEventQueue_EndGetEvent(IMFMediaEventQueue* This,IMFAsyncResult *result,IMFMediaEvent **event) {
    return This->lpVtbl->EndGetEvent(This,result,event);
}
static inline HRESULT IMFMediaEventQueue_QueueEvent(IMFMediaEventQueue* This,IMFMediaEvent *event) {
    return This->lpVtbl->QueueEvent(This,event);
}
static inline HRESULT IMFMediaEventQueue_QueueEventParamVar(IMFMediaEventQueue* This,MediaEventType met,REFGUID type,HRESULT status,const PROPVARIANT *value) {
    return This->lpVtbl->QueueEventParamVar(This,met,type,status,value);
}
static inline HRESULT IMFMediaEventQueue_QueueEventParamUnk(IMFMediaEventQueue* This,MediaEventType met,REFGUID type,HRESULT status,IUnknown *unk) {
...
/*** IMFDXGIDeviceManager methods ***/
#define IMFDXGIDeviceManager_CloseDeviceHandle(This,device) (This)->lpVtbl->CloseDeviceHandle(This,device)
#define IMFDXGIDeviceManager_GetVideoService(This,device,riid,service) (This)->lpVtbl->GetVideoService(This,device,riid,service)
#define IMFDXGIDeviceManager_LockDevice(This,device,riid,ppv,block) (This)->lpVtbl->LockDevice(This,device,riid,ppv,block)
#define IMFDXGIDeviceManager_OpenDeviceHandle(This,device) (This)->lpVtbl->OpenDeviceHandle(This,device)
#define IMFDXGIDeviceManager_ResetDevice(This,device,token) (This)->lpVtbl->ResetDevice(This,device,token)
#define IMFDXGIDeviceManager_TestDevice(This,device) (This)->lpVtbl->TestDevice(This,device)
#define IMFDXGIDeviceManager_UnlockDevice(This,device,state) (This)->lpVtbl->UnlockDevice(This,device,state)
#else
/*** IUnknown methods ***/
...
/*** IMFDXGIDeviceManager methods ***/
static inline HRESULT IMFDXGIDeviceManager_CloseDeviceHandle(IMFDXGIDeviceManager* This,HANDLE device) {
    return This->lpVtbl->CloseDeviceHandle(This,device);
}
static inline HRESULT IMFDXGIDeviceManager_GetVideoService(IMFDXGIDeviceManager* This,HANDLE device,REFIID riid,void **service) {
    return This->lpVtbl->GetVideoService(This,device,riid,service);
}
static inline HRESULT IMFDXGIDeviceManager_LockDevice(IMFDXGIDeviceManager* This,HANDLE device,REFIID riid,void **ppv,BOOL block) {
    return This->lpVtbl->LockDevice(This,device,riid,ppv,block);
}
static inline HRESULT IMFDXGIDeviceManager_OpenDeviceHandle(IMFDXGIDeviceManager* This,HANDLE *device) {
    return This->lpVtbl->OpenDeviceHandle(This,device);
}
static inline HRESULT IMFDXGIDeviceManager_ResetDevice(IMFDXGIDeviceManager* This,IUnknown *device,UINT token) {
    return This->lpVtbl->ResetDevice(This,device,token);
}
static inline HRESULT IMFDXGIDeviceManager_TestDevice(IMFDXGIDeviceManager* This,HANDLE device) {
    return This->lpVtbl->TestDevice(This,device);
}
static inline HRESULT IMFDXGIDeviceManager_UnlockDevice(IMFDXGIDeviceManager* This,HANDLE device,BOOL state) {
    return This->lpVtbl->UnlockDevice(This,device,state);
}
#endif
#endif
