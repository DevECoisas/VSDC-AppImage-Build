/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/perhist.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPersistHistory_QueryInterface(IPersistHistory* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IPersistHistory_AddRef(IPersistHistory* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IPersistHistory_Release(IPersistHistory* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
static inline HRESULT IPersistHistory_GetClassID(IPersistHistory* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
/*** IPersistHistory methods ***/
static inline HRESULT IPersistHistory_LoadHistory(IPersistHistory* This,IStream *pStream,IBindCtx *pbc) {
    return This->lpVtbl->LoadHistory(This,pStream,pbc);
}
static inline HRESULT IPersistHistory_SaveHistory(IPersistHistory* This,IStream *pStream) {
    return This->lpVtbl->SaveHistory(This,pStream);
}
static inline HRESULT IPersistHistory_SetPositionCookie(IPersistHistory* This,DWORD dwPositioncookie) {
    return This->lpVtbl->SetPositionCookie(This,dwPositioncookie);
}
static inline HRESULT IPersistHistory_GetPositionCookie(IPersistHistory* This,DWORD *pdwPositioncookie) {
