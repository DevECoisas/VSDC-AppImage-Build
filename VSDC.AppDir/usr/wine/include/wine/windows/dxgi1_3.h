/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/dxgi1_3.idl - Do not edit ***/
...
static inline HRESULT IDXGIDevice3_ReclaimResources(IDXGIDevice3* This,UINT NumResources,IDXGIResource *const *ppResources,BOOL *pDiscarded) {
...
static inline HRESULT IDXGISwapChain2_SetFullscreenState(IDXGISwapChain2* This,BOOL fullscreen,IDXGIOutput *target) {
    return This->lpVtbl->SetFullscreenState(This,fullscreen,target);
}
static inline HRESULT IDXGISwapChain2_GetFullscreenState(IDXGISwapChain2* This,BOOL *fullscreen,IDXGIOutput **target) {
...
static inline BOOL IDXGISwapChain2_IsTemporaryMonoSupported(IDXGISwapChain2* This) {
...
static inline HRESULT IDXGIOutput2_TakeOwnership(IDXGIOutput2* This,IUnknown *device,BOOL exclusive) {
...
/*** IDXGIOutput2 methods ***/
static inline BOOL IDXGIOutput2_SupportsOverlays(IDXGIOutput2* This) {
...
static inline BOOL IDXGIFactory3_IsCurrent(IDXGIFactory3* This) {
    return This->lpVtbl->IsCurrent(This);
}
/*** IDXGIFactory2 methods ***/
static inline BOOL IDXGIFactory3_IsWindowedStereoEnabled(IDXGIFactory3* This) {
...
static inline HRESULT IDXGIOutput3_TakeOwnership(IDXGIOutput3* This,IUnknown *device,BOOL exclusive) {
    return This->lpVtbl->TakeOwnership(This,device,exclusive);
}
...
/*** IDXGIOutput2 methods ***/
static inline BOOL IDXGIOutput3_SupportsOverlays(IDXGIOutput3* This) {
    return This->lpVtbl->SupportsOverlays(This);
}
/*** IDXGIOutput3 methods ***/
