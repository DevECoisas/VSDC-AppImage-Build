/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/mimeole.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeInternational_QueryInterface(IMimeInternational* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeInternational_AddRef(IMimeInternational* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeInternational_Release(IMimeInternational* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimeInternational methods ***/
static inline HRESULT IMimeInternational_SetDefaultCharset(IMimeInternational* This,HCHARSET hCharset) {
    return This->lpVtbl->SetDefaultCharset(This,hCharset);
}
static inline HRESULT IMimeInternational_GetDefaultCharset(IMimeInternational* This,LPHCHARSET phCharset) {
    return This->lpVtbl->GetDefaultCharset(This,phCharset);
}
static inline HRESULT IMimeInternational_GetCodePageCharset(IMimeInternational* This,CODEPAGEID cpiCodePage,CHARSETTYPE ctCsetType,LPHCHARSET phCharset) {
    return This->lpVtbl->GetCodePageCharset(This,cpiCodePage,ctCsetType,phCharset);
}
static inline HRESULT IMimeInternational_FindCharset(IMimeInternational* This,LPCSTR pszCharset,LPHCHARSET phCharset) {
    return This->lpVtbl->FindCharset(This,pszCharset,phCharset);
}
static inline HRESULT IMimeInternational_GetCharsetInfo(IMimeInternational* This,HCHARSET hCharset,LPINETCSETINFO pCsetInfo) {
    return This->lpVtbl->GetCharsetInfo(This,hCharset,pCsetInfo);
}
static inline HRESULT IMimeInternational_GetCodePageInfo(IMimeInternational* This,CODEPAGEID cpiCodePage,LPCODEPAGEINFO pCodePageInfo) {
    return This->lpVtbl->GetCodePageInfo(This,cpiCodePage,pCodePageInfo);
}
static inline HRESULT IMimeInternational_CanConvertCodePages(IMimeInternational* This,CODEPAGEID cpiSource,CODEPAGEID cpiDest) {
    return This->lpVtbl->CanConvertCodePages(This,cpiSource,cpiDest);
}
static inline HRESULT IMimeInternational_DecodeHeader(IMimeInternational* This,HCHARSET hCharset,LPCSTR pszData,LPPROPVARIANT pDecoded,LPRFC1522INFO pRfc1522Info) {
    return This->lpVtbl->DecodeHeader(This,hCharset,pszData,pDecoded,pRfc1522Info);
}
static inline HRESULT IMimeInternational_EncodeHeader(IMimeInternational* This,HCHARSET hCharset,LPPROPVARIANT pData,LPSTR *ppszEncoded,LPRFC1522INFO pRfc1522Info) {
    return This->lpVtbl->EncodeHeader(This,hCharset,pData,ppszEncoded,pRfc1522Info);
}
static inline HRESULT IMimeInternational_ConvertBuffer(IMimeInternational* This,CODEPAGEID cpiSource,CODEPAGEID cpiDest,LPBLOB pIn,LPBLOB pOut,ULONG *pcbRead) {
    return This->lpVtbl->ConvertBuffer(This,cpiSource,cpiDest,pIn,pOut,pcbRead);
}
static inline HRESULT IMimeInternational_ConvertString(IMimeInternational* This,CODEPAGEID cpiSource,CODEPAGEID cpiDest,LPPROPVARIANT pIn,LPPROPVARIANT pOut) {
    return This->lpVtbl->ConvertString(This,cpiSource,cpiDest,pIn,pOut);
}
static inline HRESULT IMimeInternational_MLANG_ConvertInetReset(IMimeInternational* This) {
    return This->lpVtbl->MLANG_ConvertInetReset(This);
}
static inline HRESULT IMimeInternational_MLANG_ConvertInetString(IMimeInternational* This,CODEPAGEID cpiSource,CODEPAGEID cpiDest,LPCSTR pSource,int *pnSizeOfSource,LPSTR pDestination,int *pnDstSize) {
    return This->lpVtbl->MLANG_ConvertInetString(This,cpiSource,cpiDest,pSource,pnSizeOfSource,pDestination,pnDstSize);
}
static inline HRESULT IMimeInternational_Rfc1522Decode(IMimeInternational* This,LPCSTR pszValue,LPSTR pszCharset,ULONG cchmax,LPSTR *ppszDecoded) {
    return This->lpVtbl->Rfc1522Decode(This,pszValue,pszCharset,cchmax,ppszDecoded);
}
static inline HRESULT IMimeInternational_Rfc1522Encode(IMimeInternational* This,LPCSTR pszValue,HCHARSET hCharset,LPSTR *ppszEncoded) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeSecurity_QueryInterface(IMimeSecurity* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeSecurity_AddRef(IMimeSecurity* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeSecurity_Release(IMimeSecurity* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimeSecurity methods ***/
static inline HRESULT IMimeSecurity_InitNew(IMimeSecurity* This) {
    return This->lpVtbl->InitNew(This);
}
static inline HRESULT IMimeSecurity_CheckInit(IMimeSecurity* This) {
    return This->lpVtbl->CheckInit(This);
}
static inline HRESULT IMimeSecurity_EncodeMessage(IMimeSecurity* This,IMimeMessageTree *pTree,DWORD dwFlags) {
    return This->lpVtbl->EncodeMessage(This,pTree,dwFlags);
}
static inline HRESULT IMimeSecurity_EncodeBody(IMimeSecurity* This,IMimeMessageTree *pTree,HBODY hEncodeRoot,DWORD dwFlags) {
    return This->lpVtbl->EncodeBody(This,pTree,hEncodeRoot,dwFlags);
}
static inline HRESULT IMimeSecurity_DecodeMessage(IMimeSecurity* This,IMimeMessageTree *pTree,DWORD dwFlags) {
    return This->lpVtbl->DecodeMessage(This,pTree,dwFlags);
}
static inline HRESULT IMimeSecurity_DecodeBody(IMimeSecurity* This,IMimeMessageTree *pTree,HBODY hDecodeRoot,DWORD dwFlags) {
    return This->lpVtbl->DecodeBody(This,pTree,hDecodeRoot,dwFlags);
}
static inline HRESULT IMimeSecurity_EnumCertificates(IMimeSecurity* This,HCAPICERTSTORE hc,DWORD dwUsage,PCX509CERT pPrev,PCX509CERT *ppCert) {
    return This->lpVtbl->EnumCertificates(This,hc,dwUsage,pPrev,ppCert);
}
static inline HRESULT IMimeSecurity_GetCertificateName(IMimeSecurity* This,const PCX509CERT pX509Cert,const CERTNAMETYPE cn,LPSTR *ppszName) {
    return This->lpVtbl->GetCertificateName(This,pX509Cert,cn,ppszName);
}
static inline HRESULT IMimeSecurity_GetMessageType(IMimeSecurity* This,const HWND hwndParent,IMimeBody *pBody,DWORD *pdwSecType) {
    return This->lpVtbl->GetMessageType(This,hwndParent,pBody,pdwSecType);
}
static inline HRESULT IMimeSecurity_GetCertData(IMimeSecurity* This,const PCX509CERT pX509Cert,const CERTDATAID dataid,LPPROPVARIANT pValue) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeEnumHeaderRows_QueryInterface(IMimeEnumHeaderRows* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeEnumHeaderRows_AddRef(IMimeEnumHeaderRows* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeEnumHeaderRows_Release(IMimeEnumHeaderRows* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimeEnumHeaderRows methods ***/
static inline HRESULT IMimeEnumHeaderRows_Next(IMimeEnumHeaderRows* This,ULONG fetch,LPENUMHEADERROW row,ULONG *fetched) {
    return This->lpVtbl->Next(This,fetch,row,fetched);
}
static inline HRESULT IMimeEnumHeaderRows_Skip(IMimeEnumHeaderRows* This,ULONG items) {
    return This->lpVtbl->Skip(This,items);
}
static inline HRESULT IMimeEnumHeaderRows_Reset(IMimeEnumHeaderRows* This) {
    return This->lpVtbl->Reset(This);
}
static inline HRESULT IMimeEnumHeaderRows_Clone(IMimeEnumHeaderRows* This,IMimeEnumHeaderRows **rows) {
    return This->lpVtbl->Clone(This,rows);
}
static inline HRESULT IMimeEnumHeaderRows_Count(IMimeEnumHeaderRows* This,ULONG *pcItems) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeHeaderTable_QueryInterface(IMimeHeaderTable* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeHeaderTable_AddRef(IMimeHeaderTable* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeHeaderTable_Release(IMimeHeaderTable* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
static inline HRESULT IMimeHeaderTable_GetClassID(IMimeHeaderTable* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
/*** IPersistStream methods ***/
static inline HRESULT IMimeHeaderTable_IsDirty(IMimeHeaderTable* This) {
    return This->lpVtbl->IsDirty(This);
}
static inline HRESULT IMimeHeaderTable_Load(IMimeHeaderTable* This,IStream *pStm) {
    return This->lpVtbl->Load(This,pStm);
}
static inline HRESULT IMimeHeaderTable_Save(IMimeHeaderTable* This,IStream *pStm,BOOL fClearDirty) {
    return This->lpVtbl->Save(This,pStm,fClearDirty);
}
static inline HRESULT IMimeHeaderTable_GetSizeMax(IMimeHeaderTable* This,ULARGE_INTEGER *pcbSize) {
    return This->lpVtbl->GetSizeMax(This,pcbSize);
}
/*** IMimeHeaderTable methods ***/
static inline HRESULT IMimeHeaderTable_FindFirstRow(IMimeHeaderTable* This,LPFINDHEADER header,LPHHEADERROW row) {
    return This->lpVtbl->FindFirstRow(This,header,row);
}
static inline HRESULT IMimeHeaderTable_FindNextRow(IMimeHeaderTable* This,LPFINDHEADER header,LPHHEADERROW row) {
    return This->lpVtbl->FindNextRow(This,header,row);
}
static inline HRESULT IMimeHeaderTable_CountRows(IMimeHeaderTable* This,const char *header,ULONG *rows) {
    return This->lpVtbl->CountRows(This,header,rows);
}
static inline HRESULT IMimeHeaderTable_AppendRow(IMimeHeaderTable* This,const char *header,DWORD flags,const char *data,ULONG count,LPHHEADERROW row) {
    return This->lpVtbl->AppendRow(This,header,flags,data,count,row);
}
static inline HRESULT IMimeHeaderTable_DeleteRow(IMimeHeaderTable* This,HHEADERROW row) {
    return This->lpVtbl->DeleteRow(This,row);
}
static inline HRESULT IMimeHeaderTable_GetRowData(IMimeHeaderTable* This,HHEADERROW row,DWORD flags,char **data,ULONG *len) {
    return This->lpVtbl->GetRowData(This,row,flags,data,len);
}
static inline HRESULT IMimeHeaderTable_SetRowData(IMimeHeaderTable* This,HHEADERROW row,DWORD flags,const char *data,ULONG len) {
    return This->lpVtbl->SetRowData(This,row,flags,data,len);
}
static inline HRESULT IMimeHeaderTable_GetRowInfo(IMimeHeaderTable* This,HHEADERROW row,LPHEADERROWINFO info) {
    return This->lpVtbl->GetRowInfo(This,row,info);
}
static inline HRESULT IMimeHeaderTable_SetRowNumber(IMimeHeaderTable* This,HHEADERROW row,DWORD number) {
    return This->lpVtbl->SetRowNumber(This,row,number);
}
static inline HRESULT IMimeHeaderTable_EnumRows(IMimeHeaderTable* This,const char *header,DWORD flags,IMimeEnumHeaderRows **rows) {
    return This->lpVtbl->EnumRows(This,header,flags,rows);
}
static inline HRESULT IMimeHeaderTable_Clone(IMimeHeaderTable* This,IMimeHeaderTable **table) {
    return This->lpVtbl->Clone(This,table);
}
static inline HRESULT IMimeHeaderTable_BindToObject(IMimeHeaderTable* This,REFIID riid,void *object) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimePropertySchema_QueryInterface(IMimePropertySchema* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimePropertySchema_AddRef(IMimePropertySchema* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimePropertySchema_Release(IMimePropertySchema* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimePropertySchema methods ***/
static inline HRESULT IMimePropertySchema_RegisterProperty(IMimePropertySchema* This,const char *name,DWORD flags,DWORD rownumber,VARTYPE vtdefault,DWORD *propid) {
    return This->lpVtbl->RegisterProperty(This,name,flags,rownumber,vtdefault,propid);
}
static inline HRESULT IMimePropertySchema_ModifyProperty(IMimePropertySchema* This,const char *name,DWORD flags,DWORD rownumber,VARTYPE vtdefault) {
    return This->lpVtbl->ModifyProperty(This,name,flags,rownumber,vtdefault);
}
static inline HRESULT IMimePropertySchema_GetPropertyId(IMimePropertySchema* This,const char *name,DWORD *propid) {
    return This->lpVtbl->GetPropertyId(This,name,propid);
}
static inline HRESULT IMimePropertySchema_GetPropertyName(IMimePropertySchema* This,DWORD propid,char **name) {
    return This->lpVtbl->GetPropertyName(This,propid,name);
}
static inline HRESULT IMimePropertySchema_RegisterAddressType(IMimePropertySchema* This,const char *name,DWORD *adrtype) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimePropertySet_QueryInterface(IMimePropertySet* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimePropertySet_AddRef(IMimePropertySet* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimePropertySet_Release(IMimePropertySet* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
static inline HRESULT IMimePropertySet_GetClassID(IMimePropertySet* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
/*** IPersistStreamInit methods ***/
static inline HRESULT IMimePropertySet_IsDirty(IMimePropertySet* This) {
    return This->lpVtbl->IsDirty(This);
}
static inline HRESULT IMimePropertySet_Load(IMimePropertySet* This,LPSTREAM pStm) {
    return This->lpVtbl->Load(This,pStm);
}
static inline HRESULT IMimePropertySet_Save(IMimePropertySet* This,LPSTREAM pStm,BOOL fClearDirty) {
    return This->lpVtbl->Save(This,pStm,fClearDirty);
}
static inline HRESULT IMimePropertySet_GetSizeMax(IMimePropertySet* This,ULARGE_INTEGER *pcbSize) {
    return This->lpVtbl->GetSizeMax(This,pcbSize);
}
static inline HRESULT IMimePropertySet_InitNew(IMimePropertySet* This) {
    return This->lpVtbl->InitNew(This);
}
/*** IMimePropertySet methods ***/
static inline HRESULT IMimePropertySet_GetPropInfo(IMimePropertySet* This,LPCSTR pszName,LPMIMEPROPINFO pInfo) {
    return This->lpVtbl->GetPropInfo(This,pszName,pInfo);
}
static inline HRESULT IMimePropertySet_SetPropInfo(IMimePropertySet* This,LPCSTR pszName,LPCMIMEPROPINFO pInfo) {
    return This->lpVtbl->SetPropInfo(This,pszName,pInfo);
}
static inline HRESULT IMimePropertySet_GetProp(IMimePropertySet* This,LPCSTR pszName,DWORD dwFlags,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetProp(This,pszName,dwFlags,pValue);
}
static inline HRESULT IMimePropertySet_SetProp(IMimePropertySet* This,LPCSTR pszName,DWORD dwFlags,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetProp(This,pszName,dwFlags,pValue);
}
static inline HRESULT IMimePropertySet_AppendProp(IMimePropertySet* This,LPCSTR pszName,DWORD dwFlags,LPPROPVARIANT pValue) {
    return This->lpVtbl->AppendProp(This,pszName,dwFlags,pValue);
}
static inline HRESULT IMimePropertySet_DeleteProp(IMimePropertySet* This,LPCSTR pszName) {
    return This->lpVtbl->DeleteProp(This,pszName);
}
static inline HRESULT IMimePropertySet_CopyProps(IMimePropertySet* This,ULONG cNames,LPCSTR *prgszName,IMimePropertySet *pPropertySet) {
    return This->lpVtbl->CopyProps(This,cNames,prgszName,pPropertySet);
}
static inline HRESULT IMimePropertySet_MoveProps(IMimePropertySet* This,ULONG cNames,LPCSTR *prgszName,IMimePropertySet *pPropertySet) {
    return This->lpVtbl->MoveProps(This,cNames,prgszName,pPropertySet);
}
static inline HRESULT IMimePropertySet_DeleteExcept(IMimePropertySet* This,ULONG cNames,LPCSTR *prgszName) {
    return This->lpVtbl->DeleteExcept(This,cNames,prgszName);
}
static inline HRESULT IMimePropertySet_QueryProp(IMimePropertySet* This,LPCSTR pszName,LPCSTR pszCriteria,boolean fSubString,boolean fCaseSensitive) {
    return This->lpVtbl->QueryProp(This,pszName,pszCriteria,fSubString,fCaseSensitive);
}
static inline HRESULT IMimePropertySet_GetCharset(IMimePropertySet* This,LPHCHARSET phCharset) {
    return This->lpVtbl->GetCharset(This,phCharset);
}
static inline HRESULT IMimePropertySet_SetCharset(IMimePropertySet* This,HCHARSET hCharset,CSETAPPLYTYPE applytype) {
    return This->lpVtbl->SetCharset(This,hCharset,applytype);
}
static inline HRESULT IMimePropertySet_GetParameters(IMimePropertySet* This,LPCSTR pszName,ULONG *pcParams,LPMIMEPARAMINFO *pprgParam) {
    return This->lpVtbl->GetParameters(This,pszName,pcParams,pprgParam);
}
static inline HRESULT IMimePropertySet_IsContentType(IMimePropertySet* This,LPCSTR pszPriType,LPCSTR pszSubType) {
    return This->lpVtbl->IsContentType(This,pszPriType,pszSubType);
}
static inline HRESULT IMimePropertySet_BindToObject(IMimePropertySet* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->BindToObject(This,riid,ppvObject);
}
static inline HRESULT IMimePropertySet_Clone(IMimePropertySet* This,IMimePropertySet **ppPropertySet) {
    return This->lpVtbl->Clone(This,ppPropertySet);
}
static inline HRESULT IMimePropertySet_SetOption(IMimePropertySet* This,const TYPEDID oid,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetOption(This,oid,pValue);
}
static inline HRESULT IMimePropertySet_GetOption(IMimePropertySet* This,const TYPEDID oid,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetOption(This,oid,pValue);
}
static inline HRESULT IMimePropertySet_EnumProps(IMimePropertySet* This,DWORD dwFlags,IMimeEnumProperties **ppEnum) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeAddressTable_QueryInterface(IMimeAddressTable* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeAddressTable_AddRef(IMimeAddressTable* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeAddressTable_Release(IMimeAddressTable* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimeAddressTable methods ***/
static inline HRESULT IMimeAddressTable_Append(IMimeAddressTable* This,DWORD addrtype,ENCODINGTYPE encoding,const char *friendly,const char *email,HADDRESS *address) {
    return This->lpVtbl->Append(This,addrtype,encoding,friendly,email,address);
}
static inline HRESULT IMimeAddressTable_Insert(IMimeAddressTable* This,ADDRESSPROPS *addressprop,HADDRESS *address) {
    return This->lpVtbl->Insert(This,addressprop,address);
}
static inline HRESULT IMimeAddressTable_SetProps(IMimeAddressTable* This,HADDRESS address,ADDRESSPROPS *addressprop) {
    return This->lpVtbl->SetProps(This,address,addressprop);
}
static inline HRESULT IMimeAddressTable_GetProps(IMimeAddressTable* This,HADDRESS address,ADDRESSPROPS *addressprop) {
    return This->lpVtbl->GetProps(This,address,addressprop);
}
static inline HRESULT IMimeAddressTable_GetSender(IMimeAddressTable* This,ADDRESSPROPS *addressprop) {
    return This->lpVtbl->GetSender(This,addressprop);
}
static inline HRESULT IMimeAddressTable_CountTypes(IMimeAddressTable* This,DWORD addrtype,ULONG *count) {
    return This->lpVtbl->CountTypes(This,addrtype,count);
}
static inline HRESULT IMimeAddressTable_GetTypes(IMimeAddressTable* This,DWORD addrtype,DWORD dwProps,ADDRESSLIST *list) {
    return This->lpVtbl->GetTypes(This,addrtype,dwProps,list);
}
static inline HRESULT IMimeAddressTable_EnumTypes(IMimeAddressTable* This,DWORD addrtype,DWORD props,IMimeEnumAddressTypes **types) {
    return This->lpVtbl->EnumTypes(This,addrtype,props,types);
}
static inline HRESULT IMimeAddressTable_Delete(IMimeAddressTable* This,HADDRESS hAddress) {
    return This->lpVtbl->Delete(This,hAddress);
}
static inline HRESULT IMimeAddressTable_DeleteTypes(IMimeAddressTable* This,DWORD addrtype) {
    return This->lpVtbl->DeleteTypes(This,addrtype);
}
static inline HRESULT IMimeAddressTable_GetFormat(IMimeAddressTable* This,DWORD addrtype,ADDRESSFORMAT addrformat,char **format) {
    return This->lpVtbl->GetFormat(This,addrtype,addrformat,format);
}
static inline HRESULT IMimeAddressTable_AppendRfc822(IMimeAddressTable* This,DWORD addrtype,ENCODINGTYPE encoding,const char *rfcaddr) {
    return This->lpVtbl->AppendRfc822(This,addrtype,encoding,rfcaddr);
}
static inline HRESULT IMimeAddressTable_ParseRfc822(IMimeAddressTable* This,DWORD addrtype,ENCODINGTYPE encoding,const char *rfcaddr,ADDRESSLIST *list) {
    return This->lpVtbl->ParseRfc822(This,addrtype,encoding,rfcaddr,list);
}
static inline HRESULT IMimeAddressTable_Clone(IMimeAddressTable* This,IMimeAddressTable **table) {
    return This->lpVtbl->Clone(This,table);
}
static inline HRESULT IMimeAddressTable_BindToObject(IMimeAddressTable* This,REFIID riid,void **obj) {
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMimeWebDocument, 0xee519f11, 0x851a, 0x11d0, 0x82,0x5c, 0x00,0xc0,0x4f,0xd8,0x5a,0xb4)
#endif
#else
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeWebDocument_QueryInterface(IMimeWebDocument* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeWebDocument_AddRef(IMimeWebDocument* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeWebDocument_Release(IMimeWebDocument* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeBody_QueryInterface(IMimeBody* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeBody_AddRef(IMimeBody* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeBody_Release(IMimeBody* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
static inline HRESULT IMimeBody_GetClassID(IMimeBody* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
/*** IPersistStreamInit methods ***/
static inline HRESULT IMimeBody_IsDirty(IMimeBody* This) {
    return This->lpVtbl->IsDirty(This);
}
static inline HRESULT IMimeBody_Load(IMimeBody* This,LPSTREAM pStm) {
    return This->lpVtbl->Load(This,pStm);
}
static inline HRESULT IMimeBody_Save(IMimeBody* This,LPSTREAM pStm,BOOL fClearDirty) {
    return This->lpVtbl->Save(This,pStm,fClearDirty);
}
static inline HRESULT IMimeBody_GetSizeMax(IMimeBody* This,ULARGE_INTEGER *pcbSize) {
    return This->lpVtbl->GetSizeMax(This,pcbSize);
}
static inline HRESULT IMimeBody_InitNew(IMimeBody* This) {
    return This->lpVtbl->InitNew(This);
}
/*** IMimePropertySet methods ***/
static inline HRESULT IMimeBody_GetPropInfo(IMimeBody* This,LPCSTR pszName,LPMIMEPROPINFO pInfo) {
    return This->lpVtbl->GetPropInfo(This,pszName,pInfo);
}
static inline HRESULT IMimeBody_SetPropInfo(IMimeBody* This,LPCSTR pszName,LPCMIMEPROPINFO pInfo) {
    return This->lpVtbl->SetPropInfo(This,pszName,pInfo);
}
static inline HRESULT IMimeBody_GetProp(IMimeBody* This,LPCSTR pszName,DWORD dwFlags,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetProp(This,pszName,dwFlags,pValue);
}
static inline HRESULT IMimeBody_SetProp(IMimeBody* This,LPCSTR pszName,DWORD dwFlags,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetProp(This,pszName,dwFlags,pValue);
}
static inline HRESULT IMimeBody_AppendProp(IMimeBody* This,LPCSTR pszName,DWORD dwFlags,LPPROPVARIANT pValue) {
    return This->lpVtbl->AppendProp(This,pszName,dwFlags,pValue);
}
static inline HRESULT IMimeBody_DeleteProp(IMimeBody* This,LPCSTR pszName) {
    return This->lpVtbl->DeleteProp(This,pszName);
}
static inline HRESULT IMimeBody_CopyProps(IMimeBody* This,ULONG cNames,LPCSTR *prgszName,IMimePropertySet *pPropertySet) {
    return This->lpVtbl->CopyProps(This,cNames,prgszName,pPropertySet);
}
static inline HRESULT IMimeBody_MoveProps(IMimeBody* This,ULONG cNames,LPCSTR *prgszName,IMimePropertySet *pPropertySet) {
    return This->lpVtbl->MoveProps(This,cNames,prgszName,pPropertySet);
}
static inline HRESULT IMimeBody_DeleteExcept(IMimeBody* This,ULONG cNames,LPCSTR *prgszName) {
    return This->lpVtbl->DeleteExcept(This,cNames,prgszName);
}
static inline HRESULT IMimeBody_QueryProp(IMimeBody* This,LPCSTR pszName,LPCSTR pszCriteria,boolean fSubString,boolean fCaseSensitive) {
    return This->lpVtbl->QueryProp(This,pszName,pszCriteria,fSubString,fCaseSensitive);
}
static inline HRESULT IMimeBody_GetCharset(IMimeBody* This,LPHCHARSET phCharset) {
    return This->lpVtbl->GetCharset(This,phCharset);
}
static inline HRESULT IMimeBody_SetCharset(IMimeBody* This,HCHARSET hCharset,CSETAPPLYTYPE applytype) {
    return This->lpVtbl->SetCharset(This,hCharset,applytype);
}
static inline HRESULT IMimeBody_GetParameters(IMimeBody* This,LPCSTR pszName,ULONG *pcParams,LPMIMEPARAMINFO *pprgParam) {
    return This->lpVtbl->GetParameters(This,pszName,pcParams,pprgParam);
}
static inline HRESULT IMimeBody_IsContentType(IMimeBody* This,LPCSTR pszPriType,LPCSTR pszSubType) {
    return This->lpVtbl->IsContentType(This,pszPriType,pszSubType);
}
static inline HRESULT IMimeBody_BindToObject(IMimeBody* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->BindToObject(This,riid,ppvObject);
}
static inline HRESULT IMimeBody_Clone(IMimeBody* This,IMimePropertySet **ppPropertySet) {
    return This->lpVtbl->Clone(This,ppPropertySet);
}
static inline HRESULT IMimeBody_SetOption(IMimeBody* This,const TYPEDID oid,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetOption(This,oid,pValue);
}
static inline HRESULT IMimeBody_GetOption(IMimeBody* This,const TYPEDID oid,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetOption(This,oid,pValue);
}
static inline HRESULT IMimeBody_EnumProps(IMimeBody* This,DWORD dwFlags,IMimeEnumProperties **ppEnum) {
    return This->lpVtbl->EnumProps(This,dwFlags,ppEnum);
}
/*** IMimeBody methods ***/
static inline HRESULT IMimeBody_IsType(IMimeBody* This,IMSGBODYTYPE bodytype) {
    return This->lpVtbl->IsType(This,bodytype);
}
static inline HRESULT IMimeBody_SetDisplayName(IMimeBody* This,LPCSTR pszDisplay) {
    return This->lpVtbl->SetDisplayName(This,pszDisplay);
}
static inline HRESULT IMimeBody_GetDisplayName(IMimeBody* This,LPSTR *ppszDisplay) {
    return This->lpVtbl->GetDisplayName(This,ppszDisplay);
}
static inline HRESULT IMimeBody_GetOffsets(IMimeBody* This,LPBODYOFFSETS pOffsets) {
    return This->lpVtbl->GetOffsets(This,pOffsets);
}
static inline HRESULT IMimeBody_GetCurrentEncoding(IMimeBody* This,ENCODINGTYPE *pietEncoding) {
    return This->lpVtbl->GetCurrentEncoding(This,pietEncoding);
}
static inline HRESULT IMimeBody_SetCurrentEncoding(IMimeBody* This,ENCODINGTYPE ietEncoding) {
    return This->lpVtbl->SetCurrentEncoding(This,ietEncoding);
}
static inline HRESULT IMimeBody_GetEstimatedSize(IMimeBody* This,ENCODINGTYPE ietEncoding,ULONG *pcbSize) {
    return This->lpVtbl->GetEstimatedSize(This,ietEncoding,pcbSize);
}
static inline HRESULT IMimeBody_GetDataHere(IMimeBody* This,ENCODINGTYPE ietEncoding,IStream *pStream) {
    return This->lpVtbl->GetDataHere(This,ietEncoding,pStream);
}
static inline HRESULT IMimeBody_GetData(IMimeBody* This,ENCODINGTYPE ietEncoding,IStream **ppStream) {
    return This->lpVtbl->GetData(This,ietEncoding,ppStream);
}
static inline HRESULT IMimeBody_SetData(IMimeBody* This,ENCODINGTYPE ietEncoding,LPCSTR pszPriType,LPCSTR pszSubType,REFIID riid,LPVOID pvObject) {
    return This->lpVtbl->SetData(This,ietEncoding,pszPriType,pszSubType,riid,pvObject);
}
static inline HRESULT IMimeBody_EmptyData(IMimeBody* This) {
    return This->lpVtbl->EmptyData(This);
}
static inline HRESULT IMimeBody_CopyTo(IMimeBody* This,IMimeBody *pBody) {
    return This->lpVtbl->CopyTo(This,pBody);
}
static inline HRESULT IMimeBody_GetTransmitInfo(IMimeBody* This,LPTRANSMITINFO pTransmitInfo) {
    return This->lpVtbl->GetTransmitInfo(This,pTransmitInfo);
}
static inline HRESULT IMimeBody_SaveToFile(IMimeBody* This,ENCODINGTYPE ietEncoding,LPCSTR pszFilePath) {
    return This->lpVtbl->SaveToFile(This,ietEncoding,pszFilePath);
}
static inline HRESULT IMimeBody_GetHandle(IMimeBody* This,LPHBODY phBody) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeMessageTree_QueryInterface(IMimeMessageTree* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeMessageTree_AddRef(IMimeMessageTree* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeMessageTree_Release(IMimeMessageTree* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
static inline HRESULT IMimeMessageTree_GetClassID(IMimeMessageTree* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
/*** IPersistStreamInit methods ***/
static inline HRESULT IMimeMessageTree_IsDirty(IMimeMessageTree* This) {
    return This->lpVtbl->IsDirty(This);
}
static inline HRESULT IMimeMessageTree_Load(IMimeMessageTree* This,LPSTREAM pStm) {
    return This->lpVtbl->Load(This,pStm);
}
static inline HRESULT IMimeMessageTree_Save(IMimeMessageTree* This,LPSTREAM pStm,BOOL fClearDirty) {
    return This->lpVtbl->Save(This,pStm,fClearDirty);
}
static inline HRESULT IMimeMessageTree_GetSizeMax(IMimeMessageTree* This,ULARGE_INTEGER *pcbSize) {
    return This->lpVtbl->GetSizeMax(This,pcbSize);
}
static inline HRESULT IMimeMessageTree_InitNew(IMimeMessageTree* This) {
    return This->lpVtbl->InitNew(This);
}
/*** IMimeMessageTree methods ***/
static inline HRESULT IMimeMessageTree_GetMessageSource(IMimeMessageTree* This,IStream **ppStream,DWORD dwFlags) {
    return This->lpVtbl->GetMessageSource(This,ppStream,dwFlags);
}
static inline HRESULT IMimeMessageTree_GetMessageSize(IMimeMessageTree* This,ULONG *pcbSize,DWORD dwFlags) {
    return This->lpVtbl->GetMessageSize(This,pcbSize,dwFlags);
}
static inline HRESULT IMimeMessageTree_LoadOffsetTable(IMimeMessageTree* This,IStream *pStream) {
    return This->lpVtbl->LoadOffsetTable(This,pStream);
}
static inline HRESULT IMimeMessageTree_SaveOffsetTable(IMimeMessageTree* This,IStream *pStream,DWORD dwFlags) {
    return This->lpVtbl->SaveOffsetTable(This,pStream,dwFlags);
}
static inline HRESULT IMimeMessageTree_GetFlags(IMimeMessageTree* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetFlags(This,pdwFlags);
}
static inline HRESULT IMimeMessageTree_Commit(IMimeMessageTree* This,DWORD dwFlags) {
    return This->lpVtbl->Commit(This,dwFlags);
}
static inline HRESULT IMimeMessageTree_HandsOffStorage(IMimeMessageTree* This) {
    return This->lpVtbl->HandsOffStorage(This);
}
static inline HRESULT IMimeMessageTree_BindToObject(IMimeMessageTree* This,const HBODY hBody,REFIID riid,void **ppvObject) {
    return This->lpVtbl->BindToObject(This,hBody,riid,ppvObject);
}
static inline HRESULT IMimeMessageTree_SaveBody(IMimeMessageTree* This,HBODY hBody,DWORD dwFlags,IStream *pStream) {
    return This->lpVtbl->SaveBody(This,hBody,dwFlags,pStream);
}
static inline HRESULT IMimeMessageTree_InsertBody(IMimeMessageTree* This,BODYLOCATION location,HBODY hPivot,LPHBODY phBody) {
    return This->lpVtbl->InsertBody(This,location,hPivot,phBody);
}
static inline HRESULT IMimeMessageTree_GetBody(IMimeMessageTree* This,BODYLOCATION location,HBODY hPivot,LPHBODY phBody) {
    return This->lpVtbl->GetBody(This,location,hPivot,phBody);
}
static inline HRESULT IMimeMessageTree_DeleteBody(IMimeMessageTree* This,HBODY hBody,DWORD dwFlags) {
    return This->lpVtbl->DeleteBody(This,hBody,dwFlags);
}
static inline HRESULT IMimeMessageTree_MoveBody(IMimeMessageTree* This,HBODY hBody,BODYLOCATION location) {
    return This->lpVtbl->MoveBody(This,hBody,location);
}
static inline HRESULT IMimeMessageTree_CountBodies(IMimeMessageTree* This,HBODY hParent,boolean fRecurse,ULONG *pcBodies) {
    return This->lpVtbl->CountBodies(This,hParent,fRecurse,pcBodies);
}
static inline HRESULT IMimeMessageTree_FindFirst(IMimeMessageTree* This,LPFINDBODY pFindBody,LPHBODY phBody) {
    return This->lpVtbl->FindFirst(This,pFindBody,phBody);
}
static inline HRESULT IMimeMessageTree_FindNext(IMimeMessageTree* This,LPFINDBODY pFindBody,LPHBODY phBody) {
    return This->lpVtbl->FindNext(This,pFindBody,phBody);
}
static inline HRESULT IMimeMessageTree_ResolveURL(IMimeMessageTree* This,HBODY hRelated,LPCSTR pszBase,LPCSTR pszURL,DWORD dwFlags,LPHBODY phBody) {
    return This->lpVtbl->ResolveURL(This,hRelated,pszBase,pszURL,dwFlags,phBody);
}
static inline HRESULT IMimeMessageTree_ToMultipart(IMimeMessageTree* This,HBODY hBody,LPCSTR pszSubType,LPHBODY phMultipart) {
    return This->lpVtbl->ToMultipart(This,hBody,pszSubType,phMultipart);
}
static inline HRESULT IMimeMessageTree_GetBodyOffsets(IMimeMessageTree* This,HBODY hBody,LPBODYOFFSETS pOffsets) {
    return This->lpVtbl->GetBodyOffsets(This,hBody,pOffsets);
}
static inline HRESULT IMimeMessageTree_GetCharset(IMimeMessageTree* This,LPHCHARSET phCharset) {
    return This->lpVtbl->GetCharset(This,phCharset);
}
static inline HRESULT IMimeMessageTree_SetCharset(IMimeMessageTree* This,HCHARSET hCharset,CSETAPPLYTYPE applytype) {
    return This->lpVtbl->SetCharset(This,hCharset,applytype);
}
static inline HRESULT IMimeMessageTree_IsBodyType(IMimeMessageTree* This,HBODY hBody,IMSGBODYTYPE bodytype) {
    return This->lpVtbl->IsBodyType(This,hBody,bodytype);
}
static inline HRESULT IMimeMessageTree_IsContentType(IMimeMessageTree* This,HBODY hBody,LPCSTR pszPriType,LPCSTR pszSubType) {
    return This->lpVtbl->IsContentType(This,hBody,pszPriType,pszSubType);
}
static inline HRESULT IMimeMessageTree_QueryBodyProp(IMimeMessageTree* This,HBODY hBody,LPCSTR pszName,LPCSTR pszCriteria,boolean fSubString,boolean fCaseSensitive) {
    return This->lpVtbl->QueryBodyProp(This,hBody,pszName,pszCriteria,fSubString,fCaseSensitive);
}
static inline HRESULT IMimeMessageTree_GetBodyProp(IMimeMessageTree* This,HBODY hBody,LPCSTR pszName,DWORD dwFlags,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetBodyProp(This,hBody,pszName,dwFlags,pValue);
}
static inline HRESULT IMimeMessageTree_SetBodyProp(IMimeMessageTree* This,HBODY hBody,LPCSTR pszName,DWORD dwFlags,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetBodyProp(This,hBody,pszName,dwFlags,pValue);
}
static inline HRESULT IMimeMessageTree_DeleteBodyProp(IMimeMessageTree* This,HBODY hBody,LPCSTR pszName) {
    return This->lpVtbl->DeleteBodyProp(This,hBody,pszName);
}
static inline HRESULT IMimeMessageTree_SetOption(IMimeMessageTree* This,const TYPEDID oid,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetOption(This,oid,pValue);
}
static inline HRESULT IMimeMessageTree_GetOption(IMimeMessageTree* This,const TYPEDID oid,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetOption(This,oid,pValue);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeMessage_QueryInterface(IMimeMessage* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeMessage_AddRef(IMimeMessage* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeMessage_Release(IMimeMessage* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
static inline HRESULT IMimeMessage_GetClassID(IMimeMessage* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
/*** IPersistStreamInit methods ***/
static inline HRESULT IMimeMessage_IsDirty(IMimeMessage* This) {
    return This->lpVtbl->IsDirty(This);
}
static inline HRESULT IMimeMessage_Load(IMimeMessage* This,LPSTREAM pStm) {
    return This->lpVtbl->Load(This,pStm);
}
static inline HRESULT IMimeMessage_Save(IMimeMessage* This,LPSTREAM pStm,BOOL fClearDirty) {
    return This->lpVtbl->Save(This,pStm,fClearDirty);
}
static inline HRESULT IMimeMessage_GetSizeMax(IMimeMessage* This,ULARGE_INTEGER *pcbSize) {
    return This->lpVtbl->GetSizeMax(This,pcbSize);
}
static inline HRESULT IMimeMessage_InitNew(IMimeMessage* This) {
    return This->lpVtbl->InitNew(This);
}
/*** IMimeMessageTree methods ***/
static inline HRESULT IMimeMessage_GetMessageSource(IMimeMessage* This,IStream **ppStream,DWORD dwFlags) {
    return This->lpVtbl->GetMessageSource(This,ppStream,dwFlags);
}
static inline HRESULT IMimeMessage_GetMessageSize(IMimeMessage* This,ULONG *pcbSize,DWORD dwFlags) {
    return This->lpVtbl->GetMessageSize(This,pcbSize,dwFlags);
}
static inline HRESULT IMimeMessage_LoadOffsetTable(IMimeMessage* This,IStream *pStream) {
    return This->lpVtbl->LoadOffsetTable(This,pStream);
}
static inline HRESULT IMimeMessage_SaveOffsetTable(IMimeMessage* This,IStream *pStream,DWORD dwFlags) {
    return This->lpVtbl->SaveOffsetTable(This,pStream,dwFlags);
}
static inline HRESULT IMimeMessage_GetFlags(IMimeMessage* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetFlags(This,pdwFlags);
}
static inline HRESULT IMimeMessage_Commit(IMimeMessage* This,DWORD dwFlags) {
    return This->lpVtbl->Commit(This,dwFlags);
}
static inline HRESULT IMimeMessage_HandsOffStorage(IMimeMessage* This) {
    return This->lpVtbl->HandsOffStorage(This);
}
static inline HRESULT IMimeMessage_BindToObject(IMimeMessage* This,const HBODY hBody,REFIID riid,void **ppvObject) {
    return This->lpVtbl->BindToObject(This,hBody,riid,ppvObject);
}
static inline HRESULT IMimeMessage_SaveBody(IMimeMessage* This,HBODY hBody,DWORD dwFlags,IStream *pStream) {
    return This->lpVtbl->SaveBody(This,hBody,dwFlags,pStream);
}
static inline HRESULT IMimeMessage_InsertBody(IMimeMessage* This,BODYLOCATION location,HBODY hPivot,LPHBODY phBody) {
    return This->lpVtbl->InsertBody(This,location,hPivot,phBody);
}
static inline HRESULT IMimeMessage_GetBody(IMimeMessage* This,BODYLOCATION location,HBODY hPivot,LPHBODY phBody) {
    return This->lpVtbl->GetBody(This,location,hPivot,phBody);
}
static inline HRESULT IMimeMessage_DeleteBody(IMimeMessage* This,HBODY hBody,DWORD dwFlags) {
    return This->lpVtbl->DeleteBody(This,hBody,dwFlags);
}
static inline HRESULT IMimeMessage_MoveBody(IMimeMessage* This,HBODY hBody,BODYLOCATION location) {
    return This->lpVtbl->MoveBody(This,hBody,location);
}
static inline HRESULT IMimeMessage_CountBodies(IMimeMessage* This,HBODY hParent,boolean fRecurse,ULONG *pcBodies) {
    return This->lpVtbl->CountBodies(This,hParent,fRecurse,pcBodies);
}
static inline HRESULT IMimeMessage_FindFirst(IMimeMessage* This,LPFINDBODY pFindBody,LPHBODY phBody) {
    return This->lpVtbl->FindFirst(This,pFindBody,phBody);
}
static inline HRESULT IMimeMessage_FindNext(IMimeMessage* This,LPFINDBODY pFindBody,LPHBODY phBody) {
    return This->lpVtbl->FindNext(This,pFindBody,phBody);
}
static inline HRESULT IMimeMessage_ResolveURL(IMimeMessage* This,HBODY hRelated,LPCSTR pszBase,LPCSTR pszURL,DWORD dwFlags,LPHBODY phBody) {
    return This->lpVtbl->ResolveURL(This,hRelated,pszBase,pszURL,dwFlags,phBody);
}
static inline HRESULT IMimeMessage_ToMultipart(IMimeMessage* This,HBODY hBody,LPCSTR pszSubType,LPHBODY phMultipart) {
    return This->lpVtbl->ToMultipart(This,hBody,pszSubType,phMultipart);
}
static inline HRESULT IMimeMessage_GetBodyOffsets(IMimeMessage* This,HBODY hBody,LPBODYOFFSETS pOffsets) {
    return This->lpVtbl->GetBodyOffsets(This,hBody,pOffsets);
}
static inline HRESULT IMimeMessage_GetCharset(IMimeMessage* This,LPHCHARSET phCharset) {
    return This->lpVtbl->GetCharset(This,phCharset);
}
static inline HRESULT IMimeMessage_SetCharset(IMimeMessage* This,HCHARSET hCharset,CSETAPPLYTYPE applytype) {
    return This->lpVtbl->SetCharset(This,hCharset,applytype);
}
static inline HRESULT IMimeMessage_IsBodyType(IMimeMessage* This,HBODY hBody,IMSGBODYTYPE bodytype) {
    return This->lpVtbl->IsBodyType(This,hBody,bodytype);
}
static inline HRESULT IMimeMessage_IsContentType(IMimeMessage* This,HBODY hBody,LPCSTR pszPriType,LPCSTR pszSubType) {
    return This->lpVtbl->IsContentType(This,hBody,pszPriType,pszSubType);
}
static inline HRESULT IMimeMessage_QueryBodyProp(IMimeMessage* This,HBODY hBody,LPCSTR pszName,LPCSTR pszCriteria,boolean fSubString,boolean fCaseSensitive) {
    return This->lpVtbl->QueryBodyProp(This,hBody,pszName,pszCriteria,fSubString,fCaseSensitive);
}
static inline HRESULT IMimeMessage_GetBodyProp(IMimeMessage* This,HBODY hBody,LPCSTR pszName,DWORD dwFlags,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetBodyProp(This,hBody,pszName,dwFlags,pValue);
}
static inline HRESULT IMimeMessage_SetBodyProp(IMimeMessage* This,HBODY hBody,LPCSTR pszName,DWORD dwFlags,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetBodyProp(This,hBody,pszName,dwFlags,pValue);
}
static inline HRESULT IMimeMessage_DeleteBodyProp(IMimeMessage* This,HBODY hBody,LPCSTR pszName) {
    return This->lpVtbl->DeleteBodyProp(This,hBody,pszName);
}
static inline HRESULT IMimeMessage_SetOption(IMimeMessage* This,const TYPEDID oid,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetOption(This,oid,pValue);
}
static inline HRESULT IMimeMessage_GetOption(IMimeMessage* This,const TYPEDID oid,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetOption(This,oid,pValue);
}
/*** IMimeMessage methods ***/
static inline HRESULT IMimeMessage_CreateWebPage(IMimeMessage* This,IStream *pRootStm,LPWEBPAGEOPTIONS pOptions,IMimeMessageCallback *pCallback,IMoniker **ppMoniker) {
    return This->lpVtbl->CreateWebPage(This,pRootStm,pOptions,pCallback,ppMoniker);
}
static inline HRESULT IMimeMessage_GetProp(IMimeMessage* This,LPCSTR pszName,DWORD dwFlags,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetProp(This,pszName,dwFlags,pValue);
}
static inline HRESULT IMimeMessage_SetProp(IMimeMessage* This,LPCSTR pszName,DWORD dwFlags,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetProp(This,pszName,dwFlags,pValue);
}
static inline HRESULT IMimeMessage_DeleteProp(IMimeMessage* This,LPCSTR pszName) {
    return This->lpVtbl->DeleteProp(This,pszName);
}
static inline HRESULT IMimeMessage_QueryProp(IMimeMessage* This,LPCSTR pszName,LPCSTR pszCriteria,boolean fSubString,boolean fCaseSensitive) {
    return This->lpVtbl->QueryProp(This,pszName,pszCriteria,fSubString,fCaseSensitive);
}
static inline HRESULT IMimeMessage_GetTextBody(IMimeMessage* This,DWORD dwTxtType,ENCODINGTYPE ietEncoding,IStream **pStream,LPHBODY phBody) {
    return This->lpVtbl->GetTextBody(This,dwTxtType,ietEncoding,pStream,phBody);
}
static inline HRESULT IMimeMessage_SetTextBody(IMimeMessage* This,DWORD dwTxtType,ENCODINGTYPE ietEncoding,HBODY hAlternative,IStream *pStream,LPHBODY phBody) {
    return This->lpVtbl->SetTextBody(This,dwTxtType,ietEncoding,hAlternative,pStream,phBody);
}
static inline HRESULT IMimeMessage_AttachObject(IMimeMessage* This,REFIID riid,void *pvObject,LPHBODY phBody) {
    return This->lpVtbl->AttachObject(This,riid,pvObject,phBody);
}
static inline HRESULT IMimeMessage_AttachFile(IMimeMessage* This,LPCSTR pszFilePath,IStream *pstmFile,LPHBODY phBody) {
    return This->lpVtbl->AttachFile(This,pszFilePath,pstmFile,phBody);
}
static inline HRESULT IMimeMessage_AttachURL(IMimeMessage* This,LPCSTR pszBase,LPCSTR pszURL,DWORD dwFlags,IStream *pstmURL,LPSTR *ppszCIDURL,LPHBODY phBody) {
    return This->lpVtbl->AttachURL(This,pszBase,pszURL,dwFlags,pstmURL,ppszCIDURL,phBody);
}
static inline HRESULT IMimeMessage_GetAttachments(IMimeMessage* This,ULONG *pcAttach,LPHBODY *pprghAttach) {
    return This->lpVtbl->GetAttachments(This,pcAttach,pprghAttach);
}
static inline HRESULT IMimeMessage_GetAddressTable(IMimeMessage* This,IMimeAddressTable **ppTable) {
    return This->lpVtbl->GetAddressTable(This,ppTable);
}
static inline HRESULT IMimeMessage_GetSender(IMimeMessage* This,LPADDRESSPROPS pAddress) {
    return This->lpVtbl->GetSender(This,pAddress);
}
static inline HRESULT IMimeMessage_GetAddressTypes(IMimeMessage* This,DWORD dwAdrTypes,DWORD dwProps,LPADDRESSLIST pList) {
    return This->lpVtbl->GetAddressTypes(This,dwAdrTypes,dwProps,pList);
}
static inline HRESULT IMimeMessage_GetAddressFormat(IMimeMessage* This,DWORD dwAdrTypes,ADDRESSFORMAT format,LPSTR *ppszFormat) {
    return This->lpVtbl->GetAddressFormat(This,dwAdrTypes,format,ppszFormat);
}
static inline HRESULT IMimeMessage_EnumAddressTypes(IMimeMessage* This,DWORD dwAdrTypes,DWORD dwProps,IMimeEnumAddressTypes **ppEnum) {
    return This->lpVtbl->EnumAddressTypes(This,dwAdrTypes,dwProps,ppEnum);
}
static inline HRESULT IMimeMessage_SplitMessage(IMimeMessage* This,ULONG cbMaxPart,IMimeMessageParts **ppParts) {
    return This->lpVtbl->SplitMessage(This,cbMaxPart,ppParts);
}
static inline HRESULT IMimeMessage_GetRootMoniker(IMimeMessage* This,IMoniker **ppMoniker) {
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMimeMessageCallback, 0x761aa641, 0x7bda, 0x11d1, 0x8a,0xa9, 0x00,0xc0,0x4f,0xb9,0x51,0xf3)
#endif
#else
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeMessageCallback_QueryInterface(IMimeMessageCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeMessageCallback_AddRef(IMimeMessageCallback* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeMessageCallback_Release(IMimeMessageCallback* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimeMessageCallback methods ***/
static inline HRESULT IMimeMessageCallback_OnWebPageSplitter(IMimeMessageCallback* This,DWORD cInlined,IStream *ppStream) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPersistMime_QueryInterface(IPersistMime* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IPersistMime_AddRef(IPersistMime* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IPersistMime_Release(IPersistMime* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
static inline HRESULT IPersistMime_GetClassID(IPersistMime* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeMessageParts_QueryInterface(IMimeMessageParts* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeMessageParts_AddRef(IMimeMessageParts* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeMessageParts_Release(IMimeMessageParts* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeEnumProperties_QueryInterface(IMimeEnumProperties* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeEnumProperties_AddRef(IMimeEnumProperties* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeEnumProperties_Release(IMimeEnumProperties* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimeEnumProperties methods ***/
static inline HRESULT IMimeEnumProperties_Next(IMimeEnumProperties* This,ULONG cFetch,LPENUMPROPERTY prgProp,ULONG *pcFetched) {
    return This->lpVtbl->Next(This,cFetch,prgProp,pcFetched);
}
static inline HRESULT IMimeEnumProperties_Skip(IMimeEnumProperties* This,ULONG cItems) {
    return This->lpVtbl->Skip(This,cItems);
}
static inline HRESULT IMimeEnumProperties_Reset(IMimeEnumProperties* This) {
    return This->lpVtbl->Reset(This);
}
static inline HRESULT IMimeEnumProperties_Clone(IMimeEnumProperties* This,IMimeEnumProperties **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
static inline HRESULT IMimeEnumProperties_Count(IMimeEnumProperties* This,ULONG *pcItems) {
    return This->lpVtbl->Count(This,pcItems);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeEnumAddressTypes_QueryInterface(IMimeEnumAddressTypes* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeEnumAddressTypes_AddRef(IMimeEnumAddressTypes* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeEnumAddressTypes_Release(IMimeEnumAddressTypes* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeEnumMessageParts_QueryInterface(IMimeEnumMessageParts* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeEnumMessageParts_AddRef(IMimeEnumMessageParts* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeEnumMessageParts_Release(IMimeEnumMessageParts* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IHashTable_QueryInterface(IHashTable* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IHashTable_AddRef(IHashTable* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IHashTable_Release(IHashTable* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeAllocator_QueryInterface(IMimeAllocator* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeAllocator_AddRef(IMimeAllocator* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeAllocator_Release(IMimeAllocator* This) {
    return This->lpVtbl->Release(This);
}
/*** IMalloc methods ***/
static inline LPVOID IMimeAllocator_Alloc(IMimeAllocator* This,SIZE_T cb) {
    return This->lpVtbl->Alloc(This,cb);
}
static inline LPVOID IMimeAllocator_Realloc(IMimeAllocator* This,LPVOID pv,SIZE_T cb) {
    return This->lpVtbl->Realloc(This,pv,cb);
}
static inline void IMimeAllocator_Free(IMimeAllocator* This,LPVOID pv) {
    This->lpVtbl->Free(This,pv);
}
static inline SIZE_T IMimeAllocator_GetSize(IMimeAllocator* This,LPVOID pv) {
    return This->lpVtbl->GetSize(This,pv);
}
static inline int IMimeAllocator_DidAlloc(IMimeAllocator* This,LPVOID pv) {
    return This->lpVtbl->DidAlloc(This,pv);
}
static inline void IMimeAllocator_HeapMinimize(IMimeAllocator* This) {
    This->lpVtbl->HeapMinimize(This);
}
/*** IMimeAllocator methods ***/
static inline HRESULT IMimeAllocator_FreeParamInfoArray(IMimeAllocator* This,ULONG cParams,LPMIMEPARAMINFO prgParam,boolean fFreeArray) {
    return This->lpVtbl->FreeParamInfoArray(This,cParams,prgParam,fFreeArray);
}
static inline HRESULT IMimeAllocator_FreeAddressList(IMimeAllocator* This,LPADDRESSLIST pList) {
    return This->lpVtbl->FreeAddressList(This,pList);
}
static inline HRESULT IMimeAllocator_FreeAddressProps(IMimeAllocator* This,LPADDRESSPROPS pAddress) {
    return This->lpVtbl->FreeAddressProps(This,pAddress);
}
static inline HRESULT IMimeAllocator_ReleaseObjects(IMimeAllocator* This,ULONG cObjects,IUnknown **prgpUnknown,boolean fFreeArray) {
    return This->lpVtbl->ReleaseObjects(This,cObjects,prgpUnknown,fFreeArray);
}
static inline HRESULT IMimeAllocator_FreeEnumHeaderRowArray(IMimeAllocator* This,ULONG cRows,LPENUMHEADERROW prgRow,boolean fFreeArray) {
    return This->lpVtbl->FreeEnumHeaderRowArray(This,cRows,prgRow,fFreeArray);
}
static inline HRESULT IMimeAllocator_FreeEnumPropertyArray(IMimeAllocator* This,ULONG cProps,LPENUMPROPERTY prgProp,boolean fFreeArray) {
    return This->lpVtbl->FreeEnumPropertyArray(This,cProps,prgProp,fFreeArray);
}
static inline HRESULT IMimeAllocator_FreeThumbprint(IMimeAllocator* This,THUMBBLOB *pthumbprint) {
    return This->lpVtbl->FreeThumbprint(This,pthumbprint);
}
static inline HRESULT IMimeAllocator_PropVariantClear(IMimeAllocator* This,LPPROPVARIANT pProp) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeObjResolver_QueryInterface(IMimeObjResolver* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeObjResolver_AddRef(IMimeObjResolver* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeObjResolver_Release(IMimeObjResolver* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IFontCache_QueryInterface(IFontCache* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IFontCache_AddRef(IFontCache* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IFontCache_Release(IFontCache* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IFontCacheNotify_QueryInterface(IFontCacheNotify* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IFontCacheNotify_AddRef(IFontCacheNotify* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IFontCacheNotify_Release(IFontCacheNotify* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeEditTag_QueryInterface(IMimeEditTag* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeEditTag_AddRef(IMimeEditTag* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeEditTag_Release(IMimeEditTag* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeEditTagCollection_QueryInterface(IMimeEditTagCollection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeEditTagCollection_AddRef(IMimeEditTagCollection* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeEditTagCollection_Release(IMimeEditTagCollection* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMimeSecurityCallback_QueryInterface(IMimeSecurityCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMimeSecurityCallback_AddRef(IMimeSecurityCallback* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMimeSecurityCallback_Release(IMimeSecurityCallback* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
MIMEOLEAPI MimeOleSetCompatMode(DWORD);
MIMEOLEAPI MimeOleContentTypeFromUrl(LPCSTR,LPCSTR,LPSTR*);
MIMEOLEAPI MimeOleParseMhtmlUrl(LPSTR,LPSTR*,LPSTR*);
MIMEOLEAPI MimeOleObjectFromUrl(LPCSTR,BOOL,REFIID,LPVOID*,IUnknown**);
MIMEOLEAPI MimeOleObjectFromMoniker(BINDF,IMoniker*,IBindCtx*,REFIID,LPVOID*,IMoniker**);
MIMEOLEAPI MimeOleCombineURL(LPCSTR,ULONG,LPCSTR,ULONG,BOOL,LPSTR*);
MIMEOLEAPI MimeOleGetSubjectFileName(IMimePropertySet*,ULONG*,ULONG*,LPSTR,ULONG);
MIMEOLEAPI MimeOleCreateWebDocument(LPCSTR,LPCSTR,IMimeWebDocument**);
MIMEOLEAPI MimeOleGetRelatedSection(IMimeMessageTree*,boolean,LPHBODY,boolean*);
MIMEOLEAPI MimeOleGetMixedSection(IMimeMessageTree*,boolean,LPHBODY,boolean*);
MIMEOLEAPI MimeOleGetAlternativeSection(IMimeMessageTree*,LPHBODY,boolean*);
MIMEOLEAPI MimeOleGenerateCID(LPSTR,ULONG,boolean);
MIMEOLEAPI MimeOleGenerateMID(LPSTR,ULONG,boolean);
MIMEOLEAPI MimeOleCreateByteStream(IStream**);
MIMEOLEAPI MimeOlGetPropertySchema(IMimePropertySchema**);
MIMEOLEAPI MimeOleQueryString(LPCSTR,LPCSTR,boolean,boolean);
MIMEOLEAPI MimeOleGetPropA(IMimePropertySet*,LPCSTR,DWORD,LPSTR*);
MIMEOLEAPI MimeOleSetPropA(IMimePropertySet*,LPCSTR,DWORD,LPCSTR);
MIMEOLEAPI MimeOleGetPropW(IMimePropertySet*,LPCSTR,DWORD,LPWSTR*);
MIMEOLEAPI MimeOleSetPropW(IMimePropertySet*,LPCSTR,DWORD,LPCWSTR);
MIMEOLEAPI MimeOleGetBodyPropA(IMimeMessageTree*,HBODY,LPCSTR,DWORD,LPSTR*);
MIMEOLEAPI MimeOleSetBodyPropA(IMimeMessageTree*,HBODY,LPCSTR,DWORD,LPCSTR);
MIMEOLEAPI MimeOleGetBodyPropW(IMimeMessageTree*,HBODY,LPCSTR,DWORD,LPWSTR*);
MIMEOLEAPI MimeOleSetBodyPropW(IMimeMessageTree*,HBODY,LPCSTR,DWORD,LPCWSTR);
MIMEOLEAPI MimeOleCreateHeaderTable(IMimeHeaderTable**);
MIMEOLEAPI MimeOleVariantFree(LPPROPVARIANT);
MIMEOLEAPI MimeOleVariantCopy(LPPROPVARIANT,LPPROPVARIANT);
MIMEOLEAPI MimeOleGetExtClassId(LPCSTR,LPCLSID);
MIMEOLEAPI MimeOleEncodeHeader(HCHARSET,LPPROPVARIANT,LPSTR*,LPRFC1522INFO);
MIMEOLEAPI MimeOleDecodeHeader(HCHARSET,LPCSTR,LPPROPVARIANT,LPRFC1522INFO);
MIMEOLEAPI MimeOleRfc1522Decode(LPCSTR,LPSTR,ULONG,LPSTR*);
MIMEOLEAPI MimeOleRfc1522Encode(LPCSTR,HCHARSET,LPSTR*);
MIMEOLEAPI MimeOleGetInternat(IMimeInternational**);
MIMEOLEAPI MimeOleFindCharset(LPCSTR,LPHCHARSET);
MIMEOLEAPI MimeOleGetCharsetInfo(HCHARSET,LPINETCSETINFO);
MIMEOLEAPI MimeOleGetCodePageInfo(HCHARSET,LPCODEPAGEINFO);
MIMEOLEAPI MimeOleGetDefaultCharset(LPHCHARSET);
MIMEOLEAPI MimeOleSetDefaultCharset(HCHARSET);
MIMEOLEAPI MimeOleGetCodePageCharset(CODEPAGEID,CHARSETTYPE,LPHCHARSET);
MIMEOLEAPI MimeOleCreateVirtualStream(IStream**);
MIMEOLEAPI MimeOleOpenFileStream(LPCSTR,DWORD,DWORD,IStream**);
MIMEOLEAPI MimeOleIsTnefStream(IStream*);
MIMEOLEAPI MimeOleGenerateFileName(LPCSTR,LPCSTR,LPCSTR,LPSTR*);
MIMEOLEAPI MimeOleGetFileExtension(LPCSTR,LPSTR,ULONG);
MIMEOLEAPI MimeOleCreateSecurity(IMimeSecurity**);
MIMEOLEAPI MimeOleInetDateToFileTime(LPCSTR,LPFILETIME);
MIMEOLEAPI MimeOleFileTimeToInetDate(LPFILETIME,LPSTR,ULONG);
MIMEOLEAPI MimeOleCreateMessageParts(IMimeMessageParts**);
MIMEOLEAPI MimeOleGetAllocator(IMimeAllocator**);
MIMEOLEAPI MimeOleParseRfc822Address(DWORD,ENCODINGTYPE,LPCSTR,LPADDRESSLIST);
MIMEOLEAPI MimeOleCreateMessage(IUnknown*,IMimeMessage**);
MIMEOLEAPI MimeOleMergePartialHeaders(IStream*,IStream*);
MIMEOLEAPI MimeOleEscapeString(CODEPAGEID,LPCSTR,LPSTR*);
MIMEOLEAPI MimeOleGetExtContentType(LPCSTR,LPSTR*);
MIMEOLEAPI MimeOleGetContentTypeExt(LPCSTR,LPSTR*);
MIMEOLEAPI MimeOleGetFileInfo(LPSTR,LPSTR*,LPSTR*,LPSTR*,LPSTR*,LPSTR*);
MIMEOLEAPI MimeOleCreateBody(IMimeBody**);
MIMEOLEAPI MimeOleCreatePropertySet(IUnknown*,IMimePropertySet**);
MIMEOLEAPI MimeOleCreateMessageTree(IUnknown*,IMimeMessageTree**);
MIMEOLEAPI MimeOleGetCertsFromThumbprints(THUMBBLOB*,X509CERTRESULT*,const HCERTSTORE*,DWORD);
MIMEOLEAPI MimeOleSplitMessage(IMimeMessage*,ULONG,IMimeMessageParts**);
MIMEOLEAPI MimeOleClearDirtyTree(IMimeMessageTree*);
MIMEOLEAPI MimeOleConvertEnrichedToHTML(CODEPAGEID,IStream*,IStream*);
MIMEOLEAPI MimeOleSMimeCapsToDlg(LPBYTE,DWORD,DWORD,PCX509CERT*,HWND,DWORD,DWORD,DWORD);
MIMEOLEAPI MimeOleSMimeCapsFromDlg(HWND,DWORD,DWORD,DWORD,LPBYTE,DWORD*);
MIMEOLEAPI MimeOleSMimeCapInit(LPBYTE,DWORD,LPVOID*);
MIMEOLEAPI MimeOleSMimeCapAddSMimeCap(LPBYTE,DWORD,LPVOID);
MIMEOLEAPI MimeOleSMimeCapAddCert(LPBYTE,DWORD,BOOL,LPVOID);
MIMEOLEAPI MimeOleSMimeCapGetEncAlg(LPVOID,LPBYTE,DWORD*,DWORD*);
MIMEOLEAPI MimeOleSMimeCapGetHashAlg(LPVOID,LPBYTE,DWORD*,DWORD*);
MIMEOLEAPI MimeOleSMimeCapRelease(LPVOID);
MIMEOLEAPI MimeOleAlgNameFromSMimeap(LPBYTE,DWORD,LPCSTR*);
MIMEOLEAPI MimeOleAlgStrengthFromSMimeCap(LPBYTE,DWORD,BOOL,DWORD*);
MIMEOLEAPI MimeOleSMimeCapsFull(LPVOID,BOOL,BOOL,LPBYTE,DWORD*);
MIMEOLEAPI MimeOleCreateHashTable(DWORD,BOOL,IHashTable**);
MIMEOLEAPI MimeOleStripHeaders(IMimeMessage*,HBODY,LPCSTR,LPCSTR,IStream**);
MIMEOLEAPI MimeEditViewSource(HWND,IMimeMessage*);
MIMEOLEAPI MimeEditIsSafeToRun(HWND,LPCSTR);
MIMEOLEAPI MimeEditVerifyTrust(HWND,LPCSTR,LPCSTR);
MIMEOLEAPI MimeEditCreateMimeDocument(IUnknown*,IMimeMessage*,DWORD,IMimeMessage**);
MIMEOLEAPI MimeEditGetBackgroundImageUrl(IUnknown*,BSTR*);
MIMEOLEAPI MimeEditDocumentFromStream(IStream*,REFIID,void**);
MIMEOLEAPI MimeOleGetPropertySchema(IMimePropertySchema**);
MIMEOLEAPI MimeGetAddressFormatW(REFIID,void*,DWORD,ADDRESSFORMAT,WCHAR**);
