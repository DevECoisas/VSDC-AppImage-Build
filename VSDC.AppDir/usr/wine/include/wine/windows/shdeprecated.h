/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/shdeprecated.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITravelEntry_QueryInterface(ITravelEntry* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITravelEntry_AddRef(ITravelEntry* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITravelEntry_Release(ITravelEntry* This) {
    return This->lpVtbl->Release(This);
}
/*** ITravelEntry methods ***/
static inline HRESULT ITravelEntry_Invoke(ITravelEntry* This,IUnknown *punk) {
    return This->lpVtbl->Invoke(This,punk);
}
static inline HRESULT ITravelEntry_Update(ITravelEntry* This,IUnknown *punk,BOOL fIsLocalAnchor) {
    return This->lpVtbl->Update(This,punk,fIsLocalAnchor);
}
static inline HRESULT ITravelEntry_GetPidl(ITravelEntry* This,LPITEMIDLIST *ppidl) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITravelLog_QueryInterface(ITravelLog* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITravelLog_AddRef(ITravelLog* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITravelLog_Release(ITravelLog* This) {
    return This->lpVtbl->Release(This);
}
/*** ITravelLog methods ***/
static inline HRESULT ITravelLog_AddEntry(ITravelLog* This,IUnknown *punk,BOOL fIsLocalAnchor) {
    return This->lpVtbl->AddEntry(This,punk,fIsLocalAnchor);
}
static inline HRESULT ITravelLog_UpdateEntry(ITravelLog* This,IUnknown *punk,BOOL fIsLocalAnchor) {
    return This->lpVtbl->UpdateEntry(This,punk,fIsLocalAnchor);
}
static inline HRESULT ITravelLog_UpdateExternal(ITravelLog* This,IUnknown *punk,IUnknown *punkHLBrowseContext) {
    return This->lpVtbl->UpdateExternal(This,punk,punkHLBrowseContext);
}
static inline HRESULT ITravelLog_Travel(ITravelLog* This,IUnknown *punk,int iOffset) {
    return This->lpVtbl->Travel(This,punk,iOffset);
}
static inline HRESULT ITravelLog_GetTravelEntry(ITravelLog* This,IUnknown *punk,int iOffset,ITravelEntry **ppte) {
    return This->lpVtbl->GetTravelEntry(This,punk,iOffset,ppte);
}
static inline HRESULT ITravelLog_FindTravelEntry(ITravelLog* This,IUnknown *punk,LPCITEMIDLIST pidl,ITravelEntry **ppte) {
    return This->lpVtbl->FindTravelEntry(This,punk,pidl,ppte);
}
static inline HRESULT ITravelLog_GetToolTipText(ITravelLog* This,IUnknown *punk,int iOffset,int idsTemplate,LPWSTR pwzText,DWORD cchText) {
    return This->lpVtbl->GetToolTipText(This,punk,iOffset,idsTemplate,pwzText,cchText);
}
static inline HRESULT ITravelLog_InsertMenuEntries(ITravelLog* This,IUnknown *punk,HMENU hmenu,int nPos,int idFirst,int idLast,DWORD dwFlags) {
    return This->lpVtbl->InsertMenuEntries(This,punk,hmenu,nPos,idFirst,idLast,dwFlags);
}
static inline HRESULT ITravelLog_Clone(ITravelLog* This,ITravelLog **pptl) {
    return This->lpVtbl->Clone(This,pptl);
}
static inline DWORD ITravelLog_CountEntries(ITravelLog* This,IUnknown *punk) {
    return This->lpVtbl->CountEntries(This,punk);
}
static inline HRESULT ITravelLog_Revert(ITravelLog* This) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IExpDispSupport_QueryInterface(IExpDispSupport* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IExpDispSupport_AddRef(IExpDispSupport* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IExpDispSupport_Release(IExpDispSupport* This) {
    return This->lpVtbl->Release(This);
}
/*** IExpDispSupport methods ***/
static inline HRESULT IExpDispSupport_FindCIE4ConnectionPoint(IExpDispSupport* This,REFIID riid,CIE4ConnectionPoint **ppccp) {
    return This->lpVtbl->FindCIE4ConnectionPoint(This,riid,ppccp);
}
static inline HRESULT IExpDispSupport_OnTranslateAccelerator(IExpDispSupport* This,MSG *pMsg,DWORD grfModifiers) {
    return This->lpVtbl->OnTranslateAccelerator(This,pMsg,grfModifiers);
}
static inline HRESULT IExpDispSupport_OnInvoke(IExpDispSupport* This,DISPID dispidMember,REFIID iid,LCID lcid,WORD wFlags,DISPPARAMS *pdispparams,VARIANT *pVarResult,EXCEPINFO *pexcepinfo,UINT *puArgErr) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IBrowserService_QueryInterface(IBrowserService* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IBrowserService_AddRef(IBrowserService* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IBrowserService_Release(IBrowserService* This) {
    return This->lpVtbl->Release(This);
}
/*** IBrowserService methods ***/
static inline HRESULT IBrowserService_GetParentSite(IBrowserService* This,IOleInPlaceSite **ppipsite) {
    return This->lpVtbl->GetParentSite(This,ppipsite);
}
static inline HRESULT IBrowserService_SetTitle(IBrowserService* This,IShellView *psv,LPCWSTR pszName) {
    return This->lpVtbl->SetTitle(This,psv,pszName);
}
static inline HRESULT IBrowserService_GetTitle(IBrowserService* This,IShellView *psv,LPWSTR pszName,DWORD cchName) {
    return This->lpVtbl->GetTitle(This,psv,pszName,cchName);
}
static inline HRESULT IBrowserService_GetOleObject(IBrowserService* This,IOleObject **ppobjv) {
    return This->lpVtbl->GetOleObject(This,ppobjv);
}
static inline HRESULT IBrowserService_GetTravelLog(IBrowserService* This,ITravelLog **pptl) {
    return This->lpVtbl->GetTravelLog(This,pptl);
}
static inline HRESULT IBrowserService_ShowControlWindow(IBrowserService* This,UINT id,BOOL fShow) {
    return This->lpVtbl->ShowControlWindow(This,id,fShow);
}
static inline HRESULT IBrowserService_IsControlWindowShown(IBrowserService* This,UINT id,BOOL *pfShown) {
    return This->lpVtbl->IsControlWindowShown(This,id,pfShown);
}
static inline HRESULT IBrowserService_IEGetDisplayName(IBrowserService* This,PCIDLIST_ABSOLUTE pidl,LPWSTR pwszName,UINT uFlags) {
    return This->lpVtbl->IEGetDisplayName(This,pidl,pwszName,uFlags);
}
static inline HRESULT IBrowserService_IEParseDisplayName(IBrowserService* This,UINT uiCP,LPCWSTR pwszPath,PIDLIST_ABSOLUTE *ppidlOut) {
    return This->lpVtbl->IEParseDisplayName(This,uiCP,pwszPath,ppidlOut);
}
static inline HRESULT IBrowserService_DisplayParseError(IBrowserService* This,HRESULT hres,LPCWSTR pwszPath) {
    return This->lpVtbl->DisplayParseError(This,hres,pwszPath);
}
static inline HRESULT IBrowserService_NavigateToPidl(IBrowserService* This,PCIDLIST_ABSOLUTE pidl,DWORD grfHLNF) {
    return This->lpVtbl->NavigateToPidl(This,pidl,grfHLNF);
}
static inline HRESULT IBrowserService_SetNavigateState(IBrowserService* This,BNSTATE bnstate) {
    return This->lpVtbl->SetNavigateState(This,bnstate);
}
static inline HRESULT IBrowserService_GetNavigateState(IBrowserService* This,BNSTATE *pbnstate) {
    return This->lpVtbl->GetNavigateState(This,pbnstate);
}
static inline HRESULT IBrowserService_NotifyRedirect(IBrowserService* This,IShellView *psv,PCIDLIST_ABSOLUTE pidl,BOOL *pfDidBrowse) {
    return This->lpVtbl->NotifyRedirect(This,psv,pidl,pfDidBrowse);
}
static inline HRESULT IBrowserService_UpdateWindowList(IBrowserService* This) {
    return This->lpVtbl->UpdateWindowList(This);
}
static inline HRESULT IBrowserService_UpdateBackForwardState(IBrowserService* This) {
    return This->lpVtbl->UpdateBackForwardState(This);
}
static inline HRESULT IBrowserService_SetFlags(IBrowserService* This,DWORD dwFlags,DWORD dwFlagMask) {
    return This->lpVtbl->SetFlags(This,dwFlags,dwFlagMask);
}
static inline HRESULT IBrowserService_GetFlags(IBrowserService* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetFlags(This,pdwFlags);
}
static inline HRESULT IBrowserService_CanNavigateNow(IBrowserService* This) {
    return This->lpVtbl->CanNavigateNow(This);
}
static inline HRESULT IBrowserService_GetPidl(IBrowserService* This,PIDLIST_ABSOLUTE *ppidl) {
    return This->lpVtbl->GetPidl(This,ppidl);
}
static inline HRESULT IBrowserService_SetReferrer(IBrowserService* This,PCIDLIST_ABSOLUTE pidl) {
    return This->lpVtbl->SetReferrer(This,pidl);
}
static inline DWORD IBrowserService_GetBrowserIndex(IBrowserService* This) {
    return This->lpVtbl->GetBrowserIndex(This);
}
static inline HRESULT IBrowserService_GetBrowserByIndex(IBrowserService* This,DWORD dwID,IUnknown **ppunk) {
    return This->lpVtbl->GetBrowserByIndex(This,dwID,ppunk);
}
static inline HRESULT IBrowserService_GetHistoryObject(IBrowserService* This,IOleObject **ppole,IStream **pstm,IBindCtx **ppbc) {
    return This->lpVtbl->GetHistoryObject(This,ppole,pstm,ppbc);
}
static inline HRESULT IBrowserService_SetHistoryObject(IBrowserService* This,IOleObject *pole,BOOL fIsLocalAnchor) {
    return This->lpVtbl->SetHistoryObject(This,pole,fIsLocalAnchor);
}
static inline HRESULT IBrowserService_CacheOLEServer(IBrowserService* This,IOleObject *pole) {
    return This->lpVtbl->CacheOLEServer(This,pole);
}
static inline HRESULT IBrowserService_GetSetCodePage(IBrowserService* This,VARIANT *pvarIn,VARIANT *pvarOut) {
    return This->lpVtbl->GetSetCodePage(This,pvarIn,pvarOut);
}
static inline HRESULT IBrowserService_OnHttpEquiv(IBrowserService* This,IShellView *psv,BOOL fDone,VARIANT *pvarargIn,VARIANT *pvarargOut) {
    return This->lpVtbl->OnHttpEquiv(This,psv,fDone,pvarargIn,pvarargOut);
}
static inline HRESULT IBrowserService_GetPalette(IBrowserService* This,HPALETTE *hpal) {
    return This->lpVtbl->GetPalette(This,hpal);
}
static inline HRESULT IBrowserService_RegisterWindow(IBrowserService* This,BOOL fForceRegister,int swc) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IShellService_QueryInterface(IShellService* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IShellService_AddRef(IShellService* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IShellService_Release(IShellService* This) {
    return This->lpVtbl->Release(This);
}
/*** IShellService methods ***/
static inline HRESULT IShellService_SetOwner(IShellService* This,IUnknown *pUnk) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IBrowserService2_QueryInterface(IBrowserService2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IBrowserService2_AddRef(IBrowserService2* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IBrowserService2_Release(IBrowserService2* This) {
    return This->lpVtbl->Release(This);
}
/*** IBrowserService methods ***/
static inline HRESULT IBrowserService2_GetParentSite(IBrowserService2* This,IOleInPlaceSite **ppipsite) {
    return This->lpVtbl->GetParentSite(This,ppipsite);
}
static inline HRESULT IBrowserService2_SetTitle(IBrowserService2* This,IShellView *psv,LPCWSTR pszName) {
    return This->lpVtbl->SetTitle(This,psv,pszName);
}
static inline HRESULT IBrowserService2_GetTitle(IBrowserService2* This,IShellView *psv,LPWSTR pszName,DWORD cchName) {
    return This->lpVtbl->GetTitle(This,psv,pszName,cchName);
}
static inline HRESULT IBrowserService2_GetOleObject(IBrowserService2* This,IOleObject **ppobjv) {
    return This->lpVtbl->GetOleObject(This,ppobjv);
}
static inline HRESULT IBrowserService2_GetTravelLog(IBrowserService2* This,ITravelLog **pptl) {
    return This->lpVtbl->GetTravelLog(This,pptl);
}
static inline HRESULT IBrowserService2_ShowControlWindow(IBrowserService2* This,UINT id,BOOL fShow) {
    return This->lpVtbl->ShowControlWindow(This,id,fShow);
}
static inline HRESULT IBrowserService2_IsControlWindowShown(IBrowserService2* This,UINT id,BOOL *pfShown) {
    return This->lpVtbl->IsControlWindowShown(This,id,pfShown);
}
static inline HRESULT IBrowserService2_IEGetDisplayName(IBrowserService2* This,PCIDLIST_ABSOLUTE pidl,LPWSTR pwszName,UINT uFlags) {
    return This->lpVtbl->IEGetDisplayName(This,pidl,pwszName,uFlags);
}
static inline HRESULT IBrowserService2_IEParseDisplayName(IBrowserService2* This,UINT uiCP,LPCWSTR pwszPath,PIDLIST_ABSOLUTE *ppidlOut) {
    return This->lpVtbl->IEParseDisplayName(This,uiCP,pwszPath,ppidlOut);
}
static inline HRESULT IBrowserService2_DisplayParseError(IBrowserService2* This,HRESULT hres,LPCWSTR pwszPath) {
    return This->lpVtbl->DisplayParseError(This,hres,pwszPath);
}
static inline HRESULT IBrowserService2_NavigateToPidl(IBrowserService2* This,PCIDLIST_ABSOLUTE pidl,DWORD grfHLNF) {
    return This->lpVtbl->NavigateToPidl(This,pidl,grfHLNF);
}
static inline HRESULT IBrowserService2_SetNavigateState(IBrowserService2* This,BNSTATE bnstate) {
    return This->lpVtbl->SetNavigateState(This,bnstate);
}
static inline HRESULT IBrowserService2_GetNavigateState(IBrowserService2* This,BNSTATE *pbnstate) {
    return This->lpVtbl->GetNavigateState(This,pbnstate);
}
static inline HRESULT IBrowserService2_NotifyRedirect(IBrowserService2* This,IShellView *psv,PCIDLIST_ABSOLUTE pidl,BOOL *pfDidBrowse) {
    return This->lpVtbl->NotifyRedirect(This,psv,pidl,pfDidBrowse);
}
static inline HRESULT IBrowserService2_UpdateWindowList(IBrowserService2* This) {
    return This->lpVtbl->UpdateWindowList(This);
}
static inline HRESULT IBrowserService2_UpdateBackForwardState(IBrowserService2* This) {
    return This->lpVtbl->UpdateBackForwardState(This);
}
static inline HRESULT IBrowserService2_SetFlags(IBrowserService2* This,DWORD dwFlags,DWORD dwFlagMask) {
    return This->lpVtbl->SetFlags(This,dwFlags,dwFlagMask);
}
static inline HRESULT IBrowserService2_GetFlags(IBrowserService2* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetFlags(This,pdwFlags);
}
static inline HRESULT IBrowserService2_CanNavigateNow(IBrowserService2* This) {
    return This->lpVtbl->CanNavigateNow(This);
}
static inline HRESULT IBrowserService2_GetPidl(IBrowserService2* This,PIDLIST_ABSOLUTE *ppidl) {
    return This->lpVtbl->GetPidl(This,ppidl);
}
static inline HRESULT IBrowserService2_SetReferrer(IBrowserService2* This,PCIDLIST_ABSOLUTE pidl) {
    return This->lpVtbl->SetReferrer(This,pidl);
}
static inline DWORD IBrowserService2_GetBrowserIndex(IBrowserService2* This) {
    return This->lpVtbl->GetBrowserIndex(This);
}
static inline HRESULT IBrowserService2_GetBrowserByIndex(IBrowserService2* This,DWORD dwID,IUnknown **ppunk) {
    return This->lpVtbl->GetBrowserByIndex(This,dwID,ppunk);
}
static inline HRESULT IBrowserService2_GetHistoryObject(IBrowserService2* This,IOleObject **ppole,IStream **pstm,IBindCtx **ppbc) {
    return This->lpVtbl->GetHistoryObject(This,ppole,pstm,ppbc);
}
static inline HRESULT IBrowserService2_SetHistoryObject(IBrowserService2* This,IOleObject *pole,BOOL fIsLocalAnchor) {
    return This->lpVtbl->SetHistoryObject(This,pole,fIsLocalAnchor);
}
static inline HRESULT IBrowserService2_CacheOLEServer(IBrowserService2* This,IOleObject *pole) {
    return This->lpVtbl->CacheOLEServer(This,pole);
}
static inline HRESULT IBrowserService2_GetSetCodePage(IBrowserService2* This,VARIANT *pvarIn,VARIANT *pvarOut) {
    return This->lpVtbl->GetSetCodePage(This,pvarIn,pvarOut);
}
static inline HRESULT IBrowserService2_OnHttpEquiv(IBrowserService2* This,IShellView *psv,BOOL fDone,VARIANT *pvarargIn,VARIANT *pvarargOut) {
    return This->lpVtbl->OnHttpEquiv(This,psv,fDone,pvarargIn,pvarargOut);
}
static inline HRESULT IBrowserService2_GetPalette(IBrowserService2* This,HPALETTE *hpal) {
    return This->lpVtbl->GetPalette(This,hpal);
}
static inline HRESULT IBrowserService2_RegisterWindow(IBrowserService2* This,BOOL fForceRegister,int swc) {
    return This->lpVtbl->RegisterWindow(This,fForceRegister,swc);
}
/*** IBrowserService2 methods ***/
static inline LRESULT IBrowserService2_WndProcBS(IBrowserService2* This,HWND hwnd,UINT uMsg,WPARAM wParam,LPARAM lParam) {
    return This->lpVtbl->WndProcBS(This,hwnd,uMsg,wParam,lParam);
}
static inline HRESULT IBrowserService2_SetAsDefFolderSettings(IBrowserService2* This) {
    return This->lpVtbl->SetAsDefFolderSettings(This);
}
static inline HRESULT IBrowserService2_GetViewRect(IBrowserService2* This,RECT *prc) {
    return This->lpVtbl->GetViewRect(This,prc);
}
static inline HRESULT IBrowserService2_OnSize(IBrowserService2* This,WPARAM wParam) {
    return This->lpVtbl->OnSize(This,wParam);
}
static inline HRESULT IBrowserService2_OnCreate(IBrowserService2* This,struct tagCREATESTRUCTW *pcs) {
    return This->lpVtbl->OnCreate(This,pcs);
}
static inline LRESULT IBrowserService2_OnCommand(IBrowserService2* This,WPARAM wParam,LPARAM lParam) {
    return This->lpVtbl->OnCommand(This,wParam,lParam);
}
static inline HRESULT IBrowserService2_OnDestroy(IBrowserService2* This) {
    return This->lpVtbl->OnDestroy(This);
}
static inline LRESULT IBrowserService2_OnNotify(IBrowserService2* This,struct tagNMHDR *pnm) {
    return This->lpVtbl->OnNotify(This,pnm);
}
static inline HRESULT IBrowserService2_OnSetFocus(IBrowserService2* This) {
    return This->lpVtbl->OnSetFocus(This);
}
static inline HRESULT IBrowserService2_OnFrameWindowActivateBS(IBrowserService2* This,BOOL fActive) {
    return This->lpVtbl->OnFrameWindowActivateBS(This,fActive);
}
static inline HRESULT IBrowserService2_ReleaseShellView(IBrowserService2* This) {
    return This->lpVtbl->ReleaseShellView(This);
}
static inline HRESULT IBrowserService2_ActivatePendingView(IBrowserService2* This) {
    return This->lpVtbl->ActivatePendingView(This);
}
static inline HRESULT IBrowserService2_CreateViewWindow(IBrowserService2* This,IShellView *psvNew,IShellView *psvOld,LPRECT prcView,HWND *phwnd) {
    return This->lpVtbl->CreateViewWindow(This,psvNew,psvOld,prcView,phwnd);
}
static inline HRESULT IBrowserService2_CreateBrowserPropSheetExt(IBrowserService2* This,REFIID riid,void **ppv) {
    return This->lpVtbl->CreateBrowserPropSheetExt(This,riid,ppv);
}
static inline HRESULT IBrowserService2_GetViewWindow(IBrowserService2* This,HWND *phwndView) {
    return This->lpVtbl->GetViewWindow(This,phwndView);
}
static inline HRESULT IBrowserService2_GetBaseBrowserData(IBrowserService2* This,LPCBASEBROWSERDATA *pbbd) {
    return This->lpVtbl->GetBaseBrowserData(This,pbbd);
}
static inline LPBASEBROWSERDATA IBrowserService2_PutBaseBrowserData(IBrowserService2* This) {
    return This->lpVtbl->PutBaseBrowserData(This);
}
static inline HRESULT IBrowserService2_InitializeTravelLog(IBrowserService2* This,ITravelLog *ptl,DWORD dw) {
    return This->lpVtbl->InitializeTravelLog(This,ptl,dw);
}
static inline HRESULT IBrowserService2_SetTopBrowser(IBrowserService2* This) {
    return This->lpVtbl->SetTopBrowser(This);
}
static inline HRESULT IBrowserService2_Offline(IBrowserService2* This,int iCmd) {
    return This->lpVtbl->Offline(This,iCmd);
}
static inline HRESULT IBrowserService2_AllowViewResize(IBrowserService2* This,BOOL f) {
    return This->lpVtbl->AllowViewResize(This,f);
}
static inline HRESULT IBrowserService2_SetActivateState(IBrowserService2* This,UINT u) {
    return This->lpVtbl->SetActivateState(This,u);
}
static inline HRESULT IBrowserService2_UpdateSecureLockIcon(IBrowserService2* This,int eSecureLock) {
    return This->lpVtbl->UpdateSecureLockIcon(This,eSecureLock);
}
static inline HRESULT IBrowserService2_InitializeDownloadManager(IBrowserService2* This) {
    return This->lpVtbl->InitializeDownloadManager(This);
}
static inline HRESULT IBrowserService2_InitializeTransitionSite(IBrowserService2* This) {
    return This->lpVtbl->InitializeTransitionSite(This);
}
static inline HRESULT IBrowserService2__Initialize(IBrowserService2* This,HWND hwnd,IUnknown *pauto) {
    return This->lpVtbl->_Initialize(This,hwnd,pauto);
}
static inline HRESULT IBrowserService2__CancelPendingNavigationAsync(IBrowserService2* This) {
    return This->lpVtbl->_CancelPendingNavigationAsync(This);
}
static inline HRESULT IBrowserService2__CancelPendingView(IBrowserService2* This) {
    return This->lpVtbl->_CancelPendingView(This);
}
static inline HRESULT IBrowserService2__MaySaveChanges(IBrowserService2* This) {
    return This->lpVtbl->_MaySaveChanges(This);
}
static inline HRESULT IBrowserService2__PauseOrResumeView(IBrowserService2* This,BOOL fPaused) {
    return This->lpVtbl->_PauseOrResumeView(This,fPaused);
}
static inline HRESULT IBrowserService2__DisableModeless(IBrowserService2* This) {
    return This->lpVtbl->_DisableModeless(This);
}
static inline HRESULT IBrowserService2__NavigateToPidl(IBrowserService2* This,LPCITEMIDLIST pidl,DWORD grfHLNF,DWORD dwFlags) {
    return This->lpVtbl->_NavigateToPidl(This,pidl,grfHLNF,dwFlags);
}
static inline HRESULT IBrowserService2__TryShell2Rename(IBrowserService2* This,IShellView *psv,LPCITEMIDLIST pidlNew) {
    return This->lpVtbl->_TryShell2Rename(This,psv,pidlNew);
}
static inline HRESULT IBrowserService2__SwitchActivationNow(IBrowserService2* This) {
    return This->lpVtbl->_SwitchActivationNow(This);
}
static inline HRESULT IBrowserService2__ExecChildren(IBrowserService2* This,IUnknown *punkBar,BOOL fBroadcast,const GUID *pguidCmdGroup,DWORD nCmdID,DWORD nCmdexecopt,VARIANTARG *pvarargIn,VARIANTARG *pvarargOut) {
    return This->lpVtbl->_ExecChildren(This,punkBar,fBroadcast,pguidCmdGroup,nCmdID,nCmdexecopt,pvarargIn,pvarargOut);
}
static inline HRESULT IBrowserService2__SendChildren(IBrowserService2* This,HWND hwndBar,BOOL fBroadcast,UINT uMsg,WPARAM wParam,LPARAM lParam) {
    return This->lpVtbl->_SendChildren(This,hwndBar,fBroadcast,uMsg,wParam,lParam);
}
static inline HRESULT IBrowserService2_GetFolderSetData(IBrowserService2* This,struct tagFolderSetData *pfsd) {
    return This->lpVtbl->GetFolderSetData(This,pfsd);
}
static inline HRESULT IBrowserService2__OnFocusChange(IBrowserService2* This,UINT itb) {
    return This->lpVtbl->_OnFocusChange(This,itb);
}
static inline HRESULT IBrowserService2_v_ShowHideChildWindows(IBrowserService2* This,BOOL fChildOnly) {
    return This->lpVtbl->v_ShowHideChildWindows(This,fChildOnly);
}
static inline UINT IBrowserService2__get_itbLastFocus(IBrowserService2* This) {
    return This->lpVtbl->_get_itbLastFocus(This);
}
static inline HRESULT IBrowserService2__put_itbLastFocus(IBrowserService2* This,UINT itbLastFocus) {
    return This->lpVtbl->_put_itbLastFocus(This,itbLastFocus);
}
static inline HRESULT IBrowserService2__UIActivateView(IBrowserService2* This,UINT uState) {
    return This->lpVtbl->_UIActivateView(This,uState);
}
static inline HRESULT IBrowserService2__GetViewBorderRect(IBrowserService2* This,RECT *prc) {
    return This->lpVtbl->_GetViewBorderRect(This,prc);
}
static inline HRESULT IBrowserService2__UpdateViewRectSize(IBrowserService2* This) {
    return This->lpVtbl->_UpdateViewRectSize(This);
}
static inline HRESULT IBrowserService2__ResizeNextBorder(IBrowserService2* This,UINT itb) {
    return This->lpVtbl->_ResizeNextBorder(This,itb);
}
static inline HRESULT IBrowserService2__ResizeView(IBrowserService2* This) {
    return This->lpVtbl->_ResizeView(This);
}
static inline HRESULT IBrowserService2__GetEffectiveClientArea(IBrowserService2* This,LPRECT lprectBorder,HMONITOR hmon) {
    return This->lpVtbl->_GetEffectiveClientArea(This,lprectBorder,hmon);
}
static inline IStream * IBrowserService2_v_GetViewStream(IBrowserService2* This,LPCITEMIDLIST pidl,DWORD grfMode,LPCWSTR pwszName) {
    return This->lpVtbl->v_GetViewStream(This,pidl,grfMode,pwszName);
}
static inline LRESULT IBrowserService2_ForwardViewMsg(IBrowserService2* This,UINT uMsg,WPARAM wParam,LPARAM lParam) {
    return This->lpVtbl->ForwardViewMsg(This,uMsg,wParam,lParam);
}
static inline HRESULT IBrowserService2_SetAcceleratorMenu(IBrowserService2* This,HACCEL hacc) {
    return This->lpVtbl->SetAcceleratorMenu(This,hacc);
}
static inline int IBrowserService2__GetToolbarCount(IBrowserService2* This) {
    return This->lpVtbl->_GetToolbarCount(This);
}
static inline LPTOOLBARITEM IBrowserService2__GetToolbarItem(IBrowserService2* This,int itb) {
    return This->lpVtbl->_GetToolbarItem(This,itb);
}
static inline HRESULT IBrowserService2__SaveToolbars(IBrowserService2* This,IStream *pstm) {
    return This->lpVtbl->_SaveToolbars(This,pstm);
}
static inline HRESULT IBrowserService2__LoadToolbars(IBrowserService2* This,IStream *pstm) {
    return This->lpVtbl->_LoadToolbars(This,pstm);
}
static inline HRESULT IBrowserService2__CloseAndReleaseToolbars(IBrowserService2* This,BOOL fClose) {
    return This->lpVtbl->_CloseAndReleaseToolbars(This,fClose);
}
static inline HRESULT IBrowserService2_v_MayGetNextToolbarFocus(IBrowserService2* This,LPMSG lpMsg,UINT itbNext,int citb,LPTOOLBARITEM *pptbi,HWND *phwnd) {
    return This->lpVtbl->v_MayGetNextToolbarFocus(This,lpMsg,itbNext,citb,pptbi,phwnd);
}
static inline HRESULT IBrowserService2__ResizeNextBorderHelper(IBrowserService2* This,UINT itb,BOOL bUseHmonitor) {
    return This->lpVtbl->_ResizeNextBorderHelper(This,itb,bUseHmonitor);
}
static inline UINT IBrowserService2__FindTBar(IBrowserService2* This,IUnknown *punkSrc) {
    return This->lpVtbl->_FindTBar(This,punkSrc);
}
static inline HRESULT IBrowserService2__SetFocus(IBrowserService2* This,LPTOOLBARITEM ptbi,HWND hwnd,LPMSG lpMsg) {
    return This->lpVtbl->_SetFocus(This,ptbi,hwnd,lpMsg);
}
static inline HRESULT IBrowserService2_v_MayTranslateAccelerator(IBrowserService2* This,MSG *pmsg) {
    return This->lpVtbl->v_MayTranslateAccelerator(This,pmsg);
}
static inline HRESULT IBrowserService2__GetBorderDWHelper(IBrowserService2* This,IUnknown *punkSrc,LPRECT lprectBorder,BOOL bUseHmonitor) {
    return This->lpVtbl->_GetBorderDWHelper(This,punkSrc,lprectBorder,bUseHmonitor);
}
static inline HRESULT IBrowserService2_v_CheckZoneCrossing(IBrowserService2* This,LPCITEMIDLIST pidl) {
