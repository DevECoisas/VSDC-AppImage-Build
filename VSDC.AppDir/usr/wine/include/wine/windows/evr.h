/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/evr.idl - Do not edit ***/
...
static inline HRESULT IMFVideoPresenter_OnClockStop(IMFVideoPresenter* This,MFTIME hnssSystemTime) {
...
/*** IMFTopologyServiceLookup methods ***/
static inline HRESULT IMFTopologyServiceLookup_LookupService(IMFTopologyServiceLookup* This,MF_SERVICE_LOOKUP_TYPE lookup_type,DWORD index,REFGUID service,REFIID riid,void **objects,DWORD *num_objects) {
...
/*** IMFTopologyServiceLookupClient methods ***/
static inline HRESULT IMFTopologyServiceLookupClient_InitServicePointers(IMFTopologyServiceLookupClient* This,IMFTopologyServiceLookup *service_lookup) {
...
/*** IMFVideoDeviceID methods ***/
static inline HRESULT IMFVideoDeviceID_GetDeviceID(IMFVideoDeviceID* This,IID *device_id) {
...
/*** IMFVideoMixerControl methods ***/
static inline HRESULT IMFVideoMixerControl_SetStreamZOrder(IMFVideoMixerControl* This,DWORD stream_id,DWORD zorder) {
    return This->lpVtbl->SetStreamZOrder(This,stream_id,zorder);
}
static inline HRESULT IMFVideoMixerControl_GetStreamZOrder(IMFVideoMixerControl* This,DWORD stream_id,DWORD *zorder) {
    return This->lpVtbl->GetStreamZOrder(This,stream_id,zorder);
}
static inline HRESULT IMFVideoMixerControl_SetStreamOutputRect(IMFVideoMixerControl* This,DWORD stream_id,const MFVideoNormalizedRect *rect) {
    return This->lpVtbl->SetStreamOutputRect(This,stream_id,rect);
}
static inline HRESULT IMFVideoMixerControl_GetStreamOutputRect(IMFVideoMixerControl* This,DWORD stream_id,MFVideoNormalizedRect *rect) {
...
/*** IMFVideoMixerControl methods ***/
static inline HRESULT IMFVideoMixerControl2_SetStreamZOrder(IMFVideoMixerControl2* This,DWORD stream_id,DWORD zorder) {
    return This->lpVtbl->SetStreamZOrder(This,stream_id,zorder);
}
static inline HRESULT IMFVideoMixerControl2_GetStreamZOrder(IMFVideoMixerControl2* This,DWORD stream_id,DWORD *zorder) {
    return This->lpVtbl->GetStreamZOrder(This,stream_id,zorder);
}
static inline HRESULT IMFVideoMixerControl2_SetStreamOutputRect(IMFVideoMixerControl2* This,DWORD stream_id,const MFVideoNormalizedRect *rect) {
    return This->lpVtbl->SetStreamOutputRect(This,stream_id,rect);
}
static inline HRESULT IMFVideoMixerControl2_GetStreamOutputRect(IMFVideoMixerControl2* This,DWORD stream_id,MFVideoNormalizedRect *rect) {
    return This->lpVtbl->GetStreamOutputRect(This,stream_id,rect);
}
/*** IMFVideoMixerControl2 methods ***/
static inline HRESULT IMFVideoMixerControl2_SetMixingPrefs(IMFVideoMixerControl2* This,DWORD flags) {
    return This->lpVtbl->SetMixingPrefs(This,flags);
}
static inline HRESULT IMFVideoMixerControl2_GetMixingPrefs(IMFVideoMixerControl2* This,DWORD *flags) {
...
/*** IMFDesiredSample methods ***/
static inline HRESULT IMFDesiredSample_GetDesiredSampleTimeAndDuration(IMFDesiredSample* This,LONGLONG *sample_time,LONGLONG *sample_duration) {
    return This->lpVtbl->GetDesiredSampleTimeAndDuration(This,sample_time,sample_duration);
}
static inline void IMFDesiredSample_SetDesiredSampleTimeAndDuration(IMFDesiredSample* This,LONGLONG sample_time,LONGLONG sample_duration) {
...
/*** IMFVideoDisplayControl methods ***/
static inline HRESULT IMFVideoDisplayControl_GetNativeVideoSize(IMFVideoDisplayControl* This,SIZE *video_size,SIZE *aspect_ratio) {
    return This->lpVtbl->GetNativeVideoSize(This,video_size,aspect_ratio);
}
static inline HRESULT IMFVideoDisplayControl_GetIdealVideoSize(IMFVideoDisplayControl* This,SIZE *min_size,SIZE *max_size) {
    return This->lpVtbl->GetIdealVideoSize(This,min_size,max_size);
}
static inline HRESULT IMFVideoDisplayControl_SetVideoPosition(IMFVideoDisplayControl* This,const MFVideoNormalizedRect *source,const RECT *dest) {
    return This->lpVtbl->SetVideoPosition(This,source,dest);
}
static inline HRESULT IMFVideoDisplayControl_GetVideoPosition(IMFVideoDisplayControl* This,MFVideoNormalizedRect *source,RECT *dest) {
    return This->lpVtbl->GetVideoPosition(This,source,dest);
}
static inline HRESULT IMFVideoDisplayControl_SetAspectRatioMode(IMFVideoDisplayControl* This,DWORD mode) {
    return This->lpVtbl->SetAspectRatioMode(This,mode);
}
static inline HRESULT IMFVideoDisplayControl_GetAspectRatioMode(IMFVideoDisplayControl* This,DWORD *mode) {
    return This->lpVtbl->GetAspectRatioMode(This,mode);
}
static inline HRESULT IMFVideoDisplayControl_SetVideoWindow(IMFVideoDisplayControl* This,HWND window) {
    return This->lpVtbl->SetVideoWindow(This,window);
}
static inline HRESULT IMFVideoDisplayControl_GetVideoWindow(IMFVideoDisplayControl* This,HWND *window) {
...
static inline HRESULT IMFVideoDisplayControl_GetCurrentImage(IMFVideoDisplayControl* This,LPBITMAPINFOHEADER header,BYTE **dib,DWORD *dib_size,LONGLONG *timestamp) {
    return This->lpVtbl->GetCurrentImage(This,header,dib,dib_size,timestamp);
}
static inline HRESULT IMFVideoDisplayControl_SetBorderColor(IMFVideoDisplayControl* This,COLORREF color) {
    return This->lpVtbl->SetBorderColor(This,color);
}
static inline HRESULT IMFVideoDisplayControl_GetBorderColor(IMFVideoDisplayControl* This,COLORREF *color) {
    return This->lpVtbl->GetBorderColor(This,color);
}
static inline HRESULT IMFVideoDisplayControl_SetRenderingPrefs(IMFVideoDisplayControl* This,DWORD flags) {
    return This->lpVtbl->SetRenderingPrefs(This,flags);
}
static inline HRESULT IMFVideoDisplayControl_GetRenderingPrefs(IMFVideoDisplayControl* This,DWORD *flags) {
    return This->lpVtbl->GetRenderingPrefs(This,flags);
}
static inline HRESULT IMFVideoDisplayControl_SetFullscreen(IMFVideoDisplayControl* This,BOOL fullscreen) {
    return This->lpVtbl->SetFullscreen(This,fullscreen);
}
static inline HRESULT IMFVideoDisplayControl_GetFullscreen(IMFVideoDisplayControl* This,BOOL *fullscreen) {
