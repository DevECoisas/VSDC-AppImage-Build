/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/msopc.idl - Do not edit ***/
...
#define OPC_E_ENUM_CANNOT_MOVE_NEXT MAKE_HRESULT(SEVERITY_ERROR, FACILITY_OPC, 0x51)
#define OPC_E_ENUM_CANNOT_MOVE_PREVIOUS MAKE_HRESULT(SEVERITY_ERROR, FACILITY_OPC, 0x52)
#define OPC_E_ENUM_INVALID_POSITION MAKE_HRESULT(SEVERITY_ERROR, FACILITY_OPC, 0x53)
#define OPC_E_ZIP_COMPRESSION_FAILED MAKE_HRESULT(SEVERITY_ERROR, FACILITY_OPC, 0x1003)
#ifndef __IOpcPartUri_FWD_DEFINED__
#define __IOpcPartUri_FWD_DEFINED__
typedef interface IOpcPartUri IOpcPartUri;
#ifdef __cplusplus
...
/*** IOpcPart methods ***/
static inline HRESULT IOpcPart_GetRelationshipSet(IOpcPart* This,IOpcRelationshipSet **relationship_set) {
...
static inline HRESULT IOpcPart_GetContentType(IOpcPart* This,LPWSTR *type) {
    return This->lpVtbl->GetContentType(This,type);
}
static inline HRESULT IOpcPart_GetCompressionOptions(IOpcPart* This,OPC_COMPRESSION_OPTIONS *options) {
...
/*** IOpcPartEnumerator methods ***/
static inline HRESULT IOpcPartEnumerator_MoveNext(IOpcPartEnumerator* This,BOOL *has_next) {
    return This->lpVtbl->MoveNext(This,has_next);
}
static inline HRESULT IOpcPartEnumerator_MovePrevious(IOpcPartEnumerator* This,BOOL *has_previous) {
...
static inline HRESULT IOpcPartEnumerator_Clone(IOpcPartEnumerator* This,IOpcPartEnumerator **enumerator) {
...
/*** IOpcRelationshipEnumerator methods ***/
static inline HRESULT IOpcRelationshipEnumerator_MoveNext(IOpcRelationshipEnumerator* This,BOOL *has_next) {
    return This->lpVtbl->MoveNext(This,has_next);
}
static inline HRESULT IOpcRelationshipEnumerator_MovePrevious(IOpcRelationshipEnumerator* This,BOOL *has_previous) {
    return This->lpVtbl->MovePrevious(This,has_previous);
}
...
static inline HRESULT IOpcRelationshipEnumerator_Clone(IOpcRelationshipEnumerator* This,IOpcRelationshipEnumerator **enumerator) {
    return This->lpVtbl->Clone(This,enumerator);
}
#endif
#endif
...
static inline HRESULT IOpcPartSet_CreatePart(IOpcPartSet* This,IOpcPartUri *name,LPCWSTR content_type,OPC_COMPRESSION_OPTIONS compression_options,IOpcPart **part) {
...
static inline HRESULT IOpcPartSet_PartExists(IOpcPartSet* This,IOpcPartUri *name,BOOL *exists) {
    return This->lpVtbl->PartExists(This,name,exists);
}
static inline HRESULT IOpcPartSet_GetEnumerator(IOpcPartSet* This,IOpcPartEnumerator **enumerator) {
...
/*** IOpcRelationship methods ***/
static inline HRESULT IOpcRelationship_GetId(IOpcRelationship* This,LPWSTR *id) {
    return This->lpVtbl->GetId(This,id);
}
static inline HRESULT IOpcRelationship_GetRelationshipType(IOpcRelationship* This,LPWSTR *type) {
    return This->lpVtbl->GetRelationshipType(This,type);
}
static inline HRESULT IOpcRelationship_GetSourceUri(IOpcRelationship* This,IOpcUri **uri) {
    return This->lpVtbl->GetSourceUri(This,uri);
}
static inline HRESULT IOpcRelationship_GetTargetUri(IOpcRelationship* This,IUri **target) {
    return This->lpVtbl->GetTargetUri(This,target);
}
static inline HRESULT IOpcRelationship_GetTargetMode(IOpcRelationship* This,OPC_URI_TARGET_MODE *target_mode) {
...
/*** IOpcRelationshipSet methods ***/
static inline HRESULT IOpcRelationshipSet_GetRelationship(IOpcRelationshipSet* This,LPCWSTR id,IOpcRelationship **relationship) {
    return This->lpVtbl->GetRelationship(This,id,relationship);
}
static inline HRESULT IOpcRelationshipSet_CreateRelationship(IOpcRelationshipSet* This,LPCWSTR id,LPCWSTR type,IUri *target_uri,OPC_URI_TARGET_MODE target_mode,IOpcRelationship **relationship) {
    return This->lpVtbl->CreateRelationship(This,id,type,target_uri,target_mode,relationship);
}
static inline HRESULT IOpcRelationshipSet_DeleteRelationship(IOpcRelationshipSet* This,LPCWSTR id) {
    return This->lpVtbl->DeleteRelationship(This,id);
}
static inline HRESULT IOpcRelationshipSet_RelationshipExists(IOpcRelationshipSet* This,LPCWSTR id,BOOL *exists) {
    return This->lpVtbl->RelationshipExists(This,id,exists);
}
static inline HRESULT IOpcRelationshipSet_GetEnumerator(IOpcRelationshipSet* This,IOpcRelationshipEnumerator **enumerator) {
    return This->lpVtbl->GetEnumerator(This,enumerator);
}
static inline HRESULT IOpcRelationshipSet_GetEnumeratorForType(IOpcRelationshipSet* This,LPCWSTR type,IOpcRelationshipEnumerator **enumerator) {
    return This->lpVtbl->GetEnumeratorForType(This,type,enumerator);
}
static inline HRESULT IOpcRelationshipSet_GetRelationshipsContentStream(IOpcRelationshipSet* This,IStream **stream) {
...
/*** IOpcPackage methods ***/
static inline HRESULT IOpcPackage_GetPartSet(IOpcPackage* This,IOpcPartSet **part_set) {
    return This->lpVtbl->GetPartSet(This,part_set);
}
static inline HRESULT IOpcPackage_GetRelationshipSet(IOpcPackage* This,IOpcRelationshipSet **relationship_set) {
    return This->lpVtbl->GetRelationshipSet(This,relationship_set);
}
#endif
#endif
...
static inline HRESULT IOpcUri_HasProperty(IOpcUri* This,Uri_PROPERTY uriProp,BOOL *pfHasProperty) {
...
static inline HRESULT IOpcUri_IsEqual(IOpcUri* This,IUri *pUri,BOOL *pfEqual) {
    return This->lpVtbl->IsEqual(This,pUri,pfEqual);
}
/*** IOpcUri methods ***/
static inline HRESULT IOpcUri_GetRelationshipsPartUri(IOpcUri* This,IOpcPartUri **part_uri) {
    return This->lpVtbl->GetRelationshipsPartUri(This,part_uri);
}
static inline HRESULT IOpcUri_GetRelativeUri(IOpcUri* This,IOpcPartUri *part_uri,IUri **relative_uri) {
    return This->lpVtbl->GetRelativeUri(This,part_uri,relative_uri);
}
static inline HRESULT IOpcUri_CombinePartUri(IOpcUri* This,IUri *relative_uri,IOpcPartUri **combined) {
...
static inline HRESULT IOpcPartUri_HasProperty(IOpcPartUri* This,Uri_PROPERTY uriProp,BOOL *pfHasProperty) {
    return This->lpVtbl->HasProperty(This,uriProp,pfHasProperty);
}
...
static inline HRESULT IOpcPartUri_IsEqual(IOpcPartUri* This,IUri *pUri,BOOL *pfEqual) {
    return This->lpVtbl->IsEqual(This,pUri,pfEqual);
}
/*** IOpcUri methods ***/
static inline HRESULT IOpcPartUri_GetRelationshipsPartUri(IOpcPartUri* This,IOpcPartUri **part_uri) {
    return This->lpVtbl->GetRelationshipsPartUri(This,part_uri);
}
static inline HRESULT IOpcPartUri_GetRelativeUri(IOpcPartUri* This,IOpcPartUri *part_uri,IUri **relative_uri) {
    return This->lpVtbl->GetRelativeUri(This,part_uri,relative_uri);
}
static inline HRESULT IOpcPartUri_CombinePartUri(IOpcPartUri* This,IUri *relative_uri,IOpcPartUri **combined) {
    return This->lpVtbl->CombinePartUri(This,relative_uri,combined);
}
/*** IOpcPartUri methods ***/
static inline HRESULT IOpcPartUri_ComparePartUri(IOpcPartUri* This,IOpcPartUri *part_uri,INT32 *result) {
    return This->lpVtbl->ComparePartUri(This,part_uri,result);
}
static inline HRESULT IOpcPartUri_GetSourceUri(IOpcPartUri* This,IOpcUri **source_uri) {
    return This->lpVtbl->GetSourceUri(This,source_uri);
}
static inline HRESULT IOpcPartUri_IsRelationshipsPartUri(IOpcPartUri* This,BOOL *result) {
...
/*** IOpcFactory methods ***/
static inline HRESULT IOpcFactory_CreatePackageRootUri(IOpcFactory* This,IOpcUri **uri) {
    return This->lpVtbl->CreatePackageRootUri(This,uri);
}
static inline HRESULT IOpcFactory_CreatePartUri(IOpcFactory* This,LPCWSTR uri,IOpcPartUri **part_uri) {
    return This->lpVtbl->CreatePartUri(This,uri,part_uri);
}
static inline HRESULT IOpcFactory_CreateStreamOnFile(IOpcFactory* This,LPCWSTR filename,OPC_STREAM_IO_MODE io_mode,SECURITY_ATTRIBUTES *sa,DWORD flags,IStream **stream) {
...
static inline HRESULT IOpcFactory_CreateDigitalSignatureManager(IOpcFactory* This,IOpcPackage *package,IOpcDigitalSignatureManager **signature_manager) {
