/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/atliface.idl - Do not edit ***/
...
/*** IDocHostUIHandlerDispatch methods ***/
static inline HRESULT IDocHostUIHandlerDispatch_ShowContextMenu(IDocHostUIHandlerDispatch* This,DWORD id,LONG x,LONG y,IUnknown *unkreserved,IDispatch *dispreserved,HRESULT *retval) {
    return This->lpVtbl->ShowContextMenu(This,id,x,y,unkreserved,dispreserved,retval);
}
static inline HRESULT IDocHostUIHandlerDispatch_GetHostInfo(IDocHostUIHandlerDispatch* This,DWORD *flags,DWORD *doubleclick) {
    return This->lpVtbl->GetHostInfo(This,flags,doubleclick);
}
static inline HRESULT IDocHostUIHandlerDispatch_ShowUI(IDocHostUIHandlerDispatch* This,DWORD id,IUnknown *activeobject,IUnknown *cmdtarget,IUnknown *frame,IUnknown *doc,HRESULT *retval) {
...
static inline HRESULT IDocHostUIHandlerDispatch_EnableModeless(IDocHostUIHandlerDispatch* This,VARIANT_BOOL enable) {
    return This->lpVtbl->EnableModeless(This,enable);
}
static inline HRESULT IDocHostUIHandlerDispatch_OnDocWindowActivate(IDocHostUIHandlerDispatch* This,VARIANT_BOOL activate) {
    return This->lpVtbl->OnDocWindowActivate(This,activate);
}
static inline HRESULT IDocHostUIHandlerDispatch_OnFrameWindowActivate(IDocHostUIHandlerDispatch* This,VARIANT_BOOL activate) {
    return This->lpVtbl->OnFrameWindowActivate(This,activate);
}
static inline HRESULT IDocHostUIHandlerDispatch_ResizeBorder(IDocHostUIHandlerDispatch* This,LONG left,LONG top,LONG right,LONG bottom,IUnknown *window,VARIANT_BOOL framewindow) {
    return This->lpVtbl->ResizeBorder(This,left,top,right,bottom,window,framewindow);
}
static inline HRESULT IDocHostUIHandlerDispatch_TranslateAccelerator(IDocHostUIHandlerDispatch* This,HWND hwnd,UINT msg,WPARAM wparam,LPARAM lparam,BSTR guid_cmd_group,HRESULT *retval) {
    return This->lpVtbl->TranslateAccelerator(This,hwnd,msg,wparam,lparam,guid_cmd_group,retval);
}
static inline HRESULT IDocHostUIHandlerDispatch_GetOptionKeyPath(IDocHostUIHandlerDispatch* This,BSTR *key,DWORD reserved) {
    return This->lpVtbl->GetOptionKeyPath(This,key,reserved);
}
static inline HRESULT IDocHostUIHandlerDispatch_GetDropTarget(IDocHostUIHandlerDispatch* This,IUnknown *droptarget,IUnknown **ret_droptarget) {
    return This->lpVtbl->GetDropTarget(This,droptarget,ret_droptarget);
}
static inline HRESULT IDocHostUIHandlerDispatch_GetExternal(IDocHostUIHandlerDispatch* This,IDispatch **disp) {
    return This->lpVtbl->GetExternal(This,disp);
}
static inline HRESULT IDocHostUIHandlerDispatch_TranslateUrl(IDocHostUIHandlerDispatch* This,DWORD reserved,BSTR url,BSTR *translated_url) {
    return This->lpVtbl->TranslateUrl(This,reserved,url,translated_url);
}
static inline HRESULT IDocHostUIHandlerDispatch_FilterDataObject(IDocHostUIHandlerDispatch* This,IUnknown *dataobject,IUnknown **dataobject_ret) {
...
/*** IAxWinAmbientDispatch methods ***/
static inline HRESULT IAxWinAmbientDispatch_put_AllowWindowlessActivation(IAxWinAmbientDispatch* This,VARIANT_BOOL allow) {
    return This->lpVtbl->put_AllowWindowlessActivation(This,allow);
}
static inline HRESULT IAxWinAmbientDispatch_get_AllowWindowlessActivation(IAxWinAmbientDispatch* This,VARIANT_BOOL *allowed) {
    return This->lpVtbl->get_AllowWindowlessActivation(This,allowed);
}
static inline HRESULT IAxWinAmbientDispatch_put_BackColor(IAxWinAmbientDispatch* This,OLE_COLOR color) {
    return This->lpVtbl->put_BackColor(This,color);
}
static inline HRESULT IAxWinAmbientDispatch_get_BackColor(IAxWinAmbientDispatch* This,OLE_COLOR *color) {
    return This->lpVtbl->get_BackColor(This,color);
}
static inline HRESULT IAxWinAmbientDispatch_put_ForeColor(IAxWinAmbientDispatch* This,OLE_COLOR color) {
    return This->lpVtbl->put_ForeColor(This,color);
}
static inline HRESULT IAxWinAmbientDispatch_get_ForeColor(IAxWinAmbientDispatch* This,OLE_COLOR *color) {
    return This->lpVtbl->get_ForeColor(This,color);
}
static inline HRESULT IAxWinAmbientDispatch_put_LocaleID(IAxWinAmbientDispatch* This,LCID lcid) {
    return This->lpVtbl->put_LocaleID(This,lcid);
}
static inline HRESULT IAxWinAmbientDispatch_get_LocaleID(IAxWinAmbientDispatch* This,LCID *lcid) {
    return This->lpVtbl->get_LocaleID(This,lcid);
}
static inline HRESULT IAxWinAmbientDispatch_put_UserMode(IAxWinAmbientDispatch* This,VARIANT_BOOL mode) {
    return This->lpVtbl->put_UserMode(This,mode);
}
static inline HRESULT IAxWinAmbientDispatch_get_UserMode(IAxWinAmbientDispatch* This,VARIANT_BOOL *mode) {
    return This->lpVtbl->get_UserMode(This,mode);
}
static inline HRESULT IAxWinAmbientDispatch_put_DisplayAsDefault(IAxWinAmbientDispatch* This,VARIANT_BOOL display) {
    return This->lpVtbl->put_DisplayAsDefault(This,display);
}
static inline HRESULT IAxWinAmbientDispatch_get_DisplayAsDefault(IAxWinAmbientDispatch* This,VARIANT_BOOL *display) {
    return This->lpVtbl->get_DisplayAsDefault(This,display);
}
static inline HRESULT IAxWinAmbientDispatch_put_Font(IAxWinAmbientDispatch* This,IFontDisp *font) {
    return This->lpVtbl->put_Font(This,font);
}
static inline HRESULT IAxWinAmbientDispatch_get_Font(IAxWinAmbientDispatch* This,IFontDisp **font) {
    return This->lpVtbl->get_Font(This,font);
}
static inline HRESULT IAxWinAmbientDispatch_put_MessageReflect(IAxWinAmbientDispatch* This,VARIANT_BOOL reflect) {
    return This->lpVtbl->put_MessageReflect(This,reflect);
}
static inline HRESULT IAxWinAmbientDispatch_get_MessageReflect(IAxWinAmbientDispatch* This,VARIANT_BOOL *reflect) {
    return This->lpVtbl->get_MessageReflect(This,reflect);
}
static inline HRESULT IAxWinAmbientDispatch_get_ShowGrabHandles(IAxWinAmbientDispatch* This,VARIANT_BOOL *show) {
    return This->lpVtbl->get_ShowGrabHandles(This,show);
}
static inline HRESULT IAxWinAmbientDispatch_get_ShowHatching(IAxWinAmbientDispatch* This,VARIANT_BOOL *show) {
    return This->lpVtbl->get_ShowHatching(This,show);
}
static inline HRESULT IAxWinAmbientDispatch_put_DocHostFlags(IAxWinAmbientDispatch* This,DWORD flags) {
    return This->lpVtbl->put_DocHostFlags(This,flags);
}
static inline HRESULT IAxWinAmbientDispatch_get_DocHostFlags(IAxWinAmbientDispatch* This,DWORD *flags) {
    return This->lpVtbl->get_DocHostFlags(This,flags);
}
static inline HRESULT IAxWinAmbientDispatch_put_DocHostDoubleClickFlags(IAxWinAmbientDispatch* This,DWORD flags) {
    return This->lpVtbl->put_DocHostDoubleClickFlags(This,flags);
}
static inline HRESULT IAxWinAmbientDispatch_get_DocHostDoubleClickFlags(IAxWinAmbientDispatch* This,DWORD *flags) {
    return This->lpVtbl->get_DocHostDoubleClickFlags(This,flags);
}
static inline HRESULT IAxWinAmbientDispatch_put_AllowContextMenu(IAxWinAmbientDispatch* This,VARIANT_BOOL allow) {
    return This->lpVtbl->put_AllowContextMenu(This,allow);
}
static inline HRESULT IAxWinAmbientDispatch_get_AllowContextMenu(IAxWinAmbientDispatch* This,VARIANT_BOOL *allow) {
    return This->lpVtbl->get_AllowContextMenu(This,allow);
}
static inline HRESULT IAxWinAmbientDispatch_put_AllowShowUI(IAxWinAmbientDispatch* This,VARIANT_BOOL allow) {
    return This->lpVtbl->put_AllowShowUI(This,allow);
}
static inline HRESULT IAxWinAmbientDispatch_get_AllowShowUI(IAxWinAmbientDispatch* This,VARIANT_BOOL *allow) {
    return This->lpVtbl->get_AllowShowUI(This,allow);
}
static inline HRESULT IAxWinAmbientDispatch_put_OptionKeyPath(IAxWinAmbientDispatch* This,BSTR path) {
    return This->lpVtbl->put_OptionKeyPath(This,path);
}
static inline HRESULT IAxWinAmbientDispatch_get_OptionKeyPath(IAxWinAmbientDispatch* This,BSTR *path) {
...
/*** IAxWinAmbientDispatch methods ***/
static inline HRESULT IAxWinAmbientDispatchEx_put_AllowWindowlessActivation(IAxWinAmbientDispatchEx* This,VARIANT_BOOL allow) {
    return This->lpVtbl->put_AllowWindowlessActivation(This,allow);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_AllowWindowlessActivation(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *allowed) {
    return This->lpVtbl->get_AllowWindowlessActivation(This,allowed);
}
static inline HRESULT IAxWinAmbientDispatchEx_put_BackColor(IAxWinAmbientDispatchEx* This,OLE_COLOR color) {
    return This->lpVtbl->put_BackColor(This,color);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_BackColor(IAxWinAmbientDispatchEx* This,OLE_COLOR *color) {
    return This->lpVtbl->get_BackColor(This,color);
}
static inline HRESULT IAxWinAmbientDispatchEx_put_ForeColor(IAxWinAmbientDispatchEx* This,OLE_COLOR color) {
    return This->lpVtbl->put_ForeColor(This,color);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_ForeColor(IAxWinAmbientDispatchEx* This,OLE_COLOR *color) {
    return This->lpVtbl->get_ForeColor(This,color);
}
static inline HRESULT IAxWinAmbientDispatchEx_put_LocaleID(IAxWinAmbientDispatchEx* This,LCID lcid) {
    return This->lpVtbl->put_LocaleID(This,lcid);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_LocaleID(IAxWinAmbientDispatchEx* This,LCID *lcid) {
    return This->lpVtbl->get_LocaleID(This,lcid);
}
static inline HRESULT IAxWinAmbientDispatchEx_put_UserMode(IAxWinAmbientDispatchEx* This,VARIANT_BOOL mode) {
    return This->lpVtbl->put_UserMode(This,mode);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_UserMode(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *mode) {
    return This->lpVtbl->get_UserMode(This,mode);
}
static inline HRESULT IAxWinAmbientDispatchEx_put_DisplayAsDefault(IAxWinAmbientDispatchEx* This,VARIANT_BOOL display) {
    return This->lpVtbl->put_DisplayAsDefault(This,display);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_DisplayAsDefault(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *display) {
    return This->lpVtbl->get_DisplayAsDefault(This,display);
}
static inline HRESULT IAxWinAmbientDispatchEx_put_Font(IAxWinAmbientDispatchEx* This,IFontDisp *font) {
    return This->lpVtbl->put_Font(This,font);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_Font(IAxWinAmbientDispatchEx* This,IFontDisp **font) {
    return This->lpVtbl->get_Font(This,font);
}
static inline HRESULT IAxWinAmbientDispatchEx_put_MessageReflect(IAxWinAmbientDispatchEx* This,VARIANT_BOOL reflect) {
    return This->lpVtbl->put_MessageReflect(This,reflect);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_MessageReflect(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *reflect) {
    return This->lpVtbl->get_MessageReflect(This,reflect);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_ShowGrabHandles(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *show) {
    return This->lpVtbl->get_ShowGrabHandles(This,show);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_ShowHatching(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *show) {
    return This->lpVtbl->get_ShowHatching(This,show);
}
static inline HRESULT IAxWinAmbientDispatchEx_put_DocHostFlags(IAxWinAmbientDispatchEx* This,DWORD flags) {
    return This->lpVtbl->put_DocHostFlags(This,flags);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_DocHostFlags(IAxWinAmbientDispatchEx* This,DWORD *flags) {
    return This->lpVtbl->get_DocHostFlags(This,flags);
}
static inline HRESULT IAxWinAmbientDispatchEx_put_DocHostDoubleClickFlags(IAxWinAmbientDispatchEx* This,DWORD flags) {
    return This->lpVtbl->put_DocHostDoubleClickFlags(This,flags);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_DocHostDoubleClickFlags(IAxWinAmbientDispatchEx* This,DWORD *flags) {
    return This->lpVtbl->get_DocHostDoubleClickFlags(This,flags);
}
static inline HRESULT IAxWinAmbientDispatchEx_put_AllowContextMenu(IAxWinAmbientDispatchEx* This,VARIANT_BOOL allow) {
    return This->lpVtbl->put_AllowContextMenu(This,allow);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_AllowContextMenu(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *allow) {
    return This->lpVtbl->get_AllowContextMenu(This,allow);
}
static inline HRESULT IAxWinAmbientDispatchEx_put_AllowShowUI(IAxWinAmbientDispatchEx* This,VARIANT_BOOL allow) {
    return This->lpVtbl->put_AllowShowUI(This,allow);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_AllowShowUI(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *allow) {
    return This->lpVtbl->get_AllowShowUI(This,allow);
}
static inline HRESULT IAxWinAmbientDispatchEx_put_OptionKeyPath(IAxWinAmbientDispatchEx* This,BSTR path) {
    return This->lpVtbl->put_OptionKeyPath(This,path);
}
static inline HRESULT IAxWinAmbientDispatchEx_get_OptionKeyPath(IAxWinAmbientDispatchEx* This,BSTR *path) {
    return This->lpVtbl->get_OptionKeyPath(This,path);
}
/*** IAxWinAmbientDispatchEx methods ***/
static inline HRESULT IAxWinAmbientDispatchEx_SetAmbientDispatch(IAxWinAmbientDispatchEx* This,IDispatch *disp) {
