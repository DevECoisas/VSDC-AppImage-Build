/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/directmanipulation.idl - Do not edit ***/
...
static inline HRESULT IDirectManipulationManager_ProcessInput(IDirectManipulationManager* This,const MSG *msg,BOOL *handled) {
...
static inline HRESULT IDirectManipulationViewport_ZoomToRect(IDirectManipulationViewport* This,const float left,const float top,const float right,const float bottom,BOOL animate) {
...
static inline HRESULT IDirectManipulationViewport2_ZoomToRect(IDirectManipulationViewport2* This,const float left,const float top,const float right,const float bottom,BOOL animate) {
    return This->lpVtbl->ZoomToRect(This,left,top,right,bottom,animate);
}
...
static inline HRESULT IDirectManipulationManager2_ProcessInput(IDirectManipulationManager2* This,const MSG *msg,BOOL *handled) {
    return This->lpVtbl->ProcessInput(This,msg,handled);
}
