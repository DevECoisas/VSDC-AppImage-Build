/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/d2d1_1.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1GdiMetafileSink_QueryInterface(ID2D1GdiMetafileSink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1GdiMetafileSink_AddRef(ID2D1GdiMetafileSink* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1GdiMetafileSink_Release(ID2D1GdiMetafileSink* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1GdiMetafileSink methods ***/
static inline HRESULT ID2D1GdiMetafileSink_ProcessRecord(ID2D1GdiMetafileSink* This,DWORD type,const void *data,DWORD size) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1GdiMetafile_QueryInterface(ID2D1GdiMetafile* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1GdiMetafile_AddRef(ID2D1GdiMetafile* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1GdiMetafile_Release(ID2D1GdiMetafile* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static inline void ID2D1GdiMetafile_GetFactory(ID2D1GdiMetafile* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1GdiMetafile methods ***/
static inline HRESULT ID2D1GdiMetafile_Stream(ID2D1GdiMetafile* This,ID2D1GdiMetafileSink *sink) {
    return This->lpVtbl->Stream(This,sink);
}
static inline HRESULT ID2D1GdiMetafile_GetBounds(ID2D1GdiMetafile* This,D2D1_RECT_F *bounds) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1PathGeometry1_QueryInterface(ID2D1PathGeometry1* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1PathGeometry1_AddRef(ID2D1PathGeometry1* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1PathGeometry1_Release(ID2D1PathGeometry1* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static inline void ID2D1PathGeometry1_GetFactory(ID2D1PathGeometry1* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1Geometry methods ***/
static inline HRESULT ID2D1PathGeometry1_GetBounds(ID2D1PathGeometry1* This,const D2D1_MATRIX_3X2_F *transform,D2D1_RECT_F *bounds) {
    return This->lpVtbl->GetBounds(This,transform,bounds);
}
static inline HRESULT ID2D1PathGeometry1_GetWidenedBounds(ID2D1PathGeometry1* This,float stroke_width,ID2D1StrokeStyle *stroke_style,const D2D1_MATRIX_3X2_F *transform,float tolerance,D2D1_RECT_F *bounds) {
    return This->lpVtbl->GetWidenedBounds(This,stroke_width,stroke_style,transform,tolerance,bounds);
}
static inline HRESULT ID2D1PathGeometry1_StrokeContainsPoint(ID2D1PathGeometry1* This,D2D1_POINT_2F point,float stroke_width,ID2D1StrokeStyle *stroke_style,const D2D1_MATRIX_3X2_F *transform,float tolerance,BOOL *contains) {
    return This->lpVtbl->StrokeContainsPoint(This,point,stroke_width,stroke_style,transform,tolerance,contains);
}
static inline HRESULT ID2D1PathGeometry1_FillContainsPoint(ID2D1PathGeometry1* This,D2D1_POINT_2F point,const D2D1_MATRIX_3X2_F *transform,float tolerance,BOOL *contains) {
    return This->lpVtbl->FillContainsPoint(This,point,transform,tolerance,contains);
}
static inline HRESULT ID2D1PathGeometry1_CompareWithGeometry(ID2D1PathGeometry1* This,ID2D1Geometry *geometry,const D2D1_MATRIX_3X2_F *transform,float tolerance,D2D1_GEOMETRY_RELATION *relation) {
    return This->lpVtbl->CompareWithGeometry(This,geometry,transform,tolerance,relation);
}
static inline HRESULT ID2D1PathGeometry1_Simplify(ID2D1PathGeometry1* This,D2D1_GEOMETRY_SIMPLIFICATION_OPTION option,const D2D1_MATRIX_3X2_F *transform,float tolerance,ID2D1SimplifiedGeometrySink *sink) {
    return This->lpVtbl->Simplify(This,option,transform,tolerance,sink);
}
static inline HRESULT ID2D1PathGeometry1_Tessellate(ID2D1PathGeometry1* This,const D2D1_MATRIX_3X2_F *transform,float tolerance,ID2D1TessellationSink *sink) {
    return This->lpVtbl->Tessellate(This,transform,tolerance,sink);
}
static inline HRESULT ID2D1PathGeometry1_CombineWithGeometry(ID2D1PathGeometry1* This,ID2D1Geometry *geometry,D2D1_COMBINE_MODE combine_mode,const D2D1_MATRIX_3X2_F *transform,float tolerance,ID2D1SimplifiedGeometrySink *sink) {
    return This->lpVtbl->CombineWithGeometry(This,geometry,combine_mode,transform,tolerance,sink);
}
static inline HRESULT ID2D1PathGeometry1_Outline(ID2D1PathGeometry1* This,const D2D1_MATRIX_3X2_F *transform,float tolerance,ID2D1SimplifiedGeometrySink *sink) {
    return This->lpVtbl->Outline(This,transform,tolerance,sink);
}
static inline HRESULT ID2D1PathGeometry1_ComputeArea(ID2D1PathGeometry1* This,const D2D1_MATRIX_3X2_F *transform,float tolerance,float *area) {
    return This->lpVtbl->ComputeArea(This,transform,tolerance,area);
}
static inline HRESULT ID2D1PathGeometry1_ComputeLength(ID2D1PathGeometry1* This,const D2D1_MATRIX_3X2_F *transform,float tolerance,float *length) {
    return This->lpVtbl->ComputeLength(This,transform,tolerance,length);
}
static inline HRESULT ID2D1PathGeometry1_ComputePointAtLength(ID2D1PathGeometry1* This,float length,const D2D1_MATRIX_3X2_F *transform,float tolerance,D2D1_POINT_2F *point,D2D1_POINT_2F *tangent) {
    return This->lpVtbl->ComputePointAtLength(This,length,transform,tolerance,point,tangent);
}
static inline HRESULT ID2D1PathGeometry1_Widen(ID2D1PathGeometry1* This,float stroke_width,ID2D1StrokeStyle *stroke_style,const D2D1_MATRIX_3X2_F *transform,float tolerance,ID2D1SimplifiedGeometrySink *sink) {
    return This->lpVtbl->Widen(This,stroke_width,stroke_style,transform,tolerance,sink);
}
/*** ID2D1PathGeometry methods ***/
static inline HRESULT ID2D1PathGeometry1_Open(ID2D1PathGeometry1* This,ID2D1GeometrySink **sink) {
    return This->lpVtbl->Open(This,sink);
}
static inline HRESULT ID2D1PathGeometry1_Stream(ID2D1PathGeometry1* This,ID2D1GeometrySink *sink) {
    return This->lpVtbl->Stream(This,sink);
}
static inline HRESULT ID2D1PathGeometry1_GetSegmentCount(ID2D1PathGeometry1* This,UINT32 *count) {
    return This->lpVtbl->GetSegmentCount(This,count);
}
static inline HRESULT ID2D1PathGeometry1_GetFigureCount(ID2D1PathGeometry1* This,UINT32 *count) {
    return This->lpVtbl->GetFigureCount(This,count);
}
/*** ID2D1PathGeometry1 methods ***/
static inline HRESULT ID2D1PathGeometry1_ComputePointAndSegmentAtLength(ID2D1PathGeometry1* This,float length,UINT32 start_segment,const D2D1_MATRIX_3X2_F *transform,float tolerance,D2D1_POINT_DESCRIPTION *point_desc) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1Properties_QueryInterface(ID2D1Properties* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1Properties_AddRef(ID2D1Properties* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1Properties_Release(ID2D1Properties* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Properties methods ***/
static inline UINT32 ID2D1Properties_GetPropertyCount(ID2D1Properties* This) {
    return This->lpVtbl->GetPropertyCount(This);
}
static inline HRESULT ID2D1Properties_GetPropertyName(ID2D1Properties* This,UINT32 index,WCHAR *name,UINT32 name_count) {
    return This->lpVtbl->GetPropertyName(This,index,name,name_count);
}
static inline UINT32 ID2D1Properties_GetPropertyNameLength(ID2D1Properties* This,UINT32 index) {
    return This->lpVtbl->GetPropertyNameLength(This,index);
}
static inline D2D1_PROPERTY_TYPE ID2D1Properties_GetType(ID2D1Properties* This,UINT32 index) {
    return This->lpVtbl->GetType(This,index);
}
static inline UINT32 ID2D1Properties_GetPropertyIndex(ID2D1Properties* This,const WCHAR *name) {
    return This->lpVtbl->GetPropertyIndex(This,name);
}
static inline HRESULT ID2D1Properties_SetValueByName(ID2D1Properties* This,const WCHAR *name,D2D1_PROPERTY_TYPE type,const BYTE *value,UINT32 value_size) {
    return This->lpVtbl->SetValueByName(This,name,type,value,value_size);
}
static inline HRESULT ID2D1Properties_SetValue(ID2D1Properties* This,UINT32 index,D2D1_PROPERTY_TYPE type,const BYTE *value,UINT32 value_size) {
    return This->lpVtbl->SetValue(This,index,type,value,value_size);
}
static inline HRESULT ID2D1Properties_GetValueByName(ID2D1Properties* This,const WCHAR *name,D2D1_PROPERTY_TYPE type,BYTE *value,UINT32 value_size) {
    return This->lpVtbl->GetValueByName(This,name,type,value,value_size);
}
static inline HRESULT ID2D1Properties_GetValue(ID2D1Properties* This,UINT32 index,D2D1_PROPERTY_TYPE type,BYTE *value,UINT32 value_size) {
    return This->lpVtbl->GetValue(This,index,type,value,value_size);
}
static inline UINT32 ID2D1Properties_GetValueSize(ID2D1Properties* This,UINT32 index) {
    return This->lpVtbl->GetValueSize(This,index);
}
static inline HRESULT ID2D1Properties_GetSubProperties(ID2D1Properties* This,UINT32 index,ID2D1Properties **props) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1Effect_QueryInterface(ID2D1Effect* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1Effect_AddRef(ID2D1Effect* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1Effect_Release(ID2D1Effect* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Properties methods ***/
static inline UINT32 ID2D1Effect_GetPropertyCount(ID2D1Effect* This) {
    return This->lpVtbl->GetPropertyCount(This);
}
static inline HRESULT ID2D1Effect_GetPropertyName(ID2D1Effect* This,UINT32 index,WCHAR *name,UINT32 name_count) {
    return This->lpVtbl->GetPropertyName(This,index,name,name_count);
}
static inline UINT32 ID2D1Effect_GetPropertyNameLength(ID2D1Effect* This,UINT32 index) {
    return This->lpVtbl->GetPropertyNameLength(This,index);
}
static inline D2D1_PROPERTY_TYPE ID2D1Effect_GetType(ID2D1Effect* This,UINT32 index) {
    return This->lpVtbl->GetType(This,index);
}
static inline UINT32 ID2D1Effect_GetPropertyIndex(ID2D1Effect* This,const WCHAR *name) {
    return This->lpVtbl->GetPropertyIndex(This,name);
}
static inline HRESULT ID2D1Effect_SetValueByName(ID2D1Effect* This,const WCHAR *name,D2D1_PROPERTY_TYPE type,const BYTE *value,UINT32 value_size) {
    return This->lpVtbl->SetValueByName(This,name,type,value,value_size);
}
static inline HRESULT ID2D1Effect_SetValue(ID2D1Effect* This,UINT32 index,D2D1_PROPERTY_TYPE type,const BYTE *value,UINT32 value_size) {
    return This->lpVtbl->SetValue(This,index,type,value,value_size);
}
static inline HRESULT ID2D1Effect_GetValueByName(ID2D1Effect* This,const WCHAR *name,D2D1_PROPERTY_TYPE type,BYTE *value,UINT32 value_size) {
    return This->lpVtbl->GetValueByName(This,name,type,value,value_size);
}
static inline HRESULT ID2D1Effect_GetValue(ID2D1Effect* This,UINT32 index,D2D1_PROPERTY_TYPE type,BYTE *value,UINT32 value_size) {
    return This->lpVtbl->GetValue(This,index,type,value,value_size);
}
static inline UINT32 ID2D1Effect_GetValueSize(ID2D1Effect* This,UINT32 index) {
    return This->lpVtbl->GetValueSize(This,index);
}
static inline HRESULT ID2D1Effect_GetSubProperties(ID2D1Effect* This,UINT32 index,ID2D1Properties **props) {
    return This->lpVtbl->GetSubProperties(This,index,props);
}
/*** ID2D1Effect methods ***/
static inline void ID2D1Effect_SetInput(ID2D1Effect* This,UINT32 index,ID2D1Image *input,BOOL invalidate) {
    This->lpVtbl->SetInput(This,index,input,invalidate);
}
static inline HRESULT ID2D1Effect_SetInputCount(ID2D1Effect* This,UINT32 count) {
    return This->lpVtbl->SetInputCount(This,count);
}
static inline void ID2D1Effect_GetInput(ID2D1Effect* This,UINT32 index,ID2D1Image **input) {
    This->lpVtbl->GetInput(This,index,input);
}
static inline UINT32 ID2D1Effect_GetInputCount(ID2D1Effect* This) {
    return This->lpVtbl->GetInputCount(This);
}
static inline void ID2D1Effect_GetOutput(ID2D1Effect* This,ID2D1Image **output) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1DrawingStateBlock1_QueryInterface(ID2D1DrawingStateBlock1* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1DrawingStateBlock1_AddRef(ID2D1DrawingStateBlock1* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1DrawingStateBlock1_Release(ID2D1DrawingStateBlock1* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static inline void ID2D1DrawingStateBlock1_GetFactory(ID2D1DrawingStateBlock1* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1DrawingStateBlock methods ***/
static inline void ID2D1DrawingStateBlock1_SetTextRenderingParams(ID2D1DrawingStateBlock1* This,IDWriteRenderingParams *text_rendering_params) {
    This->lpVtbl->SetTextRenderingParams(This,text_rendering_params);
}
static inline void ID2D1DrawingStateBlock1_GetTextRenderingParams(ID2D1DrawingStateBlock1* This,IDWriteRenderingParams **text_rendering_params) {
    This->lpVtbl->GetTextRenderingParams(This,text_rendering_params);
}
/*** ID2D1DrawingStateBlock1 methods ***/
static inline void ID2D1DrawingStateBlock1_GetDescription(ID2D1DrawingStateBlock1* This,D2D1_DRAWING_STATE_DESCRIPTION1 *desc) {
    This->lpVtbl->ID2D1DrawingStateBlock1_GetDescription(This,desc);
}
static inline void ID2D1DrawingStateBlock1_SetDescription(ID2D1DrawingStateBlock1* This,const D2D1_DRAWING_STATE_DESCRIPTION1 *desc) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1ColorContext_QueryInterface(ID2D1ColorContext* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1ColorContext_AddRef(ID2D1ColorContext* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1ColorContext_Release(ID2D1ColorContext* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static inline void ID2D1ColorContext_GetFactory(ID2D1ColorContext* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1ColorContext methods ***/
static inline D2D1_COLOR_SPACE ID2D1ColorContext_GetColorSpace(ID2D1ColorContext* This) {
    return This->lpVtbl->GetColorSpace(This);
}
static inline UINT32 ID2D1ColorContext_GetProfileSize(ID2D1ColorContext* This) {
    return This->lpVtbl->GetProfileSize(This);
}
static inline HRESULT ID2D1ColorContext_GetProfile(ID2D1ColorContext* This,BYTE *profile,UINT32 size) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1Bitmap1_QueryInterface(ID2D1Bitmap1* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1Bitmap1_AddRef(ID2D1Bitmap1* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1Bitmap1_Release(ID2D1Bitmap1* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static inline void ID2D1Bitmap1_GetFactory(ID2D1Bitmap1* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1Bitmap methods ***/
static inline D2D1_SIZE_F ID2D1Bitmap1_GetSize(ID2D1Bitmap1* This) {
    D2D1_SIZE_F __ret;
    return *This->lpVtbl->GetSize(This,&__ret);
}
static inline D2D1_SIZE_U ID2D1Bitmap1_GetPixelSize(ID2D1Bitmap1* This) {
    D2D1_SIZE_U __ret;
    return *This->lpVtbl->GetPixelSize(This,&__ret);
}
static inline D2D1_PIXEL_FORMAT ID2D1Bitmap1_GetPixelFormat(ID2D1Bitmap1* This) {
    D2D1_PIXEL_FORMAT __ret;
    return *This->lpVtbl->GetPixelFormat(This,&__ret);
}
static inline void ID2D1Bitmap1_GetDpi(ID2D1Bitmap1* This,float *dpi_x,float *dpi_y) {
    This->lpVtbl->GetDpi(This,dpi_x,dpi_y);
}
static inline HRESULT ID2D1Bitmap1_CopyFromBitmap(ID2D1Bitmap1* This,const D2D1_POINT_2U *dst_point,ID2D1Bitmap *bitmap,const D2D1_RECT_U *src_rect) {
    return This->lpVtbl->CopyFromBitmap(This,dst_point,bitmap,src_rect);
}
static inline HRESULT ID2D1Bitmap1_CopyFromRenderTarget(ID2D1Bitmap1* This,const D2D1_POINT_2U *dst_point,ID2D1RenderTarget *render_target,const D2D1_RECT_U *src_rect) {
    return This->lpVtbl->CopyFromRenderTarget(This,dst_point,render_target,src_rect);
}
static inline HRESULT ID2D1Bitmap1_CopyFromMemory(ID2D1Bitmap1* This,const D2D1_RECT_U *dst_rect,const void *src_data,UINT32 pitch) {
    return This->lpVtbl->CopyFromMemory(This,dst_rect,src_data,pitch);
}
/*** ID2D1Bitmap1 methods ***/
static inline void ID2D1Bitmap1_GetColorContext(ID2D1Bitmap1* This,ID2D1ColorContext **context) {
    This->lpVtbl->GetColorContext(This,context);
}
static inline D2D1_BITMAP_OPTIONS ID2D1Bitmap1_GetOptions(ID2D1Bitmap1* This) {
    return This->lpVtbl->GetOptions(This);
}
static inline HRESULT ID2D1Bitmap1_GetSurface(ID2D1Bitmap1* This,IDXGISurface **surface) {
    return This->lpVtbl->GetSurface(This,surface);
}
static inline HRESULT ID2D1Bitmap1_Map(ID2D1Bitmap1* This,D2D1_MAP_OPTIONS options,D2D1_MAPPED_RECT *mapped_rect) {
    return This->lpVtbl->Map(This,options,mapped_rect);
}
static inline HRESULT ID2D1Bitmap1_Unmap(ID2D1Bitmap1* This) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1BitmapBrush1_QueryInterface(ID2D1BitmapBrush1* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1BitmapBrush1_AddRef(ID2D1BitmapBrush1* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1BitmapBrush1_Release(ID2D1BitmapBrush1* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static inline void ID2D1BitmapBrush1_GetFactory(ID2D1BitmapBrush1* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1Brush methods ***/
static inline void ID2D1BitmapBrush1_SetOpacity(ID2D1BitmapBrush1* This,float opacity) {
    This->lpVtbl->SetOpacity(This,opacity);
}
static inline void ID2D1BitmapBrush1_SetTransform(ID2D1BitmapBrush1* This,const D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->SetTransform(This,transform);
}
static inline float ID2D1BitmapBrush1_GetOpacity(ID2D1BitmapBrush1* This) {
    return This->lpVtbl->GetOpacity(This);
}
static inline void ID2D1BitmapBrush1_GetTransform(ID2D1BitmapBrush1* This,D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->GetTransform(This,transform);
}
/*** ID2D1BitmapBrush methods ***/
static inline void ID2D1BitmapBrush1_SetExtendModeX(ID2D1BitmapBrush1* This,D2D1_EXTEND_MODE mode) {
    This->lpVtbl->SetExtendModeX(This,mode);
}
static inline void ID2D1BitmapBrush1_SetExtendModeY(ID2D1BitmapBrush1* This,D2D1_EXTEND_MODE mode) {
    This->lpVtbl->SetExtendModeY(This,mode);
}
static inline void ID2D1BitmapBrush1_SetInterpolationMode(ID2D1BitmapBrush1* This,D2D1_BITMAP_INTERPOLATION_MODE mode) {
    This->lpVtbl->SetInterpolationMode(This,mode);
}
static inline void ID2D1BitmapBrush1_SetBitmap(ID2D1BitmapBrush1* This,ID2D1Bitmap *bitmap) {
    This->lpVtbl->SetBitmap(This,bitmap);
}
static inline D2D1_EXTEND_MODE ID2D1BitmapBrush1_GetExtendModeX(ID2D1BitmapBrush1* This) {
    return This->lpVtbl->GetExtendModeX(This);
}
static inline D2D1_EXTEND_MODE ID2D1BitmapBrush1_GetExtendModeY(ID2D1BitmapBrush1* This) {
    return This->lpVtbl->GetExtendModeY(This);
}
static inline D2D1_BITMAP_INTERPOLATION_MODE ID2D1BitmapBrush1_GetInterpolationMode(ID2D1BitmapBrush1* This) {
    return This->lpVtbl->GetInterpolationMode(This);
}
static inline void ID2D1BitmapBrush1_GetBitmap(ID2D1BitmapBrush1* This,ID2D1Bitmap **bitmap) {
    This->lpVtbl->GetBitmap(This,bitmap);
}
/*** ID2D1BitmapBrush1 methods ***/
static inline void ID2D1BitmapBrush1_SetInterpolationMode1(ID2D1BitmapBrush1* This,D2D1_INTERPOLATION_MODE mode) {
    This->lpVtbl->SetInterpolationMode1(This,mode);
}
static inline D2D1_INTERPOLATION_MODE ID2D1BitmapBrush1_GetInterpolationMode1(ID2D1BitmapBrush1* This) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1GradientStopCollection1_QueryInterface(ID2D1GradientStopCollection1* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1GradientStopCollection1_AddRef(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1GradientStopCollection1_Release(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static inline void ID2D1GradientStopCollection1_GetFactory(ID2D1GradientStopCollection1* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1GradientStopCollection methods ***/
static inline UINT32 ID2D1GradientStopCollection1_GetGradientStopCount(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->GetGradientStopCount(This);
}
static inline void ID2D1GradientStopCollection1_GetGradientStops(ID2D1GradientStopCollection1* This,D2D1_GRADIENT_STOP *stops,UINT32 stop_count) {
    This->lpVtbl->GetGradientStops(This,stops,stop_count);
}
static inline D2D1_GAMMA ID2D1GradientStopCollection1_GetColorInterpolationGamma(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->GetColorInterpolationGamma(This);
}
static inline D2D1_EXTEND_MODE ID2D1GradientStopCollection1_GetExtendMode(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->GetExtendMode(This);
}
/*** ID2D1GradientStopCollection1 methods ***/
static inline void ID2D1GradientStopCollection1_GetGradientStops1(ID2D1GradientStopCollection1* This,D2D1_GRADIENT_STOP *gradient,UINT32 count) {
    This->lpVtbl->GetGradientStops1(This,gradient,count);
}
static inline D2D1_COLOR_SPACE ID2D1GradientStopCollection1_GetPreInterpolationSpace(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->GetPreInterpolationSpace(This);
}
static inline D2D1_COLOR_SPACE ID2D1GradientStopCollection1_GetPostInterpolationSpace(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->GetPostInterpolationSpace(This);
}
static inline D2D1_BUFFER_PRECISION ID2D1GradientStopCollection1_GetBufferPrecision(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->GetBufferPrecision(This);
}
static inline D2D1_COLOR_INTERPOLATION_MODE ID2D1GradientStopCollection1_GetColorInterpolationMode(ID2D1GradientStopCollection1* This) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1Device_QueryInterface(ID2D1Device* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1Device_AddRef(ID2D1Device* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1Device_Release(ID2D1Device* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static inline void ID2D1Device_GetFactory(ID2D1Device* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1Device methods ***/
static inline HRESULT ID2D1Device_CreateDeviceContext(ID2D1Device* This,D2D1_DEVICE_CONTEXT_OPTIONS options,ID2D1DeviceContext **context) {
    return This->lpVtbl->CreateDeviceContext(This,options,context);
}
static inline HRESULT ID2D1Device_CreatePrintControl(ID2D1Device* This,IWICImagingFactory *wic_factory,IPrintDocumentPackageTarget *document_target,const D2D1_PRINT_CONTROL_PROPERTIES *desc,ID2D1PrintControl **print_control) {
    return This->lpVtbl->CreatePrintControl(This,wic_factory,document_target,desc,print_control);
}
static inline void ID2D1Device_SetMaximumTextureMemory(ID2D1Device* This,UINT64 max_texture_memory) {
    This->lpVtbl->SetMaximumTextureMemory(This,max_texture_memory);
}
static inline UINT64 ID2D1Device_GetMaximumTextureMemory(ID2D1Device* This) {
    return This->lpVtbl->GetMaximumTextureMemory(This);
}
static inline HRESULT ID2D1Device_ClearResources(ID2D1Device* This,UINT msec_since_use) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1CommandSink_QueryInterface(ID2D1CommandSink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1CommandSink_AddRef(ID2D1CommandSink* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1CommandSink_Release(ID2D1CommandSink* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1CommandSink methods ***/
static inline HRESULT ID2D1CommandSink_BeginDraw(ID2D1CommandSink* This) {
    return This->lpVtbl->BeginDraw(This);
}
static inline HRESULT ID2D1CommandSink_EndDraw(ID2D1CommandSink* This) {
    return This->lpVtbl->EndDraw(This);
}
static inline HRESULT ID2D1CommandSink_SetAntialiasMode(ID2D1CommandSink* This,D2D1_ANTIALIAS_MODE antialias_mode) {
    return This->lpVtbl->SetAntialiasMode(This,antialias_mode);
}
static inline HRESULT ID2D1CommandSink_SetTags(ID2D1CommandSink* This,D2D1_TAG tag1,D2D1_TAG tag2) {
    return This->lpVtbl->SetTags(This,tag1,tag2);
}
static inline HRESULT ID2D1CommandSink_SetTextAntialiasMode(ID2D1CommandSink* This,D2D1_TEXT_ANTIALIAS_MODE antialias_mode) {
    return This->lpVtbl->SetTextAntialiasMode(This,antialias_mode);
}
static inline HRESULT ID2D1CommandSink_SetTextRenderingParams(ID2D1CommandSink* This,IDWriteRenderingParams *text_rendering_params) {
    return This->lpVtbl->SetTextRenderingParams(This,text_rendering_params);
}
static inline HRESULT ID2D1CommandSink_SetTransform(ID2D1CommandSink* This,const D2D1_MATRIX_3X2_F *transform) {
    return This->lpVtbl->SetTransform(This,transform);
}
static inline HRESULT ID2D1CommandSink_SetPrimitiveBlend(ID2D1CommandSink* This,D2D1_PRIMITIVE_BLEND primitive_blend) {
    return This->lpVtbl->SetPrimitiveBlend(This,primitive_blend);
}
static inline HRESULT ID2D1CommandSink_SetUnitMode(ID2D1CommandSink* This,D2D1_UNIT_MODE unit_mode) {
    return This->lpVtbl->SetUnitMode(This,unit_mode);
}
static inline HRESULT ID2D1CommandSink_Clear(ID2D1CommandSink* This,const D2D1_COLOR_F *color) {
    return This->lpVtbl->Clear(This,color);
}
static inline HRESULT ID2D1CommandSink_DrawGlyphRun(ID2D1CommandSink* This,D2D1_POINT_2F baseline_origin,const DWRITE_GLYPH_RUN *glyph_run,const DWRITE_GLYPH_RUN_DESCRIPTION *glyph_run_desc,ID2D1Brush *brush,DWRITE_MEASURING_MODE measuring_mode) {
    return This->lpVtbl->DrawGlyphRun(This,baseline_origin,glyph_run,glyph_run_desc,brush,measuring_mode);
}
static inline HRESULT ID2D1CommandSink_DrawLine(ID2D1CommandSink* This,D2D1_POINT_2F p0,D2D1_POINT_2F p1,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    return This->lpVtbl->DrawLine(This,p0,p1,brush,stroke_width,stroke_style);
}
static inline HRESULT ID2D1CommandSink_DrawGeometry(ID2D1CommandSink* This,ID2D1Geometry *geometry,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    return This->lpVtbl->DrawGeometry(This,geometry,brush,stroke_width,stroke_style);
}
static inline HRESULT ID2D1CommandSink_DrawRectangle(ID2D1CommandSink* This,const D2D1_RECT_F *rect,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    return This->lpVtbl->DrawRectangle(This,rect,brush,stroke_width,stroke_style);
}
static inline HRESULT ID2D1CommandSink_DrawBitmap(ID2D1CommandSink* This,ID2D1Bitmap *bitmap,const D2D1_RECT_F *dst_rect,float opacity,D2D1_INTERPOLATION_MODE interpolation_mode,const D2D1_RECT_F *src_rect,const D2D1_MATRIX_4X4_F *perspective_transform) {
    return This->lpVtbl->DrawBitmap(This,bitmap,dst_rect,opacity,interpolation_mode,src_rect,perspective_transform);
}
static inline HRESULT ID2D1CommandSink_DrawImage(ID2D1CommandSink* This,ID2D1Image *image,const D2D1_POINT_2F *target_offset,const D2D1_RECT_F *image_rect,D2D1_INTERPOLATION_MODE interpolation_mode,D2D1_COMPOSITE_MODE composite_mode) {
    return This->lpVtbl->DrawImage(This,image,target_offset,image_rect,interpolation_mode,composite_mode);
}
static inline HRESULT ID2D1CommandSink_DrawGdiMetafile(ID2D1CommandSink* This,ID2D1GdiMetafile *metafile,const D2D1_POINT_2F *target_offset) {
    return This->lpVtbl->DrawGdiMetafile(This,metafile,target_offset);
}
static inline HRESULT ID2D1CommandSink_FillMesh(ID2D1CommandSink* This,ID2D1Mesh *mesh,ID2D1Brush *brush) {
    return This->lpVtbl->FillMesh(This,mesh,brush);
}
static inline HRESULT ID2D1CommandSink_FillOpacityMask(ID2D1CommandSink* This,ID2D1Bitmap *bitmap,ID2D1Brush *brush,const D2D1_RECT_F *dst_rect,const D2D1_RECT_F *src_rect) {
    return This->lpVtbl->FillOpacityMask(This,bitmap,brush,dst_rect,src_rect);
}
static inline HRESULT ID2D1CommandSink_FillGeometry(ID2D1CommandSink* This,ID2D1Geometry *geometry,ID2D1Brush *brush,ID2D1Brush *opacity_brush) {
    return This->lpVtbl->FillGeometry(This,geometry,brush,opacity_brush);
}
static inline HRESULT ID2D1CommandSink_FillRectangle(ID2D1CommandSink* This,const D2D1_RECT_F *rect,ID2D1Brush *brush) {
    return This->lpVtbl->FillRectangle(This,rect,brush);
}
static inline HRESULT ID2D1CommandSink_PushAxisAlignedClip(ID2D1CommandSink* This,const D2D1_RECT_F *clip_rect,D2D1_ANTIALIAS_MODE antialias_mode) {
    return This->lpVtbl->PushAxisAlignedClip(This,clip_rect,antialias_mode);
}
static inline HRESULT ID2D1CommandSink_PushLayer(ID2D1CommandSink* This,const D2D1_LAYER_PARAMETERS1 *layer_parameters,ID2D1Layer *layer) {
    return This->lpVtbl->PushLayer(This,layer_parameters,layer);
}
static inline HRESULT ID2D1CommandSink_PopAxisAlignedClip(ID2D1CommandSink* This) {
    return This->lpVtbl->PopAxisAlignedClip(This);
}
static inline HRESULT ID2D1CommandSink_PopLayer(ID2D1CommandSink* This) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1CommandList_QueryInterface(ID2D1CommandList* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1CommandList_AddRef(ID2D1CommandList* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1CommandList_Release(ID2D1CommandList* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static inline void ID2D1CommandList_GetFactory(ID2D1CommandList* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1CommandList methods ***/
static inline HRESULT ID2D1CommandList_Stream(ID2D1CommandList* This,ID2D1CommandSink *sink) {
    return This->lpVtbl->Stream(This,sink);
}
static inline HRESULT ID2D1CommandList_Close(ID2D1CommandList* This) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1PrintControl_QueryInterface(ID2D1PrintControl* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1PrintControl_AddRef(ID2D1PrintControl* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1PrintControl_Release(ID2D1PrintControl* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1PrintControl methods ***/
static inline HRESULT ID2D1PrintControl_AddPage(ID2D1PrintControl* This,ID2D1CommandList *list,D2D_SIZE_F size,IStream *stream,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    return This->lpVtbl->AddPage(This,list,size,stream,tag1,tag2);
}
static inline HRESULT ID2D1PrintControl_Close(ID2D1PrintControl* This) {
    return This->lpVtbl->Close(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1ImageBrush_QueryInterface(ID2D1ImageBrush* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1ImageBrush_AddRef(ID2D1ImageBrush* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1ImageBrush_Release(ID2D1ImageBrush* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static inline void ID2D1ImageBrush_GetFactory(ID2D1ImageBrush* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1Brush methods ***/
static inline void ID2D1ImageBrush_SetOpacity(ID2D1ImageBrush* This,float opacity) {
    This->lpVtbl->SetOpacity(This,opacity);
}
static inline void ID2D1ImageBrush_SetTransform(ID2D1ImageBrush* This,const D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->SetTransform(This,transform);
}
static inline float ID2D1ImageBrush_GetOpacity(ID2D1ImageBrush* This) {
    return This->lpVtbl->GetOpacity(This);
}
static inline void ID2D1ImageBrush_GetTransform(ID2D1ImageBrush* This,D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->GetTransform(This,transform);
}
/*** ID2D1ImageBrush methods ***/
static inline void ID2D1ImageBrush_SetImage(ID2D1ImageBrush* This,ID2D1Image *image) {
    This->lpVtbl->SetImage(This,image);
}
static inline void ID2D1ImageBrush_SetExtendModeX(ID2D1ImageBrush* This,D2D1_EXTEND_MODE extend_mode) {
    This->lpVtbl->SetExtendModeX(This,extend_mode);
}
static inline void ID2D1ImageBrush_SetExtendModeY(ID2D1ImageBrush* This,D2D1_EXTEND_MODE extend_mode) {
    This->lpVtbl->SetExtendModeY(This,extend_mode);
}
static inline void ID2D1ImageBrush_SetInterpolationMode(ID2D1ImageBrush* This,D2D1_INTERPOLATION_MODE interpolation_mode) {
    This->lpVtbl->SetInterpolationMode(This,interpolation_mode);
}
static inline void ID2D1ImageBrush_SetSourceRectangle(ID2D1ImageBrush* This,const D2D1_RECT_F *rect) {
    This->lpVtbl->SetSourceRectangle(This,rect);
}
static inline void ID2D1ImageBrush_GetImage(ID2D1ImageBrush* This,ID2D1Image **image) {
    This->lpVtbl->GetImage(This,image);
}
static inline D2D1_EXTEND_MODE ID2D1ImageBrush_GetExtendModeX(ID2D1ImageBrush* This) {
    return This->lpVtbl->GetExtendModeX(This);
}
static inline D2D1_EXTEND_MODE ID2D1ImageBrush_GetExtendModeY(ID2D1ImageBrush* This) {
    return This->lpVtbl->GetExtendModeY(This);
}
static inline D2D1_INTERPOLATION_MODE ID2D1ImageBrush_GetInterpolationMode(ID2D1ImageBrush* This) {
    return This->lpVtbl->GetInterpolationMode(This);
}
static inline void ID2D1ImageBrush_GetSourceRectangle(ID2D1ImageBrush* This,D2D1_RECT_F *rect) {
...
ID2D1DeviceContext : public ID2D1RenderTarget
{
    ...
    virtual HRESULT STDMETHODCALLTYPE GetImageLocalBounds(
        ID2D1Image *image,
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1DeviceContext_QueryInterface(ID2D1DeviceContext* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1DeviceContext_AddRef(ID2D1DeviceContext* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1DeviceContext_Release(ID2D1DeviceContext* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static inline void ID2D1DeviceContext_GetFactory(ID2D1DeviceContext* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1RenderTarget methods ***/
static inline HRESULT ID2D1DeviceContext_CreateSharedBitmap(ID2D1DeviceContext* This,REFIID iid,void *data,const D2D1_BITMAP_PROPERTIES *desc,ID2D1Bitmap **bitmap) {
    return This->lpVtbl->CreateSharedBitmap(This,iid,data,desc,bitmap);
}
static inline HRESULT ID2D1DeviceContext_CreateSolidColorBrush(ID2D1DeviceContext* This,const D2D1_COLOR_F *color,const D2D1_BRUSH_PROPERTIES *desc,ID2D1SolidColorBrush **brush) {
    return This->lpVtbl->CreateSolidColorBrush(This,color,desc,brush);
}
static inline HRESULT ID2D1DeviceContext_CreateLinearGradientBrush(ID2D1DeviceContext* This,const D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES *gradient_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1GradientStopCollection *gradient,ID2D1LinearGradientBrush **brush) {
    return This->lpVtbl->CreateLinearGradientBrush(This,gradient_brush_desc,brush_desc,gradient,brush);
}
static inline HRESULT ID2D1DeviceContext_CreateRadialGradientBrush(ID2D1DeviceContext* This,const D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES *gradient_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1GradientStopCollection *gradient,ID2D1RadialGradientBrush **brush) {
    return This->lpVtbl->CreateRadialGradientBrush(This,gradient_brush_desc,brush_desc,gradient,brush);
}
static inline HRESULT ID2D1DeviceContext_CreateCompatibleRenderTarget(ID2D1DeviceContext* This,const D2D1_SIZE_F *size,const D2D1_SIZE_U *pixel_size,const D2D1_PIXEL_FORMAT *format,D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS options,ID2D1BitmapRenderTarget **render_target) {
    return This->lpVtbl->CreateCompatibleRenderTarget(This,size,pixel_size,format,options,render_target);
}
static inline HRESULT ID2D1DeviceContext_CreateLayer(ID2D1DeviceContext* This,const D2D1_SIZE_F *size,ID2D1Layer **layer) {
    return This->lpVtbl->CreateLayer(This,size,layer);
}
static inline HRESULT ID2D1DeviceContext_CreateMesh(ID2D1DeviceContext* This,ID2D1Mesh **mesh) {
    return This->lpVtbl->CreateMesh(This,mesh);
}
static inline void ID2D1DeviceContext_DrawLine(ID2D1DeviceContext* This,D2D1_POINT_2F p0,D2D1_POINT_2F p1,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawLine(This,p0,p1,brush,stroke_width,stroke_style);
}
static inline void ID2D1DeviceContext_DrawRectangle(ID2D1DeviceContext* This,const D2D1_RECT_F *rect,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawRectangle(This,rect,brush,stroke_width,stroke_style);
}
static inline void ID2D1DeviceContext_FillRectangle(ID2D1DeviceContext* This,const D2D1_RECT_F *rect,ID2D1Brush *brush) {
    This->lpVtbl->FillRectangle(This,rect,brush);
}
static inline void ID2D1DeviceContext_DrawRoundedRectangle(ID2D1DeviceContext* This,const D2D1_ROUNDED_RECT *rect,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawRoundedRectangle(This,rect,brush,stroke_width,stroke_style);
}
static inline void ID2D1DeviceContext_FillRoundedRectangle(ID2D1DeviceContext* This,const D2D1_ROUNDED_RECT *rect,ID2D1Brush *brush) {
    This->lpVtbl->FillRoundedRectangle(This,rect,brush);
}
static inline void ID2D1DeviceContext_DrawEllipse(ID2D1DeviceContext* This,const D2D1_ELLIPSE *ellipse,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawEllipse(This,ellipse,brush,stroke_width,stroke_style);
}
static inline void ID2D1DeviceContext_FillEllipse(ID2D1DeviceContext* This,const D2D1_ELLIPSE *ellipse,ID2D1Brush *brush) {
    This->lpVtbl->FillEllipse(This,ellipse,brush);
}
static inline void ID2D1DeviceContext_DrawGeometry(ID2D1DeviceContext* This,ID2D1Geometry *geometry,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawGeometry(This,geometry,brush,stroke_width,stroke_style);
}
static inline void ID2D1DeviceContext_FillGeometry(ID2D1DeviceContext* This,ID2D1Geometry *geometry,ID2D1Brush *brush,ID2D1Brush *opacity_brush) {
    This->lpVtbl->FillGeometry(This,geometry,brush,opacity_brush);
}
static inline void ID2D1DeviceContext_FillMesh(ID2D1DeviceContext* This,ID2D1Mesh *mesh,ID2D1Brush *brush) {
    This->lpVtbl->FillMesh(This,mesh,brush);
}
static inline void ID2D1DeviceContext_DrawText(ID2D1DeviceContext* This,const WCHAR *string,UINT32 string_len,IDWriteTextFormat *text_format,const D2D1_RECT_F *layout_rect,ID2D1Brush *brush,D2D1_DRAW_TEXT_OPTIONS options,DWRITE_MEASURING_MODE measuring_mode) {
    This->lpVtbl->DrawText(This,string,string_len,text_format,layout_rect,brush,options,measuring_mode);
}
static inline void ID2D1DeviceContext_DrawTextLayout(ID2D1DeviceContext* This,D2D1_POINT_2F origin,IDWriteTextLayout *layout,ID2D1Brush *brush,D2D1_DRAW_TEXT_OPTIONS options) {
    This->lpVtbl->DrawTextLayout(This,origin,layout,brush,options);
}
static inline void ID2D1DeviceContext_SetTransform(ID2D1DeviceContext* This,const D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->SetTransform(This,transform);
}
static inline void ID2D1DeviceContext_GetTransform(ID2D1DeviceContext* This,D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->GetTransform(This,transform);
}
static inline void ID2D1DeviceContext_SetAntialiasMode(ID2D1DeviceContext* This,D2D1_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->SetAntialiasMode(This,antialias_mode);
}
static inline D2D1_ANTIALIAS_MODE ID2D1DeviceContext_GetAntialiasMode(ID2D1DeviceContext* This) {
    return This->lpVtbl->GetAntialiasMode(This);
}
static inline void ID2D1DeviceContext_SetTextAntialiasMode(ID2D1DeviceContext* This,D2D1_TEXT_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->SetTextAntialiasMode(This,antialias_mode);
}
static inline D2D1_TEXT_ANTIALIAS_MODE ID2D1DeviceContext_GetTextAntialiasMode(ID2D1DeviceContext* This) {
    return This->lpVtbl->GetTextAntialiasMode(This);
}
static inline void ID2D1DeviceContext_SetTextRenderingParams(ID2D1DeviceContext* This,IDWriteRenderingParams *text_rendering_params) {
    This->lpVtbl->SetTextRenderingParams(This,text_rendering_params);
}
static inline void ID2D1DeviceContext_GetTextRenderingParams(ID2D1DeviceContext* This,IDWriteRenderingParams **text_rendering_params) {
    This->lpVtbl->GetTextRenderingParams(This,text_rendering_params);
}
static inline void ID2D1DeviceContext_SetTags(ID2D1DeviceContext* This,D2D1_TAG tag1,D2D1_TAG tag2) {
    This->lpVtbl->SetTags(This,tag1,tag2);
}
static inline void ID2D1DeviceContext_GetTags(ID2D1DeviceContext* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    This->lpVtbl->GetTags(This,tag1,tag2);
}
static inline void ID2D1DeviceContext_PopLayer(ID2D1DeviceContext* This) {
    This->lpVtbl->PopLayer(This);
}
static inline HRESULT ID2D1DeviceContext_Flush(ID2D1DeviceContext* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    return This->lpVtbl->Flush(This,tag1,tag2);
}
static inline void ID2D1DeviceContext_SaveDrawingState(ID2D1DeviceContext* This,ID2D1DrawingStateBlock *state_block) {
    This->lpVtbl->SaveDrawingState(This,state_block);
}
static inline void ID2D1DeviceContext_RestoreDrawingState(ID2D1DeviceContext* This,ID2D1DrawingStateBlock *state_block) {
    This->lpVtbl->RestoreDrawingState(This,state_block);
}
static inline void ID2D1DeviceContext_PushAxisAlignedClip(ID2D1DeviceContext* This,const D2D1_RECT_F *clip_rect,D2D1_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->PushAxisAlignedClip(This,clip_rect,antialias_mode);
}
static inline void ID2D1DeviceContext_PopAxisAlignedClip(ID2D1DeviceContext* This) {
    This->lpVtbl->PopAxisAlignedClip(This);
}
static inline void ID2D1DeviceContext_Clear(ID2D1DeviceContext* This,const D2D1_COLOR_F *color) {
    This->lpVtbl->Clear(This,color);
}
static inline void ID2D1DeviceContext_BeginDraw(ID2D1DeviceContext* This) {
    This->lpVtbl->BeginDraw(This);
}
static inline HRESULT ID2D1DeviceContext_EndDraw(ID2D1DeviceContext* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    return This->lpVtbl->EndDraw(This,tag1,tag2);
}
static inline D2D1_PIXEL_FORMAT ID2D1DeviceContext_GetPixelFormat(ID2D1DeviceContext* This) {
    D2D1_PIXEL_FORMAT __ret;
    return *This->lpVtbl->GetPixelFormat(This,&__ret);
}
static inline void ID2D1DeviceContext_SetDpi(ID2D1DeviceContext* This,float dpi_x,float dpi_y) {
    This->lpVtbl->SetDpi(This,dpi_x,dpi_y);
}
static inline void ID2D1DeviceContext_GetDpi(ID2D1DeviceContext* This,float *dpi_x,float *dpi_y) {
    This->lpVtbl->GetDpi(This,dpi_x,dpi_y);
}
static inline D2D1_SIZE_F ID2D1DeviceContext_GetSize(ID2D1DeviceContext* This) {
    D2D1_SIZE_F __ret;
    return *This->lpVtbl->GetSize(This,&__ret);
}
static inline D2D1_SIZE_U ID2D1DeviceContext_GetPixelSize(ID2D1DeviceContext* This) {
    D2D1_SIZE_U __ret;
    return *This->lpVtbl->GetPixelSize(This,&__ret);
}
static inline UINT32 ID2D1DeviceContext_GetMaximumBitmapSize(ID2D1DeviceContext* This) {
    return This->lpVtbl->GetMaximumBitmapSize(This);
}
static inline BOOL ID2D1DeviceContext_IsSupported(ID2D1DeviceContext* This,const D2D1_RENDER_TARGET_PROPERTIES *desc) {
    return This->lpVtbl->IsSupported(This,desc);
}
/*** ID2D1DeviceContext methods ***/
static inline HRESULT ID2D1DeviceContext_CreateBitmap(ID2D1DeviceContext* This,D2D1_SIZE_U size,const void *src_data,UINT32 pitch,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmap(This,size,src_data,pitch,desc,bitmap);
}
static inline HRESULT ID2D1DeviceContext_CreateBitmapFromWicBitmap(ID2D1DeviceContext* This,IWICBitmapSource *bitmap_source,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmapFromWicBitmap(This,bitmap_source,desc,bitmap);
}
static inline HRESULT ID2D1DeviceContext_CreateColorContext(ID2D1DeviceContext* This,D2D1_COLOR_SPACE space,const BYTE *profile,UINT32 profile_size,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContext(This,space,profile,profile_size,color_context);
}
static inline HRESULT ID2D1DeviceContext_CreateColorContextFromFilename(ID2D1DeviceContext* This,const WCHAR *filename,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContextFromFilename(This,filename,color_context);
}
static inline HRESULT ID2D1DeviceContext_CreateColorContextFromWicColorContext(ID2D1DeviceContext* This,IWICColorContext *wic_color_context,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContextFromWicColorContext(This,wic_color_context,color_context);
}
static inline HRESULT ID2D1DeviceContext_CreateBitmapFromDxgiSurface(ID2D1DeviceContext* This,IDXGISurface *surface,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->CreateBitmapFromDxgiSurface(This,surface,desc,bitmap);
}
static inline HRESULT ID2D1DeviceContext_CreateEffect(ID2D1DeviceContext* This,REFCLSID effect_id,ID2D1Effect **effect) {
    return This->lpVtbl->CreateEffect(This,effect_id,effect);
}
static inline HRESULT ID2D1DeviceContext_CreateGradientStopCollection(ID2D1DeviceContext* This,const D2D1_GRADIENT_STOP *stops,UINT32 stop_count,D2D1_COLOR_SPACE preinterpolation_space,D2D1_COLOR_SPACE postinterpolation_space,D2D1_BUFFER_PRECISION buffer_precision,D2D1_EXTEND_MODE extend_mode,D2D1_COLOR_INTERPOLATION_MODE color_interpolation_mode,ID2D1GradientStopCollection1 **gradient) {
...
static inline HRESULT ID2D1DeviceContext_CreateImageBrush(ID2D1DeviceContext* This,ID2D1Image *image,const D2D1_IMAGE_BRUSH_PROPERTIES *image_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1ImageBrush **brush) {
    return This->lpVtbl->CreateImageBrush(This,image,image_brush_desc,brush_desc,brush);
}
static inline HRESULT ID2D1DeviceContext_CreateBitmapBrush(ID2D1DeviceContext* This,ID2D1Bitmap *bitmap,const D2D1_BITMAP_BRUSH_PROPERTIES1 *bitmap_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1BitmapBrush1 **bitmap_brush) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmapBrush(This,bitmap,bitmap_brush_desc,brush_desc,bitmap_brush);
}
static inline HRESULT ID2D1DeviceContext_CreateCommandList(ID2D1DeviceContext* This,ID2D1CommandList **command_list) {
    return This->lpVtbl->CreateCommandList(This,command_list);
}
static inline BOOL ID2D1DeviceContext_IsDxgiFormatSupported(ID2D1DeviceContext* This,DXGI_FORMAT format) {
    return This->lpVtbl->IsDxgiFormatSupported(This,format);
}
static inline BOOL ID2D1DeviceContext_IsBufferPrecisionSupported(ID2D1DeviceContext* This,D2D1_BUFFER_PRECISION buffer_precision) {
    return This->lpVtbl->IsBufferPrecisionSupported(This,buffer_precision);
}
static inline HRESULT ID2D1DeviceContext_GetImageLocalBounds(ID2D1DeviceContext* This,ID2D1Image *image,D2D1_RECT_F *local_bounds) {
    return This->lpVtbl->GetImageLocalBounds(This,image,local_bounds);
}
static inline HRESULT ID2D1DeviceContext_GetImageWorldBounds(ID2D1DeviceContext* This,ID2D1Image *image,D2D1_RECT_F *world_bounds) {
    return This->lpVtbl->GetImageWorldBounds(This,image,world_bounds);
}
static inline HRESULT ID2D1DeviceContext_GetGlyphRunWorldBounds(ID2D1DeviceContext* This,D2D1_POINT_2F baseline_origin,const DWRITE_GLYPH_RUN *glyph_run,DWRITE_MEASURING_MODE measuring_mode,D2D1_RECT_F *bounds) {
    return This->lpVtbl->GetGlyphRunWorldBounds(This,baseline_origin,glyph_run,measuring_mode,bounds);
}
static inline void ID2D1DeviceContext_GetDevice(ID2D1DeviceContext* This,ID2D1Device **device) {
    This->lpVtbl->GetDevice(This,device);
}
static inline void ID2D1DeviceContext_SetTarget(ID2D1DeviceContext* This,ID2D1Image *target) {
    This->lpVtbl->SetTarget(This,target);
}
static inline void ID2D1DeviceContext_GetTarget(ID2D1DeviceContext* This,ID2D1Image **target) {
    This->lpVtbl->GetTarget(This,target);
}
static inline void ID2D1DeviceContext_SetRenderingControls(ID2D1DeviceContext* This,const D2D1_RENDERING_CONTROLS *rendering_controls) {
    This->lpVtbl->SetRenderingControls(This,rendering_controls);
}
static inline void ID2D1DeviceContext_GetRenderingControls(ID2D1DeviceContext* This,D2D1_RENDERING_CONTROLS *rendering_controls) {
    This->lpVtbl->GetRenderingControls(This,rendering_controls);
}
static inline void ID2D1DeviceContext_SetPrimitiveBlend(ID2D1DeviceContext* This,D2D1_PRIMITIVE_BLEND primitive_blend) {
    This->lpVtbl->SetPrimitiveBlend(This,primitive_blend);
}
static inline D2D1_PRIMITIVE_BLEND ID2D1DeviceContext_GetPrimitiveBlend(ID2D1DeviceContext* This) {
    return This->lpVtbl->GetPrimitiveBlend(This);
}
static inline void ID2D1DeviceContext_SetUnitMode(ID2D1DeviceContext* This,D2D1_UNIT_MODE unit_mode) {
    This->lpVtbl->SetUnitMode(This,unit_mode);
}
static inline D2D1_UNIT_MODE ID2D1DeviceContext_GetUnitMode(ID2D1DeviceContext* This) {
    return This->lpVtbl->GetUnitMode(This);
}
static inline void ID2D1DeviceContext_DrawGlyphRun(ID2D1DeviceContext* This,D2D1_POINT_2F baseline_origin,const DWRITE_GLYPH_RUN *glyph_run,const DWRITE_GLYPH_RUN_DESCRIPTION *glyph_run_desc,ID2D1Brush *brush,DWRITE_MEASURING_MODE measuring_mode) {
    This->lpVtbl->ID2D1DeviceContext_DrawGlyphRun(This,baseline_origin,glyph_run,glyph_run_desc,brush,measuring_mode);
}
static inline void ID2D1DeviceContext_DrawImage(ID2D1DeviceContext* This,ID2D1Image *image,const D2D1_POINT_2F *target_offset,const D2D1_RECT_F *image_rect,D2D1_INTERPOLATION_MODE interpolation_mode,D2D1_COMPOSITE_MODE composite_mode) {
    This->lpVtbl->DrawImage(This,image,target_offset,image_rect,interpolation_mode,composite_mode);
}
static inline void ID2D1DeviceContext_DrawGdiMetafile(ID2D1DeviceContext* This,ID2D1GdiMetafile *metafile,const D2D1_POINT_2F *target_offset) {
    This->lpVtbl->DrawGdiMetafile(This,metafile,target_offset);
}
static inline void ID2D1DeviceContext_DrawBitmap(ID2D1DeviceContext* This,ID2D1Bitmap *bitmap,const D2D1_RECT_F *dst_rect,float opacity,D2D1_INTERPOLATION_MODE interpolation_mode,const D2D1_RECT_F *src_rect,const D2D1_MATRIX_4X4_F *perspective_transform) {
    This->lpVtbl->ID2D1DeviceContext_DrawBitmap(This,bitmap,dst_rect,opacity,interpolation_mode,src_rect,perspective_transform);
}
static inline void ID2D1DeviceContext_PushLayer(ID2D1DeviceContext* This,const D2D1_LAYER_PARAMETERS1 *layer_parameters,ID2D1Layer *layer) {
    This->lpVtbl->ID2D1DeviceContext_PushLayer(This,layer_parameters,layer);
}
static inline HRESULT ID2D1DeviceContext_InvalidateEffectInputRectangle(ID2D1DeviceContext* This,ID2D1Effect *effect,UINT32 input,const D2D1_RECT_F *input_rect) {
    return This->lpVtbl->InvalidateEffectInputRectangle(This,effect,input,input_rect);
}
static inline HRESULT ID2D1DeviceContext_GetEffectInvalidRectangleCount(ID2D1DeviceContext* This,ID2D1Effect *effect,UINT32 *rect_count) {
    return This->lpVtbl->GetEffectInvalidRectangleCount(This,effect,rect_count);
}
static inline HRESULT ID2D1DeviceContext_GetEffectInvalidRectangles(ID2D1DeviceContext* This,ID2D1Effect *effect,D2D1_RECT_F *rectangles,UINT32 rect_count) {
    return This->lpVtbl->GetEffectInvalidRectangles(This,effect,rectangles,rect_count);
}
static inline HRESULT ID2D1DeviceContext_GetEffectRequiredInputRectangles(ID2D1DeviceContext* This,ID2D1Effect *effect,const D2D1_RECT_F *image_rect,const D2D1_EFFECT_INPUT_DESCRIPTION *desc,D2D1_RECT_F *input_rect,UINT32 input_count) {
    return This->lpVtbl->GetEffectRequiredInputRectangles(This,effect,image_rect,desc,input_rect,input_count);
}
static inline void ID2D1DeviceContext_FillOpacityMask(ID2D1DeviceContext* This,ID2D1Bitmap *mask,ID2D1Brush *brush,const D2D1_RECT_F *dst_rect,const D2D1_RECT_F *src_rect) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1StrokeStyle1_QueryInterface(ID2D1StrokeStyle1* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1StrokeStyle1_AddRef(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1StrokeStyle1_Release(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static inline void ID2D1StrokeStyle1_GetFactory(ID2D1StrokeStyle1* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1StrokeStyle methods ***/
static inline D2D1_CAP_STYLE ID2D1StrokeStyle1_GetStartCap(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetStartCap(This);
}
static inline D2D1_CAP_STYLE ID2D1StrokeStyle1_GetEndCap(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetEndCap(This);
}
static inline D2D1_CAP_STYLE ID2D1StrokeStyle1_GetDashCap(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetDashCap(This);
}
static inline float ID2D1StrokeStyle1_GetMiterLimit(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetMiterLimit(This);
}
static inline D2D1_LINE_JOIN ID2D1StrokeStyle1_GetLineJoin(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetLineJoin(This);
}
static inline float ID2D1StrokeStyle1_GetDashOffset(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetDashOffset(This);
}
static inline D2D1_DASH_STYLE ID2D1StrokeStyle1_GetDashStyle(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetDashStyle(This);
}
static inline UINT32 ID2D1StrokeStyle1_GetDashesCount(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetDashesCount(This);
}
static inline void ID2D1StrokeStyle1_GetDashes(ID2D1StrokeStyle1* This,float *dashes,UINT32 count) {
    This->lpVtbl->GetDashes(This,dashes,count);
}
/*** ID2D1StrokeStyle1 methods ***/
static inline D2D1_STROKE_TRANSFORM_TYPE ID2D1StrokeStyle1_GetStrokeTransformType(ID2D1StrokeStyle1* This) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1Factory1_QueryInterface(ID2D1Factory1* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1Factory1_AddRef(ID2D1Factory1* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1Factory1_Release(ID2D1Factory1* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Factory methods ***/
static inline HRESULT ID2D1Factory1_ReloadSystemMetrics(ID2D1Factory1* This) {
    return This->lpVtbl->ReloadSystemMetrics(This);
}
static inline void ID2D1Factory1_GetDesktopDpi(ID2D1Factory1* This,float *dpi_x,float *dpi_y) {
    This->lpVtbl->GetDesktopDpi(This,dpi_x,dpi_y);
}
static inline HRESULT ID2D1Factory1_CreateRectangleGeometry(ID2D1Factory1* This,const D2D1_RECT_F *rect,ID2D1RectangleGeometry **geometry) {
    return This->lpVtbl->CreateRectangleGeometry(This,rect,geometry);
}
static inline HRESULT ID2D1Factory1_CreateRoundedRectangleGeometry(ID2D1Factory1* This,const D2D1_ROUNDED_RECT *rect,ID2D1RoundedRectangleGeometry **geometry) {
    return This->lpVtbl->CreateRoundedRectangleGeometry(This,rect,geometry);
}
static inline HRESULT ID2D1Factory1_CreateEllipseGeometry(ID2D1Factory1* This,const D2D1_ELLIPSE *ellipse,ID2D1EllipseGeometry **geometry) {
    return This->lpVtbl->CreateEllipseGeometry(This,ellipse,geometry);
}
static inline HRESULT ID2D1Factory1_CreateGeometryGroup(ID2D1Factory1* This,D2D1_FILL_MODE fill_mode,ID2D1Geometry **geometries,UINT32 geometry_count,ID2D1GeometryGroup **group) {
    return This->lpVtbl->CreateGeometryGroup(This,fill_mode,geometries,geometry_count,group);
}
static inline HRESULT ID2D1Factory1_CreateTransformedGeometry(ID2D1Factory1* This,ID2D1Geometry *src_geometry,const D2D1_MATRIX_3X2_F *transform,ID2D1TransformedGeometry **transformed_geometry) {
    return This->lpVtbl->CreateTransformedGeometry(This,src_geometry,transform,transformed_geometry);
}
static inline HRESULT ID2D1Factory1_CreateWicBitmapRenderTarget(ID2D1Factory1* This,IWICBitmap *target,const D2D1_RENDER_TARGET_PROPERTIES *desc,ID2D1RenderTarget **render_target) {
    return This->lpVtbl->CreateWicBitmapRenderTarget(This,target,desc,render_target);
}
static inline HRESULT ID2D1Factory1_CreateHwndRenderTarget(ID2D1Factory1* This,const D2D1_RENDER_TARGET_PROPERTIES *desc,const D2D1_HWND_RENDER_TARGET_PROPERTIES *hwnd_rt_desc,ID2D1HwndRenderTarget **render_target) {
    return This->lpVtbl->CreateHwndRenderTarget(This,desc,hwnd_rt_desc,render_target);
}
static inline HRESULT ID2D1Factory1_CreateDxgiSurfaceRenderTarget(ID2D1Factory1* This,IDXGISurface *surface,const D2D1_RENDER_TARGET_PROPERTIES *desc,ID2D1RenderTarget **render_target) {
    return This->lpVtbl->CreateDxgiSurfaceRenderTarget(This,surface,desc,render_target);
}
static inline HRESULT ID2D1Factory1_CreateDCRenderTarget(ID2D1Factory1* This,const D2D1_RENDER_TARGET_PROPERTIES *desc,ID2D1DCRenderTarget **render_target) {
    return This->lpVtbl->CreateDCRenderTarget(This,desc,render_target);
}
/*** ID2D1Factory1 methods ***/
static inline HRESULT ID2D1Factory1_CreateDevice(ID2D1Factory1* This,IDXGIDevice *dxgi_device,ID2D1Device **device) {
    return This->lpVtbl->CreateDevice(This,dxgi_device,device);
}
static inline HRESULT ID2D1Factory1_CreateStrokeStyle(ID2D1Factory1* This,const D2D1_STROKE_STYLE_PROPERTIES1 *desc,const float *dashes,UINT32 dash_count,ID2D1StrokeStyle1 **stroke_style) {
    return This->lpVtbl->ID2D1Factory1_CreateStrokeStyle(This,desc,dashes,dash_count,stroke_style);
}
static inline HRESULT ID2D1Factory1_CreatePathGeometry(ID2D1Factory1* This,ID2D1PathGeometry1 **geometry) {
    return This->lpVtbl->ID2D1Factory1_CreatePathGeometry(This,geometry);
}
static inline HRESULT ID2D1Factory1_CreateDrawingStateBlock(ID2D1Factory1* This,const D2D1_DRAWING_STATE_DESCRIPTION1 *desc,IDWriteRenderingParams *text_rendering_params,ID2D1DrawingStateBlock1 **state_block) {
    return This->lpVtbl->ID2D1Factory1_CreateDrawingStateBlock(This,desc,text_rendering_params,state_block);
}
static inline HRESULT ID2D1Factory1_CreateGdiMetafile(ID2D1Factory1* This,IStream *stream,ID2D1GdiMetafile **metafile) {
    return This->lpVtbl->CreateGdiMetafile(This,stream,metafile);
}
static inline HRESULT ID2D1Factory1_RegisterEffectFromStream(ID2D1Factory1* This,REFCLSID effect_id,IStream *property_xml,const struct D2D1_PROPERTY_BINDING *bindings,UINT32 binding_count,PD2D1_EFFECT_FACTORY effect_factory) {
    return This->lpVtbl->RegisterEffectFromStream(This,effect_id,property_xml,bindings,binding_count,effect_factory);
}
static inline HRESULT ID2D1Factory1_RegisterEffectFromString(ID2D1Factory1* This,REFCLSID effect_id,const WCHAR *property_xml,const struct D2D1_PROPERTY_BINDING *bindings,UINT32 binding_count,PD2D1_EFFECT_FACTORY effect_factory) {
    return This->lpVtbl->RegisterEffectFromString(This,effect_id,property_xml,bindings,binding_count,effect_factory);
}
static inline HRESULT ID2D1Factory1_UnregisterEffect(ID2D1Factory1* This,REFCLSID effect_id) {
    return This->lpVtbl->UnregisterEffect(This,effect_id);
}
static inline HRESULT ID2D1Factory1_GetRegisteredEffects(ID2D1Factory1* This,CLSID *effects,UINT32 effect_count,UINT32 *returned,UINT32 *registered) {
    return This->lpVtbl->GetRegisteredEffects(This,effects,effect_count,returned,registered);
}
static inline HRESULT ID2D1Factory1_GetEffectProperties(ID2D1Factory1* This,REFCLSID effect_id,ID2D1Properties **props) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID2D1Multithread_QueryInterface(ID2D1Multithread* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID2D1Multithread_AddRef(ID2D1Multithread* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID2D1Multithread_Release(ID2D1Multithread* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Multithread methods ***/
static inline BOOL ID2D1Multithread_GetMultithreadProtected(ID2D1Multithread* This) {
    return This->lpVtbl->GetMultithreadProtected(This);
}
static inline void ID2D1Multithread_Enter(ID2D1Multithread* This) {
    This->lpVtbl->Enter(This);
}
static inline void ID2D1Multithread_Leave(ID2D1Multithread* This) {
...
HRESULT __stdcall  D2D1CreateDeviceContext(IDXGISurface *dxgi_surface,const D2D1_CREATION_PROPERTIES *creation_properties,ID2D1DeviceContext **context);
