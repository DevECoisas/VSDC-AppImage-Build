/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/endpointvolume.idl - Do not edit ***/
...
static inline HRESULT IAudioEndpointVolume_SetMute(IAudioEndpointVolume* This,BOOL bMute,LPCGUID pguidEventContext) {
    return This->lpVtbl->SetMute(This,bMute,pguidEventContext);
}
static inline HRESULT IAudioEndpointVolume_GetMute(IAudioEndpointVolume* This,BOOL *bMute) {
...
static inline HRESULT IAudioEndpointVolumeEx_SetMute(IAudioEndpointVolumeEx* This,BOOL bMute,LPCGUID pguidEventContext) {
    return This->lpVtbl->SetMute(This,bMute,pguidEventContext);
}
static inline HRESULT IAudioEndpointVolumeEx_GetMute(IAudioEndpointVolumeEx* This,BOOL *bMute) {
    return This->lpVtbl->GetMute(This,bMute);
}
