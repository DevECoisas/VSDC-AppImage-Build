/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/medparam.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMediaParamInfo_QueryInterface(IMediaParamInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMediaParamInfo_AddRef(IMediaParamInfo* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMediaParamInfo_Release(IMediaParamInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** IMediaParamInfo methods ***/
static inline HRESULT IMediaParamInfo_GetParamCount(IMediaParamInfo* This,DWORD *count) {
    return This->lpVtbl->GetParamCount(This,count);
}
static inline HRESULT IMediaParamInfo_GetParamInfo(IMediaParamInfo* This,DWORD index,MP_PARAMINFO *info) {
    return This->lpVtbl->GetParamInfo(This,index,info);
}
static inline HRESULT IMediaParamInfo_GetParamText(IMediaParamInfo* This,DWORD index,WCHAR **text) {
    return This->lpVtbl->GetParamText(This,index,text);
}
static inline HRESULT IMediaParamInfo_GetNumTimeFormats(IMediaParamInfo* This,DWORD *count) {
    return This->lpVtbl->GetNumTimeFormats(This,count);
}
static inline HRESULT IMediaParamInfo_GetSupportedTimeFormat(IMediaParamInfo* This,DWORD index,GUID *guid) {
    return This->lpVtbl->GetSupportedTimeFormat(This,index,guid);
}
static inline HRESULT IMediaParamInfo_GetCurrentTimeFormat(IMediaParamInfo* This,GUID *guid,MP_TIMEDATA *time_data) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMediaParams_QueryInterface(IMediaParams* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMediaParams_AddRef(IMediaParams* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMediaParams_Release(IMediaParams* This) {
    return This->lpVtbl->Release(This);
}
/*** IMediaParams methods ***/
static inline HRESULT IMediaParams_GetParam(IMediaParams* This,DWORD index,MP_DATA *data) {
    return This->lpVtbl->GetParam(This,index,data);
}
static inline HRESULT IMediaParams_SetParam(IMediaParams* This,DWORD index,MP_DATA data) {
    return This->lpVtbl->SetParam(This,index,data);
}
static inline HRESULT IMediaParams_AddEnvelope(IMediaParams* This,DWORD index,DWORD count,MP_ENVELOPE_SEGMENT *segments) {
    return This->lpVtbl->AddEnvelope(This,index,count,segments);
}
static inline HRESULT IMediaParams_FlushEnvelope(IMediaParams* This,DWORD index,REFERENCE_TIME start,REFERENCE_TIME end) {
    return This->lpVtbl->FlushEnvelope(This,index,start,end);
}
static inline HRESULT IMediaParams_SetTimeFormat(IMediaParams* This,GUID guid,MP_TIMEDATA time_data) {
