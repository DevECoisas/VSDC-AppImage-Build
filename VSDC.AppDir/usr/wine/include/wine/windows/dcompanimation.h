/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/dcompanimation.idl - Do not edit ***/
...
static inline HRESULT IDCompositionAnimation_SetAbsoluteBeginTime(IDCompositionAnimation* This,LARGE_INTEGER time) {
    return This->lpVtbl->SetAbsoluteBeginTime(This,time);
}
static inline HRESULT IDCompositionAnimation_AddCubic(IDCompositionAnimation* This,double offset,float constant_coefficient,float linear_coefficient,float quadratic_coefficient,float cubic_coefficient) {
    return This->lpVtbl->AddCubic(This,offset,constant_coefficient,linear_coefficient,quadratic_coefficient,cubic_coefficient);
}
static inline HRESULT IDCompositionAnimation_AddSinusoidal(IDCompositionAnimation* This,double offset,float bias,float amplitude,float frequency,float phase) {
    return This->lpVtbl->AddSinusoidal(This,offset,bias,amplitude,frequency,phase);
}
static inline HRESULT IDCompositionAnimation_AddRepeat(IDCompositionAnimation* This,double offset,double duration) {
    return This->lpVtbl->AddRepeat(This,offset,duration);
}
static inline HRESULT IDCompositionAnimation_End(IDCompositionAnimation* This,double offset,float value) {
