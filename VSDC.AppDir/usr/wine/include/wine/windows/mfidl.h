/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/mfidl.idl - Do not edit ***/
...
/*** IMFClock methods ***/
static inline HRESULT IMFClock_GetClockCharacteristics(IMFClock* This,DWORD *characteristics) {
    return This->lpVtbl->GetClockCharacteristics(This,characteristics);
}
static inline HRESULT IMFClock_GetCorrelatedTime(IMFClock* This,DWORD reserved,LONGLONG *clock_time,MFTIME *system_time) {
    return This->lpVtbl->GetCorrelatedTime(This,reserved,clock_time,system_time);
}
static inline HRESULT IMFClock_GetContinuityKey(IMFClock* This,DWORD *key) {
    return This->lpVtbl->GetContinuityKey(This,key);
}
static inline HRESULT IMFClock_GetState(IMFClock* This,DWORD reserved,MFCLOCK_STATE *state) {
    return This->lpVtbl->GetState(This,reserved,state);
}
static inline HRESULT IMFClock_GetProperties(IMFClock* This,MFCLOCK_PROPERTIES *props) {
...
/*** IMFRateSupport methods ***/
static inline HRESULT IMFRateSupport_GetSlowestRate(IMFRateSupport* This,MFRATE_DIRECTION direction,BOOL thin,float *rate) {
    return This->lpVtbl->GetSlowestRate(This,direction,thin,rate);
}
static inline HRESULT IMFRateSupport_GetFastestRate(IMFRateSupport* This,MFRATE_DIRECTION direction,BOOL thin,float *rate) {
    return This->lpVtbl->GetFastestRate(This,direction,thin,rate);
}
static inline HRESULT IMFRateSupport_IsRateSupported(IMFRateSupport* This,BOOL thin,float rate,float *nearest_supported_rate) {
...
/*** IMFRateControl methods ***/
static inline HRESULT IMFRateControl_SetRate(IMFRateControl* This,BOOL thin,float rate) {
    return This->lpVtbl->SetRate(This,thin,rate);
}
static inline HRESULT IMFRateControl_GetRate(IMFRateControl* This,BOOL *thin,float *rate) {
...
/*** IMFTimer methods ***/
static inline HRESULT IMFTimer_SetTimer(IMFTimer* This,DWORD flags,LONGLONG time,IMFAsyncCallback *callback,IUnknown *state,IUnknown **key) {
    return This->lpVtbl->SetTimer(This,flags,time,callback,state,key);
}
static inline HRESULT IMFTimer_CancelTimer(IMFTimer* This,IUnknown *key) {
...
static inline HRESULT IMFTopologyNode_CompareItem(IMFTopologyNode* This,REFGUID guidKey,REFPROPVARIANT Value,BOOL *pbResult) {
    return This->lpVtbl->CompareItem(This,guidKey,Value,pbResult);
}
static inline HRESULT IMFTopologyNode_Compare(IMFTopologyNode* This,IMFAttributes *pTheirs,MF_ATTRIBUTES_MATCH_TYPE MatchType,BOOL *pbResult) {
...
/*** IMFTopologyNode methods ***/
static inline HRESULT IMFTopologyNode_SetObject(IMFTopologyNode* This,IUnknown *object) {
    return This->lpVtbl->SetObject(This,object);
}
static inline HRESULT IMFTopologyNode_GetObject(IMFTopologyNode* This,IUnknown **object) {
    return This->lpVtbl->GetObject(This,object);
}
static inline HRESULT IMFTopologyNode_GetNodeType(IMFTopologyNode* This,MF_TOPOLOGY_TYPE *type) {
    return This->lpVtbl->GetNodeType(This,type);
}
static inline HRESULT IMFTopologyNode_GetTopoNodeID(IMFTopologyNode* This,TOPOID *id) {
    return This->lpVtbl->GetTopoNodeID(This,id);
}
static inline HRESULT IMFTopologyNode_SetTopoNodeID(IMFTopologyNode* This,TOPOID id) {
    return This->lpVtbl->SetTopoNodeID(This,id);
}
static inline HRESULT IMFTopologyNode_GetInputCount(IMFTopologyNode* This,DWORD *count) {
    return This->lpVtbl->GetInputCount(This,count);
}
static inline HRESULT IMFTopologyNode_GetOutputCount(IMFTopologyNode* This,DWORD *count) {
    return This->lpVtbl->GetOutputCount(This,count);
}
static inline HRESULT IMFTopologyNode_ConnectOutput(IMFTopologyNode* This,DWORD output_index,IMFTopologyNode *node,DWORD input_index) {
    return This->lpVtbl->ConnectOutput(This,output_index,node,input_index);
}
static inline HRESULT IMFTopologyNode_DisconnectOutput(IMFTopologyNode* This,DWORD index) {
    return This->lpVtbl->DisconnectOutput(This,index);
}
static inline HRESULT IMFTopologyNode_GetInput(IMFTopologyNode* This,DWORD input_index,IMFTopologyNode **node,DWORD *output_index) {
    return This->lpVtbl->GetInput(This,input_index,node,output_index);
}
static inline HRESULT IMFTopologyNode_GetOutput(IMFTopologyNode* This,DWORD output_index,IMFTopologyNode **node,DWORD *input_index) {
    return This->lpVtbl->GetOutput(This,output_index,node,input_index);
}
static inline HRESULT IMFTopologyNode_SetOutputPrefType(IMFTopologyNode* This,DWORD index,IMFMediaType *type) {
    return This->lpVtbl->SetOutputPrefType(This,index,type);
}
static inline HRESULT IMFTopologyNode_GetOutputPrefType(IMFTopologyNode* This,DWORD output_index,IMFMediaType **type) {
    return This->lpVtbl->GetOutputPrefType(This,output_index,type);
}
static inline HRESULT IMFTopologyNode_SetInputPrefType(IMFTopologyNode* This,DWORD index,IMFMediaType *type) {
    return This->lpVtbl->SetInputPrefType(This,index,type);
}
static inline HRESULT IMFTopologyNode_GetInputPrefType(IMFTopologyNode* This,DWORD index,IMFMediaType **type) {
    return This->lpVtbl->GetInputPrefType(This,index,type);
}
static inline HRESULT IMFTopologyNode_CloneFrom(IMFTopologyNode* This,IMFTopologyNode *node) {
...
static inline HRESULT IMFTopology_CompareItem(IMFTopology* This,REFGUID guidKey,REFPROPVARIANT Value,BOOL *pbResult) {
    return This->lpVtbl->CompareItem(This,guidKey,Value,pbResult);
}
static inline HRESULT IMFTopology_Compare(IMFTopology* This,IMFAttributes *pTheirs,MF_ATTRIBUTES_MATCH_TYPE MatchType,BOOL *pbResult) {
    return This->lpVtbl->Compare(This,pTheirs,MatchType,pbResult);
}
...
/*** IMFTopology methods ***/
static inline HRESULT IMFTopology_GetTopologyID(IMFTopology* This,TOPOID *id) {
    return This->lpVtbl->GetTopologyID(This,id);
}
static inline HRESULT IMFTopology_AddNode(IMFTopology* This,IMFTopologyNode *node) {
    return This->lpVtbl->AddNode(This,node);
}
static inline HRESULT IMFTopology_RemoveNode(IMFTopology* This,IMFTopologyNode *node) {
    return This->lpVtbl->RemoveNode(This,node);
}
static inline HRESULT IMFTopology_GetNodeCount(IMFTopology* This,WORD *nodes) {
    return This->lpVtbl->GetNodeCount(This,nodes);
}
static inline HRESULT IMFTopology_GetNode(IMFTopology* This,WORD index,IMFTopologyNode **node) {
    return This->lpVtbl->GetNode(This,index,node);
}
static inline HRESULT IMFTopology_Clear(IMFTopology* This) {
    return This->lpVtbl->Clear(This);
}
static inline HRESULT IMFTopology_CloneFrom(IMFTopology* This,IMFTopology *topology) {
    return This->lpVtbl->CloneFrom(This,topology);
}
static inline HRESULT IMFTopology_GetNodeByID(IMFTopology* This,TOPOID id,IMFTopologyNode **node) {
    return This->lpVtbl->GetNodeByID(This,id,node);
}
static inline HRESULT IMFTopology_GetSourceNodeCollection(IMFTopology* This,IMFCollection **collection) {
    return This->lpVtbl->GetSourceNodeCollection(This,collection);
}
static inline HRESULT IMFTopology_GetOutputNodeCollection(IMFTopology* This,IMFCollection **collection) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFTopologyNodeAttributeEditor_QueryInterface(IMFTopologyNodeAttributeEditor* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFTopologyNodeAttributeEditor_AddRef(IMFTopologyNodeAttributeEditor* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFTopologyNodeAttributeEditor_Release(IMFTopologyNodeAttributeEditor* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFTopologyNodeAttributeEditor methods ***/
static inline HRESULT IMFTopologyNodeAttributeEditor_UpdateNodeAttributes(IMFTopologyNodeAttributeEditor* This,TOPOID id,DWORD count,MFTOPONODE_ATTRIBUTE_UPDATE *attr_updates) {
...
/*** IMFTopoLoader methods ***/
static inline HRESULT IMFTopoLoader_Load(IMFTopoLoader* This,IMFTopology *input_topology,IMFTopology **output_topology,IMFTopology *current_topology) {
...
/*** IMFMediaSession methods ***/
static inline HRESULT IMFMediaSession_SetTopology(IMFMediaSession* This,DWORD flags,IMFTopology *topology) {
...
static inline HRESULT IMFMediaSession_Start(IMFMediaSession* This,const GUID *format,const PROPVARIANT *start) {
...
static inline HRESULT IMFMediaSession_GetClock(IMFMediaSession* This,IMFClock **clock) {
    return This->lpVtbl->GetClock(This,clock);
}
static inline HRESULT IMFMediaSession_GetSessionCapabilities(IMFMediaSession* This,DWORD *caps) {
    return This->lpVtbl->GetSessionCapabilities(This,caps);
}
static inline HRESULT IMFMediaSession_GetFullTopology(IMFMediaSession* This,DWORD flags,TOPOID id,IMFTopology **topology) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFByteStreamHandler_QueryInterface(IMFByteStreamHandler* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFByteStreamHandler_AddRef(IMFByteStreamHandler* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFByteStreamHandler_Release(IMFByteStreamHandler* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFByteStreamHandler methods ***/
static inline HRESULT IMFByteStreamHandler_BeginCreateObject(IMFByteStreamHandler* This,IMFByteStream *stream,const WCHAR *url,DWORD flags,IPropertyStore *props,IUnknown **cancel_cookie,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginCreateObject(This,stream,url,flags,props,cancel_cookie,callback,state);
}
static inline HRESULT IMFByteStreamHandler_EndCreateObject(IMFByteStreamHandler* This,IMFAsyncResult *result,MF_OBJECT_TYPE *obj_type,IUnknown **object) {
    return This->lpVtbl->EndCreateObject(This,result,obj_type,object);
}
static inline HRESULT IMFByteStreamHandler_CancelObjectCreation(IMFByteStreamHandler* This,IUnknown *cancel_cookie) {
    return This->lpVtbl->CancelObjectCreation(This,cancel_cookie);
}
static inline HRESULT IMFByteStreamHandler_GetMaxNumberOfBytesRequiredForResolution(IMFByteStreamHandler* This,QWORD *bytes) {
...
/*** IMFByteStreamBuffering methods ***/
static inline HRESULT IMFByteStreamBuffering_SetBufferingParams(IMFByteStreamBuffering* This,MFBYTESTREAM_BUFFERING_PARAMS *params) {
    return This->lpVtbl->SetBufferingParams(This,params);
}
static inline HRESULT IMFByteStreamBuffering_EnableBuffering(IMFByteStreamBuffering* This,BOOL enable) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFByteStreamCacheControl_QueryInterface(IMFByteStreamCacheControl* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFByteStreamCacheControl_AddRef(IMFByteStreamCacheControl* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFByteStreamCacheControl_Release(IMFByteStreamCacheControl* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFByteStreamCacheControl methods ***/
static inline HRESULT IMFByteStreamCacheControl_StopBackgroundTransfer(IMFByteStreamCacheControl* This) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFByteStreamTimeSeek_QueryInterface(IMFByteStreamTimeSeek* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFByteStreamTimeSeek_AddRef(IMFByteStreamTimeSeek* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFByteStreamTimeSeek_Release(IMFByteStreamTimeSeek* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFByteStreamTimeSeek methods ***/
static inline HRESULT IMFByteStreamTimeSeek_IsTimeSeekSupported(IMFByteStreamTimeSeek* This,BOOL *is_supported) {
    return This->lpVtbl->IsTimeSeekSupported(This,is_supported);
}
static inline HRESULT IMFByteStreamTimeSeek_TimeSeek(IMFByteStreamTimeSeek* This,QWORD position) {
    return This->lpVtbl->TimeSeek(This,position);
}
static inline HRESULT IMFByteStreamTimeSeek_GetTimeSeekResult(IMFByteStreamTimeSeek* This,QWORD *start_time,QWORD *stop_time,QWORD *duration) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFSchemeHandler_QueryInterface(IMFSchemeHandler* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFSchemeHandler_AddRef(IMFSchemeHandler* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFSchemeHandler_Release(IMFSchemeHandler* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFSchemeHandler methods ***/
static inline HRESULT IMFSchemeHandler_BeginCreateObject(IMFSchemeHandler* This,const WCHAR *url,DWORD flags,IPropertyStore *props,IUnknown **cancel_cookie,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginCreateObject(This,url,flags,props,cancel_cookie,callback,state);
}
static inline HRESULT IMFSchemeHandler_EndCreateObject(IMFSchemeHandler* This,IMFAsyncResult *result,MF_OBJECT_TYPE *obj_type,IUnknown **object) {
    return This->lpVtbl->EndCreateObject(This,result,obj_type,object);
}
static inline HRESULT IMFSchemeHandler_CancelObjectCreation(IMFSchemeHandler* This,IUnknown *cancel_cookie) {
    return This->lpVtbl->CancelObjectCreation(This,cancel_cookie);
}
#endif
#endif
...
/*** IMFSourceResolver methods ***/
static inline HRESULT IMFSourceResolver_CreateObjectFromURL(IMFSourceResolver* This,const WCHAR *url,DWORD flags,IPropertyStore *props,MF_OBJECT_TYPE *obj_type,IUnknown **object) {
    return This->lpVtbl->CreateObjectFromURL(This,url,flags,props,obj_type,object);
}
static inline HRESULT IMFSourceResolver_CreateObjectFromByteStream(IMFSourceResolver* This,IMFByteStream *stream,const WCHAR *url,DWORD flags,IPropertyStore *props,MF_OBJECT_TYPE *obj_type,IUnknown **object) {
    return This->lpVtbl->CreateObjectFromByteStream(This,stream,url,flags,props,obj_type,object);
}
static inline HRESULT IMFSourceResolver_BeginCreateObjectFromURL(IMFSourceResolver* This,const WCHAR *url,DWORD flags,IPropertyStore *props,IUnknown **cancel_cookie,IMFAsyncCallback *callback,IUnknown *unk_state) {
    return This->lpVtbl->BeginCreateObjectFromURL(This,url,flags,props,cancel_cookie,callback,unk_state);
}
static inline HRESULT IMFSourceResolver_EndCreateObjectFromURL(IMFSourceResolver* This,IMFAsyncResult *result,MF_OBJECT_TYPE *obj_type,IUnknown **object) {
    return This->lpVtbl->EndCreateObjectFromURL(This,result,obj_type,object);
}
static inline HRESULT IMFSourceResolver_BeginCreateObjectFromByteStream(IMFSourceResolver* This,IMFByteStream *stream,const WCHAR *url,DWORD flags,IPropertyStore *props,IUnknown **cancel_cookie,IMFAsyncCallback *callback,IUnknown *unk_state) {
    return This->lpVtbl->BeginCreateObjectFromByteStream(This,stream,url,flags,props,cancel_cookie,callback,unk_state);
}
static inline HRESULT IMFSourceResolver_EndCreateObjectFromByteStream(IMFSourceResolver* This,IMFAsyncResult *result,MF_OBJECT_TYPE *obj_type,IUnknown **object) {
    return This->lpVtbl->EndCreateObjectFromByteStream(This,result,obj_type,object);
}
static inline HRESULT IMFSourceResolver_CancelObjectCreation(IMFSourceResolver* This,IUnknown *cancel_cookie) {
    return This->lpVtbl->CancelObjectCreation(This,cancel_cookie);
}
#endif
#endif
...
/*** IMFMediaTypeHandler methods ***/
static inline HRESULT IMFMediaTypeHandler_IsMediaTypeSupported(IMFMediaTypeHandler* This,IMFMediaType *in_type,IMFMediaType **out_type) {
    return This->lpVtbl->IsMediaTypeSupported(This,in_type,out_type);
}
static inline HRESULT IMFMediaTypeHandler_GetMediaTypeCount(IMFMediaTypeHandler* This,DWORD *count) {
    return This->lpVtbl->GetMediaTypeCount(This,count);
}
static inline HRESULT IMFMediaTypeHandler_GetMediaTypeByIndex(IMFMediaTypeHandler* This,DWORD index,IMFMediaType **type) {
    return This->lpVtbl->GetMediaTypeByIndex(This,index,type);
}
static inline HRESULT IMFMediaTypeHandler_SetCurrentMediaType(IMFMediaTypeHandler* This,IMFMediaType *type) {
    return This->lpVtbl->SetCurrentMediaType(This,type);
}
static inline HRESULT IMFMediaTypeHandler_GetCurrentMediaType(IMFMediaTypeHandler* This,IMFMediaType **type) {
    return This->lpVtbl->GetCurrentMediaType(This,type);
}
static inline HRESULT IMFMediaTypeHandler_GetMajorType(IMFMediaTypeHandler* This,GUID *type) {
...
static inline HRESULT IMFStreamDescriptor_CompareItem(IMFStreamDescriptor* This,REFGUID guidKey,REFPROPVARIANT Value,BOOL *pbResult) {
    return This->lpVtbl->CompareItem(This,guidKey,Value,pbResult);
}
static inline HRESULT IMFStreamDescriptor_Compare(IMFStreamDescriptor* This,IMFAttributes *pTheirs,MF_ATTRIBUTES_MATCH_TYPE MatchType,BOOL *pbResult) {
    return This->lpVtbl->Compare(This,pTheirs,MatchType,pbResult);
}
...
/*** IMFStreamDescriptor methods ***/
static inline HRESULT IMFStreamDescriptor_GetStreamIdentifier(IMFStreamDescriptor* This,DWORD *identifier) {
    return This->lpVtbl->GetStreamIdentifier(This,identifier);
}
static inline HRESULT IMFStreamDescriptor_GetMediaTypeHandler(IMFStreamDescriptor* This,IMFMediaTypeHandler **handler) {
...
static inline HRESULT IMFClockStateSink_OnClockStop(IMFClockStateSink* This,MFTIME hnssSystemTime) {
...
static inline HRESULT IMFPresentationDescriptor_CompareItem(IMFPresentationDescriptor* This,REFGUID guidKey,REFPROPVARIANT Value,BOOL *pbResult) {
    return This->lpVtbl->CompareItem(This,guidKey,Value,pbResult);
}
static inline HRESULT IMFPresentationDescriptor_Compare(IMFPresentationDescriptor* This,IMFAttributes *pTheirs,MF_ATTRIBUTES_MATCH_TYPE MatchType,BOOL *pbResult) {
    return This->lpVtbl->Compare(This,pTheirs,MatchType,pbResult);
}
...
/*** IMFPresentationDescriptor methods ***/
static inline HRESULT IMFPresentationDescriptor_GetStreamDescriptorCount(IMFPresentationDescriptor* This,DWORD *count) {
    return This->lpVtbl->GetStreamDescriptorCount(This,count);
}
static inline HRESULT IMFPresentationDescriptor_GetStreamDescriptorByIndex(IMFPresentationDescriptor* This,DWORD index,BOOL *selected,IMFStreamDescriptor **descriptor) {
    return This->lpVtbl->GetStreamDescriptorByIndex(This,index,selected,descriptor);
}
static inline HRESULT IMFPresentationDescriptor_SelectStream(IMFPresentationDescriptor* This,DWORD index) {
    return This->lpVtbl->SelectStream(This,index);
}
static inline HRESULT IMFPresentationDescriptor_DeselectStream(IMFPresentationDescriptor* This,DWORD index) {
    return This->lpVtbl->DeselectStream(This,index);
}
static inline HRESULT IMFPresentationDescriptor_Clone(IMFPresentationDescriptor* This,IMFPresentationDescriptor **descriptor) {
...
/*** IMFMetadata methods ***/
static inline HRESULT IMFMetadata_SetLanguage(IMFMetadata* This,const WCHAR *lang) {
    return This->lpVtbl->SetLanguage(This,lang);
}
static inline HRESULT IMFMetadata_GetLanguage(IMFMetadata* This,WCHAR **lang) {
    return This->lpVtbl->GetLanguage(This,lang);
}
static inline HRESULT IMFMetadata_GetAllLanguages(IMFMetadata* This,PROPVARIANT *languages) {
    return This->lpVtbl->GetAllLanguages(This,languages);
}
static inline HRESULT IMFMetadata_SetProperty(IMFMetadata* This,const WCHAR *name,const PROPVARIANT *values) {
    return This->lpVtbl->SetProperty(This,name,values);
}
static inline HRESULT IMFMetadata_GetProperty(IMFMetadata* This,const WCHAR *name,PROPVARIANT *values) {
    return This->lpVtbl->GetProperty(This,name,values);
}
static inline HRESULT IMFMetadata_DeleteProperty(IMFMetadata* This,const WCHAR *name) {
    return This->lpVtbl->DeleteProperty(This,name);
}
static inline HRESULT IMFMetadata_GetAllPropertyNames(IMFMetadata* This,PROPVARIANT *names) {
...
/*** IMFMetadataProvider methods ***/
static inline HRESULT IMFMetadataProvider_GetMFMetadata(IMFMetadataProvider* This,IMFPresentationDescriptor *descriptor,DWORD identifier,DWORD flags,IMFMetadata **metadata) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFSequencerSource_QueryInterface(IMFSequencerSource* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFSequencerSource_AddRef(IMFSequencerSource* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFSequencerSource_Release(IMFSequencerSource* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFSequencerSource methods ***/
static inline HRESULT IMFSequencerSource_AppendTopology(IMFSequencerSource* This,IMFTopology *topology,DWORD flags,MFSequencerElementId *element) {
    return This->lpVtbl->AppendTopology(This,topology,flags,element);
}
static inline HRESULT IMFSequencerSource_DeleteTopology(IMFSequencerSource* This,MFSequencerElementId element) {
    return This->lpVtbl->DeleteTopology(This,element);
}
static inline HRESULT IMFSequencerSource_GetPresentationContext(IMFSequencerSource* This,IMFPresentationDescriptor *pd,MFSequencerElementId *id,IMFTopology **topology) {
    return This->lpVtbl->GetPresentationContext(This,pd,id,topology);
}
static inline HRESULT IMFSequencerSource_UpdateTopology(IMFSequencerSource* This,MFSequencerElementId od,IMFTopology *topology) {
    return This->lpVtbl->UpdateTopology(This,od,topology);
}
static inline HRESULT IMFSequencerSource_UpdateTopologyFlags(IMFSequencerSource* This,MFSequencerElementId id,DWORD flags) {
...
static inline HRESULT IMFSampleGrabberSinkCallback_OnClockStop(IMFSampleGrabberSinkCallback* This,MFTIME hnssSystemTime) {
    return This->lpVtbl->OnClockStop(This,hnssSystemTime);
}
...
/*** IMFSampleGrabberSinkCallback methods ***/
static inline HRESULT IMFSampleGrabberSinkCallback_OnSetPresentationClock(IMFSampleGrabberSinkCallback* This,IMFPresentationClock *clock) {
    return This->lpVtbl->OnSetPresentationClock(This,clock);
}
static inline HRESULT IMFSampleGrabberSinkCallback_OnProcessSample(IMFSampleGrabberSinkCallback* This,REFGUID major_type,DWORD sample_flags,LONGLONG sample_time,LONGLONG sample_duration,const BYTE *buffer,DWORD sample_size) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFSampleGrabberSinkCallback2_QueryInterface(IMFSampleGrabberSinkCallback2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFSampleGrabberSinkCallback2_AddRef(IMFSampleGrabberSinkCallback2* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFSampleGrabberSinkCallback2_Release(IMFSampleGrabberSinkCallback2* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFClockStateSink methods ***/
static inline HRESULT IMFSampleGrabberSinkCallback2_OnClockStart(IMFSampleGrabberSinkCallback2* This,MFTIME hnsSystemTime,LONGLONG llClockStartOffset) {
    return This->lpVtbl->OnClockStart(This,hnsSystemTime,llClockStartOffset);
}
static inline HRESULT IMFSampleGrabberSinkCallback2_OnClockStop(IMFSampleGrabberSinkCallback2* This,MFTIME hnssSystemTime) {
    return This->lpVtbl->OnClockStop(This,hnssSystemTime);
}
static inline HRESULT IMFSampleGrabberSinkCallback2_OnClockPause(IMFSampleGrabberSinkCallback2* This,MFTIME hnsSystemTime) {
    return This->lpVtbl->OnClockPause(This,hnsSystemTime);
}
static inline HRESULT IMFSampleGrabberSinkCallback2_OnClockRestart(IMFSampleGrabberSinkCallback2* This,MFTIME hnsSystemTime) {
    return This->lpVtbl->OnClockRestart(This,hnsSystemTime);
}
static inline HRESULT IMFSampleGrabberSinkCallback2_OnClockSetRate(IMFSampleGrabberSinkCallback2* This,MFTIME hnsSystemTime,float flRate) {
    return This->lpVtbl->OnClockSetRate(This,hnsSystemTime,flRate);
}
/*** IMFSampleGrabberSinkCallback methods ***/
static inline HRESULT IMFSampleGrabberSinkCallback2_OnSetPresentationClock(IMFSampleGrabberSinkCallback2* This,IMFPresentationClock *clock) {
    return This->lpVtbl->OnSetPresentationClock(This,clock);
}
static inline HRESULT IMFSampleGrabberSinkCallback2_OnProcessSample(IMFSampleGrabberSinkCallback2* This,REFGUID major_type,DWORD sample_flags,LONGLONG sample_time,LONGLONG sample_duration,const BYTE *buffer,DWORD sample_size) {
    return This->lpVtbl->OnProcessSample(This,major_type,sample_flags,sample_time,sample_duration,buffer,sample_size);
}
static inline HRESULT IMFSampleGrabberSinkCallback2_OnShutdown(IMFSampleGrabberSinkCallback2* This) {
    return This->lpVtbl->OnShutdown(This);
}
/*** IMFSampleGrabberSinkCallback2 methods ***/
static inline HRESULT IMFSampleGrabberSinkCallback2_OnProcessSampleEx(IMFSampleGrabberSinkCallback2* This,REFGUID major_type,DWORD sample_flags,LONGLONG sample_time,LONGLONG sample_duration,const BYTE *buffer,DWORD sample_size,IMFAttributes *attributes) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFSeekInfo_QueryInterface(IMFSeekInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFSeekInfo_AddRef(IMFSeekInfo* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFSeekInfo_Release(IMFSeekInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFSeekInfo methods ***/
static inline HRESULT IMFSeekInfo_GetNearestKeyFrames(IMFSeekInfo* This,const GUID *format,const PROPVARIANT *position,PROPVARIANT *prev_frame,PROPVARIANT *next_frame) {
...
HRESULT WINAPI MFCreateWAVEMediaSink(IMFByteStream *stream, IMFMediaType *media_type, IMFMediaSink **sink);
...
HRESULT WINAPI MFTranscodeGetAudioOutputAvailableTypes(REFGUID subtype, DWORD flags,
        IMFAttributes *config, IMFCollection **types);
...
/*** IMFMediaSource methods ***/
static inline HRESULT IMFMediaSource_GetCharacteristics(IMFMediaSource* This,DWORD *characteristics) {
    return This->lpVtbl->GetCharacteristics(This,characteristics);
}
static inline HRESULT IMFMediaSource_CreatePresentationDescriptor(IMFMediaSource* This,IMFPresentationDescriptor **descriptor) {
    return This->lpVtbl->CreatePresentationDescriptor(This,descriptor);
}
static inline HRESULT IMFMediaSource_Start(IMFMediaSource* This,IMFPresentationDescriptor *descriptor,const GUID *time_format,const PROPVARIANT *start_position) {
...
/*** IMFMediaSource methods ***/
static inline HRESULT IMFMediaSourceEx_GetCharacteristics(IMFMediaSourceEx* This,DWORD *characteristics) {
    return This->lpVtbl->GetCharacteristics(This,characteristics);
}
static inline HRESULT IMFMediaSourceEx_CreatePresentationDescriptor(IMFMediaSourceEx* This,IMFPresentationDescriptor **descriptor) {
    return This->lpVtbl->CreatePresentationDescriptor(This,descriptor);
}
static inline HRESULT IMFMediaSourceEx_Start(IMFMediaSourceEx* This,IMFPresentationDescriptor *descriptor,const GUID *time_format,const PROPVARIANT *start_position) {
    return This->lpVtbl->Start(This,descriptor,time_format,start_position);
}
...
/*** IMFMediaSourceEx methods ***/
static inline HRESULT IMFMediaSourceEx_GetSourceAttributes(IMFMediaSourceEx* This,IMFAttributes **attributes) {
    return This->lpVtbl->GetSourceAttributes(This,attributes);
}
static inline HRESULT IMFMediaSourceEx_GetStreamAttributes(IMFMediaSourceEx* This,DWORD streamid,IMFAttributes **attributes) {
    return This->lpVtbl->GetStreamAttributes(This,streamid,attributes);
}
static inline HRESULT IMFMediaSourceEx_SetD3DManager(IMFMediaSourceEx* This,IUnknown *manager) {
...
/*** IMFMediaStream methods ***/
static inline HRESULT IMFMediaStream_GetMediaSource(IMFMediaStream* This,IMFMediaSource **source) {
    return This->lpVtbl->GetMediaSource(This,source);
}
static inline HRESULT IMFMediaStream_GetStreamDescriptor(IMFMediaStream* This,IMFStreamDescriptor **descriptor) {
    return This->lpVtbl->GetStreamDescriptor(This,descriptor);
}
static inline HRESULT IMFMediaStream_RequestSample(IMFMediaStream* This,IUnknown *token) {
...
/*** IMFClock methods ***/
static inline HRESULT IMFPresentationTimeSource_GetClockCharacteristics(IMFPresentationTimeSource* This,DWORD *characteristics) {
    return This->lpVtbl->GetClockCharacteristics(This,characteristics);
}
static inline HRESULT IMFPresentationTimeSource_GetCorrelatedTime(IMFPresentationTimeSource* This,DWORD reserved,LONGLONG *clock_time,MFTIME *system_time) {
    return This->lpVtbl->GetCorrelatedTime(This,reserved,clock_time,system_time);
}
static inline HRESULT IMFPresentationTimeSource_GetContinuityKey(IMFPresentationTimeSource* This,DWORD *key) {
    return This->lpVtbl->GetContinuityKey(This,key);
}
static inline HRESULT IMFPresentationTimeSource_GetState(IMFPresentationTimeSource* This,DWORD reserved,MFCLOCK_STATE *state) {
    return This->lpVtbl->GetState(This,reserved,state);
}
static inline HRESULT IMFPresentationTimeSource_GetProperties(IMFPresentationTimeSource* This,MFCLOCK_PROPERTIES *props) {
    return This->lpVtbl->GetProperties(This,props);
}
/*** IMFPresentationTimeSource methods ***/
static inline HRESULT IMFPresentationTimeSource_GetUnderlyingClock(IMFPresentationTimeSource* This,IMFClock **clock) {
...
/*** IMFClock methods ***/
static inline HRESULT IMFPresentationClock_GetClockCharacteristics(IMFPresentationClock* This,DWORD *characteristics) {
    return This->lpVtbl->GetClockCharacteristics(This,characteristics);
}
static inline HRESULT IMFPresentationClock_GetCorrelatedTime(IMFPresentationClock* This,DWORD reserved,LONGLONG *clock_time,MFTIME *system_time) {
    return This->lpVtbl->GetCorrelatedTime(This,reserved,clock_time,system_time);
}
static inline HRESULT IMFPresentationClock_GetContinuityKey(IMFPresentationClock* This,DWORD *key) {
    return This->lpVtbl->GetContinuityKey(This,key);
}
static inline HRESULT IMFPresentationClock_GetState(IMFPresentationClock* This,DWORD reserved,MFCLOCK_STATE *state) {
    return This->lpVtbl->GetState(This,reserved,state);
}
static inline HRESULT IMFPresentationClock_GetProperties(IMFPresentationClock* This,MFCLOCK_PROPERTIES *props) {
    return This->lpVtbl->GetProperties(This,props);
}
/*** IMFPresentationClock methods ***/
static inline HRESULT IMFPresentationClock_SetTimeSource(IMFPresentationClock* This,IMFPresentationTimeSource *time_source) {
    return This->lpVtbl->SetTimeSource(This,time_source);
}
static inline HRESULT IMFPresentationClock_GetTimeSource(IMFPresentationClock* This,IMFPresentationTimeSource **time_source) {
    return This->lpVtbl->GetTimeSource(This,time_source);
}
static inline HRESULT IMFPresentationClock_GetTime(IMFPresentationClock* This,MFTIME *time) {
    return This->lpVtbl->GetTime(This,time);
}
static inline HRESULT IMFPresentationClock_AddClockStateSink(IMFPresentationClock* This,IMFClockStateSink *state_sink) {
    return This->lpVtbl->AddClockStateSink(This,state_sink);
}
static inline HRESULT IMFPresentationClock_RemoveClockStateSink(IMFPresentationClock* This,IMFClockStateSink *state_sink) {
    return This->lpVtbl->RemoveClockStateSink(This,state_sink);
}
static inline HRESULT IMFPresentationClock_Start(IMFPresentationClock* This,LONGLONG start_offset) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFClockConsumer_QueryInterface(IMFClockConsumer* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFClockConsumer_AddRef(IMFClockConsumer* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFClockConsumer_Release(IMFClockConsumer* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFClockConsumer methods ***/
static inline HRESULT IMFClockConsumer_SetPresentationClock(IMFClockConsumer* This,IMFPresentationClock *clock) {
    return This->lpVtbl->SetPresentationClock(This,clock);
}
static inline HRESULT IMFClockConsumer_GetPresentationClock(IMFClockConsumer* This,IMFPresentationClock **clock) {
...
/*** IMFMediaSink methods ***/
static inline HRESULT IMFMediaSink_GetCharacteristics(IMFMediaSink* This,DWORD *characteristics) {
    return This->lpVtbl->GetCharacteristics(This,characteristics);
}
static inline HRESULT IMFMediaSink_AddStreamSink(IMFMediaSink* This,DWORD stream_sink_id,IMFMediaType *media_type,IMFStreamSink **stream_sink) {
    return This->lpVtbl->AddStreamSink(This,stream_sink_id,media_type,stream_sink);
}
static inline HRESULT IMFMediaSink_RemoveStreamSink(IMFMediaSink* This,DWORD stream_sink_id) {
    return This->lpVtbl->RemoveStreamSink(This,stream_sink_id);
}
static inline HRESULT IMFMediaSink_GetStreamSinkCount(IMFMediaSink* This,DWORD *count) {
    return This->lpVtbl->GetStreamSinkCount(This,count);
}
static inline HRESULT IMFMediaSink_GetStreamSinkByIndex(IMFMediaSink* This,DWORD index,IMFStreamSink **sink) {
    return This->lpVtbl->GetStreamSinkByIndex(This,index,sink);
}
static inline HRESULT IMFMediaSink_GetStreamSinkById(IMFMediaSink* This,DWORD stream_sink_id,IMFStreamSink **sink) {
    return This->lpVtbl->GetStreamSinkById(This,stream_sink_id,sink);
}
static inline HRESULT IMFMediaSink_SetPresentationClock(IMFMediaSink* This,IMFPresentationClock *clock) {
    return This->lpVtbl->SetPresentationClock(This,clock);
}
static inline HRESULT IMFMediaSink_GetPresentationClock(IMFMediaSink* This,IMFPresentationClock **clock) {
    return This->lpVtbl->GetPresentationClock(This,clock);
}
...
/*** IMFMediaSink methods ***/
static inline HRESULT IMFFinalizableMediaSink_GetCharacteristics(IMFFinalizableMediaSink* This,DWORD *characteristics) {
    return This->lpVtbl->GetCharacteristics(This,characteristics);
}
static inline HRESULT IMFFinalizableMediaSink_AddStreamSink(IMFFinalizableMediaSink* This,DWORD stream_sink_id,IMFMediaType *media_type,IMFStreamSink **stream_sink) {
    return This->lpVtbl->AddStreamSink(This,stream_sink_id,media_type,stream_sink);
}
static inline HRESULT IMFFinalizableMediaSink_RemoveStreamSink(IMFFinalizableMediaSink* This,DWORD stream_sink_id) {
    return This->lpVtbl->RemoveStreamSink(This,stream_sink_id);
}
static inline HRESULT IMFFinalizableMediaSink_GetStreamSinkCount(IMFFinalizableMediaSink* This,DWORD *count) {
    return This->lpVtbl->GetStreamSinkCount(This,count);
}
static inline HRESULT IMFFinalizableMediaSink_GetStreamSinkByIndex(IMFFinalizableMediaSink* This,DWORD index,IMFStreamSink **sink) {
    return This->lpVtbl->GetStreamSinkByIndex(This,index,sink);
}
static inline HRESULT IMFFinalizableMediaSink_GetStreamSinkById(IMFFinalizableMediaSink* This,DWORD stream_sink_id,IMFStreamSink **sink) {
    return This->lpVtbl->GetStreamSinkById(This,stream_sink_id,sink);
}
static inline HRESULT IMFFinalizableMediaSink_SetPresentationClock(IMFFinalizableMediaSink* This,IMFPresentationClock *clock) {
    return This->lpVtbl->SetPresentationClock(This,clock);
}
static inline HRESULT IMFFinalizableMediaSink_GetPresentationClock(IMFFinalizableMediaSink* This,IMFPresentationClock **clock) {
    return This->lpVtbl->GetPresentationClock(This,clock);
}
...
/*** IMFFinalizableMediaSink methods ***/
static inline HRESULT IMFFinalizableMediaSink_BeginFinalize(IMFFinalizableMediaSink* This,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginFinalize(This,callback,state);
}
static inline HRESULT IMFFinalizableMediaSink_EndFinalize(IMFFinalizableMediaSink* This,IMFAsyncResult *result) {
...
/*** IMFMediaSinkPreroll methods ***/
static inline HRESULT IMFMediaSinkPreroll_NotifyPreroll(IMFMediaSinkPreroll* This,MFTIME start_time) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFStreamingSinkConfig_QueryInterface(IMFStreamingSinkConfig* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFStreamingSinkConfig_AddRef(IMFStreamingSinkConfig* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFStreamingSinkConfig_Release(IMFStreamingSinkConfig* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFStreamingSinkConfig methods ***/
static inline HRESULT IMFStreamingSinkConfig_StartStreaming(IMFStreamingSinkConfig* This,BOOL is_byte_offset,QWORD seek_offset) {
...
/*** IMFStreamSink methods ***/
static inline HRESULT IMFStreamSink_GetMediaSink(IMFStreamSink* This,IMFMediaSink **sink) {
    return This->lpVtbl->GetMediaSink(This,sink);
}
static inline HRESULT IMFStreamSink_GetIdentifier(IMFStreamSink* This,DWORD *identifier) {
    return This->lpVtbl->GetIdentifier(This,identifier);
}
static inline HRESULT IMFStreamSink_GetMediaTypeHandler(IMFStreamSink* This,IMFMediaTypeHandler **handler) {
    return This->lpVtbl->GetMediaTypeHandler(This,handler);
}
static inline HRESULT IMFStreamSink_ProcessSample(IMFStreamSink* This,IMFSample *sample) {
    return This->lpVtbl->ProcessSample(This,sample);
}
static inline HRESULT IMFStreamSink_PlaceMarker(IMFStreamSink* This,MFSTREAMSINK_MARKER_TYPE marker_type,const PROPVARIANT *marker_value,const PROPVARIANT *context_value) {
...
static inline HRESULT IMFShutdown_GetShutdownStatus(IMFShutdown* This,MFSHUTDOWN_STATUS *status) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFQualityManager_QueryInterface(IMFQualityManager* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFQualityManager_AddRef(IMFQualityManager* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFQualityManager_Release(IMFQualityManager* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFQualityManager methods ***/
static inline HRESULT IMFQualityManager_NotifyTopology(IMFQualityManager* This,IMFTopology *topology) {
    return This->lpVtbl->NotifyTopology(This,topology);
}
static inline HRESULT IMFQualityManager_NotifyPresentationClock(IMFQualityManager* This,IMFPresentationClock *clock) {
    return This->lpVtbl->NotifyPresentationClock(This,clock);
}
static inline HRESULT IMFQualityManager_NotifyProcessInput(IMFQualityManager* This,IMFTopologyNode *node,LONG input_index,IMFSample *sample) {
    return This->lpVtbl->NotifyProcessInput(This,node,input_index,sample);
}
static inline HRESULT IMFQualityManager_NotifyProcessOutput(IMFQualityManager* This,IMFTopologyNode *node,LONG output_index,IMFSample *sample) {
    return This->lpVtbl->NotifyProcessOutput(This,node,output_index,sample);
}
static inline HRESULT IMFQualityManager_NotifyQualityEvent(IMFQualityManager* This,IUnknown *object,IMFMediaEvent *event) {
    return This->lpVtbl->NotifyQualityEvent(This,object,event);
}
static inline HRESULT IMFQualityManager_Shutdown(IMFQualityManager* This) {
    return This->lpVtbl->Shutdown(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFQualityAdvise_QueryInterface(IMFQualityAdvise* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFQualityAdvise_AddRef(IMFQualityAdvise* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFQualityAdvise_Release(IMFQualityAdvise* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFQualityAdvise methods ***/
static inline HRESULT IMFQualityAdvise_SetDropMode(IMFQualityAdvise* This,MF_QUALITY_DROP_MODE mode) {
    return This->lpVtbl->SetDropMode(This,mode);
}
static inline HRESULT IMFQualityAdvise_SetQualityLevel(IMFQualityAdvise* This,MF_QUALITY_LEVEL level) {
    return This->lpVtbl->SetQualityLevel(This,level);
}
static inline HRESULT IMFQualityAdvise_GetDropMode(IMFQualityAdvise* This,MF_QUALITY_DROP_MODE *mode) {
    return This->lpVtbl->GetDropMode(This,mode);
}
static inline HRESULT IMFQualityAdvise_GetQualityLevel(IMFQualityAdvise* This,MF_QUALITY_LEVEL *level) {
    return This->lpVtbl->GetQualityLevel(This,level);
}
static inline HRESULT IMFQualityAdvise_DropTime(IMFQualityAdvise* This,LONGLONG interval) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFQualityAdvise2_QueryInterface(IMFQualityAdvise2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFQualityAdvise2_AddRef(IMFQualityAdvise2* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFQualityAdvise2_Release(IMFQualityAdvise2* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFQualityAdvise methods ***/
static inline HRESULT IMFQualityAdvise2_SetDropMode(IMFQualityAdvise2* This,MF_QUALITY_DROP_MODE mode) {
    return This->lpVtbl->SetDropMode(This,mode);
}
static inline HRESULT IMFQualityAdvise2_SetQualityLevel(IMFQualityAdvise2* This,MF_QUALITY_LEVEL level) {
    return This->lpVtbl->SetQualityLevel(This,level);
}
static inline HRESULT IMFQualityAdvise2_GetDropMode(IMFQualityAdvise2* This,MF_QUALITY_DROP_MODE *mode) {
    return This->lpVtbl->GetDropMode(This,mode);
}
static inline HRESULT IMFQualityAdvise2_GetQualityLevel(IMFQualityAdvise2* This,MF_QUALITY_LEVEL *level) {
    return This->lpVtbl->GetQualityLevel(This,level);
}
static inline HRESULT IMFQualityAdvise2_DropTime(IMFQualityAdvise2* This,LONGLONG interval) {
    return This->lpVtbl->DropTime(This,interval);
}
/*** IMFQualityAdvise2 methods ***/
static inline HRESULT IMFQualityAdvise2_NotifyQualityEvent(IMFQualityAdvise2* This,IMFMediaEvent *event,DWORD *flags) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFQualityAdviseLimits_QueryInterface(IMFQualityAdviseLimits* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFQualityAdviseLimits_AddRef(IMFQualityAdviseLimits* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFQualityAdviseLimits_Release(IMFQualityAdviseLimits* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFQualityAdviseLimits methods ***/
static inline HRESULT IMFQualityAdviseLimits_GetMaximumDropMode(IMFQualityAdviseLimits* This,MF_QUALITY_DROP_MODE *mode) {
    return This->lpVtbl->GetMaximumDropMode(This,mode);
}
static inline HRESULT IMFQualityAdviseLimits_GetMinimumQualityLevel(IMFQualityAdviseLimits* This,MF_QUALITY_LEVEL *level) {
...
/*** IMFTrackedSample methods ***/
static inline HRESULT IMFTrackedSample_SetAllocator(IMFTrackedSample* This,IMFAsyncCallback *sample_allocator,IUnknown *state) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFLocalMFTRegistration_QueryInterface(IMFLocalMFTRegistration* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFLocalMFTRegistration_AddRef(IMFLocalMFTRegistration* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFLocalMFTRegistration_Release(IMFLocalMFTRegistration* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFLocalMFTRegistration methods ***/
static inline HRESULT IMFLocalMFTRegistration_RegisterMFTs(IMFLocalMFTRegistration* This,MFT_REGISTRATION_INFO *info,DWORD count) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFMediaSourceTopologyProvider_QueryInterface(IMFMediaSourceTopologyProvider* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFMediaSourceTopologyProvider_AddRef(IMFMediaSourceTopologyProvider* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFMediaSourceTopologyProvider_Release(IMFMediaSourceTopologyProvider* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFMediaSourceTopologyProvider methods ***/
static inline HRESULT IMFMediaSourceTopologyProvider_GetMediaSourceTopology(IMFMediaSourceTopologyProvider* This,IMFPresentationDescriptor *pd,IMFTopology **topology) {
...
/*** IMFSimpleAudioVolume methods ***/
static inline HRESULT IMFSimpleAudioVolume_SetMasterVolume(IMFSimpleAudioVolume* This,float level) {
    return This->lpVtbl->SetMasterVolume(This,level);
}
static inline HRESULT IMFSimpleAudioVolume_GetMasterVolume(IMFSimpleAudioVolume* This,float *level) {
    return This->lpVtbl->GetMasterVolume(This,level);
}
static inline HRESULT IMFSimpleAudioVolume_SetMute(IMFSimpleAudioVolume* This,BOOL mute) {
    return This->lpVtbl->SetMute(This,mute);
}
static inline HRESULT IMFSimpleAudioVolume_GetMute(IMFSimpleAudioVolume* This,BOOL *mute) {
...
/*** IMFAudioStreamVolume methods ***/
static inline HRESULT IMFAudioStreamVolume_GetChannelCount(IMFAudioStreamVolume* This,UINT32 *count) {
    return This->lpVtbl->GetChannelCount(This,count);
}
static inline HRESULT IMFAudioStreamVolume_SetChannelVolume(IMFAudioStreamVolume* This,UINT32 index,const float level) {
    return This->lpVtbl->SetChannelVolume(This,index,level);
}
static inline HRESULT IMFAudioStreamVolume_GetChannelVolume(IMFAudioStreamVolume* This,UINT32 index,float *level) {
    return This->lpVtbl->GetChannelVolume(This,index,level);
}
static inline HRESULT IMFAudioStreamVolume_SetAllVolumes(IMFAudioStreamVolume* This,UINT32 count,const float *volumes) {
    return This->lpVtbl->SetAllVolumes(This,count,volumes);
}
static inline HRESULT IMFAudioStreamVolume_GetAllVolumes(IMFAudioStreamVolume* This,UINT32 count,float *volumes) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFAudioPolicy_QueryInterface(IMFAudioPolicy* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFAudioPolicy_AddRef(IMFAudioPolicy* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFAudioPolicy_Release(IMFAudioPolicy* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFAudioPolicy methods ***/
static inline HRESULT IMFAudioPolicy_SetGroupingParam(IMFAudioPolicy* This,REFGUID param) {
    return This->lpVtbl->SetGroupingParam(This,param);
}
static inline HRESULT IMFAudioPolicy_GetGroupingParam(IMFAudioPolicy* This,GUID *param) {
    return This->lpVtbl->GetGroupingParam(This,param);
}
static inline HRESULT IMFAudioPolicy_SetDisplayName(IMFAudioPolicy* This,LPCWSTR name) {
    return This->lpVtbl->SetDisplayName(This,name);
}
static inline HRESULT IMFAudioPolicy_GetDisplayName(IMFAudioPolicy* This,LPWSTR *name) {
    return This->lpVtbl->GetDisplayName(This,name);
}
static inline HRESULT IMFAudioPolicy_SetIconPath(IMFAudioPolicy* This,LPCWSTR path) {
    return This->lpVtbl->SetIconPath(This,path);
}
static inline HRESULT IMFAudioPolicy_GetIconPath(IMFAudioPolicy* This,LPWSTR *path) {
...
/*** IMFVideoSampleAllocator methods ***/
static inline HRESULT IMFVideoSampleAllocator_SetDirectXManager(IMFVideoSampleAllocator* This,IUnknown *manager) {
...
static inline HRESULT IMFVideoSampleAllocator_InitializeSampleAllocator(IMFVideoSampleAllocator* This,DWORD sample_count,IMFMediaType *media_type) {
    return This->lpVtbl->InitializeSampleAllocator(This,sample_count,media_type);
}
static inline HRESULT IMFVideoSampleAllocator_AllocateSample(IMFVideoSampleAllocator* This,IMFSample **sample) {
...
/*** IMFVideoSampleAllocatorNotifyEx methods ***/
static inline HRESULT IMFVideoSampleAllocatorNotifyEx_NotifyPrune(IMFVideoSampleAllocatorNotifyEx* This,IMFSample *sample) {
...
/*** IMFVideoSampleAllocatorCallback methods ***/
static inline HRESULT IMFVideoSampleAllocatorCallback_SetCallback(IMFVideoSampleAllocatorCallback* This,IMFVideoSampleAllocatorNotify *callback) {
    return This->lpVtbl->SetCallback(This,callback);
}
static inline HRESULT IMFVideoSampleAllocatorCallback_GetFreeSampleCount(IMFVideoSampleAllocatorCallback* This,LONG *count) {
...
/*** IMFVideoSampleAllocator methods ***/
static inline HRESULT IMFVideoSampleAllocatorEx_SetDirectXManager(IMFVideoSampleAllocatorEx* This,IUnknown *manager) {
    return This->lpVtbl->SetDirectXManager(This,manager);
}
static inline HRESULT IMFVideoSampleAllocatorEx_UninitializeSampleAllocator(IMFVideoSampleAllocatorEx* This) {
    return This->lpVtbl->UninitializeSampleAllocator(This);
}
static inline HRESULT IMFVideoSampleAllocatorEx_InitializeSampleAllocator(IMFVideoSampleAllocatorEx* This,DWORD sample_count,IMFMediaType *media_type) {
    return This->lpVtbl->InitializeSampleAllocator(This,sample_count,media_type);
}
static inline HRESULT IMFVideoSampleAllocatorEx_AllocateSample(IMFVideoSampleAllocatorEx* This,IMFSample **sample) {
    return This->lpVtbl->AllocateSample(This,sample);
}
/*** IMFVideoSampleAllocatorEx methods ***/
static inline HRESULT IMFVideoSampleAllocatorEx_InitializeSampleAllocatorEx(IMFVideoSampleAllocatorEx* This,DWORD initial_sample_count,DWORD max_sample_count,IMFAttributes *attributes,IMFMediaType *media_type) {
...
/*** IMFVideoProcessorControl methods ***/
static inline HRESULT IMFVideoProcessorControl_SetBorderColor(IMFVideoProcessorControl* This,MFARGB *color) {
    return This->lpVtbl->SetBorderColor(This,color);
}
static inline HRESULT IMFVideoProcessorControl_SetSourceRectangle(IMFVideoProcessorControl* This,RECT *rect) {
    return This->lpVtbl->SetSourceRectangle(This,rect);
}
static inline HRESULT IMFVideoProcessorControl_SetDestinationRectangle(IMFVideoProcessorControl* This,RECT *rect) {
    return This->lpVtbl->SetDestinationRectangle(This,rect);
}
static inline HRESULT IMFVideoProcessorControl_SetMirror(IMFVideoProcessorControl* This,MF_VIDEO_PROCESSOR_MIRROR mirror) {
    return This->lpVtbl->SetMirror(This,mirror);
}
static inline HRESULT IMFVideoProcessorControl_SetRotation(IMFVideoProcessorControl* This,MF_VIDEO_PROCESSOR_ROTATION rotation) {
    return This->lpVtbl->SetRotation(This,rotation);
}
static inline HRESULT IMFVideoProcessorControl_SetConstrictionSize(IMFVideoProcessorControl* This,SIZE *size) {
...
/*** IMFVideoProcessorControl methods ***/
static inline HRESULT IMFVideoProcessorControl2_SetBorderColor(IMFVideoProcessorControl2* This,MFARGB *color) {
    return This->lpVtbl->SetBorderColor(This,color);
}
static inline HRESULT IMFVideoProcessorControl2_SetSourceRectangle(IMFVideoProcessorControl2* This,RECT *rect) {
    return This->lpVtbl->SetSourceRectangle(This,rect);
}
static inline HRESULT IMFVideoProcessorControl2_SetDestinationRectangle(IMFVideoProcessorControl2* This,RECT *rect) {
    return This->lpVtbl->SetDestinationRectangle(This,rect);
}
static inline HRESULT IMFVideoProcessorControl2_SetMirror(IMFVideoProcessorControl2* This,MF_VIDEO_PROCESSOR_MIRROR mirror) {
    return This->lpVtbl->SetMirror(This,mirror);
}
static inline HRESULT IMFVideoProcessorControl2_SetRotation(IMFVideoProcessorControl2* This,MF_VIDEO_PROCESSOR_ROTATION rotation) {
    return This->lpVtbl->SetRotation(This,rotation);
}
static inline HRESULT IMFVideoProcessorControl2_SetConstrictionSize(IMFVideoProcessorControl2* This,SIZE *size) {
    return This->lpVtbl->SetConstrictionSize(This,size);
}
/*** IMFVideoProcessorControl2 methods ***/
static inline HRESULT IMFVideoProcessorControl2_SetRotationOverride(IMFVideoProcessorControl2* This,UINT rotation) {
    return This->lpVtbl->SetRotationOverride(This,rotation);
}
static inline HRESULT IMFVideoProcessorControl2_EnableHardwareEffects(IMFVideoProcessorControl2* This,BOOL enabled) {
    return This->lpVtbl->EnableHardwareEffects(This,enabled);
}
static inline HRESULT IMFVideoProcessorControl2_GetSupportedHardwareEffects(IMFVideoProcessorControl2* This,UINT *support) {
...
/*** IMFVideoProcessorControl methods ***/
static inline HRESULT IMFVideoProcessorControl3_SetBorderColor(IMFVideoProcessorControl3* This,MFARGB *color) {
    return This->lpVtbl->SetBorderColor(This,color);
}
static inline HRESULT IMFVideoProcessorControl3_SetSourceRectangle(IMFVideoProcessorControl3* This,RECT *rect) {
    return This->lpVtbl->SetSourceRectangle(This,rect);
}
static inline HRESULT IMFVideoProcessorControl3_SetDestinationRectangle(IMFVideoProcessorControl3* This,RECT *rect) {
    return This->lpVtbl->SetDestinationRectangle(This,rect);
}
static inline HRESULT IMFVideoProcessorControl3_SetMirror(IMFVideoProcessorControl3* This,MF_VIDEO_PROCESSOR_MIRROR mirror) {
    return This->lpVtbl->SetMirror(This,mirror);
}
static inline HRESULT IMFVideoProcessorControl3_SetRotation(IMFVideoProcessorControl3* This,MF_VIDEO_PROCESSOR_ROTATION rotation) {
    return This->lpVtbl->SetRotation(This,rotation);
}
static inline HRESULT IMFVideoProcessorControl3_SetConstrictionSize(IMFVideoProcessorControl3* This,SIZE *size) {
    return This->lpVtbl->SetConstrictionSize(This,size);
}
/*** IMFVideoProcessorControl2 methods ***/
static inline HRESULT IMFVideoProcessorControl3_SetRotationOverride(IMFVideoProcessorControl3* This,UINT rotation) {
    return This->lpVtbl->SetRotationOverride(This,rotation);
}
static inline HRESULT IMFVideoProcessorControl3_EnableHardwareEffects(IMFVideoProcessorControl3* This,BOOL enabled) {
    return This->lpVtbl->EnableHardwareEffects(This,enabled);
}
static inline HRESULT IMFVideoProcessorControl3_GetSupportedHardwareEffects(IMFVideoProcessorControl3* This,UINT *support) {
    return This->lpVtbl->GetSupportedHardwareEffects(This,support);
}
/*** IMFVideoProcessorControl3 methods ***/
static inline HRESULT IMFVideoProcessorControl3_GetNaturalOutputType(IMFVideoProcessorControl3* This,IMFMediaType **media_type) {
    return This->lpVtbl->GetNaturalOutputType(This,media_type);
}
static inline HRESULT IMFVideoProcessorControl3_EnableSphericalVideoProcessing(IMFVideoProcessorControl3* This,BOOL enable,MFVideoSphericalFormat format,MFVideoSphericalProjectionMode projection_mode) {
    return This->lpVtbl->EnableSphericalVideoProcessing(This,enable,format,projection_mode);
}
static inline HRESULT IMFVideoProcessorControl3_SetSphericalVideoProperties(IMFVideoProcessorControl3* This,float x,float y,float z,float w,float fov) {
    return This->lpVtbl->SetSphericalVideoProperties(This,x,y,z,w,fov);
}
static inline HRESULT IMFVideoProcessorControl3_SetOutputDevice(IMFVideoProcessorControl3* This,IUnknown *output_device) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFRealTimeClient_QueryInterface(IMFRealTimeClient* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFRealTimeClient_AddRef(IMFRealTimeClient* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFRealTimeClient_Release(IMFRealTimeClient* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFRealTimeClient methods ***/
static inline HRESULT IMFRealTimeClient_RegisterThreads(IMFRealTimeClient* This,DWORD task_index,LPCWSTR classname) {
    return This->lpVtbl->RegisterThreads(This,task_index,classname);
}
static inline HRESULT IMFRealTimeClient_UnregisterThreads(IMFRealTimeClient* This) {
    return This->lpVtbl->UnregisterThreads(This);
}
static inline HRESULT IMFRealTimeClient_SetWorkQueue(IMFRealTimeClient* This,DWORD queue_id) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFRealTimeClientEx_QueryInterface(IMFRealTimeClientEx* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFRealTimeClientEx_AddRef(IMFRealTimeClientEx* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFRealTimeClientEx_Release(IMFRealTimeClientEx* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFRealTimeClientEx methods ***/
static inline HRESULT IMFRealTimeClientEx_RegisterThreadsEx(IMFRealTimeClientEx* This,DWORD *task_index,LPCWSTR classname,LONG basepriority) {
    return This->lpVtbl->RegisterThreadsEx(This,task_index,classname,basepriority);
}
static inline HRESULT IMFRealTimeClientEx_UnregisterThreads(IMFRealTimeClientEx* This) {
    return This->lpVtbl->UnregisterThreads(This);
}
static inline HRESULT IMFRealTimeClientEx_SetWorkQueueEx(IMFRealTimeClientEx* This,DWORD mtqueue_id,LONG base_priority) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFWorkQueueServices_QueryInterface(IMFWorkQueueServices* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFWorkQueueServices_AddRef(IMFWorkQueueServices* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFWorkQueueServices_Release(IMFWorkQueueServices* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFWorkQueueServices methods ***/
static inline HRESULT IMFWorkQueueServices_BeginRegisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServices* This,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginRegisterTopologyWorkQueuesWithMMCSS(This,callback,state);
}
static inline HRESULT IMFWorkQueueServices_EndRegisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServices* This,IMFAsyncResult *result) {
    return This->lpVtbl->EndRegisterTopologyWorkQueuesWithMMCSS(This,result);
}
static inline HRESULT IMFWorkQueueServices_BeginUnregisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServices* This,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginUnregisterTopologyWorkQueuesWithMMCSS(This,callback,state);
}
static inline HRESULT IMFWorkQueueServices_EndUnregisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServices* This,IMFAsyncResult *result) {
    return This->lpVtbl->EndUnregisterTopologyWorkQueuesWithMMCSS(This,result);
}
static inline HRESULT IMFWorkQueueServices_GetTopologyWorkQueueMMCSSClass(IMFWorkQueueServices* This,DWORD queue,LPWSTR classname,DWORD *classname_len) {
    return This->lpVtbl->GetTopologyWorkQueueMMCSSClass(This,queue,classname,classname_len);
}
static inline HRESULT IMFWorkQueueServices_GetTopologyWorkQueueMMCSSTaskId(IMFWorkQueueServices* This,DWORD queue,DWORD *taksid) {
    return This->lpVtbl->GetTopologyWorkQueueMMCSSTaskId(This,queue,taksid);
}
static inline HRESULT IMFWorkQueueServices_BeginRegisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServices* This,DWORD platform_queue,LPCWSTR classname,DWORD taskid,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginRegisterPlatformWorkQueueWithMMCSS(This,platform_queue,classname,taskid,callback,state);
}
static inline HRESULT IMFWorkQueueServices_EndRegisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServices* This,IMFAsyncResult *result,DWORD *taskid) {
    return This->lpVtbl->EndRegisterPlatformWorkQueueWithMMCSS(This,result,taskid);
}
static inline HRESULT IMFWorkQueueServices_BeginUnregisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServices* This,DWORD platform_queue,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginUnregisterPlatformWorkQueueWithMMCSS(This,platform_queue,callback,state);
}
static inline HRESULT IMFWorkQueueServices_EndUnregisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServices* This,IMFAsyncResult *result) {
    return This->lpVtbl->EndUnregisterPlatformWorkQueueWithMMCSS(This,result);
}
static inline HRESULT IMFWorkQueueServices_GetPlaftormWorkQueueMMCSSClass(IMFWorkQueueServices* This,DWORD platform_queue,LPWSTR classname,DWORD *classname_len) {
    return This->lpVtbl->GetPlaftormWorkQueueMMCSSClass(This,platform_queue,classname,classname_len);
}
static inline HRESULT IMFWorkQueueServices_GetPlatformWorkQueueMMCSSTaskId(IMFWorkQueueServices* This,DWORD platform_queue,DWORD *taskid) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFWorkQueueServicesEx_QueryInterface(IMFWorkQueueServicesEx* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFWorkQueueServicesEx_AddRef(IMFWorkQueueServicesEx* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFWorkQueueServicesEx_Release(IMFWorkQueueServicesEx* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFWorkQueueServices methods ***/
static inline HRESULT IMFWorkQueueServicesEx_BeginRegisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServicesEx* This,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginRegisterTopologyWorkQueuesWithMMCSS(This,callback,state);
}
static inline HRESULT IMFWorkQueueServicesEx_EndRegisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServicesEx* This,IMFAsyncResult *result) {
    return This->lpVtbl->EndRegisterTopologyWorkQueuesWithMMCSS(This,result);
}
static inline HRESULT IMFWorkQueueServicesEx_BeginUnregisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServicesEx* This,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginUnregisterTopologyWorkQueuesWithMMCSS(This,callback,state);
}
static inline HRESULT IMFWorkQueueServicesEx_EndUnregisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServicesEx* This,IMFAsyncResult *result) {
    return This->lpVtbl->EndUnregisterTopologyWorkQueuesWithMMCSS(This,result);
}
static inline HRESULT IMFWorkQueueServicesEx_GetTopologyWorkQueueMMCSSClass(IMFWorkQueueServicesEx* This,DWORD queue,LPWSTR classname,DWORD *classname_len) {
    return This->lpVtbl->GetTopologyWorkQueueMMCSSClass(This,queue,classname,classname_len);
}
static inline HRESULT IMFWorkQueueServicesEx_GetTopologyWorkQueueMMCSSTaskId(IMFWorkQueueServicesEx* This,DWORD queue,DWORD *taksid) {
    return This->lpVtbl->GetTopologyWorkQueueMMCSSTaskId(This,queue,taksid);
}
static inline HRESULT IMFWorkQueueServicesEx_BeginRegisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServicesEx* This,DWORD platform_queue,LPCWSTR classname,DWORD taskid,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginRegisterPlatformWorkQueueWithMMCSS(This,platform_queue,classname,taskid,callback,state);
}
static inline HRESULT IMFWorkQueueServicesEx_EndRegisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServicesEx* This,IMFAsyncResult *result,DWORD *taskid) {
    return This->lpVtbl->EndRegisterPlatformWorkQueueWithMMCSS(This,result,taskid);
}
static inline HRESULT IMFWorkQueueServicesEx_BeginUnregisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServicesEx* This,DWORD platform_queue,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginUnregisterPlatformWorkQueueWithMMCSS(This,platform_queue,callback,state);
}
static inline HRESULT IMFWorkQueueServicesEx_EndUnregisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServicesEx* This,IMFAsyncResult *result) {
    return This->lpVtbl->EndUnregisterPlatformWorkQueueWithMMCSS(This,result);
}
static inline HRESULT IMFWorkQueueServicesEx_GetPlaftormWorkQueueMMCSSClass(IMFWorkQueueServicesEx* This,DWORD platform_queue,LPWSTR classname,DWORD *classname_len) {
    return This->lpVtbl->GetPlaftormWorkQueueMMCSSClass(This,platform_queue,classname,classname_len);
}
static inline HRESULT IMFWorkQueueServicesEx_GetPlatformWorkQueueMMCSSTaskId(IMFWorkQueueServicesEx* This,DWORD platform_queue,DWORD *taskid) {
    return This->lpVtbl->GetPlatformWorkQueueMMCSSTaskId(This,platform_queue,taskid);
}
/*** IMFWorkQueueServicesEx methods ***/
static inline HRESULT IMFWorkQueueServicesEx_GetTopologyWorkQueueMMCSSPriority(IMFWorkQueueServicesEx* This,DWORD queueid,LONG *priority) {
    return This->lpVtbl->GetTopologyWorkQueueMMCSSPriority(This,queueid,priority);
}
static inline HRESULT IMFWorkQueueServicesEx_BeginRegisterPlatformWorkQueueWithMMCSSEx(IMFWorkQueueServicesEx* This,DWORD platform_queue,LPCWSTR classname,DWORD taskid,LONG priority,IMFAsyncCallback *callback,IUnknown *state) {
...
static inline HRESULT IMFWorkQueueServicesEx_GetPlatformWorkQueueMMCSSPriority(IMFWorkQueueServicesEx* This,DWORD platform_queue,LONG *priority) {
...
EXTERN_GUID(MF_TRANSCODE_ADJUST_PROFILE, 0x9c37c21b, 0x060f, 0x487c, 0xa6, 0x90, 0x80, 0xd7, 0xf5, 0x0d, 0x1c, 0x72);
...
EXTERN_GUID(MF_TRANSCODE_TOPOLOGYMODE, 0x3e3df610, 0x394a, 0x40b2, 0x9d, 0xea, 0x3b, 0xab, 0x65, 0x0b, 0xeb, 0xf2);
...
EXTERN_GUID(MFTranscodeContainerType_FMPEG4, 0x9ba876f1, 0x419f, 0x4b77, 0xa1, 0xe0, 0x35, 0x95, 0x9d, 0x9d, 0x40, 0x04);
