/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/commoncontrols.idl - Do not edit ***/
...
static inline HRESULT IImageList_Merge(IImageList* This,int i1,IUnknown *punk2,int i2,int dx,int dy,REFIID riid,PVOID *ppv) {
    return This->lpVtbl->Merge(This,i1,punk2,i2,dx,dy,riid,ppv);
}
static inline HRESULT IImageList_Clone(IImageList* This,REFIID riid,PVOID *ppv) {
...
static inline HRESULT IImageList_DragShowNolock(IImageList* This,BOOL fShow) {
    return This->lpVtbl->DragShowNolock(This,fShow);
}
static inline HRESULT IImageList_GetDragImage(IImageList* This,POINT *ppt,POINT *pptHotspot,REFIID riid,PVOID *ppv) {
...
static inline HRESULT IImageList2_Merge(IImageList2* This,int i1,IUnknown *punk2,int i2,int dx,int dy,REFIID riid,PVOID *ppv) {
    return This->lpVtbl->Merge(This,i1,punk2,i2,dx,dy,riid,ppv);
}
static inline HRESULT IImageList2_Clone(IImageList2* This,REFIID riid,PVOID *ppv) {
    return This->lpVtbl->Clone(This,riid,ppv);
}
...
static inline HRESULT IImageList2_DragShowNolock(IImageList2* This,BOOL fShow) {
    return This->lpVtbl->DragShowNolock(This,fShow);
}
static inline HRESULT IImageList2_GetDragImage(IImageList2* This,POINT *ppt,POINT *pptHotspot,REFIID riid,PVOID *ppv) {
    return This->lpVtbl->GetDragImage(This,ppt,pptHotspot,riid,ppv);
}
...
/*** IImageList2 methods ***/
static inline HRESULT IImageList2_Resize(IImageList2* This,INT x_size,INT y_size) {
    return This->lpVtbl->Resize(This,x_size,y_size);
}
static inline HRESULT IImageList2_GetOriginalSize(IImageList2* This,INT image,DWORD flags,INT *cx,INT *cy) {
    return This->lpVtbl->GetOriginalSize(This,image,flags,cx,cy);
}
static inline HRESULT IImageList2_SetOriginalSize(IImageList2* This,INT image,INT cx,INT cy) {
    return This->lpVtbl->SetOriginalSize(This,image,cx,cy);
}
static inline HRESULT IImageList2_SetCallback(IImageList2* This,IUnknown *callback) {
...
static inline HRESULT IImageList2_ForceImagePresent(IImageList2* This,INT image,DWORD flags) {
    return This->lpVtbl->ForceImagePresent(This,image,flags);
}
static inline HRESULT IImageList2_DiscardImages(IImageList2* This,INT first_image,INT last_image,DWORD flags) {
    return This->lpVtbl->DiscardImages(This,first_image,last_image,flags);
}
static inline HRESULT IImageList2_PreloadImages(IImageList2* This,IMAGELISTDRAWPARAMS *params) {
    return This->lpVtbl->PreloadImages(This,params);
}
static inline HRESULT IImageList2_GetStatistics(IImageList2* This,IMAGELISTSTATS *stats) {
    return This->lpVtbl->GetStatistics(This,stats);
}
static inline HRESULT IImageList2_Initialize(IImageList2* This,INT cx,INT cy,UINT flags,INT initial,INT grow) {
    return This->lpVtbl->Initialize(This,cx,cy,flags,initial,grow);
}
static inline HRESULT IImageList2_Replace2(IImageList2* This,INT i,HBITMAP image,HBITMAP mask,IUnknown *unk,DWORD flags) {
    return This->lpVtbl->Replace2(This,i,image,mask,unk,flags);
}
static inline HRESULT IImageList2_ReplaceFromImageList(IImageList2* This,INT i,IImageList *imagelist,INT src,IUnknown *unk,DWORD flags) {
