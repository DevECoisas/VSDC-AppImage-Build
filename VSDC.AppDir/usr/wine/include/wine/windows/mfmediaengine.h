/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/mfmediaengine.idl - Do not edit ***/
...
static inline BOOL IMFMediaTimeRange_ContainsTime(IMFMediaTimeRange* This,double time) {
...
IMFMediaEngine : public IUnknown
{
    ...
    virtual BOOL STDMETHODCALLTYPE IsSeeking(
        ) = 0;
    ...
    virtual BOOL STDMETHODCALLTYPE IsPaused(
        ) = 0;
    ...
    virtual BOOL STDMETHODCALLTYPE IsEnded(
        ) = 0;

    virtual BOOL STDMETHODCALLTYPE GetAutoPlay(
        ) = 0;

    virtual HRESULT STDMETHODCALLTYPE SetAutoPlay(
        BOOL autoplay) = 0;

    virtual BOOL STDMETHODCALLTYPE GetLoop(
        ) = 0;
    ...
    virtual BOOL STDMETHODCALLTYPE GetMuted(
        ) = 0;
    ...
    virtual BOOL STDMETHODCALLTYPE HasVideo(
        ) = 0;

    virtual BOOL STDMETHODCALLTYPE HasAudio(
        ) = 0;
...
static inline BOOL IMFMediaEngine_IsSeeking(IMFMediaEngine* This) {
...
static inline BOOL IMFMediaEngine_IsPaused(IMFMediaEngine* This) {
...
static inline BOOL IMFMediaEngine_IsEnded(IMFMediaEngine* This) {
    return This->lpVtbl->IsEnded(This);
}
static inline BOOL IMFMediaEngine_GetAutoPlay(IMFMediaEngine* This) {
    return This->lpVtbl->GetAutoPlay(This);
}
static inline HRESULT IMFMediaEngine_SetAutoPlay(IMFMediaEngine* This,BOOL autoplay) {
    return This->lpVtbl->SetAutoPlay(This,autoplay);
}
static inline BOOL IMFMediaEngine_GetLoop(IMFMediaEngine* This) {
    return This->lpVtbl->GetLoop(This);
}
static inline HRESULT IMFMediaEngine_SetLoop(IMFMediaEngine* This,BOOL loop) {
...
static inline BOOL IMFMediaEngine_GetMuted(IMFMediaEngine* This) {
    return This->lpVtbl->GetMuted(This);
}
static inline HRESULT IMFMediaEngine_SetMuted(IMFMediaEngine* This,BOOL muted) {
...
static inline BOOL IMFMediaEngine_HasVideo(IMFMediaEngine* This) {
    return This->lpVtbl->HasVideo(This);
}
static inline BOOL IMFMediaEngine_HasAudio(IMFMediaEngine* This) {
...
IMFMediaEngineEx : public IMFMediaEngine
{
    ...
    virtual BOOL STDMETHODCALLTYPE IsStereo3D(
        ) = 0;
...
static inline BOOL IMFMediaEngineEx_IsSeeking(IMFMediaEngineEx* This) {
    return This->lpVtbl->IsSeeking(This);
}
...
static inline BOOL IMFMediaEngineEx_IsPaused(IMFMediaEngineEx* This) {
    return This->lpVtbl->IsPaused(This);
}
...
static inline BOOL IMFMediaEngineEx_IsEnded(IMFMediaEngineEx* This) {
    return This->lpVtbl->IsEnded(This);
}
static inline BOOL IMFMediaEngineEx_GetAutoPlay(IMFMediaEngineEx* This) {
    return This->lpVtbl->GetAutoPlay(This);
}
static inline HRESULT IMFMediaEngineEx_SetAutoPlay(IMFMediaEngineEx* This,BOOL autoplay) {
    return This->lpVtbl->SetAutoPlay(This,autoplay);
}
static inline BOOL IMFMediaEngineEx_GetLoop(IMFMediaEngineEx* This) {
    return This->lpVtbl->GetLoop(This);
}
static inline HRESULT IMFMediaEngineEx_SetLoop(IMFMediaEngineEx* This,BOOL loop) {
    return This->lpVtbl->SetLoop(This,loop);
}
...
static inline BOOL IMFMediaEngineEx_GetMuted(IMFMediaEngineEx* This) {
    return This->lpVtbl->GetMuted(This);
}
static inline HRESULT IMFMediaEngineEx_SetMuted(IMFMediaEngineEx* This,BOOL muted) {
    return This->lpVtbl->SetMuted(This,muted);
}
...
static inline BOOL IMFMediaEngineEx_HasVideo(IMFMediaEngineEx* This) {
    return This->lpVtbl->HasVideo(This);
}
static inline BOOL IMFMediaEngineEx_HasAudio(IMFMediaEngineEx* This) {
    return This->lpVtbl->HasAudio(This);
}
...
static inline BOOL IMFMediaEngineEx_IsPlaybackRateSupported(IMFMediaEngineEx* This,double rate) {
    return This->lpVtbl->IsPlaybackRateSupported(This,rate);
}
static inline HRESULT IMFMediaEngineEx_FrameStep(IMFMediaEngineEx* This,BOOL forward) {
...
static inline HRESULT IMFMediaEngineEx_GetStreamSelection(IMFMediaEngineEx* This,DWORD stream_index,BOOL *enabled) {
    return This->lpVtbl->GetStreamSelection(This,stream_index,enabled);
}
static inline HRESULT IMFMediaEngineEx_SetStreamSelection(IMFMediaEngineEx* This,DWORD stream_index,BOOL enabled) {
...
static inline HRESULT IMFMediaEngineEx_IsProtected(IMFMediaEngineEx* This,BOOL *is_protected) {
    return This->lpVtbl->IsProtected(This,is_protected);
}
static inline HRESULT IMFMediaEngineEx_InsertVideoEffect(IMFMediaEngineEx* This,IUnknown *effect,BOOL is_optional) {
    return This->lpVtbl->InsertVideoEffect(This,effect,is_optional);
}
static inline HRESULT IMFMediaEngineEx_InsertAudioEffect(IMFMediaEngineEx* This,IUnknown *effect,BOOL is_optional) {
...
static inline BOOL IMFMediaEngineEx_IsStereo3D(IMFMediaEngineEx* This) {
...
static inline HRESULT IMFMediaEngineEx_EnableWindowlessSwapchainMode(IMFMediaEngineEx* This,BOOL enable) {
...
static inline HRESULT IMFMediaEngineEx_EnableHorizontalMirrorMode(IMFMediaEngineEx* This,BOOL enable) {
...
static inline HRESULT IMFMediaEngineEx_GetRealTimeMode(IMFMediaEngineEx* This,BOOL *enabled) {
    return This->lpVtbl->GetRealTimeMode(This,enabled);
}
static inline HRESULT IMFMediaEngineEx_SetRealTimeMode(IMFMediaEngineEx* This,BOOL enable) {
...
static inline HRESULT IMFMediaEngineEx_EnableTimeUpdateTimer(IMFMediaEngineEx* This,BOOL enable) {
...
/*** IMFMediaEngineExtension methods ***/
static inline HRESULT IMFMediaEngineExtension_CanPlayType(IMFMediaEngineExtension* This,BOOL audio_only,BSTR mime_type,MF_MEDIA_ENGINE_CANPLAY *answer) {
