/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/dimm.idl - Do not edit ***/
...
static inline HRESULT IActiveIMMApp_SetOpenStatus(IActiveIMMApp* This,HIMC hIMC,BOOL fOpen) {
...
static inline HRESULT IActiveIMMApp_Activate(IActiveIMMApp* This,BOOL fRestoreLayout) {
...
static inline HRESULT IActiveIMMMessagePumpOwner_OnTranslateMessage(IActiveIMMMessagePumpOwner* This,const MSG *msg) {
    return This->lpVtbl->OnTranslateMessage(This,msg);
}
static inline HRESULT IActiveIMMMessagePumpOwner_Pause(IActiveIMMMessagePumpOwner* This,DWORD *cookie) {
    return This->lpVtbl->Pause(This,cookie);
}
static inline HRESULT IActiveIMMMessagePumpOwner_Resume(IActiveIMMMessagePumpOwner* This,DWORD cookie) {
