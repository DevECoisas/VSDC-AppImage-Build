/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/mmc.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMMCVersionInfo_QueryInterface(IMMCVersionInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMMCVersionInfo_AddRef(IMMCVersionInfo* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMMCVersionInfo_Release(IMMCVersionInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** IMMCVersionInfo methods ***/
static inline HRESULT IMMCVersionInfo_GetMMCVersion(IMMCVersionInfo* This,LONG *pVersionMajor,LONG *pVersionMinor) {
