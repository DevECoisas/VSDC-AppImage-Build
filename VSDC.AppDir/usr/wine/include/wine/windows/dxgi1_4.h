/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/dxgi1_4.idl - Do not edit ***/
...
static inline HRESULT IDXGISwapChain3_SetFullscreenState(IDXGISwapChain3* This,BOOL fullscreen,IDXGIOutput *target) {
    return This->lpVtbl->SetFullscreenState(This,fullscreen,target);
}
static inline HRESULT IDXGISwapChain3_GetFullscreenState(IDXGISwapChain3* This,BOOL *fullscreen,IDXGIOutput **target) {
...
static inline BOOL IDXGISwapChain3_IsTemporaryMonoSupported(IDXGISwapChain3* This) {
...
static inline HRESULT IDXGIOutput4_TakeOwnership(IDXGIOutput4* This,IUnknown *device,BOOL exclusive) {
...
/*** IDXGIOutput2 methods ***/
static inline BOOL IDXGIOutput4_SupportsOverlays(IDXGIOutput4* This) {
...
static inline BOOL IDXGIFactory4_IsCurrent(IDXGIFactory4* This) {
    return This->lpVtbl->IsCurrent(This);
}
/*** IDXGIFactory2 methods ***/
static inline BOOL IDXGIFactory4_IsWindowedStereoEnabled(IDXGIFactory4* This) {
