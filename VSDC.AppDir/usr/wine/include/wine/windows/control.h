/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/control.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMediaControl_QueryInterface(IMediaControl* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMediaControl_AddRef(IMediaControl* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMediaControl_Release(IMediaControl* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IMediaControl_GetTypeInfoCount(IMediaControl* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IMediaControl_GetTypeInfo(IMediaControl* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IMediaControl_GetIDsOfNames(IMediaControl* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IMediaControl_Invoke(IMediaControl* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IMediaControl methods ***/
static inline HRESULT IMediaControl_Run(IMediaControl* This) {
    return This->lpVtbl->Run(This);
}
static inline HRESULT IMediaControl_Pause(IMediaControl* This) {
    return This->lpVtbl->Pause(This);
}
static inline HRESULT IMediaControl_Stop(IMediaControl* This) {
    return This->lpVtbl->Stop(This);
}
static inline HRESULT IMediaControl_GetState(IMediaControl* This,LONG msTimeout,OAFilterState *pfs) {
    return This->lpVtbl->GetState(This,msTimeout,pfs);
}
static inline HRESULT IMediaControl_RenderFile(IMediaControl* This,BSTR strFilename) {
    return This->lpVtbl->RenderFile(This,strFilename);
}
static inline HRESULT IMediaControl_AddSourceFilter(IMediaControl* This,BSTR strFilename,IDispatch **ppUnk) {
    return This->lpVtbl->AddSourceFilter(This,strFilename,ppUnk);
}
static inline HRESULT IMediaControl_get_FilterCollection(IMediaControl* This,IDispatch **ppUnk) {
    return This->lpVtbl->get_FilterCollection(This,ppUnk);
}
static inline HRESULT IMediaControl_get_RegFilterCollection(IMediaControl* This,IDispatch **ppUnk) {
    return This->lpVtbl->get_RegFilterCollection(This,ppUnk);
}
static inline HRESULT IMediaControl_StopWhenReady(IMediaControl* This) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IBasicAudio_QueryInterface(IBasicAudio* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IBasicAudio_AddRef(IBasicAudio* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IBasicAudio_Release(IBasicAudio* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IBasicAudio_GetTypeInfoCount(IBasicAudio* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IBasicAudio_GetTypeInfo(IBasicAudio* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IBasicAudio_GetIDsOfNames(IBasicAudio* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IBasicAudio_Invoke(IBasicAudio* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IBasicAudio methods ***/
static inline HRESULT IBasicAudio_put_Volume(IBasicAudio* This,LONG lVolume) {
    return This->lpVtbl->put_Volume(This,lVolume);
}
static inline HRESULT IBasicAudio_get_Volume(IBasicAudio* This,LONG *plVolume) {
    return This->lpVtbl->get_Volume(This,plVolume);
}
static inline HRESULT IBasicAudio_put_Balance(IBasicAudio* This,LONG lBalance) {
    return This->lpVtbl->put_Balance(This,lBalance);
}
static inline HRESULT IBasicAudio_get_Balance(IBasicAudio* This,LONG *plBalance) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IVideoWindow_QueryInterface(IVideoWindow* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IVideoWindow_AddRef(IVideoWindow* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IVideoWindow_Release(IVideoWindow* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IVideoWindow_GetTypeInfoCount(IVideoWindow* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IVideoWindow_GetTypeInfo(IVideoWindow* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IVideoWindow_GetIDsOfNames(IVideoWindow* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IVideoWindow_Invoke(IVideoWindow* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IVideoWindow methods ***/
static inline HRESULT IVideoWindow_put_Caption(IVideoWindow* This,BSTR strCaption) {
    return This->lpVtbl->put_Caption(This,strCaption);
}
static inline HRESULT IVideoWindow_get_Caption(IVideoWindow* This,BSTR *strCaption) {
    return This->lpVtbl->get_Caption(This,strCaption);
}
static inline HRESULT IVideoWindow_put_WindowStyle(IVideoWindow* This,LONG WindowStyle) {
    return This->lpVtbl->put_WindowStyle(This,WindowStyle);
}
static inline HRESULT IVideoWindow_get_WindowStyle(IVideoWindow* This,LONG *WindowStyle) {
    return This->lpVtbl->get_WindowStyle(This,WindowStyle);
}
static inline HRESULT IVideoWindow_put_WindowStyleEx(IVideoWindow* This,LONG WindowStyleEx) {
    return This->lpVtbl->put_WindowStyleEx(This,WindowStyleEx);
}
static inline HRESULT IVideoWindow_get_WindowStyleEx(IVideoWindow* This,LONG *WindowStyleEx) {
    return This->lpVtbl->get_WindowStyleEx(This,WindowStyleEx);
}
static inline HRESULT IVideoWindow_put_AutoShow(IVideoWindow* This,LONG AutoShow) {
    return This->lpVtbl->put_AutoShow(This,AutoShow);
}
static inline HRESULT IVideoWindow_get_AutoShow(IVideoWindow* This,LONG *AutoShow) {
    return This->lpVtbl->get_AutoShow(This,AutoShow);
}
static inline HRESULT IVideoWindow_put_WindowState(IVideoWindow* This,LONG WindowState) {
    return This->lpVtbl->put_WindowState(This,WindowState);
}
static inline HRESULT IVideoWindow_get_WindowState(IVideoWindow* This,LONG *WindowState) {
    return This->lpVtbl->get_WindowState(This,WindowState);
}
static inline HRESULT IVideoWindow_put_BackgroundPalette(IVideoWindow* This,LONG BackgroundPalette) {
    return This->lpVtbl->put_BackgroundPalette(This,BackgroundPalette);
}
static inline HRESULT IVideoWindow_get_BackgroundPalette(IVideoWindow* This,LONG *pBackgroundPalette) {
    return This->lpVtbl->get_BackgroundPalette(This,pBackgroundPalette);
}
static inline HRESULT IVideoWindow_put_Visible(IVideoWindow* This,LONG Visible) {
    return This->lpVtbl->put_Visible(This,Visible);
}
static inline HRESULT IVideoWindow_get_Visible(IVideoWindow* This,LONG *pVisible) {
    return This->lpVtbl->get_Visible(This,pVisible);
}
static inline HRESULT IVideoWindow_put_Left(IVideoWindow* This,LONG Left) {
    return This->lpVtbl->put_Left(This,Left);
}
static inline HRESULT IVideoWindow_get_Left(IVideoWindow* This,LONG *pLeft) {
    return This->lpVtbl->get_Left(This,pLeft);
}
static inline HRESULT IVideoWindow_put_Width(IVideoWindow* This,LONG Width) {
    return This->lpVtbl->put_Width(This,Width);
}
static inline HRESULT IVideoWindow_get_Width(IVideoWindow* This,LONG *pWidth) {
    return This->lpVtbl->get_Width(This,pWidth);
}
static inline HRESULT IVideoWindow_put_Top(IVideoWindow* This,LONG Top) {
    return This->lpVtbl->put_Top(This,Top);
}
static inline HRESULT IVideoWindow_get_Top(IVideoWindow* This,LONG *pTop) {
    return This->lpVtbl->get_Top(This,pTop);
}
static inline HRESULT IVideoWindow_put_Height(IVideoWindow* This,LONG Height) {
    return This->lpVtbl->put_Height(This,Height);
}
static inline HRESULT IVideoWindow_get_Height(IVideoWindow* This,LONG *pHeight) {
    return This->lpVtbl->get_Height(This,pHeight);
}
static inline HRESULT IVideoWindow_put_Owner(IVideoWindow* This,OAHWND Owner) {
    return This->lpVtbl->put_Owner(This,Owner);
}
static inline HRESULT IVideoWindow_get_Owner(IVideoWindow* This,OAHWND *Owner) {
    return This->lpVtbl->get_Owner(This,Owner);
}
static inline HRESULT IVideoWindow_put_MessageDrain(IVideoWindow* This,OAHWND Drain) {
    return This->lpVtbl->put_MessageDrain(This,Drain);
}
static inline HRESULT IVideoWindow_get_MessageDrain(IVideoWindow* This,OAHWND *Drain) {
    return This->lpVtbl->get_MessageDrain(This,Drain);
}
static inline HRESULT IVideoWindow_get_BorderColor(IVideoWindow* This,LONG *Color) {
    return This->lpVtbl->get_BorderColor(This,Color);
}
static inline HRESULT IVideoWindow_put_BorderColor(IVideoWindow* This,LONG Color) {
    return This->lpVtbl->put_BorderColor(This,Color);
}
static inline HRESULT IVideoWindow_get_FullScreenMode(IVideoWindow* This,LONG *FullScreenMode) {
    return This->lpVtbl->get_FullScreenMode(This,FullScreenMode);
}
static inline HRESULT IVideoWindow_put_FullScreenMode(IVideoWindow* This,LONG FullScreenMode) {
    return This->lpVtbl->put_FullScreenMode(This,FullScreenMode);
}
static inline HRESULT IVideoWindow_SetWindowForeground(IVideoWindow* This,LONG Focus) {
    return This->lpVtbl->SetWindowForeground(This,Focus);
}
static inline HRESULT IVideoWindow_NotifyOwnerMessage(IVideoWindow* This,OAHWND hwnd,LONG uMsg,LONG_PTR wParam,LONG_PTR lParam) {
    return This->lpVtbl->NotifyOwnerMessage(This,hwnd,uMsg,wParam,lParam);
}
static inline HRESULT IVideoWindow_SetWindowPosition(IVideoWindow* This,LONG Left,LONG Top,LONG Width,LONG Height) {
    return This->lpVtbl->SetWindowPosition(This,Left,Top,Width,Height);
}
static inline HRESULT IVideoWindow_GetWindowPosition(IVideoWindow* This,LONG *pLeft,LONG *pTop,LONG *pWidth,LONG *pHeight) {
    return This->lpVtbl->GetWindowPosition(This,pLeft,pTop,pWidth,pHeight);
}
static inline HRESULT IVideoWindow_GetMinIdealImageSize(IVideoWindow* This,LONG *pWidth,LONG *pHeight) {
    return This->lpVtbl->GetMinIdealImageSize(This,pWidth,pHeight);
}
static inline HRESULT IVideoWindow_GetMaxIdealImageSize(IVideoWindow* This,LONG *pWidth,LONG *pHeight) {
    return This->lpVtbl->GetMaxIdealImageSize(This,pWidth,pHeight);
}
static inline HRESULT IVideoWindow_GetRestorePosition(IVideoWindow* This,LONG *pLeft,LONG *pTop,LONG *pWidth,LONG *pHeight) {
    return This->lpVtbl->GetRestorePosition(This,pLeft,pTop,pWidth,pHeight);
}
static inline HRESULT IVideoWindow_HideCursor(IVideoWindow* This,LONG HideCursor) {
    return This->lpVtbl->HideCursor(This,HideCursor);
}
static inline HRESULT IVideoWindow_IsCursorHidden(IVideoWindow* This,LONG *CursorHidden) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IBasicVideo_QueryInterface(IBasicVideo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IBasicVideo_AddRef(IBasicVideo* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IBasicVideo_Release(IBasicVideo* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IBasicVideo_GetTypeInfoCount(IBasicVideo* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IBasicVideo_GetTypeInfo(IBasicVideo* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IBasicVideo_GetIDsOfNames(IBasicVideo* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IBasicVideo_Invoke(IBasicVideo* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IBasicVideo methods ***/
static inline HRESULT IBasicVideo_get_AvgTimePerFrame(IBasicVideo* This,REFTIME *pAvgTimePerFrame) {
    return This->lpVtbl->get_AvgTimePerFrame(This,pAvgTimePerFrame);
}
static inline HRESULT IBasicVideo_get_BitRate(IBasicVideo* This,LONG *pBitRate) {
    return This->lpVtbl->get_BitRate(This,pBitRate);
}
static inline HRESULT IBasicVideo_get_BitErrorRate(IBasicVideo* This,LONG *pBitErrorRate) {
    return This->lpVtbl->get_BitErrorRate(This,pBitErrorRate);
}
static inline HRESULT IBasicVideo_get_VideoWidth(IBasicVideo* This,LONG *pVideoWidth) {
    return This->lpVtbl->get_VideoWidth(This,pVideoWidth);
}
static inline HRESULT IBasicVideo_get_VideoHeight(IBasicVideo* This,LONG *pVideoHeight) {
    return This->lpVtbl->get_VideoHeight(This,pVideoHeight);
}
static inline HRESULT IBasicVideo_put_SourceLeft(IBasicVideo* This,LONG SourceLeft) {
    return This->lpVtbl->put_SourceLeft(This,SourceLeft);
}
static inline HRESULT IBasicVideo_get_SourceLeft(IBasicVideo* This,LONG *pSourceLeft) {
    return This->lpVtbl->get_SourceLeft(This,pSourceLeft);
}
static inline HRESULT IBasicVideo_put_SourceWidth(IBasicVideo* This,LONG SourceWidth) {
    return This->lpVtbl->put_SourceWidth(This,SourceWidth);
}
static inline HRESULT IBasicVideo_get_SourceWidth(IBasicVideo* This,LONG *pSourceWidth) {
    return This->lpVtbl->get_SourceWidth(This,pSourceWidth);
}
static inline HRESULT IBasicVideo_put_SourceTop(IBasicVideo* This,LONG SourceTop) {
    return This->lpVtbl->put_SourceTop(This,SourceTop);
}
static inline HRESULT IBasicVideo_get_SourceTop(IBasicVideo* This,LONG *pSourceTop) {
    return This->lpVtbl->get_SourceTop(This,pSourceTop);
}
static inline HRESULT IBasicVideo_put_SourceHeight(IBasicVideo* This,LONG SourceHeight) {
    return This->lpVtbl->put_SourceHeight(This,SourceHeight);
}
static inline HRESULT IBasicVideo_get_SourceHeight(IBasicVideo* This,LONG *pSourceHeight) {
    return This->lpVtbl->get_SourceHeight(This,pSourceHeight);
}
static inline HRESULT IBasicVideo_put_DestinationLeft(IBasicVideo* This,LONG DestinationLeft) {
    return This->lpVtbl->put_DestinationLeft(This,DestinationLeft);
}
static inline HRESULT IBasicVideo_get_DestinationLeft(IBasicVideo* This,LONG *pDestinationLeft) {
    return This->lpVtbl->get_DestinationLeft(This,pDestinationLeft);
}
static inline HRESULT IBasicVideo_put_DestinationWidth(IBasicVideo* This,LONG DestinationWidth) {
    return This->lpVtbl->put_DestinationWidth(This,DestinationWidth);
}
static inline HRESULT IBasicVideo_get_DestinationWidth(IBasicVideo* This,LONG *pDestinationWidth) {
    return This->lpVtbl->get_DestinationWidth(This,pDestinationWidth);
}
static inline HRESULT IBasicVideo_put_DestinationTop(IBasicVideo* This,LONG DestinationTop) {
    return This->lpVtbl->put_DestinationTop(This,DestinationTop);
}
static inline HRESULT IBasicVideo_get_DestinationTop(IBasicVideo* This,LONG *pDestinationTop) {
    return This->lpVtbl->get_DestinationTop(This,pDestinationTop);
}
static inline HRESULT IBasicVideo_put_DestinationHeight(IBasicVideo* This,LONG DestinationHeight) {
    return This->lpVtbl->put_DestinationHeight(This,DestinationHeight);
}
static inline HRESULT IBasicVideo_get_DestinationHeight(IBasicVideo* This,LONG *pDestinationHeight) {
    return This->lpVtbl->get_DestinationHeight(This,pDestinationHeight);
}
static inline HRESULT IBasicVideo_SetSourcePosition(IBasicVideo* This,LONG Left,LONG Top,LONG Width,LONG Height) {
    return This->lpVtbl->SetSourcePosition(This,Left,Top,Width,Height);
}
static inline HRESULT IBasicVideo_GetSourcePosition(IBasicVideo* This,LONG *pLeft,LONG *pTop,LONG *pWidth,LONG *pHeight) {
    return This->lpVtbl->GetSourcePosition(This,pLeft,pTop,pWidth,pHeight);
}
static inline HRESULT IBasicVideo_SetDefaultSourcePosition(IBasicVideo* This) {
    return This->lpVtbl->SetDefaultSourcePosition(This);
}
static inline HRESULT IBasicVideo_SetDestinationPosition(IBasicVideo* This,LONG Left,LONG Top,LONG Width,LONG Height) {
    return This->lpVtbl->SetDestinationPosition(This,Left,Top,Width,Height);
}
static inline HRESULT IBasicVideo_GetDestinationPosition(IBasicVideo* This,LONG *pLeft,LONG *pTop,LONG *pWidth,LONG *pHeight) {
    return This->lpVtbl->GetDestinationPosition(This,pLeft,pTop,pWidth,pHeight);
}
static inline HRESULT IBasicVideo_SetDefaultDestinationPosition(IBasicVideo* This) {
    return This->lpVtbl->SetDefaultDestinationPosition(This);
}
static inline HRESULT IBasicVideo_GetVideoSize(IBasicVideo* This,LONG *pWidth,LONG *pHeight) {
    return This->lpVtbl->GetVideoSize(This,pWidth,pHeight);
}
static inline HRESULT IBasicVideo_GetVideoPaletteEntries(IBasicVideo* This,LONG StartIndex,LONG Entries,LONG *pRetrieved,LONG *pPalette) {
    return This->lpVtbl->GetVideoPaletteEntries(This,StartIndex,Entries,pRetrieved,pPalette);
}
static inline HRESULT IBasicVideo_GetCurrentImage(IBasicVideo* This,LONG *pBufferSize,LONG *pDIBImage) {
    return This->lpVtbl->GetCurrentImage(This,pBufferSize,pDIBImage);
}
static inline HRESULT IBasicVideo_IsUsingDefaultSource(IBasicVideo* This) {
    return This->lpVtbl->IsUsingDefaultSource(This);
}
static inline HRESULT IBasicVideo_IsUsingDefaultDestination(IBasicVideo* This) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IBasicVideo2_QueryInterface(IBasicVideo2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IBasicVideo2_AddRef(IBasicVideo2* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IBasicVideo2_Release(IBasicVideo2* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IBasicVideo2_GetTypeInfoCount(IBasicVideo2* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IBasicVideo2_GetTypeInfo(IBasicVideo2* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IBasicVideo2_GetIDsOfNames(IBasicVideo2* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IBasicVideo2_Invoke(IBasicVideo2* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IBasicVideo methods ***/
static inline HRESULT IBasicVideo2_get_AvgTimePerFrame(IBasicVideo2* This,REFTIME *pAvgTimePerFrame) {
    return This->lpVtbl->get_AvgTimePerFrame(This,pAvgTimePerFrame);
}
static inline HRESULT IBasicVideo2_get_BitRate(IBasicVideo2* This,LONG *pBitRate) {
    return This->lpVtbl->get_BitRate(This,pBitRate);
}
static inline HRESULT IBasicVideo2_get_BitErrorRate(IBasicVideo2* This,LONG *pBitErrorRate) {
    return This->lpVtbl->get_BitErrorRate(This,pBitErrorRate);
}
static inline HRESULT IBasicVideo2_get_VideoWidth(IBasicVideo2* This,LONG *pVideoWidth) {
    return This->lpVtbl->get_VideoWidth(This,pVideoWidth);
}
static inline HRESULT IBasicVideo2_get_VideoHeight(IBasicVideo2* This,LONG *pVideoHeight) {
    return This->lpVtbl->get_VideoHeight(This,pVideoHeight);
}
static inline HRESULT IBasicVideo2_put_SourceLeft(IBasicVideo2* This,LONG SourceLeft) {
    return This->lpVtbl->put_SourceLeft(This,SourceLeft);
}
static inline HRESULT IBasicVideo2_get_SourceLeft(IBasicVideo2* This,LONG *pSourceLeft) {
    return This->lpVtbl->get_SourceLeft(This,pSourceLeft);
}
static inline HRESULT IBasicVideo2_put_SourceWidth(IBasicVideo2* This,LONG SourceWidth) {
    return This->lpVtbl->put_SourceWidth(This,SourceWidth);
}
static inline HRESULT IBasicVideo2_get_SourceWidth(IBasicVideo2* This,LONG *pSourceWidth) {
    return This->lpVtbl->get_SourceWidth(This,pSourceWidth);
}
static inline HRESULT IBasicVideo2_put_SourceTop(IBasicVideo2* This,LONG SourceTop) {
    return This->lpVtbl->put_SourceTop(This,SourceTop);
}
static inline HRESULT IBasicVideo2_get_SourceTop(IBasicVideo2* This,LONG *pSourceTop) {
    return This->lpVtbl->get_SourceTop(This,pSourceTop);
}
static inline HRESULT IBasicVideo2_put_SourceHeight(IBasicVideo2* This,LONG SourceHeight) {
    return This->lpVtbl->put_SourceHeight(This,SourceHeight);
}
static inline HRESULT IBasicVideo2_get_SourceHeight(IBasicVideo2* This,LONG *pSourceHeight) {
    return This->lpVtbl->get_SourceHeight(This,pSourceHeight);
}
static inline HRESULT IBasicVideo2_put_DestinationLeft(IBasicVideo2* This,LONG DestinationLeft) {
    return This->lpVtbl->put_DestinationLeft(This,DestinationLeft);
}
static inline HRESULT IBasicVideo2_get_DestinationLeft(IBasicVideo2* This,LONG *pDestinationLeft) {
    return This->lpVtbl->get_DestinationLeft(This,pDestinationLeft);
}
static inline HRESULT IBasicVideo2_put_DestinationWidth(IBasicVideo2* This,LONG DestinationWidth) {
    return This->lpVtbl->put_DestinationWidth(This,DestinationWidth);
}
static inline HRESULT IBasicVideo2_get_DestinationWidth(IBasicVideo2* This,LONG *pDestinationWidth) {
    return This->lpVtbl->get_DestinationWidth(This,pDestinationWidth);
}
static inline HRESULT IBasicVideo2_put_DestinationTop(IBasicVideo2* This,LONG DestinationTop) {
    return This->lpVtbl->put_DestinationTop(This,DestinationTop);
}
static inline HRESULT IBasicVideo2_get_DestinationTop(IBasicVideo2* This,LONG *pDestinationTop) {
    return This->lpVtbl->get_DestinationTop(This,pDestinationTop);
}
static inline HRESULT IBasicVideo2_put_DestinationHeight(IBasicVideo2* This,LONG DestinationHeight) {
    return This->lpVtbl->put_DestinationHeight(This,DestinationHeight);
}
static inline HRESULT IBasicVideo2_get_DestinationHeight(IBasicVideo2* This,LONG *pDestinationHeight) {
    return This->lpVtbl->get_DestinationHeight(This,pDestinationHeight);
}
static inline HRESULT IBasicVideo2_SetSourcePosition(IBasicVideo2* This,LONG Left,LONG Top,LONG Width,LONG Height) {
    return This->lpVtbl->SetSourcePosition(This,Left,Top,Width,Height);
}
static inline HRESULT IBasicVideo2_GetSourcePosition(IBasicVideo2* This,LONG *pLeft,LONG *pTop,LONG *pWidth,LONG *pHeight) {
    return This->lpVtbl->GetSourcePosition(This,pLeft,pTop,pWidth,pHeight);
}
static inline HRESULT IBasicVideo2_SetDefaultSourcePosition(IBasicVideo2* This) {
    return This->lpVtbl->SetDefaultSourcePosition(This);
}
static inline HRESULT IBasicVideo2_SetDestinationPosition(IBasicVideo2* This,LONG Left,LONG Top,LONG Width,LONG Height) {
    return This->lpVtbl->SetDestinationPosition(This,Left,Top,Width,Height);
}
static inline HRESULT IBasicVideo2_GetDestinationPosition(IBasicVideo2* This,LONG *pLeft,LONG *pTop,LONG *pWidth,LONG *pHeight) {
    return This->lpVtbl->GetDestinationPosition(This,pLeft,pTop,pWidth,pHeight);
}
static inline HRESULT IBasicVideo2_SetDefaultDestinationPosition(IBasicVideo2* This) {
    return This->lpVtbl->SetDefaultDestinationPosition(This);
}
static inline HRESULT IBasicVideo2_GetVideoSize(IBasicVideo2* This,LONG *pWidth,LONG *pHeight) {
    return This->lpVtbl->GetVideoSize(This,pWidth,pHeight);
}
static inline HRESULT IBasicVideo2_GetVideoPaletteEntries(IBasicVideo2* This,LONG StartIndex,LONG Entries,LONG *pRetrieved,LONG *pPalette) {
    return This->lpVtbl->GetVideoPaletteEntries(This,StartIndex,Entries,pRetrieved,pPalette);
}
static inline HRESULT IBasicVideo2_GetCurrentImage(IBasicVideo2* This,LONG *pBufferSize,LONG *pDIBImage) {
    return This->lpVtbl->GetCurrentImage(This,pBufferSize,pDIBImage);
}
static inline HRESULT IBasicVideo2_IsUsingDefaultSource(IBasicVideo2* This) {
    return This->lpVtbl->IsUsingDefaultSource(This);
}
static inline HRESULT IBasicVideo2_IsUsingDefaultDestination(IBasicVideo2* This) {
    return This->lpVtbl->IsUsingDefaultDestination(This);
}
/*** IBasicVideo2 methods ***/
static inline HRESULT IBasicVideo2_GetPreferredAspectRatio(IBasicVideo2* This,LONG *plAspectX,LONG *plAspectY) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMediaEvent_QueryInterface(IMediaEvent* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMediaEvent_AddRef(IMediaEvent* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMediaEvent_Release(IMediaEvent* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IMediaEvent_GetTypeInfoCount(IMediaEvent* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IMediaEvent_GetTypeInfo(IMediaEvent* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IMediaEvent_GetIDsOfNames(IMediaEvent* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IMediaEvent_Invoke(IMediaEvent* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IMediaEvent methods ***/
static inline HRESULT IMediaEvent_GetEventHandle(IMediaEvent* This,OAEVENT *hEvent) {
    return This->lpVtbl->GetEventHandle(This,hEvent);
}
static inline HRESULT IMediaEvent_GetEvent(IMediaEvent* This,LONG *lEventCode,LONG_PTR *lParam1,LONG_PTR *lParam2,LONG msTimeout) {
    return This->lpVtbl->GetEvent(This,lEventCode,lParam1,lParam2,msTimeout);
}
static inline HRESULT IMediaEvent_WaitForCompletion(IMediaEvent* This,LONG msTimeout,LONG *pEvCode) {
    return This->lpVtbl->WaitForCompletion(This,msTimeout,pEvCode);
}
static inline HRESULT IMediaEvent_CancelDefaultHandling(IMediaEvent* This,LONG lEvCode) {
    return This->lpVtbl->CancelDefaultHandling(This,lEvCode);
}
static inline HRESULT IMediaEvent_RestoreDefaultHandling(IMediaEvent* This,LONG lEvCode) {
    return This->lpVtbl->RestoreDefaultHandling(This,lEvCode);
}
static inline HRESULT IMediaEvent_FreeEventParams(IMediaEvent* This,LONG lEvCode,LONG_PTR lParam1,LONG_PTR lParam2) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMediaEventEx_QueryInterface(IMediaEventEx* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMediaEventEx_AddRef(IMediaEventEx* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMediaEventEx_Release(IMediaEventEx* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IMediaEventEx_GetTypeInfoCount(IMediaEventEx* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IMediaEventEx_GetTypeInfo(IMediaEventEx* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IMediaEventEx_GetIDsOfNames(IMediaEventEx* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IMediaEventEx_Invoke(IMediaEventEx* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IMediaEvent methods ***/
static inline HRESULT IMediaEventEx_GetEventHandle(IMediaEventEx* This,OAEVENT *hEvent) {
    return This->lpVtbl->GetEventHandle(This,hEvent);
}
static inline HRESULT IMediaEventEx_GetEvent(IMediaEventEx* This,LONG *lEventCode,LONG_PTR *lParam1,LONG_PTR *lParam2,LONG msTimeout) {
    return This->lpVtbl->GetEvent(This,lEventCode,lParam1,lParam2,msTimeout);
}
static inline HRESULT IMediaEventEx_WaitForCompletion(IMediaEventEx* This,LONG msTimeout,LONG *pEvCode) {
    return This->lpVtbl->WaitForCompletion(This,msTimeout,pEvCode);
}
static inline HRESULT IMediaEventEx_CancelDefaultHandling(IMediaEventEx* This,LONG lEvCode) {
    return This->lpVtbl->CancelDefaultHandling(This,lEvCode);
}
static inline HRESULT IMediaEventEx_RestoreDefaultHandling(IMediaEventEx* This,LONG lEvCode) {
    return This->lpVtbl->RestoreDefaultHandling(This,lEvCode);
}
static inline HRESULT IMediaEventEx_FreeEventParams(IMediaEventEx* This,LONG lEvCode,LONG_PTR lParam1,LONG_PTR lParam2) {
    return This->lpVtbl->FreeEventParams(This,lEvCode,lParam1,lParam2);
}
/*** IMediaEventEx methods ***/
static inline HRESULT IMediaEventEx_SetNotifyWindow(IMediaEventEx* This,OAHWND hwnd,LONG lMsg,LONG_PTR lInstanceData) {
    return This->lpVtbl->SetNotifyWindow(This,hwnd,lMsg,lInstanceData);
}
static inline HRESULT IMediaEventEx_SetNotifyFlags(IMediaEventEx* This,LONG lNoNotifyFlags) {
    return This->lpVtbl->SetNotifyFlags(This,lNoNotifyFlags);
}
static inline HRESULT IMediaEventEx_GetNotifyFlags(IMediaEventEx* This,LONG *lplNoNotifyFlags) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMediaPosition_QueryInterface(IMediaPosition* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMediaPosition_AddRef(IMediaPosition* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMediaPosition_Release(IMediaPosition* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IMediaPosition_GetTypeInfoCount(IMediaPosition* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IMediaPosition_GetTypeInfo(IMediaPosition* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IMediaPosition_GetIDsOfNames(IMediaPosition* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IMediaPosition_Invoke(IMediaPosition* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IMediaPosition methods ***/
static inline HRESULT IMediaPosition_get_Duration(IMediaPosition* This,REFTIME *plength) {
    return This->lpVtbl->get_Duration(This,plength);
}
static inline HRESULT IMediaPosition_put_CurrentPosition(IMediaPosition* This,REFTIME llTime) {
    return This->lpVtbl->put_CurrentPosition(This,llTime);
}
static inline HRESULT IMediaPosition_get_CurrentPosition(IMediaPosition* This,REFTIME *pllTime) {
    return This->lpVtbl->get_CurrentPosition(This,pllTime);
}
static inline HRESULT IMediaPosition_get_StopTime(IMediaPosition* This,REFTIME *pllTime) {
    return This->lpVtbl->get_StopTime(This,pllTime);
}
static inline HRESULT IMediaPosition_put_StopTime(IMediaPosition* This,REFTIME llTime) {
    return This->lpVtbl->put_StopTime(This,llTime);
}
static inline HRESULT IMediaPosition_get_PrerollTime(IMediaPosition* This,REFTIME *pllTime) {
    return This->lpVtbl->get_PrerollTime(This,pllTime);
}
static inline HRESULT IMediaPosition_put_PrerollTime(IMediaPosition* This,REFTIME llTime) {
    return This->lpVtbl->put_PrerollTime(This,llTime);
}
static inline HRESULT IMediaPosition_put_Rate(IMediaPosition* This,double dRate) {
    return This->lpVtbl->put_Rate(This,dRate);
}
static inline HRESULT IMediaPosition_get_Rate(IMediaPosition* This,double *pdRate) {
    return This->lpVtbl->get_Rate(This,pdRate);
}
static inline HRESULT IMediaPosition_CanSeekForward(IMediaPosition* This,LONG *pCanSeekForward) {
    return This->lpVtbl->CanSeekForward(This,pCanSeekForward);
}
static inline HRESULT IMediaPosition_CanSeekBackward(IMediaPosition* This,LONG *pCanSeekBackward) {
