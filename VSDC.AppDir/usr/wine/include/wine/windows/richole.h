/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/richole.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IRichEditOle_QueryInterface(IRichEditOle* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IRichEditOle_AddRef(IRichEditOle* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IRichEditOle_Release(IRichEditOle* This) {
    return This->lpVtbl->Release(This);
}
/*** IRichEditOle methods ***/
static inline HRESULT IRichEditOle_GetClientSite(IRichEditOle* This,LPOLECLIENTSITE *lplpolesite) {
    return This->lpVtbl->GetClientSite(This,lplpolesite);
}
static inline HRESULT IRichEditOle_GetObjectCount(IRichEditOle* This) {
    return This->lpVtbl->GetObjectCount(This);
}
static inline HRESULT IRichEditOle_GetLinkCount(IRichEditOle* This) {
    return This->lpVtbl->GetLinkCount(This);
}
static inline HRESULT IRichEditOle_GetObject(IRichEditOle* This,LONG iob,REOBJECT *lpreobject,DWORD dwFlags) {
    return This->lpVtbl->GetObject(This,iob,lpreobject,dwFlags);
}
static inline HRESULT IRichEditOle_InsertObject(IRichEditOle* This,REOBJECT *lpreobject) {
    return This->lpVtbl->InsertObject(This,lpreobject);
}
static inline HRESULT IRichEditOle_ConvertObject(IRichEditOle* This,LONG iob,REFCLSID rclsidNew,LPCSTR lpstrUserTypeNew) {
    return This->lpVtbl->ConvertObject(This,iob,rclsidNew,lpstrUserTypeNew);
}
static inline HRESULT IRichEditOle_ActivateAs(IRichEditOle* This,REFCLSID rclsid,REFCLSID rclsidAs) {
    return This->lpVtbl->ActivateAs(This,rclsid,rclsidAs);
}
static inline HRESULT IRichEditOle_SetHostNames(IRichEditOle* This,LPCSTR lpstrContainerApp,LPCSTR lpstrContainerObj) {
    return This->lpVtbl->SetHostNames(This,lpstrContainerApp,lpstrContainerObj);
}
static inline HRESULT IRichEditOle_SetLinkAvailable(IRichEditOle* This,LONG iob,BOOL fAvailable) {
    return This->lpVtbl->SetLinkAvailable(This,iob,fAvailable);
}
static inline HRESULT IRichEditOle_SetDvaspect(IRichEditOle* This,LONG iob,DWORD dvaspect) {
    return This->lpVtbl->SetDvaspect(This,iob,dvaspect);
}
static inline HRESULT IRichEditOle_HandsOffStorage(IRichEditOle* This,LONG iob) {
    return This->lpVtbl->HandsOffStorage(This,iob);
}
static inline HRESULT IRichEditOle_SaveCompleted(IRichEditOle* This,LONG iob,LPSTORAGE lpstg) {
    return This->lpVtbl->SaveCompleted(This,iob,lpstg);
}
static inline HRESULT IRichEditOle_InPlaceDeactivate(IRichEditOle* This) {
    return This->lpVtbl->InPlaceDeactivate(This);
}
static inline HRESULT IRichEditOle_ContextSensitiveHelp(IRichEditOle* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
static inline HRESULT IRichEditOle_GetClipboardData(IRichEditOle* This,CHARRANGE *lpchrg,DWORD reco,LPDATAOBJECT *lplpdataobj) {
    return This->lpVtbl->GetClipboardData(This,lpchrg,reco,lplpdataobj);
}
static inline HRESULT IRichEditOle_ImportDataObject(IRichEditOle* This,LPDATAOBJECT lpdataobj,CLIPFORMAT cf,HGLOBAL hMetaPict) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IRichEditOleCallback_QueryInterface(IRichEditOleCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IRichEditOleCallback_AddRef(IRichEditOleCallback* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IRichEditOleCallback_Release(IRichEditOleCallback* This) {
    return This->lpVtbl->Release(This);
}
/*** IRichEditOleCallback methods ***/
static inline HRESULT IRichEditOleCallback_GetNewStorage(IRichEditOleCallback* This,LPSTORAGE *lplpstg) {
    return This->lpVtbl->GetNewStorage(This,lplpstg);
}
static inline HRESULT IRichEditOleCallback_GetInPlaceContext(IRichEditOleCallback* This,LPOLEINPLACEFRAME *lplpFrame,LPOLEINPLACEUIWINDOW *lplpDoc,LPOLEINPLACEFRAMEINFO lpFrameInfo) {
    return This->lpVtbl->GetInPlaceContext(This,lplpFrame,lplpDoc,lpFrameInfo);
}
static inline HRESULT IRichEditOleCallback_ShowContainerUI(IRichEditOleCallback* This,BOOL fShow) {
    return This->lpVtbl->ShowContainerUI(This,fShow);
}
static inline HRESULT IRichEditOleCallback_QueryInsertObject(IRichEditOleCallback* This,LPCLSID lpclsid,LPSTORAGE lpstg,LONG cp) {
    return This->lpVtbl->QueryInsertObject(This,lpclsid,lpstg,cp);
}
static inline HRESULT IRichEditOleCallback_DeleteObject(IRichEditOleCallback* This,LPOLEOBJECT lpoleobj) {
    return This->lpVtbl->DeleteObject(This,lpoleobj);
}
static inline HRESULT IRichEditOleCallback_QueryAcceptData(IRichEditOleCallback* This,LPDATAOBJECT lpdataobj,CLIPFORMAT *lpcfFormat,DWORD reco,BOOL fReally,HGLOBAL hMetaPict) {
    return This->lpVtbl->QueryAcceptData(This,lpdataobj,lpcfFormat,reco,fReally,hMetaPict);
}
static inline HRESULT IRichEditOleCallback_ContextSensitiveHelp(IRichEditOleCallback* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
static inline HRESULT IRichEditOleCallback_GetClipboardData(IRichEditOleCallback* This,CHARRANGE *lpchrg,DWORD reco,LPDATAOBJECT *lplpdataobj) {
    return This->lpVtbl->GetClipboardData(This,lpchrg,reco,lplpdataobj);
}
static inline HRESULT IRichEditOleCallback_GetDragDropEffect(IRichEditOleCallback* This,BOOL fDrag,DWORD grfKeyState,LPDWORD pdwEffect) {
    return This->lpVtbl->GetDragDropEffect(This,fDrag,grfKeyState,pdwEffect);
}
static inline HRESULT IRichEditOleCallback_GetContextMenu(IRichEditOleCallback* This,WORD seltype,LPOLEOBJECT lpoleobj,CHARRANGE *lpchrg,HMENU *lphmenu) {
