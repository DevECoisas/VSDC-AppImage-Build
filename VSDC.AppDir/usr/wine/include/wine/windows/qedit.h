/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/qedit.idl - Do not edit ***/
...
/*** ISampleGrabber methods ***/
static inline HRESULT ISampleGrabber_SetOneShot(ISampleGrabber* This,BOOL OneShot) {
...
static inline HRESULT ISampleGrabber_SetBufferSamples(ISampleGrabber* This,BOOL BufferThem) {
...
typedef struct __WIDL_qedit_generated_name_0000002E {
    BSTR name;
    DISPID dispID;
    LONG nValues;
} DEXTER_PARAM;
typedef struct __WIDL_qedit_generated_name_0000002F {
    VARIANT v;
    REFERENCE_TIME rt;
    DWORD dwInterp;
} DEXTER_VALUE;
...
typedef enum __WIDL_qedit_generated_name_00000030 {
...
static inline HRESULT IAMTimeline_EnableTransitions(IAMTimeline* This,BOOL enabled) {
    return This->lpVtbl->EnableTransitions(This,enabled);
}
static inline HRESULT IAMTimeline_TransitionsEnabled(IAMTimeline* This,BOOL *enabled) {
    return This->lpVtbl->TransitionsEnabled(This,enabled);
}
static inline HRESULT IAMTimeline_EnableEffects(IAMTimeline* This,BOOL enabled) {
    return This->lpVtbl->EnableEffects(This,enabled);
}
static inline HRESULT IAMTimeline_EffectsEnabled(IAMTimeline* This,BOOL *enabled) {
...
static inline HRESULT IAMTimeline_IsDirty(IAMTimeline* This,BOOL *dirty) {
...
static inline HRESULT IAMTimelineGroup_SetPreviewMode(IAMTimelineGroup* This,BOOL preview) {
    return This->lpVtbl->SetPreviewMode(This,preview);
}
static inline HRESULT IAMTimelineGroup_GetPreviewMode(IAMTimelineGroup* This,BOOL *preview) {
...
static inline HRESULT IAMTimelineGroup_IsSmartRecompressFormatSet(IAMTimelineGroup* This,BOOL *set) {
    return This->lpVtbl->IsSmartRecompressFormatSet(This,set);
}
static inline HRESULT IAMTimelineGroup_IsRecompressFormatDirty(IAMTimelineGroup* This,BOOL *dirty) {
...
static inline HRESULT IAMTimelineObj_GetSubObjectLoaded(IAMTimelineObj* This,BOOL *loaded) {
...
static inline HRESULT IAMTimelineObj_GetMuted(IAMTimelineObj* This,BOOL *muted) {
    return This->lpVtbl->GetMuted(This,muted);
}
static inline HRESULT IAMTimelineObj_SetMuted(IAMTimelineObj* This,BOOL muted) {
    return This->lpVtbl->SetMuted(This,muted);
}
static inline HRESULT IAMTimelineObj_GetLocked(IAMTimelineObj* This,BOOL *locked) {
    return This->lpVtbl->GetLocked(This,locked);
}
static inline HRESULT IAMTimelineObj_SetLocked(IAMTimelineObj* This,BOOL locked) {
...
static inline HRESULT IAMTimelineSrc_IsNormalRate(IAMTimelineSrc* This,BOOL *normal) {
