/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/d3dx11core.idl - Do not edit ***/
...
#else
/*** ID3DX11DataLoader methods ***/
static inline HRESULT ID3DX11DataLoader_Load(ID3DX11DataLoader* This) {
    return This->lpVtbl->Load(This);
}
static inline HRESULT ID3DX11DataLoader_Decompress(ID3DX11DataLoader* This,void **data,SIZE_T *bytes) {
    return This->lpVtbl->Decompress(This,data,bytes);
}
static inline HRESULT ID3DX11DataLoader_Destroy(ID3DX11DataLoader* This) {
...
#else
/*** ID3DX11DataProcessor methods ***/
static inline HRESULT ID3DX11DataProcessor_Process(ID3DX11DataProcessor* This,void *data,SIZE_T bytes) {
    return This->lpVtbl->Process(This,data,bytes);
}
static inline HRESULT ID3DX11DataProcessor_CreateDeviceObject(ID3DX11DataProcessor* This,void **data_object) {
    return This->lpVtbl->CreateDeviceObject(This,data_object);
}
static inline HRESULT ID3DX11DataProcessor_Destroy(ID3DX11DataProcessor* This) {
    return This->lpVtbl->Destroy(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3DX11ThreadPump_QueryInterface(ID3DX11ThreadPump* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ID3DX11ThreadPump_AddRef(ID3DX11ThreadPump* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ID3DX11ThreadPump_Release(ID3DX11ThreadPump* This) {
    return This->lpVtbl->Release(This);
}
/*** ID3DX11ThreadPump methods ***/
static inline HRESULT ID3DX11ThreadPump_AddWorkItem(ID3DX11ThreadPump* This,ID3DX11DataLoader *loader,ID3DX11DataProcessor *processor,HRESULT *hresult,void **device_object) {
    return This->lpVtbl->AddWorkItem(This,loader,processor,hresult,device_object);
}
static inline UINT ID3DX11ThreadPump_GetWorkItemCount(ID3DX11ThreadPump* This) {
    return This->lpVtbl->GetWorkItemCount(This);
}
static inline HRESULT ID3DX11ThreadPump_WaitForAllItems(ID3DX11ThreadPump* This) {
    return This->lpVtbl->WaitForAllItems(This);
}
static inline HRESULT ID3DX11ThreadPump_ProcessDeviceWorkItems(ID3DX11ThreadPump* This,UINT count) {
    return This->lpVtbl->ProcessDeviceWorkItems(This,count);
}
static inline HRESULT ID3DX11ThreadPump_PurgeAllItems(ID3DX11ThreadPump* This) {
    return This->lpVtbl->PurgeAllItems(This);
}
static inline HRESULT ID3DX11ThreadPump_GetQueueStatus(ID3DX11ThreadPump* This,UINT *io_queue,UINT *process_queue,UINT *device_queue) {
