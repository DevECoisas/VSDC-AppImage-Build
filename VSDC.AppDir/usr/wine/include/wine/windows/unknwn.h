/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/unknwn.idl - Do not edit ***/
...
extern "C++"
{
    ...
    public:
        ...
        HRESULT STDMETHODCALLTYPE QueryInterface(iface** pp)
        {
           return QueryInterface(__uuidof(iface), (void **)pp);
        }
        END_INTERFACE
    };
}
...
static inline HRESULT IClassFactory_LockServer(IClassFactory* This,BOOL fLock) {
