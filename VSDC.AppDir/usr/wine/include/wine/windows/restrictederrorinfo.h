/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/restrictederrorinfo.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IRestrictedErrorInfo_QueryInterface(IRestrictedErrorInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IRestrictedErrorInfo_AddRef(IRestrictedErrorInfo* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IRestrictedErrorInfo_Release(IRestrictedErrorInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** IRestrictedErrorInfo methods ***/
static inline HRESULT IRestrictedErrorInfo_GetErrorDetails(IRestrictedErrorInfo* This,BSTR *desc,HRESULT *error,BSTR *restricted_desc,BSTR *sid) {
    return This->lpVtbl->GetErrorDetails(This,desc,error,restricted_desc,sid);
}
static inline HRESULT IRestrictedErrorInfo_GetReference(IRestrictedErrorInfo* This,BSTR *reference) {
