/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/ocidl.idl - Do not edit ***/
...
static inline HRESULT IFont_get_Bold(IFont* This,BOOL *pbold) {
    return This->lpVtbl->get_Bold(This,pbold);
}
static inline HRESULT IFont_put_Bold(IFont* This,BOOL bold) {
    return This->lpVtbl->put_Bold(This,bold);
}
static inline HRESULT IFont_get_Italic(IFont* This,BOOL *pitalic) {
    return This->lpVtbl->get_Italic(This,pitalic);
}
static inline HRESULT IFont_put_Italic(IFont* This,BOOL italic) {
    return This->lpVtbl->put_Italic(This,italic);
}
static inline HRESULT IFont_get_Underline(IFont* This,BOOL *punderline) {
    return This->lpVtbl->get_Underline(This,punderline);
}
static inline HRESULT IFont_put_Underline(IFont* This,BOOL underline) {
    return This->lpVtbl->put_Underline(This,underline);
}
static inline HRESULT IFont_get_Strikethrough(IFont* This,BOOL *pstrikethrough) {
    return This->lpVtbl->get_Strikethrough(This,pstrikethrough);
}
static inline HRESULT IFont_put_Strikethrough(IFont* This,BOOL strikethrough) {
...
static inline HRESULT IPicture_get_KeepOriginalFormat(IPicture* This,BOOL *pKeep) {
    return This->lpVtbl->get_KeepOriginalFormat(This,pKeep);
}
static inline HRESULT IPicture_put_KeepOriginalFormat(IPicture* This,BOOL keep) {
...
static inline HRESULT IPicture_SaveAsFile(IPicture* This,LPSTREAM pStream,BOOL fSaveMemCopy,LONG *pCbSize) {
...
static inline HRESULT IOleControl_FreezeEvents(IOleControl* This,BOOL bFreeze) {
...
static inline HRESULT IOleControlSite_LockInPlaceActive(IOleControlSite* This,BOOL fLock) {
...
static inline HRESULT IOleControlSite_OnFocus(IOleControlSite* This,BOOL fGotFocus) {
...
static inline HRESULT IOleInPlaceSiteEx_ContextSensitiveHelp(IOleInPlaceSiteEx* This,BOOL fEnterMode) {
...
static inline HRESULT IOleInPlaceSiteEx_Scroll(IOleInPlaceSiteEx* This,SIZE scrollExtent) {
    return This->lpVtbl->Scroll(This,scrollExtent);
}
static inline HRESULT IOleInPlaceSiteEx_OnUIDeactivate(IOleInPlaceSiteEx* This,BOOL fUndoable) {
...
/*** IOleInPlaceSiteEx methods ***/
static inline HRESULT IOleInPlaceSiteEx_OnInPlaceActivateEx(IOleInPlaceSiteEx* This,BOOL *pfNoRedraw,DWORD dwFlags) {
    return This->lpVtbl->OnInPlaceActivateEx(This,pfNoRedraw,dwFlags);
}
static inline HRESULT IOleInPlaceSiteEx_OnInPlaceDeactivateEx(IOleInPlaceSiteEx* This,BOOL fNoRedraw) {
...
static inline HRESULT IOleInPlaceSiteWindowless_ContextSensitiveHelp(IOleInPlaceSiteWindowless* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
/*** IOleInPlaceSite methods ***/
...
static inline HRESULT IOleInPlaceSiteWindowless_Scroll(IOleInPlaceSiteWindowless* This,SIZE scrollExtent) {
    return This->lpVtbl->Scroll(This,scrollExtent);
}
static inline HRESULT IOleInPlaceSiteWindowless_OnUIDeactivate(IOleInPlaceSiteWindowless* This,BOOL fUndoable) {
    return This->lpVtbl->OnUIDeactivate(This,fUndoable);
}
...
/*** IOleInPlaceSiteEx methods ***/
static inline HRESULT IOleInPlaceSiteWindowless_OnInPlaceActivateEx(IOleInPlaceSiteWindowless* This,BOOL *pfNoRedraw,DWORD dwFlags) {
    return This->lpVtbl->OnInPlaceActivateEx(This,pfNoRedraw,dwFlags);
}
static inline HRESULT IOleInPlaceSiteWindowless_OnInPlaceDeactivateEx(IOleInPlaceSiteWindowless* This,BOOL fNoRedraw) {
    return This->lpVtbl->OnInPlaceDeactivateEx(This,fNoRedraw);
}
...
static inline HRESULT IOleInPlaceSiteWindowless_SetCapture(IOleInPlaceSiteWindowless* This,BOOL fCapture) {
...
static inline HRESULT IOleInPlaceSiteWindowless_SetFocus(IOleInPlaceSiteWindowless* This,BOOL fFocus) {
...
static inline HRESULT IOleInPlaceSiteWindowless_InvalidateRect(IOleInPlaceSiteWindowless* This,LPCRECT pRect,BOOL fErase) {
    return This->lpVtbl->InvalidateRect(This,pRect,fErase);
}
static inline HRESULT IOleInPlaceSiteWindowless_InvalidateRgn(IOleInPlaceSiteWindowless* This,HRGN hRGN,BOOL fErase) {
...
static inline HRESULT IOleInPlaceObjectWindowless_ContextSensitiveHelp(IOleInPlaceObjectWindowless* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
/*** IOleInPlaceObject methods ***/
...
static inline HRESULT IClassFactory2_LockServer(IClassFactory2* This,BOOL fLock) {
...
/*** IViewObject methods ***/
static inline HRESULT IViewObjectEx_Draw(IViewObjectEx* This,DWORD dwDrawAspect,LONG lindex,void *pvAspect,DVTARGETDEVICE *ptd,HDC hdcTargetDev,HDC hdcDraw,LPCRECTL lprcBounds,LPCRECTL lprcWBounds,BOOL (STDMETHODCALLTYPE *pfnContinue)(ULONG_PTR dwContinue),ULONG_PTR dwContinue) {
...
static inline HRESULT IPropertyPage_Activate(IPropertyPage* This,HWND hWndParent,LPCRECT pRect,BOOL bModal) {
...
static inline HRESULT IPropertyPage2_Activate(IPropertyPage2* This,HWND hWndParent,LPCRECT pRect,BOOL bModal) {
    return This->lpVtbl->Activate(This,hWndParent,pRect,bModal);
}
...
static inline HRESULT IPersistStreamInit_Save(IPersistStreamInit* This,LPSTREAM pStm,BOOL fClearDirty) {
...
static inline HRESULT IPersistMemory_Save(IPersistMemory* This,LPVOID pMem,BOOL fClearDirty,ULONG cbSize) {
...
static inline HRESULT IPersistPropertyBag_Save(IPersistPropertyBag* This,IPropertyBag *pPropBag,BOOL fClearDirty,BOOL fSaveAllProperties) {
...
static inline HRESULT IPersistPropertyBag2_Load(IPersistPropertyBag2* This,IPropertyBag2 *pPropBag,IErrorLog *pErrorLog) {
    return This->lpVtbl->Load(This,pPropBag,pErrorLog);
}
static inline HRESULT IPersistPropertyBag2_Save(IPersistPropertyBag2* This,IPropertyBag2 *pPropBag,BOOL fClearDirty,BOOL fSaveAllProperties) {
    return This->lpVtbl->Save(This,pPropBag,fClearDirty,fSaveAllProperties);
}
...
static inline HRESULT IPointerInactive_OnInactiveSetCursor(IPointerInactive* This,LPCRECT pRectBounds,LONG x,LONG y,DWORD dwMouseMsg,BOOL fSetAlways) {
...
static inline HRESULT IObjectWithSite_GetSite(IObjectWithSite* This,REFIID riid,PVOID *ppvSite) {
...
static inline HRESULT IOleParentUndoUnit_Close(IOleParentUndoUnit* This,IOleParentUndoUnit *pPUU,BOOL fCommit) {
...
static inline HRESULT IOleUndoManager_Close(IOleUndoManager* This,IOleParentUndoUnit *pPUU,BOOL fCommit) {
    return This->lpVtbl->Close(This,pPUU,fCommit);
}
...
static inline HRESULT IOleUndoManager_Enable(IOleUndoManager* This,BOOL fEnable) {
