/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/objsafe.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IObjectSafety_QueryInterface(IObjectSafety* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IObjectSafety_AddRef(IObjectSafety* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IObjectSafety_Release(IObjectSafety* This) {
    return This->lpVtbl->Release(This);
}
/*** IObjectSafety methods ***/
static inline HRESULT IObjectSafety_GetInterfaceSafetyOptions(IObjectSafety* This,REFIID riid,DWORD *pdwSupportedOptions,DWORD *pdwEnabledOptions) {
    return This->lpVtbl->GetInterfaceSafetyOptions(This,riid,pdwSupportedOptions,pdwEnabledOptions);
}
static inline HRESULT IObjectSafety_SetInterfaceSafetyOptions(IObjectSafety* This,REFIID riid,DWORD dwOptionSetMask,DWORD dwEnabledOptions) {
