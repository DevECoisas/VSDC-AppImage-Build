/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/dxgi1_5.idl - Do not edit ***/
...
static inline HRESULT IDXGIOutput5_TakeOwnership(IDXGIOutput5* This,IUnknown *device,BOOL exclusive) {
...
/*** IDXGIOutput2 methods ***/
static inline BOOL IDXGIOutput5_SupportsOverlays(IDXGIOutput5* This) {
...
static inline HRESULT IDXGISwapChain4_SetFullscreenState(IDXGISwapChain4* This,BOOL fullscreen,IDXGIOutput *target) {
    return This->lpVtbl->SetFullscreenState(This,fullscreen,target);
}
static inline HRESULT IDXGISwapChain4_GetFullscreenState(IDXGISwapChain4* This,BOOL *fullscreen,IDXGIOutput **target) {
...
static inline BOOL IDXGISwapChain4_IsTemporaryMonoSupported(IDXGISwapChain4* This) {
...
static inline HRESULT IDXGIDevice4_ReclaimResources(IDXGIDevice4* This,UINT NumResources,IDXGIResource *const *ppResources,BOOL *pDiscarded) {
...
static inline BOOL IDXGIFactory5_IsCurrent(IDXGIFactory5* This) {
    return This->lpVtbl->IsCurrent(This);
}
/*** IDXGIFactory2 methods ***/
static inline BOOL IDXGIFactory5_IsWindowedStereoEnabled(IDXGIFactory5* This) {
