/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/wsdbase.idl - Do not edit ***/
...
/*** IWSDAddress methods ***/
static inline HRESULT IWSDAddress_Serialize(IWSDAddress* This,LPWSTR pszBuffer,DWORD cchLength,BOOL fSafe) {
...
/*** IWSDAddress methods ***/
static inline HRESULT IWSDTransportAddress_Serialize(IWSDTransportAddress* This,LPWSTR pszBuffer,DWORD cchLength,BOOL fSafe) {
    return This->lpVtbl->Serialize(This,pszBuffer,cchLength,fSafe);
}
...
static inline HRESULT IWSDTransportAddress_GetTransportAddressEx(IWSDTransportAddress* This,BOOL fSafe,LPCWSTR *ppszAddress) {
...
/*** IWSDAddress methods ***/
static inline HRESULT IWSDUdpAddress_Serialize(IWSDUdpAddress* This,LPWSTR pszBuffer,DWORD cchLength,BOOL fSafe) {
    return This->lpVtbl->Serialize(This,pszBuffer,cchLength,fSafe);
}
...
static inline HRESULT IWSDUdpAddress_GetTransportAddressEx(IWSDUdpAddress* This,BOOL fSafe,LPCWSTR *ppszAddress) {
    return This->lpVtbl->GetTransportAddressEx(This,fSafe,ppszAddress);
}
...
static inline HRESULT IWSDUdpAddress_SetExclusive(IWSDUdpAddress* This,BOOL fExclusive) {
