/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/mfd3d12.idl - Do not edit ***/
...
IMFD3D12SynchronizationObjectCommands : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE EnqueueResourceReady(
        ID3D12CommandQueue *producer_queue) = 0;

    virtual HRESULT STDMETHODCALLTYPE EnqueueResourceReadyWait(
        ID3D12CommandQueue *consumer_queue) = 0;
...
/*** IMFD3D12SynchronizationObjectCommands methods ***/
#define IMFD3D12SynchronizationObjectCommands_EnqueueResourceReady(This,producer_queue) (This)->lpVtbl->EnqueueResourceReady(This,producer_queue)
#define IMFD3D12SynchronizationObjectCommands_EnqueueResourceReadyWait(This,consumer_queue) (This)->lpVtbl->EnqueueResourceReadyWait(This,consumer_queue)
#define IMFD3D12SynchronizationObjectCommands_SignalEventOnResourceReady(This,event) (This)->lpVtbl->SignalEventOnResourceReady(This,event)
#define IMFD3D12SynchronizationObjectCommands_EnqueueResourceRelease(This,consumer_queue) (This)->lpVtbl->EnqueueResourceRelease(This,consumer_queue)
#else
/*** IUnknown methods ***/
static inline HRESULT IMFD3D12SynchronizationObjectCommands_QueryInterface(IMFD3D12SynchronizationObjectCommands* This,REFIID riid,void **ppvObject) {
...
/*** IMFD3D12SynchronizationObjectCommands methods ***/
static inline HRESULT IMFD3D12SynchronizationObjectCommands_EnqueueResourceReady(IMFD3D12SynchronizationObjectCommands* This,ID3D12CommandQueue *producer_queue) {
    return This->lpVtbl->EnqueueResourceReady(This,producer_queue);
}
static inline HRESULT IMFD3D12SynchronizationObjectCommands_EnqueueResourceReadyWait(IMFD3D12SynchronizationObjectCommands* This,ID3D12CommandQueue *consumer_queue) {
    return This->lpVtbl->EnqueueResourceReadyWait(This,consumer_queue);
}
static inline HRESULT IMFD3D12SynchronizationObjectCommands_SignalEventOnResourceReady(IMFD3D12SynchronizationObjectCommands* This,HANDLE event) {
    return This->lpVtbl->SignalEventOnResourceReady(This,event);
}
static inline HRESULT IMFD3D12SynchronizationObjectCommands_EnqueueResourceRelease(IMFD3D12SynchronizationObjectCommands* This,ID3D12CommandQueue *consumer_queue) {
    return This->lpVtbl->EnqueueResourceRelease(This,consumer_queue);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFD3D12SynchronizationObject_QueryInterface(IMFD3D12SynchronizationObject* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFD3D12SynchronizationObject_AddRef(IMFD3D12SynchronizationObject* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFD3D12SynchronizationObject_Release(IMFD3D12SynchronizationObject* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFD3D12SynchronizationObject methods ***/
static inline HRESULT IMFD3D12SynchronizationObject_SignalEventOnFinalResourceRelease(IMFD3D12SynchronizationObject* This,HANDLE hEvent) {
...
EXTERN_GUID(MF_D3D12_SYNCHRONIZATION_OBJECT, 0x2a7c8d6a, 0x85a6, 0x494d, 0xa0, 0x46, 0x06, 0xea, 0x1a, 0x13, 0x8f, 0x4b);
...
EXTERN_GUID(MF_MT_D3D12_RESOURCE_FLAG_ALLOW_DEPTH_STENCIL, 0xb1138dc3, 0x01d5, 0x4c14, 0x9b, 0xdc, 0xcd, 0xc9, 0x33, 0x6f, 0x55, 0xb9);
...
EXTERN_GUID(MF_MT_D3D12_RESOURCE_FLAG_ALLOW_SIMULTANEOUS_ACCESS, 0xa4940b2, 0xcfd6, 0x4738, 0x9d, 0x02, 0x98, 0x11, 0x37, 0x34, 0x01, 0x5a);
