/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/wmcodecdsp.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWMResamplerProps_QueryInterface(IWMResamplerProps* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWMResamplerProps_AddRef(IWMResamplerProps* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWMResamplerProps_Release(IWMResamplerProps* This) {
    return This->lpVtbl->Release(This);
}
/*** IWMResamplerProps methods ***/
static inline HRESULT IWMResamplerProps_SetHalfFilterLength(IWMResamplerProps* This,LONG length) {
    return This->lpVtbl->SetHalfFilterLength(This,length);
}
static inline HRESULT IWMResamplerProps_SetUserChannelMtx(IWMResamplerProps* This,ChMtxType *conversion_matrix) {
