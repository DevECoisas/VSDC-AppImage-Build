/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/uiautomationcore.idl - Do not edit ***/
...
static inline HRESULT IRangeValueProvider_get_IsReadOnly(IRangeValueProvider* This,BOOL *pRetVal) {
...
static inline HRESULT ISelectionProvider_get_CanSelectMultiple(ISelectionProvider* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanSelectMultiple(This,pRetVal);
}
static inline HRESULT ISelectionProvider_get_IsSelectionRequired(ISelectionProvider* This,BOOL *pRetVal) {
...
static inline HRESULT ISelectionProvider2_get_CanSelectMultiple(ISelectionProvider2* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanSelectMultiple(This,pRetVal);
}
static inline HRESULT ISelectionProvider2_get_IsSelectionRequired(ISelectionProvider2* This,BOOL *pRetVal) {
    return This->lpVtbl->get_IsSelectionRequired(This,pRetVal);
}
/*** ISelectionProvider2 methods ***/
...
static inline HRESULT IScrollProvider_get_HorizontallyScrollable(IScrollProvider* This,BOOL *pRetVal) {
    return This->lpVtbl->get_HorizontallyScrollable(This,pRetVal);
}
static inline HRESULT IScrollProvider_get_VerticallyScrollable(IScrollProvider* This,BOOL *pRetVal) {
...
static inline HRESULT ISelectionItemProvider_get_IsSelected(ISelectionItemProvider* This,BOOL *pRetVal) {
...
static inline HRESULT ITransformProvider_get_CanMove(ITransformProvider* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanMove(This,pRetVal);
}
static inline HRESULT ITransformProvider_get_CanResize(ITransformProvider* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanResize(This,pRetVal);
}
static inline HRESULT ITransformProvider_get_CanRotate(ITransformProvider* This,BOOL *pRetVal) {
...
static inline HRESULT IValueProvider_get_IsReadOnly(IValueProvider* This,BOOL *pRetVal) {
    return This->lpVtbl->get_IsReadOnly(This,pRetVal);
}
#endif
#endif
...
static inline HRESULT IWindowProvider_WaitForInputIdle(IWindowProvider* This,int milliseconds,BOOL *pRetVal) {
    return This->lpVtbl->WaitForInputIdle(This,milliseconds,pRetVal);
}
static inline HRESULT IWindowProvider_get_CanMaximize(IWindowProvider* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanMaximize(This,pRetVal);
}
static inline HRESULT IWindowProvider_get_CanMinimize(IWindowProvider* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanMinimize(This,pRetVal);
}
static inline HRESULT IWindowProvider_get_IsModal(IWindowProvider* This,BOOL *pRetVal) {
...
static inline HRESULT IWindowProvider_get_IsTopmost(IWindowProvider* This,BOOL *pRetVal) {
...
static inline HRESULT ITransformProvider2_get_CanMove(ITransformProvider2* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanMove(This,pRetVal);
}
static inline HRESULT ITransformProvider2_get_CanResize(ITransformProvider2* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanResize(This,pRetVal);
}
static inline HRESULT ITransformProvider2_get_CanRotate(ITransformProvider2* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanRotate(This,pRetVal);
}
/*** ITransformProvider2 methods ***/
...
static inline HRESULT ITransformProvider2_get_CanZoom(ITransformProvider2* This,BOOL *pRetVal) {
...
/*** IDragProvider methods ***/
static inline HRESULT IDragProvider_get_IsGrabbed(IDragProvider* This,BOOL *pRetVal) {
...
static inline HRESULT ITextProvider2_GetCaretRange(ITextProvider2* This,BOOL *isActive,ITextRangeProvider **pRetVal) {
...
static inline HRESULT ITextRangeProvider_Compare(ITextRangeProvider* This,ITextRangeProvider *range,BOOL *pRetVal) {
...
static inline HRESULT ITextRangeProvider_FindAttribute(ITextRangeProvider* This,TEXTATTRIBUTEID attributeId,VARIANT val,BOOL backward,ITextRangeProvider **pRetVal) {
    return This->lpVtbl->FindAttribute(This,attributeId,val,backward,pRetVal);
}
static inline HRESULT ITextRangeProvider_FindText(ITextRangeProvider* This,BSTR text,BOOL backward,BOOL ignoreCase,ITextRangeProvider **pRetVal) {
...
static inline HRESULT ITextRangeProvider_ScrollIntoView(ITextRangeProvider* This,BOOL alignToTop) {
...
static inline HRESULT ITextRangeProvider2_Compare(ITextRangeProvider2* This,ITextRangeProvider *range,BOOL *pRetVal) {
    return This->lpVtbl->Compare(This,range,pRetVal);
}
...
static inline HRESULT ITextRangeProvider2_FindAttribute(ITextRangeProvider2* This,TEXTATTRIBUTEID attributeId,VARIANT val,BOOL backward,ITextRangeProvider **pRetVal) {
    return This->lpVtbl->FindAttribute(This,attributeId,val,backward,pRetVal);
}
static inline HRESULT ITextRangeProvider2_FindText(ITextRangeProvider2* This,BSTR text,BOOL backward,BOOL ignoreCase,ITextRangeProvider **pRetVal) {
    return This->lpVtbl->FindText(This,text,backward,ignoreCase,pRetVal);
}
...
static inline HRESULT ITextRangeProvider2_ScrollIntoView(ITextRangeProvider2* This,BOOL alignToTop) {
    return This->lpVtbl->ScrollIntoView(This,alignToTop);
}
...
/*** IUIAutomationPatternInstance methods ***/
static inline HRESULT IUIAutomationPatternInstance_GetProperty(IUIAutomationPatternInstance* This,UINT index,BOOL cached,enum UIAutomationType type,void *pPtr) {
