/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/msdadc.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDataConvert_QueryInterface(IDataConvert* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IDataConvert_AddRef(IDataConvert* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IDataConvert_Release(IDataConvert* This) {
    return This->lpVtbl->Release(This);
}
/*** IDataConvert methods ***/
static inline HRESULT IDataConvert_DataConvert(IDataConvert* This,DBTYPE wSrcType,DBTYPE wDstType,DBLENGTH cbSrcLength,DBLENGTH *pcbDstLength,void *pSrc,void *pDst,DBLENGTH cbDstMaxLength,DBSTATUS dbsSrcStatus,DBSTATUS *pdbsDstStatus,BYTE bPrecision,BYTE bScale,DBDATACONVERT dwFlags) {
...
static inline HRESULT IDataConvert_CanConvert(IDataConvert* This,DBTYPE wSrcType,DBTYPE wDstType) {
    return This->lpVtbl->CanConvert(This,wSrcType,wDstType);
}
static inline HRESULT IDataConvert_GetConversionSize(IDataConvert* This,DBTYPE wSrcType,DBTYPE wDstType,DBLENGTH *pcbSrcLength,DBLENGTH *pcbDstLength,void *pSrc) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDCInfo_QueryInterface(IDCInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IDCInfo_AddRef(IDCInfo* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IDCInfo_Release(IDCInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** IDCInfo methods ***/
static inline HRESULT IDCInfo_GetInfo(IDCInfo* This,ULONG cInfo,DCINFOTYPE rgeInfoType[],DCINFO **prgInfo) {
    return This->lpVtbl->GetInfo(This,cInfo,rgeInfoType,prgInfo);
}
static inline HRESULT IDCInfo_SetInfo(IDCInfo* This,ULONG cInfo,DCINFO prgInfo[]) {
