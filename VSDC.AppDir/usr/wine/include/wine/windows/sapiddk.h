/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/sapiddk.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ISpObjectTokenEnumBuilder_QueryInterface(ISpObjectTokenEnumBuilder* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ISpObjectTokenEnumBuilder_AddRef(ISpObjectTokenEnumBuilder* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ISpObjectTokenEnumBuilder_Release(ISpObjectTokenEnumBuilder* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumSpObjectTokens methods ***/
static inline HRESULT ISpObjectTokenEnumBuilder_Next(ISpObjectTokenEnumBuilder* This,ULONG celt,ISpObjectToken **pelt,ULONG *pceltFetched) {
    return This->lpVtbl->Next(This,celt,pelt,pceltFetched);
}
static inline HRESULT ISpObjectTokenEnumBuilder_Skip(ISpObjectTokenEnumBuilder* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
static inline HRESULT ISpObjectTokenEnumBuilder_Reset(ISpObjectTokenEnumBuilder* This) {
    return This->lpVtbl->Reset(This);
}
static inline HRESULT ISpObjectTokenEnumBuilder_Clone(ISpObjectTokenEnumBuilder* This,IEnumSpObjectTokens **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
static inline HRESULT ISpObjectTokenEnumBuilder_Item(ISpObjectTokenEnumBuilder* This,ULONG Index,ISpObjectToken **ppToken) {
    return This->lpVtbl->Item(This,Index,ppToken);
}
static inline HRESULT ISpObjectTokenEnumBuilder_GetCount(ISpObjectTokenEnumBuilder* This,ULONG *pCount) {
    return This->lpVtbl->GetCount(This,pCount);
}
/*** ISpObjectTokenEnumBuilder methods ***/
static inline HRESULT ISpObjectTokenEnumBuilder_SetAttribs(ISpObjectTokenEnumBuilder* This,LPCWSTR pszReqAttribs,LPCWSTR pszOptAttribs) {
    return This->lpVtbl->SetAttribs(This,pszReqAttribs,pszOptAttribs);
}
static inline HRESULT ISpObjectTokenEnumBuilder_AddTokens(ISpObjectTokenEnumBuilder* This,ULONG cTokens,ISpObjectToken **pToken) {
    return This->lpVtbl->AddTokens(This,cTokens,pToken);
}
static inline HRESULT ISpObjectTokenEnumBuilder_AddTokensFromDataKey(ISpObjectTokenEnumBuilder* This,ISpDataKey *pDataKey,LPCWSTR pszSubKey,LPCWSTR pszCategoryId) {
    return This->lpVtbl->AddTokensFromDataKey(This,pDataKey,pszSubKey,pszCategoryId);
}
static inline HRESULT ISpObjectTokenEnumBuilder_AddTokensFromTokenEnum(ISpObjectTokenEnumBuilder* This,IEnumSpObjectTokens *pTokenEnum) {
    return This->lpVtbl->AddTokensFromTokenEnum(This,pTokenEnum);
}
static inline HRESULT ISpObjectTokenEnumBuilder_Sort(ISpObjectTokenEnumBuilder* This,LPCWSTR pszTokenIdToListFirst) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ISpTTSEngineSite_QueryInterface(ISpTTSEngineSite* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ISpTTSEngineSite_AddRef(ISpTTSEngineSite* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ISpTTSEngineSite_Release(ISpTTSEngineSite* This) {
    return This->lpVtbl->Release(This);
}
/*** ISpEventSink methods ***/
static inline HRESULT ISpTTSEngineSite_AddEvents(ISpTTSEngineSite* This,const SPEVENT *events,ULONG count) {
    return This->lpVtbl->AddEvents(This,events,count);
}
static inline HRESULT ISpTTSEngineSite_GetEventInterest(ISpTTSEngineSite* This,ULONGLONG *interest) {
    return This->lpVtbl->GetEventInterest(This,interest);
}
/*** ISpTTSEngineSite methods ***/
static inline DWORD ISpTTSEngineSite_GetActions(ISpTTSEngineSite* This) {
    return This->lpVtbl->GetActions(This);
}
static inline HRESULT ISpTTSEngineSite_Write(ISpTTSEngineSite* This,const void *pBuff,ULONG cb,ULONG *pcbWritten) {
    return This->lpVtbl->Write(This,pBuff,cb,pcbWritten);
}
static inline HRESULT ISpTTSEngineSite_GetRate(ISpTTSEngineSite* This,LONG *pRateAdjust) {
    return This->lpVtbl->GetRate(This,pRateAdjust);
}
static inline HRESULT ISpTTSEngineSite_GetVolume(ISpTTSEngineSite* This,USHORT *pusVolume) {
    return This->lpVtbl->GetVolume(This,pusVolume);
}
static inline HRESULT ISpTTSEngineSite_GetSkipInfo(ISpTTSEngineSite* This,SPVSKIPTYPE *peType,LONG *plNumItems) {
    return This->lpVtbl->GetSkipInfo(This,peType,plNumItems);
}
static inline HRESULT ISpTTSEngineSite_CompleteSkip(ISpTTSEngineSite* This,LONG lNumSkipped) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ISpTTSEngine_QueryInterface(ISpTTSEngine* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ISpTTSEngine_AddRef(ISpTTSEngine* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ISpTTSEngine_Release(ISpTTSEngine* This) {
    return This->lpVtbl->Release(This);
}
/*** ISpTTSEngine methods ***/
static inline HRESULT ISpTTSEngine_Speak(ISpTTSEngine* This,DWORD dwSpeakFlags,REFGUID rguidFormatId,const WAVEFORMATEX *pWaveFormatEx,const SPVTEXTFRAG *pTextFragList,ISpTTSEngineSite *pOutputSite) {
    return This->lpVtbl->Speak(This,dwSpeakFlags,rguidFormatId,pWaveFormatEx,pTextFragList,pOutputSite);
}
static inline HRESULT ISpTTSEngine_GetOutputFormat(ISpTTSEngine* This,const GUID *pTargetFmtId,const WAVEFORMATEX *pTargetWaveFormatEx,GUID *pOutputFormatId,WAVEFORMATEX **ppCoMemOutputWaveFormatEx) {
