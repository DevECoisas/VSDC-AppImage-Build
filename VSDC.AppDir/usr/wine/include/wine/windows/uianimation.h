/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/uianimation.idl - Do not edit ***/
...
/*** IUIAnimationManagerEventHandler methods ***/
static inline HRESULT IUIAnimationManagerEventHandler_OnManagerStatusChanged(IUIAnimationManagerEventHandler* This,UI_ANIMATION_MANAGER_STATUS status,UI_ANIMATION_MANAGER_STATUS prev_status) {
...
/*** IUIAnimationVariableChangeHandler methods ***/
static inline HRESULT IUIAnimationVariableChangeHandler_OnValueChanged(IUIAnimationVariableChangeHandler* This,IUIAnimationStoryboard *storyboard,IUIAnimationVariable *variable,DOUBLE value,DOUBLE prev_value) {
...
/*** IUIAnimationVariableIntegerChangeHandler methods ***/
static inline HRESULT IUIAnimationVariableIntegerChangeHandler_OnIntegerValueChanged(IUIAnimationVariableIntegerChangeHandler* This,IUIAnimationStoryboard *storyboard,IUIAnimationVariable *variable,INT32 value,INT32 prev_value) {
...
/*** IUIAnimationStoryboardEventHandler methods ***/
static inline HRESULT IUIAnimationStoryboardEventHandler_OnStoryboardStatusChanged(IUIAnimationStoryboardEventHandler* This,IUIAnimationStoryboard *storyboard,UI_ANIMATION_STORYBOARD_STATUS status,UI_ANIMATION_STORYBOARD_STATUS prev_status) {
...
static inline HRESULT IUIAnimationTransition_GetDuration(IUIAnimationTransition* This,UI_ANIMATION_SECONDS *duration) {
...
static inline HRESULT IUIAnimationVariable_GetFinalValue(IUIAnimationVariable* This,DOUBLE *value) {
    return This->lpVtbl->GetFinalValue(This,value);
}
static inline HRESULT IUIAnimationVariable_GetPreviousValue(IUIAnimationVariable* This,DOUBLE *value) {
    return This->lpVtbl->GetPreviousValue(This,value);
}
static inline HRESULT IUIAnimationVariable_GetIntegerValue(IUIAnimationVariable* This,INT32 *value) {
    return This->lpVtbl->GetIntegerValue(This,value);
}
static inline HRESULT IUIAnimationVariable_GetFinalIntegerValue(IUIAnimationVariable* This,INT32 *value) {
    return This->lpVtbl->GetFinalIntegerValue(This,value);
}
static inline HRESULT IUIAnimationVariable_GetPreviousIntegerValue(IUIAnimationVariable* This,INT32 *value) {
...
static inline HRESULT IUIAnimationVariable_SetTag(IUIAnimationVariable* This,IUnknown *object,UINT32 id) {
    return This->lpVtbl->SetTag(This,object,id);
}
static inline HRESULT IUIAnimationVariable_GetTag(IUIAnimationVariable* This,IUnknown **object,UINT32 *id) {
...
static inline HRESULT IUIAnimationStoryboard_AddKeyframeAtOffset(IUIAnimationStoryboard* This,UI_ANIMATION_KEYFRAME existingframe,UI_ANIMATION_SECONDS offset,UI_ANIMATION_KEYFRAME *keyframe) {
...
static inline HRESULT IUIAnimationStoryboard_AddTransitionAtKeyframe(IUIAnimationStoryboard* This,IUIAnimationVariable *variable,IUIAnimationTransition *transition,UI_ANIMATION_KEYFRAME start_key) {
    return This->lpVtbl->AddTransitionAtKeyframe(This,variable,transition,start_key);
}
static inline HRESULT IUIAnimationStoryboard_AddTransitionBetweenKeyframes(IUIAnimationStoryboard* This,IUIAnimationVariable *variable,IUIAnimationTransition *transition,UI_ANIMATION_KEYFRAME start_key,UI_ANIMATION_KEYFRAME end_key) {
    return This->lpVtbl->AddTransitionBetweenKeyframes(This,variable,transition,start_key,end_key);
}
static inline HRESULT IUIAnimationStoryboard_RepeatBetweenKeyframes(IUIAnimationStoryboard* This,UI_ANIMATION_KEYFRAME start_key,UI_ANIMATION_KEYFRAME end_key,INT32 count) {
...
static inline HRESULT IUIAnimationStoryboard_SetLongestAcceptableDelay(IUIAnimationStoryboard* This,UI_ANIMATION_SECONDS delay) {
    return This->lpVtbl->SetLongestAcceptableDelay(This,delay);
}
static inline HRESULT IUIAnimationStoryboard_Schedule(IUIAnimationStoryboard* This,UI_ANIMATION_SECONDS now,UI_ANIMATION_SCHEDULING_RESULT *result) {
...
static inline HRESULT IUIAnimationStoryboard_Finish(IUIAnimationStoryboard* This,UI_ANIMATION_SECONDS deadline) {
...
static inline HRESULT IUIAnimationStoryboard_SetTag(IUIAnimationStoryboard* This,IUnknown *object,UINT32 id) {
    return This->lpVtbl->SetTag(This,object,id);
}
static inline HRESULT IUIAnimationStoryboard_GetTag(IUIAnimationStoryboard* This,IUnknown **object,UINT32 *id) {
    return This->lpVtbl->GetTag(This,object,id);
}
...
static inline HRESULT IUIAnimationStoryboard_GetElapsedTime(IUIAnimationStoryboard* This,UI_ANIMATION_SECONDS *elapsed) {
...
/*** IUIAnimationTimerClientEventHandler methods ***/
static inline HRESULT IUIAnimationTimerClientEventHandler_OnTimerClientStatusChanged(IUIAnimationTimerClientEventHandler* This,UI_ANIMATION_TIMER_CLIENT_STATUS new_status,UI_ANIMATION_TIMER_CLIENT_STATUS previous_status) {
...
/*** IUIAnimationTimerUpdateHandler methods ***/
static inline HRESULT IUIAnimationTimerUpdateHandler_OnUpdate(IUIAnimationTimerUpdateHandler* This,UI_ANIMATION_SECONDS now,UI_ANIMATION_UPDATE_RESULT *result) {
...
static inline HRESULT IUIAnimationTimerEventHandler_OnRenderingTooSlow(IUIAnimationTimerEventHandler* This,UINT32 fps) {
...
/*** IUIAnimationTimer methods ***/
static inline HRESULT IUIAnimationTimer_SetTimerUpdateHandler(IUIAnimationTimer* This,IUIAnimationTimerUpdateHandler *handler,UI_ANIMATION_IDLE_BEHAVIOR idlebehavior) {
...
static inline HRESULT IUIAnimationTimer_GetTime(IUIAnimationTimer* This,UI_ANIMATION_SECONDS *time) {
    return This->lpVtbl->GetTime(This,time);
}
static inline HRESULT IUIAnimationTimer_SetFrameRateThreshold(IUIAnimationTimer* This,UINT32 fps) {
...
/*** IUIAnimationManager methods ***/
static inline HRESULT IUIAnimationManager_CreateAnimationVariable(IUIAnimationManager* This,UI_ANIMATION_SECONDS initialvalue,IUIAnimationVariable **variable) {
    return This->lpVtbl->CreateAnimationVariable(This,initialvalue,variable);
}
static inline HRESULT IUIAnimationManager_ScheduleTransition(IUIAnimationManager* This,IUIAnimationVariable *variable,IUIAnimationTransition *transition,UI_ANIMATION_SECONDS timenow) {
...
static inline HRESULT IUIAnimationManager_FinishAllStoryboards(IUIAnimationManager* This,UI_ANIMATION_SECONDS deadline) {
...
static inline HRESULT IUIAnimationManager_Update(IUIAnimationManager* This,UI_ANIMATION_SECONDS timenow,UI_ANIMATION_UPDATE_RESULT *updateresult) {
...
static inline HRESULT IUIAnimationManager_SetDefaultLongestAcceptableDelay(IUIAnimationManager* This,UI_ANIMATION_SECONDS delay) {
...
/*** IUIAnimationPriorityComparison methods ***/
static inline HRESULT IUIAnimationPriorityComparison_HasPriority(IUIAnimationPriorityComparison* This,IUIAnimationStoryboard *scheduledboard,IUIAnimationStoryboard *newboard,UI_ANIMATION_PRIORITY_EFFECT effect) {
...
static inline HRESULT IUIAnimationInterpolator_SetDuration(IUIAnimationInterpolator* This,UI_ANIMATION_SECONDS duration) {
    return This->lpVtbl->SetDuration(This,duration);
}
static inline HRESULT IUIAnimationInterpolator_GetDuration(IUIAnimationInterpolator* This,UI_ANIMATION_SECONDS *duration) {
    return This->lpVtbl->GetDuration(This,duration);
}
static inline HRESULT IUIAnimationInterpolator_GetFinalValue(IUIAnimationInterpolator* This,double *value) {
    return This->lpVtbl->GetFinalValue(This,value);
}
static inline HRESULT IUIAnimationInterpolator_InterpolateValue(IUIAnimationInterpolator* This,UI_ANIMATION_SECONDS offset,double *value) {
    return This->lpVtbl->InterpolateValue(This,offset,value);
}
static inline HRESULT IUIAnimationInterpolator_InterpolateVelocity(IUIAnimationInterpolator* This,UI_ANIMATION_SECONDS offset,double *velocity) {
...
static inline HRESULT IUIAnimationTransitionLibrary_CreateConstantTransition(IUIAnimationTransitionLibrary* This,UI_ANIMATION_SECONDS duration,IUIAnimationTransition **transition) {
    return This->lpVtbl->CreateConstantTransition(This,duration,transition);
}
static inline HRESULT IUIAnimationTransitionLibrary_CreateDiscreteTransition(IUIAnimationTransitionLibrary* This,UI_ANIMATION_SECONDS delay,double finalvalue,UI_ANIMATION_SECONDS hold,IUIAnimationTransition **transition) {
    return This->lpVtbl->CreateDiscreteTransition(This,delay,finalvalue,hold,transition);
}
static inline HRESULT IUIAnimationTransitionLibrary_CreateLinearTransition(IUIAnimationTransitionLibrary* This,UI_ANIMATION_SECONDS duration,double finalvalue,IUIAnimationTransition **transition) {
...
static inline HRESULT IUIAnimationTransitionLibrary_CreateSinusoidalTransitionFromVelocity(IUIAnimationTransitionLibrary* This,UI_ANIMATION_SECONDS duration,UI_ANIMATION_SECONDS period,IUIAnimationTransition **transition) {
    return This->lpVtbl->CreateSinusoidalTransitionFromVelocity(This,duration,period,transition);
}
static inline HRESULT IUIAnimationTransitionLibrary_CreateSinusoidalTransitionFromRange(IUIAnimationTransitionLibrary* This,UI_ANIMATION_SECONDS duration,double minimumvalue,double maximumvalue,UI_ANIMATION_SECONDS period,UI_ANIMATION_SLOPE slope,IUIAnimationTransition **transition) {
    return This->lpVtbl->CreateSinusoidalTransitionFromRange(This,duration,minimumvalue,maximumvalue,period,slope,transition);
}
static inline HRESULT IUIAnimationTransitionLibrary_CreateAccelerateDecelerateTransition(IUIAnimationTransitionLibrary* This,UI_ANIMATION_SECONDS duration,double finalvalue,double accelerationratio,double decelerationratio,IUIAnimationTransition **transition) {
...
static inline HRESULT IUIAnimationTransitionLibrary_CreateReversalTransition(IUIAnimationTransitionLibrary* This,UI_ANIMATION_SECONDS duration,IUIAnimationTransition **transition) {
    return This->lpVtbl->CreateReversalTransition(This,duration,transition);
}
static inline HRESULT IUIAnimationTransitionLibrary_CreateCubicTransition(IUIAnimationTransitionLibrary* This,UI_ANIMATION_SECONDS duration,double finalvalue,double finalvelocity,IUIAnimationTransition **transition) {
    return This->lpVtbl->CreateCubicTransition(This,duration,finalvalue,finalvelocity,transition);
}
static inline HRESULT IUIAnimationTransitionLibrary_CreateSmoothStopTransition(IUIAnimationTransitionLibrary* This,UI_ANIMATION_SECONDS maximumduration,double finalvalue,IUIAnimationTransition **transition) {
    return This->lpVtbl->CreateSmoothStopTransition(This,maximumduration,finalvalue,transition);
}
static inline HRESULT IUIAnimationTransitionLibrary_CreateParabolicTransitionFromAcceleration(IUIAnimationTransitionLibrary* This,UI_ANIMATION_SECONDS finalvalue,double finalvelocity,double acceleration,IUIAnimationTransition **transition) {
