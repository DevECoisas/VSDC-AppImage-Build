/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/dxgi1_6.idl - Do not edit ***/
...
static inline HRESULT IDXGIOutput6_TakeOwnership(IDXGIOutput6* This,IUnknown *device,BOOL exclusive) {
...
/*** IDXGIOutput2 methods ***/
static inline BOOL IDXGIOutput6_SupportsOverlays(IDXGIOutput6* This) {
...
static inline BOOL IDXGIFactory6_IsCurrent(IDXGIFactory6* This) {
    return This->lpVtbl->IsCurrent(This);
}
/*** IDXGIFactory2 methods ***/
static inline BOOL IDXGIFactory6_IsWindowedStereoEnabled(IDXGIFactory6* This) {
...
static inline BOOL IDXGIFactory7_IsCurrent(IDXGIFactory7* This) {
    return This->lpVtbl->IsCurrent(This);
}
/*** IDXGIFactory2 methods ***/
static inline BOOL IDXGIFactory7_IsWindowedStereoEnabled(IDXGIFactory7* This) {
    return This->lpVtbl->IsWindowedStereoEnabled(This);
}
