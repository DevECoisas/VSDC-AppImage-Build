/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/bdaiface.idl - Do not edit ***/
...
static inline HRESULT IBDA_DRM_PerformDRMPairing(IBDA_DRM* This,BOOL fSync) {
...
static inline HRESULT IBDA_Encoder_GetState(IBDA_Encoder* This,DWORD *AudioBitrateMax,DWORD *AudioBitrateMin,DWORD *AudioBitrateMode,DWORD *AudioBitrateStepping,DWORD *AudioBitrate,DWORD *AudioMethodID,DWORD *AvailableAudioPrograms,DWORD *AudioProgram,DWORD *VideoBitrateMax,DWORD *VideoBitrateMin,DWORD *VideoBitrateMode,DWORD *VideoBitrate,DWORD *VideoBitrateStepping,DWORD *VideoMethodID,DWORD *SignalSourceID,ULONGLONG *SignalFormat,BOOL *SignalLock,LONG *SignalLevel,DWORD *SignalToNoiseRatio) {
...
/*** IBDA_FDC methods ***/
static inline HRESULT IBDA_FDC_GetStatus(IBDA_FDC* This,DWORD *CurrentBitrate,BOOL *CarrierLock,DWORD *CurrentFrequency,BOOL *CurrentSpectrumInversion,BSTR *CurrentPIDList,BSTR *CurrentTIDList,BOOL *Overflow) {
