/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/dxgi.idl - Do not edit ***/
...
/*** IDXGISurface1 methods ***/
static inline HRESULT IDXGISurface1_GetDC(IDXGISurface1* This,BOOL discard,HDC *hdc) {
...
static inline HRESULT IDXGIOutput_TakeOwnership(IDXGIOutput* This,IUnknown *device,BOOL exclusive) {
...
static inline HRESULT IDXGISwapChain_SetFullscreenState(IDXGISwapChain* This,BOOL fullscreen,IDXGIOutput *target) {
    return This->lpVtbl->SetFullscreenState(This,fullscreen,target);
}
static inline HRESULT IDXGISwapChain_GetFullscreenState(IDXGISwapChain* This,BOOL *fullscreen,IDXGIOutput **target) {
...
static inline BOOL IDXGIFactory1_IsCurrent(IDXGIFactory1* This) {
