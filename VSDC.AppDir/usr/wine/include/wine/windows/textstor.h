/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/textstor.idl - Do not edit ***/
...
typedef enum __WIDL_textstor_generated_name_0000000E {
    TS_AE_NONE = 0,
    TS_AE_START = 1,
    TS_AE_END = 2
} TsActiveSelEnd;
...
static inline HRESULT ITextStoreACP_QueryInsertEmbedded(ITextStoreACP* This,const GUID *pguidService,const FORMATETC *pFormatEtc,BOOL *pfInsertable) {
...
static inline HRESULT ITextStoreACP_FindNextAttrTransition(ITextStoreACP* This,LONG acpStart,LONG acpHalt,ULONG cFilterAttrs,const TS_ATTRID *paFilterAttrs,DWORD dwFlags,LONG *pacpNext,BOOL *pfFound,LONG *plFoundOffset) {
...
static inline HRESULT ITextStoreACP_GetTextExt(ITextStoreACP* This,TsViewCookie vcView,LONG acpStart,LONG acpEnd,RECT *prc,BOOL *pfClipped) {
