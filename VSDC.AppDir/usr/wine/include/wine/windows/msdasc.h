/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/msdasc.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDataSourceLocator_QueryInterface(IDataSourceLocator* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IDataSourceLocator_AddRef(IDataSourceLocator* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IDataSourceLocator_Release(IDataSourceLocator* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IDataSourceLocator_GetTypeInfoCount(IDataSourceLocator* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IDataSourceLocator_GetTypeInfo(IDataSourceLocator* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IDataSourceLocator_GetIDsOfNames(IDataSourceLocator* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IDataSourceLocator_Invoke(IDataSourceLocator* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IDataSourceLocator methods ***/
static inline HRESULT IDataSourceLocator_get_hWnd(IDataSourceLocator* This,COMPATIBLE_LONG *phwndParent) {
    return This->lpVtbl->get_hWnd(This,phwndParent);
}
static inline HRESULT IDataSourceLocator_put_hWnd(IDataSourceLocator* This,COMPATIBLE_LONG hwndParent) {
    return This->lpVtbl->put_hWnd(This,hwndParent);
}
static inline HRESULT IDataSourceLocator_PromptNew(IDataSourceLocator* This,IDispatch **ppADOConnection) {
    return This->lpVtbl->PromptNew(This,ppADOConnection);
}
static inline HRESULT IDataSourceLocator_PromptEdit(IDataSourceLocator* This,IDispatch **ppADOConnection,VARIANT_BOOL *pbSuccess) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDBPromptInitialize_QueryInterface(IDBPromptInitialize* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IDBPromptInitialize_AddRef(IDBPromptInitialize* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IDBPromptInitialize_Release(IDBPromptInitialize* This) {
    return This->lpVtbl->Release(This);
}
/*** IDBPromptInitialize methods ***/
static inline HRESULT IDBPromptInitialize_PromptDataSource(IDBPromptInitialize* This,IUnknown *pUnkOuter,HWND hWndParent,DBPROMPTOPTIONS dwPromptOptions,ULONG cSourceTypeFilter,DBSOURCETYPE *rgSourceTypeFilter,LPWSTR pwszszzProviderFilter,GUID *riid,IUnknown **ppDataSource) {
...
static inline HRESULT IDBPromptInitialize_PromptFileName(IDBPromptInitialize* This,HWND hWndParent,ULONG dwPromptOptions,LPWSTR pwszInitialDirectory,LPWSTR pwszInitialFile,LPWSTR *ppwszSelectedFile) {
...
IDataInitialize : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE LoadStringFromStorage(
        ...
        LPOLESTR *ppwszInitializationString) = 0;
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDataInitialize_QueryInterface(IDataInitialize* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IDataInitialize_AddRef(IDataInitialize* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IDataInitialize_Release(IDataInitialize* This) {
    return This->lpVtbl->Release(This);
}
/*** IDataInitialize methods ***/
static inline HRESULT IDataInitialize_GetDataSource(IDataInitialize* This,IUnknown *pUnkOuter,DWORD dwClsCtx,LPCOLESTR pwszInitializationString,REFIID riid,IUnknown **ppDataSource) {
    return This->lpVtbl->GetDataSource(This,pUnkOuter,dwClsCtx,pwszInitializationString,riid,ppDataSource);
}
static inline HRESULT IDataInitialize_GetInitializationString(IDataInitialize* This,IUnknown *pDataSource,boolean fIncludePassword,LPWSTR *ppwszInitString) {
    return This->lpVtbl->GetInitializationString(This,pDataSource,fIncludePassword,ppwszInitString);
}
static inline HRESULT IDataInitialize_CreateDBInstance(IDataInitialize* This,REFCLSID clsidProvider,IUnknown *pUnkOuter,DWORD dwClsCtx,LPWSTR pwszReserved,REFIID riid,IUnknown **ppDataSource) {
    return This->lpVtbl->CreateDBInstance(This,clsidProvider,pUnkOuter,dwClsCtx,pwszReserved,riid,ppDataSource);
}
static inline HRESULT IDataInitialize_CreateDBInstanceEx(IDataInitialize* This,REFCLSID clsidProvider,IUnknown *pUnkOuter,DWORD dwClsCtx,LPWSTR pwszReserved,COSERVERINFO *pServerInfo,DWORD cmq,MULTI_QI *results) {
    return This->lpVtbl->CreateDBInstanceEx(This,clsidProvider,pUnkOuter,dwClsCtx,pwszReserved,pServerInfo,cmq,results);
}
static inline HRESULT IDataInitialize_LoadStringFromStorage(IDataInitialize* This,LPCOLESTR pwszFileName,LPOLESTR *ppwszInitializationString) {
    return This->lpVtbl->LoadStringFromStorage(This,pwszFileName,ppwszInitializationString);
}
static inline HRESULT IDataInitialize_WriteStringToStorage(IDataInitialize* This,LPCOLESTR pwszFileName,LPCOLESTR pwszInitializationString,DWORD dwCreationDisposition) {
