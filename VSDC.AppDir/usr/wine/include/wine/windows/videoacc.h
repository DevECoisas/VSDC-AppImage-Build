/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/videoacc.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAMVideoAccelerator_QueryInterface(IAMVideoAccelerator* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IAMVideoAccelerator_AddRef(IAMVideoAccelerator* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IAMVideoAccelerator_Release(IAMVideoAccelerator* This) {
    return This->lpVtbl->Release(This);
}
/*** IAMVideoAccelerator methods ***/
static inline HRESULT IAMVideoAccelerator_GetVideoAcceleratorGUIDs(IAMVideoAccelerator* This,DWORD *count,GUID *accelerators) {
    return This->lpVtbl->GetVideoAcceleratorGUIDs(This,count,accelerators);
}
static inline HRESULT IAMVideoAccelerator_GetUncompFormatsSupported(IAMVideoAccelerator* This,const GUID *accelerator,DWORD *count,DDPIXELFORMAT *formats) {
    return This->lpVtbl->GetUncompFormatsSupported(This,accelerator,count,formats);
}
static inline HRESULT IAMVideoAccelerator_GetInternalMemInfo(IAMVideoAccelerator* This,const GUID *accelerator,const AMVAUncompDataInfo *format_info,AMVAInternalMemInfo *mem_info) {
    return This->lpVtbl->GetInternalMemInfo(This,accelerator,format_info,mem_info);
}
static inline HRESULT IAMVideoAccelerator_GetCompBufferInfo(IAMVideoAccelerator* This,const GUID *accelerator,const AMVAUncompDataInfo *uncompressed_info,DWORD *compressed_info_count,AMVACompBufferInfo *compressed_infos) {
    return This->lpVtbl->GetCompBufferInfo(This,accelerator,uncompressed_info,compressed_info_count,compressed_infos);
}
static inline HRESULT IAMVideoAccelerator_GetInternalCompBufferInfo(IAMVideoAccelerator* This,DWORD *count,AMVACompBufferInfo *infos) {
    return This->lpVtbl->GetInternalCompBufferInfo(This,count,infos);
}
static inline HRESULT IAMVideoAccelerator_BeginFrame(IAMVideoAccelerator* This,const AMVABeginFrameInfo *info) {
    return This->lpVtbl->BeginFrame(This,info);
}
static inline HRESULT IAMVideoAccelerator_EndFrame(IAMVideoAccelerator* This,const AMVAEndFrameInfo *info) {
    return This->lpVtbl->EndFrame(This,info);
}
static inline HRESULT IAMVideoAccelerator_GetBuffer(IAMVideoAccelerator* This,DWORD type_index,DWORD buffer_index,BOOL read_only,void **buffer,LONG *stride) {
    return This->lpVtbl->GetBuffer(This,type_index,buffer_index,read_only,buffer,stride);
}
static inline HRESULT IAMVideoAccelerator_ReleaseBuffer(IAMVideoAccelerator* This,DWORD type_index,DWORD buffer_index) {
    return This->lpVtbl->ReleaseBuffer(This,type_index,buffer_index);
}
static inline HRESULT IAMVideoAccelerator_Execute(IAMVideoAccelerator* This,DWORD function,void *in_data,DWORD in_size,void *out_data,DWORD out_size,DWORD buffer_count,const AMVABUFFERINFO *buffers) {
    return This->lpVtbl->Execute(This,function,in_data,in_size,out_data,out_size,buffer_count,buffers);
}
static inline HRESULT IAMVideoAccelerator_QueryRenderStatus(IAMVideoAccelerator* This,DWORD type_index,DWORD buffer_index,DWORD flags) {
    return This->lpVtbl->QueryRenderStatus(This,type_index,buffer_index,flags);
}
static inline HRESULT IAMVideoAccelerator_DisplayFrame(IAMVideoAccelerator* This,DWORD index,IMediaSample *sample) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAMVideoAcceleratorNotify_QueryInterface(IAMVideoAcceleratorNotify* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IAMVideoAcceleratorNotify_AddRef(IAMVideoAcceleratorNotify* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IAMVideoAcceleratorNotify_Release(IAMVideoAcceleratorNotify* This) {
    return This->lpVtbl->Release(This);
}
/*** IAMVideoAcceleratorNotify methods ***/
static inline HRESULT IAMVideoAcceleratorNotify_GetUncompSurfacesInfo(IAMVideoAcceleratorNotify* This,const GUID *accelerator,AMVAUncompBufferInfo *info) {
    return This->lpVtbl->GetUncompSurfacesInfo(This,accelerator,info);
}
static inline HRESULT IAMVideoAcceleratorNotify_SetUncompSurfacesInfo(IAMVideoAcceleratorNotify* This,DWORD allocated_count) {
    return This->lpVtbl->SetUncompSurfacesInfo(This,allocated_count);
}
static inline HRESULT IAMVideoAcceleratorNotify_GetCreateVideoAcceleratorData(IAMVideoAcceleratorNotify* This,const GUID *accelerator,DWORD *size,void **data) {
