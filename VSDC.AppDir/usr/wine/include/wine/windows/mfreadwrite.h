/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/mfreadwrite.idl - Do not edit ***/
...
/*** IMFSourceReader methods ***/
static inline HRESULT IMFSourceReader_GetStreamSelection(IMFSourceReader* This,DWORD index,BOOL *selected) {
    return This->lpVtbl->GetStreamSelection(This,index,selected);
}
static inline HRESULT IMFSourceReader_SetStreamSelection(IMFSourceReader* This,DWORD index,BOOL selected) {
...
/*** IMFSourceReader methods ***/
static inline HRESULT IMFSourceReaderEx_GetStreamSelection(IMFSourceReaderEx* This,DWORD index,BOOL *selected) {
    return This->lpVtbl->GetStreamSelection(This,index,selected);
}
static inline HRESULT IMFSourceReaderEx_SetStreamSelection(IMFSourceReaderEx* This,DWORD index,BOOL selected) {
    return This->lpVtbl->SetStreamSelection(This,index,selected);
}
