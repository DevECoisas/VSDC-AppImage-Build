/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/oleidl.idl - Do not edit ***/
...
static inline HRESULT IOleWindow_ContextSensitiveHelp(IOleWindow* This,BOOL fEnterMode) {
...
static inline HRESULT IOleInPlaceObject_ContextSensitiveHelp(IOleInPlaceObject* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
/*** IOleInPlaceObject methods ***/
...
static inline HRESULT IOleInPlaceUIWindow_ContextSensitiveHelp(IOleInPlaceUIWindow* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
/*** IOleInPlaceUIWindow methods ***/
...
static inline HRESULT IOleInPlaceFrame_ContextSensitiveHelp(IOleInPlaceFrame* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
/*** IOleInPlaceUIWindow methods ***/
...
static inline HRESULT IOleInPlaceFrame_EnableModeless(IOleInPlaceFrame* This,BOOL fEnable) {
...
static inline HRESULT IOleInPlaceActiveObject_ContextSensitiveHelp(IOleInPlaceActiveObject* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
/*** IOleInPlaceActiveObject methods ***/
...
static inline HRESULT IOleInPlaceActiveObject_OnFrameWindowActivate(IOleInPlaceActiveObject* This,BOOL fActivate) {
    return This->lpVtbl->OnFrameWindowActivate(This,fActivate);
}
static inline HRESULT IOleInPlaceActiveObject_OnDocWindowActivate(IOleInPlaceActiveObject* This,BOOL fActivate) {
    return This->lpVtbl->OnDocWindowActivate(This,fActivate);
}
static inline HRESULT IOleInPlaceActiveObject_ResizeBorder(IOleInPlaceActiveObject* This,LPCRECT prcBorder,IOleInPlaceUIWindow *pUIWindow,BOOL fFrameWindow) {
    return This->lpVtbl->ResizeBorder(This,prcBorder,pUIWindow,fFrameWindow);
}
static inline HRESULT IOleInPlaceActiveObject_EnableModeless(IOleInPlaceActiveObject* This,BOOL fEnable) {
    return This->lpVtbl->EnableModeless(This,fEnable);
}
#endif
#endif
...
static inline HRESULT IOleInPlaceSite_ContextSensitiveHelp(IOleInPlaceSite* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
/*** IOleInPlaceSite methods ***/
...
static inline HRESULT IOleInPlaceSite_Scroll(IOleInPlaceSite* This,SIZE scrollExtent) {
    return This->lpVtbl->Scroll(This,scrollExtent);
}
static inline HRESULT IOleInPlaceSite_OnUIDeactivate(IOleInPlaceSite* This,BOOL fUndoable) {
...
static inline HRESULT IOleContainer_LockContainer(IOleContainer* This,BOOL fLock) {
...
static inline HRESULT IOleItemContainer_LockContainer(IOleItemContainer* This,BOOL fLock) {
    return This->lpVtbl->LockContainer(This,fLock);
}
/*** IOleItemContainer methods ***/
...
static inline HRESULT IOleClientSite_OnShowWindow(IOleClientSite* This,BOOL fShow) {
...
static inline HRESULT IOleCache_SetData(IOleCache* This,FORMATETC *pformatetc,STGMEDIUM *pmedium,BOOL fRelease) {
...
static inline HRESULT IOleCache2_SetData(IOleCache2* This,FORMATETC *pformatetc,STGMEDIUM *pmedium,BOOL fRelease) {
    return This->lpVtbl->SetData(This,pformatetc,pmedium,fRelease);
}
/*** IOleCache2 methods ***/
...
static inline HRESULT IOleObject_InitFromData(IOleObject* This,IDataObject *pDataObject,BOOL fCreation,DWORD dwReserved) {
...
/*** IViewObject methods ***/
static inline HRESULT IViewObject_Draw(IViewObject* This,DWORD dwDrawAspect,LONG lindex,void *pvAspect,DVTARGETDEVICE *ptd,HDC hdcTargetDev,HDC hdcDraw,LPCRECTL lprcBounds,LPCRECTL lprcWBounds,BOOL (STDMETHODCALLTYPE *pfnContinue)(ULONG_PTR dwContinue),ULONG_PTR dwContinue) {
...
/*** IViewObject methods ***/
static inline HRESULT IViewObject2_Draw(IViewObject2* This,DWORD dwDrawAspect,LONG lindex,void *pvAspect,DVTARGETDEVICE *ptd,HDC hdcTargetDev,HDC hdcDraw,LPCRECTL lprcBounds,LPCRECTL lprcWBounds,BOOL (STDMETHODCALLTYPE *pfnContinue)(ULONG_PTR dwContinue),ULONG_PTR dwContinue) {
    return This->lpVtbl->Draw(This,dwDrawAspect,lindex,pvAspect,ptd,hdcTargetDev,hdcDraw,lprcBounds,lprcWBounds,pfnContinue,dwContinue);
}
...
/*** IDropSource methods ***/
static inline HRESULT IDropSource_QueryContinueDrag(IDropSource* This,BOOL fEscapePressed,DWORD grfKeyState) {
...
{
    virtual HRESULT STDMETHODCALLTYPE DragTargetEnter(
        HWND hwnd) = 0;

    virtual HRESULT STDMETHODCALLTYPE DragTargetLeave(
        ) = 0;
...
typedef struct IDropSourceNotifyVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *DragTargetEnter)(
        IDropSourceNotify *This,
        HWND hwnd);

    HRESULT (STDMETHODCALLTYPE *DragTargetLeave)(
        IDropSourceNotify *This);
...
/*** IDropSourceNotify methods ***/
#define IDropSourceNotify_DragTargetEnter(This,hwnd) (This)->lpVtbl->DragTargetEnter(This,hwnd)
#define IDropSourceNotify_DragTargetLeave(This) (This)->lpVtbl->DragTargetLeave(This)
#else
/*** IUnknown methods ***/
...
/*** IDropSourceNotify methods ***/
static inline HRESULT IDropSourceNotify_DragTargetEnter(IDropSourceNotify* This,HWND hwnd) {
    return This->lpVtbl->DragTargetEnter(This,hwnd);
}
static inline HRESULT IDropSourceNotify_DragTargetLeave(IDropSourceNotify* This) {
    return This->lpVtbl->DragTargetLeave(This);
}
#endif
#endif
