/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/indexsrv.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWordSink_QueryInterface(IWordSink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWordSink_AddRef(IWordSink* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWordSink_Release(IWordSink* This) {
    return This->lpVtbl->Release(This);
}
/*** IWordSink methods ***/
static inline HRESULT IWordSink_PutWord(IWordSink* This,ULONG cwc,const WCHAR *pwcInBuf,ULONG cwcSrcLen,ULONG cwcSrcPos) {
    return This->lpVtbl->PutWord(This,cwc,pwcInBuf,cwcSrcLen,cwcSrcPos);
}
static inline HRESULT IWordSink_PutAltWord(IWordSink* This,ULONG cwc,const WCHAR *pwcInBuf,ULONG cwcSrcLen,ULONG cwcSrcPos) {
    return This->lpVtbl->PutAltWord(This,cwc,pwcInBuf,cwcSrcLen,cwcSrcPos);
}
static inline HRESULT IWordSink_StartAltPhrase(IWordSink* This) {
    return This->lpVtbl->StartAltPhrase(This);
}
static inline HRESULT IWordSink_EndAltPhrase(IWordSink* This) {
    return This->lpVtbl->EndAltPhrase(This);
}
static inline HRESULT IWordSink_PutBreak(IWordSink* This,WORDREP_BREAK_TYPE breakType) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPhraseSink_QueryInterface(IPhraseSink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IPhraseSink_AddRef(IPhraseSink* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IPhraseSink_Release(IPhraseSink* This) {
    return This->lpVtbl->Release(This);
}
/*** IPhraseSink methods ***/
static inline HRESULT IPhraseSink_PutSmallPhrase(IPhraseSink* This,const WCHAR *pwcNoun,ULONG cwcNoun,const WCHAR *pwcModifier,ULONG cwcModifier,ULONG ulAttachmentType) {
    return This->lpVtbl->PutSmallPhrase(This,pwcNoun,cwcNoun,pwcModifier,cwcModifier,ulAttachmentType);
}
static inline HRESULT IPhraseSink_PutPhrase(IPhraseSink* This,const WCHAR *pwcPhrase,ULONG cwcPhrase) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWordBreaker_QueryInterface(IWordBreaker* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWordBreaker_AddRef(IWordBreaker* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWordBreaker_Release(IWordBreaker* This) {
    return This->lpVtbl->Release(This);
}
/*** IWordBreaker methods ***/
static inline HRESULT IWordBreaker_Init(IWordBreaker* This,BOOL fQuery,ULONG ulMaxTokenSize,BOOL *pfLicense) {
    return This->lpVtbl->Init(This,fQuery,ulMaxTokenSize,pfLicense);
}
static inline HRESULT IWordBreaker_BreakText(IWordBreaker* This,TEXT_SOURCE *pTextSource,IWordSink *pWordSink,IPhraseSink *pPhraseSink) {
    return This->lpVtbl->BreakText(This,pTextSource,pWordSink,pPhraseSink);
}
static inline HRESULT IWordBreaker_ComposePhrase(IWordBreaker* This,const WCHAR *pwcNoun,ULONG cwcNoun,const WCHAR *pwcModifier,ULONG cwcModifier,ULONG ulAttachmentType,WCHAR *pwcPhrase,ULONG *pcwcPhrase) {
    return This->lpVtbl->ComposePhrase(This,pwcNoun,cwcNoun,pwcModifier,cwcModifier,ulAttachmentType,pwcPhrase,pcwcPhrase);
}
static inline HRESULT IWordBreaker_GetLicenseToUse(IWordBreaker* This,const WCHAR **ppwcsLicense) {
