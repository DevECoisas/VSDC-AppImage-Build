/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/mstask.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEnumWorkItems_QueryInterface(IEnumWorkItems* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IEnumWorkItems_AddRef(IEnumWorkItems* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IEnumWorkItems_Release(IEnumWorkItems* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumWorkItems methods ***/
static inline HRESULT IEnumWorkItems_Next(IEnumWorkItems* This,ULONG celt,LPWSTR **rgpwszNames,ULONG *pceltFetched) {
    return This->lpVtbl->Next(This,celt,rgpwszNames,pceltFetched);
}
static inline HRESULT IEnumWorkItems_Skip(IEnumWorkItems* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
static inline HRESULT IEnumWorkItems_Reset(IEnumWorkItems* This) {
    return This->lpVtbl->Reset(This);
}
static inline HRESULT IEnumWorkItems_Clone(IEnumWorkItems* This,IEnumWorkItems **ppEnumWorkItems) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IProvideTaskPage_QueryInterface(IProvideTaskPage* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IProvideTaskPage_AddRef(IProvideTaskPage* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IProvideTaskPage_Release(IProvideTaskPage* This) {
    return This->lpVtbl->Release(This);
}
/*** IProvideTaskPage methods ***/
static inline HRESULT IProvideTaskPage_GetPage(IProvideTaskPage* This,TASKPAGE tpType,BOOL fPersistChanges,HPROPSHEETPAGE *phPage) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITaskTrigger_QueryInterface(ITaskTrigger* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITaskTrigger_AddRef(ITaskTrigger* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITaskTrigger_Release(ITaskTrigger* This) {
    return This->lpVtbl->Release(This);
}
/*** ITaskTrigger methods ***/
static inline HRESULT ITaskTrigger_SetTrigger(ITaskTrigger* This,const PTASK_TRIGGER pTrigger) {
    return This->lpVtbl->SetTrigger(This,pTrigger);
}
static inline HRESULT ITaskTrigger_GetTrigger(ITaskTrigger* This,PTASK_TRIGGER pTrigger) {
    return This->lpVtbl->GetTrigger(This,pTrigger);
}
static inline HRESULT ITaskTrigger_GetTriggerString(ITaskTrigger* This,LPWSTR *ppwszTrigger) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IScheduledWorkItem_QueryInterface(IScheduledWorkItem* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IScheduledWorkItem_AddRef(IScheduledWorkItem* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IScheduledWorkItem_Release(IScheduledWorkItem* This) {
    return This->lpVtbl->Release(This);
}
/*** IScheduledWorkItem methods ***/
static inline HRESULT IScheduledWorkItem_CreateTrigger(IScheduledWorkItem* This,WORD *piNewTrigger,ITaskTrigger **ppTrigger) {
    return This->lpVtbl->CreateTrigger(This,piNewTrigger,ppTrigger);
}
static inline HRESULT IScheduledWorkItem_DeleteTrigger(IScheduledWorkItem* This,WORD iTrigger) {
    return This->lpVtbl->DeleteTrigger(This,iTrigger);
}
static inline HRESULT IScheduledWorkItem_GetTriggerCount(IScheduledWorkItem* This,WORD *plCount) {
    return This->lpVtbl->GetTriggerCount(This,plCount);
}
static inline HRESULT IScheduledWorkItem_GetTrigger(IScheduledWorkItem* This,WORD iTrigger,ITaskTrigger **ppTrigger) {
    return This->lpVtbl->GetTrigger(This,iTrigger,ppTrigger);
}
static inline HRESULT IScheduledWorkItem_GetTriggerString(IScheduledWorkItem* This,WORD iTrigger,LPWSTR *ppwszTrigger) {
    return This->lpVtbl->GetTriggerString(This,iTrigger,ppwszTrigger);
}
static inline HRESULT IScheduledWorkItem_GetRunTimes(IScheduledWorkItem* This,const LPSYSTEMTIME pstBegin,const LPSYSTEMTIME pstEnd,WORD *pCount,LPSYSTEMTIME *rgstTaskTimes) {
    return This->lpVtbl->GetRunTimes(This,pstBegin,pstEnd,pCount,rgstTaskTimes);
}
static inline HRESULT IScheduledWorkItem_GetNextRunTime(IScheduledWorkItem* This,SYSTEMTIME *pstNextRun) {
    return This->lpVtbl->GetNextRunTime(This,pstNextRun);
}
static inline HRESULT IScheduledWorkItem_SetIdleWait(IScheduledWorkItem* This,WORD wIdleMinutes,WORD wDeadlineMinutes) {
    return This->lpVtbl->SetIdleWait(This,wIdleMinutes,wDeadlineMinutes);
}
static inline HRESULT IScheduledWorkItem_GetIdleWait(IScheduledWorkItem* This,WORD *pwIdleMinutes,WORD *pwDeadlineMinutes) {
    return This->lpVtbl->GetIdleWait(This,pwIdleMinutes,pwDeadlineMinutes);
}
static inline HRESULT IScheduledWorkItem_Run(IScheduledWorkItem* This) {
    return This->lpVtbl->Run(This);
}
static inline HRESULT IScheduledWorkItem_Terminate(IScheduledWorkItem* This) {
    return This->lpVtbl->Terminate(This);
}
static inline HRESULT IScheduledWorkItem_EditWorkItem(IScheduledWorkItem* This,HWND hParent,DWORD dwReserved) {
    return This->lpVtbl->EditWorkItem(This,hParent,dwReserved);
}
static inline HRESULT IScheduledWorkItem_GetMostRecentRunTime(IScheduledWorkItem* This,SYSTEMTIME *pstLastRun) {
    return This->lpVtbl->GetMostRecentRunTime(This,pstLastRun);
}
static inline HRESULT IScheduledWorkItem_GetStatus(IScheduledWorkItem* This,HRESULT *phrStatus) {
    return This->lpVtbl->GetStatus(This,phrStatus);
}
static inline HRESULT IScheduledWorkItem_GetExitCode(IScheduledWorkItem* This,DWORD *pdwExitCode) {
    return This->lpVtbl->GetExitCode(This,pdwExitCode);
}
static inline HRESULT IScheduledWorkItem_SetComment(IScheduledWorkItem* This,LPCWSTR pwszComment) {
    return This->lpVtbl->SetComment(This,pwszComment);
}
static inline HRESULT IScheduledWorkItem_GetComment(IScheduledWorkItem* This,LPWSTR *ppwszComment) {
    return This->lpVtbl->GetComment(This,ppwszComment);
}
static inline HRESULT IScheduledWorkItem_SetCreator(IScheduledWorkItem* This,LPCWSTR pwszCreator) {
    return This->lpVtbl->SetCreator(This,pwszCreator);
}
static inline HRESULT IScheduledWorkItem_GetCreator(IScheduledWorkItem* This,LPWSTR *ppwszCreator) {
    return This->lpVtbl->GetCreator(This,ppwszCreator);
}
static inline HRESULT IScheduledWorkItem_SetWorkItemData(IScheduledWorkItem* This,WORD cBytes,BYTE rgbData[]) {
    return This->lpVtbl->SetWorkItemData(This,cBytes,rgbData);
}
static inline HRESULT IScheduledWorkItem_GetWorkItemData(IScheduledWorkItem* This,WORD *pcBytes,BYTE **ppBytes) {
    return This->lpVtbl->GetWorkItemData(This,pcBytes,ppBytes);
}
static inline HRESULT IScheduledWorkItem_SetErrorRetryCount(IScheduledWorkItem* This,WORD wRetryCount) {
    return This->lpVtbl->SetErrorRetryCount(This,wRetryCount);
}
static inline HRESULT IScheduledWorkItem_GetErrorRetryCount(IScheduledWorkItem* This,WORD *pwRetryCount) {
    return This->lpVtbl->GetErrorRetryCount(This,pwRetryCount);
}
static inline HRESULT IScheduledWorkItem_SetErrorRetryInterval(IScheduledWorkItem* This,WORD wRetryInterval) {
    return This->lpVtbl->SetErrorRetryInterval(This,wRetryInterval);
}
static inline HRESULT IScheduledWorkItem_GetErrorRetryInterval(IScheduledWorkItem* This,WORD *pwRetryInterval) {
    return This->lpVtbl->GetErrorRetryInterval(This,pwRetryInterval);
}
static inline HRESULT IScheduledWorkItem_SetFlags(IScheduledWorkItem* This,DWORD dwFlags) {
    return This->lpVtbl->SetFlags(This,dwFlags);
}
static inline HRESULT IScheduledWorkItem_GetFlags(IScheduledWorkItem* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetFlags(This,pdwFlags);
}
static inline HRESULT IScheduledWorkItem_SetAccountInformation(IScheduledWorkItem* This,LPCWSTR pwszAccountName,LPCWSTR pwszPassword) {
    return This->lpVtbl->SetAccountInformation(This,pwszAccountName,pwszPassword);
}
static inline HRESULT IScheduledWorkItem_GetAccountInformation(IScheduledWorkItem* This,LPWSTR *ppwszAccountName) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITask_QueryInterface(ITask* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITask_AddRef(ITask* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITask_Release(ITask* This) {
    return This->lpVtbl->Release(This);
}
/*** IScheduledWorkItem methods ***/
static inline HRESULT ITask_CreateTrigger(ITask* This,WORD *piNewTrigger,ITaskTrigger **ppTrigger) {
    return This->lpVtbl->CreateTrigger(This,piNewTrigger,ppTrigger);
}
static inline HRESULT ITask_DeleteTrigger(ITask* This,WORD iTrigger) {
    return This->lpVtbl->DeleteTrigger(This,iTrigger);
}
static inline HRESULT ITask_GetTriggerCount(ITask* This,WORD *plCount) {
    return This->lpVtbl->GetTriggerCount(This,plCount);
}
static inline HRESULT ITask_GetTrigger(ITask* This,WORD iTrigger,ITaskTrigger **ppTrigger) {
    return This->lpVtbl->GetTrigger(This,iTrigger,ppTrigger);
}
static inline HRESULT ITask_GetTriggerString(ITask* This,WORD iTrigger,LPWSTR *ppwszTrigger) {
    return This->lpVtbl->GetTriggerString(This,iTrigger,ppwszTrigger);
}
static inline HRESULT ITask_GetRunTimes(ITask* This,const LPSYSTEMTIME pstBegin,const LPSYSTEMTIME pstEnd,WORD *pCount,LPSYSTEMTIME *rgstTaskTimes) {
    return This->lpVtbl->GetRunTimes(This,pstBegin,pstEnd,pCount,rgstTaskTimes);
}
static inline HRESULT ITask_GetNextRunTime(ITask* This,SYSTEMTIME *pstNextRun) {
    return This->lpVtbl->GetNextRunTime(This,pstNextRun);
}
static inline HRESULT ITask_SetIdleWait(ITask* This,WORD wIdleMinutes,WORD wDeadlineMinutes) {
    return This->lpVtbl->SetIdleWait(This,wIdleMinutes,wDeadlineMinutes);
}
static inline HRESULT ITask_GetIdleWait(ITask* This,WORD *pwIdleMinutes,WORD *pwDeadlineMinutes) {
    return This->lpVtbl->GetIdleWait(This,pwIdleMinutes,pwDeadlineMinutes);
}
static inline HRESULT ITask_Run(ITask* This) {
    return This->lpVtbl->Run(This);
}
static inline HRESULT ITask_Terminate(ITask* This) {
    return This->lpVtbl->Terminate(This);
}
static inline HRESULT ITask_EditWorkItem(ITask* This,HWND hParent,DWORD dwReserved) {
    return This->lpVtbl->EditWorkItem(This,hParent,dwReserved);
}
static inline HRESULT ITask_GetMostRecentRunTime(ITask* This,SYSTEMTIME *pstLastRun) {
    return This->lpVtbl->GetMostRecentRunTime(This,pstLastRun);
}
static inline HRESULT ITask_GetStatus(ITask* This,HRESULT *phrStatus) {
    return This->lpVtbl->GetStatus(This,phrStatus);
}
static inline HRESULT ITask_GetExitCode(ITask* This,DWORD *pdwExitCode) {
    return This->lpVtbl->GetExitCode(This,pdwExitCode);
}
static inline HRESULT ITask_SetComment(ITask* This,LPCWSTR pwszComment) {
    return This->lpVtbl->SetComment(This,pwszComment);
}
static inline HRESULT ITask_GetComment(ITask* This,LPWSTR *ppwszComment) {
    return This->lpVtbl->GetComment(This,ppwszComment);
}
static inline HRESULT ITask_SetCreator(ITask* This,LPCWSTR pwszCreator) {
    return This->lpVtbl->SetCreator(This,pwszCreator);
}
static inline HRESULT ITask_GetCreator(ITask* This,LPWSTR *ppwszCreator) {
    return This->lpVtbl->GetCreator(This,ppwszCreator);
}
static inline HRESULT ITask_SetWorkItemData(ITask* This,WORD cBytes,BYTE rgbData[]) {
    return This->lpVtbl->SetWorkItemData(This,cBytes,rgbData);
}
static inline HRESULT ITask_GetWorkItemData(ITask* This,WORD *pcBytes,BYTE **ppBytes) {
    return This->lpVtbl->GetWorkItemData(This,pcBytes,ppBytes);
}
static inline HRESULT ITask_SetErrorRetryCount(ITask* This,WORD wRetryCount) {
    return This->lpVtbl->SetErrorRetryCount(This,wRetryCount);
}
static inline HRESULT ITask_GetErrorRetryCount(ITask* This,WORD *pwRetryCount) {
    return This->lpVtbl->GetErrorRetryCount(This,pwRetryCount);
}
static inline HRESULT ITask_SetErrorRetryInterval(ITask* This,WORD wRetryInterval) {
    return This->lpVtbl->SetErrorRetryInterval(This,wRetryInterval);
}
static inline HRESULT ITask_GetErrorRetryInterval(ITask* This,WORD *pwRetryInterval) {
    return This->lpVtbl->GetErrorRetryInterval(This,pwRetryInterval);
}
static inline HRESULT ITask_SetFlags(ITask* This,DWORD dwFlags) {
    return This->lpVtbl->SetFlags(This,dwFlags);
}
static inline HRESULT ITask_GetFlags(ITask* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetFlags(This,pdwFlags);
}
static inline HRESULT ITask_SetAccountInformation(ITask* This,LPCWSTR pwszAccountName,LPCWSTR pwszPassword) {
    return This->lpVtbl->SetAccountInformation(This,pwszAccountName,pwszPassword);
}
static inline HRESULT ITask_GetAccountInformation(ITask* This,LPWSTR *ppwszAccountName) {
    return This->lpVtbl->GetAccountInformation(This,ppwszAccountName);
}
/*** ITask methods ***/
static inline HRESULT ITask_SetApplicationName(ITask* This,LPCWSTR pwszApplicationName) {
    return This->lpVtbl->SetApplicationName(This,pwszApplicationName);
}
static inline HRESULT ITask_GetApplicationName(ITask* This,LPWSTR *ppwszApplicationName) {
    return This->lpVtbl->GetApplicationName(This,ppwszApplicationName);
}
static inline HRESULT ITask_SetParameters(ITask* This,LPCWSTR pwszParameters) {
    return This->lpVtbl->SetParameters(This,pwszParameters);
}
static inline HRESULT ITask_GetParameters(ITask* This,LPWSTR *ppwszParameters) {
    return This->lpVtbl->GetParameters(This,ppwszParameters);
}
static inline HRESULT ITask_SetWorkingDirectory(ITask* This,LPCWSTR pwszWorkingDirectory) {
    return This->lpVtbl->SetWorkingDirectory(This,pwszWorkingDirectory);
}
static inline HRESULT ITask_GetWorkingDirectory(ITask* This,LPWSTR *ppwszWorkingDirectory) {
    return This->lpVtbl->GetWorkingDirectory(This,ppwszWorkingDirectory);
}
static inline HRESULT ITask_SetPriority(ITask* This,DWORD dwPriority) {
    return This->lpVtbl->SetPriority(This,dwPriority);
}
static inline HRESULT ITask_GetPriority(ITask* This,DWORD *pdwPriority) {
    return This->lpVtbl->GetPriority(This,pdwPriority);
}
static inline HRESULT ITask_SetTaskFlags(ITask* This,DWORD dwFlags) {
    return This->lpVtbl->SetTaskFlags(This,dwFlags);
}
static inline HRESULT ITask_GetTaskFlags(ITask* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetTaskFlags(This,pdwFlags);
}
static inline HRESULT ITask_SetMaxRunTime(ITask* This,DWORD dwMaxRunTime) {
    return This->lpVtbl->SetMaxRunTime(This,dwMaxRunTime);
}
static inline HRESULT ITask_GetMaxRunTime(ITask* This,DWORD *pdwMaxRunTime) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITaskScheduler_QueryInterface(ITaskScheduler* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITaskScheduler_AddRef(ITaskScheduler* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITaskScheduler_Release(ITaskScheduler* This) {
    return This->lpVtbl->Release(This);
}
/*** ITaskScheduler methods ***/
static inline HRESULT ITaskScheduler_SetTargetComputer(ITaskScheduler* This,LPCWSTR pwszComputer) {
    return This->lpVtbl->SetTargetComputer(This,pwszComputer);
}
static inline HRESULT ITaskScheduler_GetTargetComputer(ITaskScheduler* This,LPWSTR *ppwszComputer) {
    return This->lpVtbl->GetTargetComputer(This,ppwszComputer);
}
static inline HRESULT ITaskScheduler_Enum(ITaskScheduler* This,IEnumWorkItems **ppEnumTasks) {
    return This->lpVtbl->Enum(This,ppEnumTasks);
}
static inline HRESULT ITaskScheduler_Activate(ITaskScheduler* This,LPCWSTR pwszName,REFIID riid,IUnknown **ppunk) {
    return This->lpVtbl->Activate(This,pwszName,riid,ppunk);
}
static inline HRESULT ITaskScheduler_Delete(ITaskScheduler* This,LPCWSTR pwszName) {
    return This->lpVtbl->Delete(This,pwszName);
}
static inline HRESULT ITaskScheduler_NewWorkItem(ITaskScheduler* This,LPCWSTR pwszTaskName,REFCLSID rclsid,REFIID riid,IUnknown **ppunk) {
    return This->lpVtbl->NewWorkItem(This,pwszTaskName,rclsid,riid,ppunk);
}
static inline HRESULT ITaskScheduler_AddWorkItem(ITaskScheduler* This,LPCWSTR pwszTaskName,IScheduledWorkItem *pWorkItem) {
    return This->lpVtbl->AddWorkItem(This,pwszTaskName,pWorkItem);
}
static inline HRESULT ITaskScheduler_IsOfType(ITaskScheduler* This,LPCWSTR pwszName,REFIID riid) {
