/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/xpsobjectmodel_1.idl - Do not edit ***/
...
/*** IXpsDocumentPackageTarget methods ***/
static inline HRESULT IXpsDocumentPackageTarget_GetXpsOMPackageWriter(IXpsDocumentPackageTarget* This,IOpcPartUri *documentpart,IOpcPartUri *controlpart,IXpsOMPackageWriter **writer) {
    return This->lpVtbl->GetXpsOMPackageWriter(This,documentpart,controlpart,writer);
}
static inline HRESULT IXpsDocumentPackageTarget_GetXpsOMFactory(IXpsDocumentPackageTarget* This,IXpsOMObjectFactory **factory) {
    return This->lpVtbl->GetXpsOMFactory(This,factory);
}
static inline HRESULT IXpsDocumentPackageTarget_GetXpsType(IXpsDocumentPackageTarget* This,XPS_DOCUMENT_TYPE *document_type) {
