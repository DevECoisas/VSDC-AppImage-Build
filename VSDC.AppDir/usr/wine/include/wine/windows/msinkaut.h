/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/msinkaut.idl - Do not edit ***/
...
/*** IInkExtendedProperties methods ***/
static inline HRESULT IInkExtendedProperties_Count(IInkExtendedProperties* This,LONG *Count) {
    return This->lpVtbl->Count(This,Count);
}
static inline HRESULT IInkExtendedProperties__NewEnum(IInkExtendedProperties* This,IUnknown **_NewEnum) {
    return This->lpVtbl->_NewEnum(This,_NewEnum);
}
...
static inline HRESULT IInkDrawingAttributes_put_Color(IInkDrawingAttributes* This,LONG CurrentColor) {
    return This->lpVtbl->put_Color(This,CurrentColor);
}
static inline HRESULT IInkDrawingAttributes_get_Width(IInkDrawingAttributes* This,single *CurrentWidth) {
    return This->lpVtbl->get_Width(This,CurrentWidth);
}
static inline HRESULT IInkDrawingAttributes_put_Width(IInkDrawingAttributes* This,single CurrentWidth) {
    return This->lpVtbl->put_Width(This,CurrentWidth);
}
static inline HRESULT IInkDrawingAttributes_get_Height(IInkDrawingAttributes* This,single *CurrentHeight) {
    return This->lpVtbl->get_Height(This,CurrentHeight);
}
static inline HRESULT IInkDrawingAttributes_put_Height(IInkDrawingAttributes* This,single CurrentHeight) {
    return This->lpVtbl->put_Height(This,CurrentHeight);
}
...
static inline HRESULT IInkDrawingAttributes_put_Transparency(IInkDrawingAttributes* This,LONG CurrentTransparency) {
    return This->lpVtbl->put_Transparency(This,CurrentTransparency);
}
...
static inline HRESULT IInkDrawingAttributes_put_RasterOperation(IInkDrawingAttributes* This,InkRasterOperation CurrentRasterOperation) {
    return This->lpVtbl->put_RasterOperation(This,CurrentRasterOperation);
}
...
static inline HRESULT IInkDrawingAttributes_put_PenTip(IInkDrawingAttributes* This,InkPenTip CurrentPenTip) {
    return This->lpVtbl->put_PenTip(This,CurrentPenTip);
}
...
static inline HRESULT IInkTransform_Translate(IInkTransform* This,single HorizontalComponent,single VerticalComponent) {
    return This->lpVtbl->Translate(This,HorizontalComponent,VerticalComponent);
}
static inline HRESULT IInkTransform_Rotate(IInkTransform* This,single Degrees,single x,single y) {
...
static inline HRESULT IInkTransform_Shear(IInkTransform* This,single HorizontalComponent,single VerticalComponent) {
    return This->lpVtbl->Shear(This,HorizontalComponent,VerticalComponent);
}
static inline HRESULT IInkTransform_ScaleTransform(IInkTransform* This,single HorizontalMultiplier,single VerticalMultiplier) {
    return This->lpVtbl->ScaleTransform(This,HorizontalMultiplier,VerticalMultiplier);
}
static inline HRESULT IInkTransform_GetTransform(IInkTransform* This,single *eM11,single *eM12,single *eM21,single *eM22,single *eDx,single *eDy) {
    return This->lpVtbl->GetTransform(This,eM11,eM12,eM21,eM22,eDx,eDy);
}
static inline HRESULT IInkTransform_SetTransform(IInkTransform* This,single eM11,single eM12,single eM21,single eM22,single eDx,single eDy) {
    return This->lpVtbl->SetTransform(This,eM11,eM12,eM21,eM22,eDx,eDy);
}
static inline HRESULT IInkTransform_get_eM11(IInkTransform* This,single *Value) {
    return This->lpVtbl->get_eM11(This,Value);
}
static inline HRESULT IInkTransform_put_eM11(IInkTransform* This,single Value) {
    return This->lpVtbl->put_eM11(This,Value);
}
static inline HRESULT IInkTransform_get_eM12(IInkTransform* This,single *Value) {
    return This->lpVtbl->get_eM12(This,Value);
}
static inline HRESULT IInkTransform_put_eM12(IInkTransform* This,single Value) {
    return This->lpVtbl->put_eM12(This,Value);
}
static inline HRESULT IInkTransform_get_eM21(IInkTransform* This,single *Value) {
    return This->lpVtbl->get_eM21(This,Value);
}
static inline HRESULT IInkTransform_put_eM21(IInkTransform* This,single Value) {
    return This->lpVtbl->put_eM21(This,Value);
}
static inline HRESULT IInkTransform_get_eM22(IInkTransform* This,single *Value) {
    return This->lpVtbl->get_eM22(This,Value);
}
static inline HRESULT IInkTransform_put_eM22(IInkTransform* This,single Value) {
    return This->lpVtbl->put_eM22(This,Value);
}
static inline HRESULT IInkTransform_get_eDx(IInkTransform* This,single *Value) {
    return This->lpVtbl->get_eDx(This,Value);
}
static inline HRESULT IInkTransform_put_eDx(IInkTransform* This,single Value) {
    return This->lpVtbl->put_eDx(This,Value);
}
static inline HRESULT IInkTransform_get_eDy(IInkTransform* This,single *Value) {
    return This->lpVtbl->get_eDy(This,Value);
}
static inline HRESULT IInkTransform_put_eDy(IInkTransform* This,single Value) {
...
typedef enum __WIDL_msinkaut_generated_name_0000001E {
    TPMU_Default = 0,
    TPMU_Inches = 1,
    TPMU_Centimeters = 2,
    TPMU_Degrees = 3,
...
static inline HRESULT IInkStrokeDisp_HitTestCircle(IInkStrokeDisp* This,LONG x,LONG y,single radius,VARIANT_BOOL *Intersects) {
    return This->lpVtbl->HitTestCircle(This,x,y,radius,Intersects);
}
static inline HRESULT IInkStrokeDisp_NearestPoint(IInkStrokeDisp* This,LONG x,LONG y,single *Distance,single *Point) {
    return This->lpVtbl->NearestPoint(This,x,y,Distance,Point);
}
static inline HRESULT IInkStrokeDisp_Split(IInkStrokeDisp* This,single SplitAt,IInkStrokeDisp **NewStroke) {
    return This->lpVtbl->Split(This,SplitAt,NewStroke);
}
static inline HRESULT IInkStrokeDisp_GetPacketDescriptionPropertyMetrics(IInkStrokeDisp* This,BSTR propertyName,LONG *Minimum,LONG *Maximum,TabletPropertyMetricUnit *Units,single *Resolution) {
...
static inline HRESULT IInkStrokeDisp_Move(IInkStrokeDisp* This,single HorizontalComponent,single VerticalComponent) {
    return This->lpVtbl->Move(This,HorizontalComponent,VerticalComponent);
}
static inline HRESULT IInkStrokeDisp_Rotate(IInkStrokeDisp* This,single Degrees,single x,single y) {
    return This->lpVtbl->Rotate(This,Degrees,x,y);
}
static inline HRESULT IInkStrokeDisp_Shear(IInkStrokeDisp* This,single HorizontalMultiplier,single VerticalMultiplier) {
    return This->lpVtbl->Shear(This,HorizontalMultiplier,VerticalMultiplier);
}
static inline HRESULT IInkStrokeDisp_ScaleTransform(IInkStrokeDisp* This,single HorizontalMultiplier,single VerticalMultiplier) {
    return This->lpVtbl->ScaleTransform(This,HorizontalMultiplier,VerticalMultiplier);
}
#endif
#endif
...
static inline HRESULT IInkRecognitionAlternate_GetStrokesFromStrokeRanges(IInkRecognitionAlternate* This,IInkStrokes *Stroke,IInkStrokes **GetStrokesFromTextRange) {
...
static inline HRESULT IInkDisp_get_CustomStrokes(IInkDisp* This,IInkCustomStrokes **CustomStrokes) {
    return This->lpVtbl->get_CustomStrokes(This,CustomStrokes);
}
...
static inline HRESULT IInkRenderer_Draw(IInkRenderer* This,LONG hDC,IInkStrokes *Strokes) {
    return This->lpVtbl->Draw(This,hDC,Strokes);
}
static inline HRESULT IInkRenderer_DrawStroke(IInkRenderer* This,LONG hDC,IInkStrokeDisp *Stroke,IInkDrawingAttributes *DrawingAttributes) {
    return This->lpVtbl->DrawStroke(This,hDC,Stroke,DrawingAttributes);
}
static inline HRESULT IInkRenderer_PixelToInkSpace(IInkRenderer* This,LONG hDC,LONG *x,LONG *y) {
    return This->lpVtbl->PixelToInkSpace(This,hDC,x,y);
}
static inline HRESULT IInkRenderer_InkSpaceToPixel(IInkRenderer* This,LONG hdcDisplay,LONG *x,LONG *y) {
    return This->lpVtbl->InkSpaceToPixel(This,hdcDisplay,x,y);
}
static inline HRESULT IInkRenderer_PixelToInkSpaceFromPoints(IInkRenderer* This,LONG hDC,VARIANT *Points) {
    return This->lpVtbl->PixelToInkSpaceFromPoints(This,hDC,Points);
}
static inline HRESULT IInkRenderer_InkSpaceToPixelFromPoints(IInkRenderer* This,LONG hDC,VARIANT *Points) {
...
static inline HRESULT IInkRenderer_Move(IInkRenderer* This,single HorizontalComponent,single VerticalComponent) {
    return This->lpVtbl->Move(This,HorizontalComponent,VerticalComponent);
}
static inline HRESULT IInkRenderer_Rotate(IInkRenderer* This,single Degrees,single x,single y) {
    return This->lpVtbl->Rotate(This,Degrees,x,y);
}
static inline HRESULT IInkRenderer_ScaleTransform(IInkRenderer* This,single HorizontalMultiplier,single VerticalMultiplier,VARIANT_BOOL ApplyOnPenWidth) {
...
typedef enum __WIDL_msinkaut_generated_name_0000001F {
    ICM_InkOnly = 0,
    ICM_GestureOnly = 1,
    ICM_InkAndGesture = 2
} InkCollectionMode;
typedef enum __WIDL_msinkaut_generated_name_00000020 {
    IMP_Default = 0,
    IMP_Arrow = 1,
    IMP_Crosshair = 2,
    IMP_Ibeam = 3,
...
typedef enum __WIDL_msinkaut_generated_name_00000021 {
    THWC_Integrated = 1,
...
static inline HRESULT IInkTablet_GetPropertyMetrics(IInkTablet* This,BSTR propertyName,LONG *Minimum,LONG *Maximum,TabletPropertyMetricUnit *Units,single *Resolution) {
...
typedef enum __WIDL_msinkaut_generated_name_00000022 {
    ICBS_Unavailable = 0,
    ICBS_Up = 1,
    ICBS_Down = 2
...
typedef enum __WIDL_msinkaut_generated_name_00000023 {
    IAG_AllGestures = 0,
    IAG_NoGesture = 61440,
...
typedef enum __WIDL_msinkaut_generated_name_00000024 {
...
/*** IInkCollector methods ***/
static inline HRESULT IInkCollector_get_hWnd(IInkCollector* This,LONG *CurrentWindow) {
    return This->lpVtbl->get_hWnd(This,CurrentWindow);
}
static inline HRESULT IInkCollector_put_hWnd(IInkCollector* This,LONG CurrentWindow) {
    return This->lpVtbl->put_hWnd(This,CurrentWindow);
}
...
static inline HRESULT IInkCollector_putref_DefaultDrawingAttributes(IInkCollector* This,IInkDrawingAttributes *CurrentAttributes) {
    return This->lpVtbl->putref_DefaultDrawingAttributes(This,CurrentAttributes);
}
...
static inline HRESULT IInkCollector_putref_Renderer(IInkCollector* This,IInkRenderer *CurrentInkRenderer) {
    return This->lpVtbl->putref_Renderer(This,CurrentInkRenderer);
}
static inline HRESULT IInkCollector_get_Ink(IInkCollector* This,IInkDisp **Ink) {
    return This->lpVtbl->get_Ink(This,Ink);
}
static inline HRESULT IInkCollector_putref_Ink(IInkCollector* This,IInkDisp *Ink) {
    return This->lpVtbl->putref_Ink(This,Ink);
}
