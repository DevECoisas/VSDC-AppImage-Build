/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/oleacc.idl - Do not edit ***/
...
static inline HRESULT IAccessible_get_accDescription(IAccessible* This,VARIANT varID,BSTR *description) {
    return This->lpVtbl->get_accDescription(This,varID,description);
}
static inline HRESULT IAccessible_get_accRole(IAccessible* This,VARIANT varID,VARIANT *role) {
    return This->lpVtbl->get_accRole(This,varID,role);
}
static inline HRESULT IAccessible_get_accState(IAccessible* This,VARIANT varID,VARIANT *state) {
    return This->lpVtbl->get_accState(This,varID,state);
}
static inline HRESULT IAccessible_get_accHelp(IAccessible* This,VARIANT varID,BSTR *help) {
    return This->lpVtbl->get_accHelp(This,varID,help);
}
static inline HRESULT IAccessible_get_accHelpTopic(IAccessible* This,BSTR *helpfile,VARIANT varID,LONG *pidTopic) {
    return This->lpVtbl->get_accHelpTopic(This,helpfile,varID,pidTopic);
}
static inline HRESULT IAccessible_get_accKeyboardShortcut(IAccessible* This,VARIANT varID,BSTR *shortcut) {
...
static inline HRESULT IAccessible_get_accDefaultAction(IAccessible* This,VARIANT varID,BSTR *action) {
...
static inline HRESULT IAccessible_accLocation(IAccessible* This,LONG *left,LONG *top,LONG *width,LONG *height,VARIANT varID) {
    return This->lpVtbl->accLocation(This,left,top,width,height,varID);
}
static inline HRESULT IAccessible_accNavigate(IAccessible* This,LONG dir,VARIANT varStart,VARIANT *pvarEnd) {
    return This->lpVtbl->accNavigate(This,dir,varStart,pvarEnd);
}
static inline HRESULT IAccessible_accHitTest(IAccessible* This,LONG left,LONG top,VARIANT *pvarID) {
...
static inline HRESULT IAccessible_put_accName(IAccessible* This,VARIANT varID,BSTR name) {
    return This->lpVtbl->put_accName(This,varID,name);
}
static inline HRESULT IAccessible_put_accValue(IAccessible* This,VARIANT varID,BSTR value) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAccessibleHandler_QueryInterface(IAccessibleHandler* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IAccessibleHandler_AddRef(IAccessibleHandler* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IAccessibleHandler_Release(IAccessibleHandler* This) {
    return This->lpVtbl->Release(This);
}
/*** IAccessibleHandler methods ***/
static inline HRESULT IAccessibleHandler_AccessibleObjectFromID(IAccessibleHandler* This,LONG hwnd,LONG lObjectID,LPACCESSIBLE *pIAccessible) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAccIdentity_QueryInterface(IAccIdentity* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IAccIdentity_AddRef(IAccIdentity* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IAccIdentity_Release(IAccIdentity* This) {
    return This->lpVtbl->Release(This);
}
/*** IAccIdentity methods ***/
static inline HRESULT IAccIdentity_GetIdentityString(IAccIdentity* This,DWORD idchild,BYTE **str,DWORD *string_len) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAccPropServer_QueryInterface(IAccPropServer* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IAccPropServer_AddRef(IAccPropServer* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IAccPropServer_Release(IAccPropServer* This) {
    return This->lpVtbl->Release(This);
}
/*** IAccPropServer methods ***/
static inline HRESULT IAccPropServer_GetPropValue(IAccPropServer* This,const BYTE *str,DWORD string_len,MSAAPROPID idProp,VARIANT *value,BOOL *has_prop) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAccPropServices_QueryInterface(IAccPropServices* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IAccPropServices_AddRef(IAccPropServices* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IAccPropServices_Release(IAccPropServices* This) {
    return This->lpVtbl->Release(This);
}
/*** IAccPropServices methods ***/
static inline HRESULT IAccPropServices_SetPropValue(IAccPropServices* This,const BYTE *str,DWORD string_len,MSAAPROPID idProp,VARIANT var) {
    return This->lpVtbl->SetPropValue(This,str,string_len,idProp,var);
}
static inline HRESULT IAccPropServices_SetPropServer(IAccPropServices* This,const BYTE *str,DWORD string_len,const MSAAPROPID *props,int cProps,IAccPropServer *pServer,AnnoScope AnnoScope) {
    return This->lpVtbl->SetPropServer(This,str,string_len,props,cProps,pServer,AnnoScope);
}
static inline HRESULT IAccPropServices_ClearProps(IAccPropServices* This,const BYTE *str,DWORD string_len,const MSAAPROPID *props,int cProps) {
    return This->lpVtbl->ClearProps(This,str,string_len,props,cProps);
}
static inline HRESULT IAccPropServices_SetHwndProp(IAccPropServices* This,HWND hwnd,DWORD idObject,DWORD idChild,MSAAPROPID idProp,VARIANT var) {
    return This->lpVtbl->SetHwndProp(This,hwnd,idObject,idChild,idProp,var);
}
static inline HRESULT IAccPropServices_SetHwndPropStr(IAccPropServices* This,HWND hwnd,DWORD idObject,DWORD idChild,MSAAPROPID idProp,LPWSTR str) {
    return This->lpVtbl->SetHwndPropStr(This,hwnd,idObject,idChild,idProp,str);
}
static inline HRESULT IAccPropServices_SetHwndPropServer(IAccPropServices* This,HWND hwnd,DWORD idObject,DWORD idChild,const MSAAPROPID *props,int cProps,IAccPropServer *server,AnnoScope scope) {
    return This->lpVtbl->SetHwndPropServer(This,hwnd,idObject,idChild,props,cProps,server,scope);
}
static inline HRESULT IAccPropServices_ClearHwndProps(IAccPropServices* This,HWND hwnd,DWORD idObject,DWORD idChild,const MSAAPROPID *props,int cProps) {
    return This->lpVtbl->ClearHwndProps(This,hwnd,idObject,idChild,props,cProps);
}
static inline HRESULT IAccPropServices_ComposeHwndIdentityString(IAccPropServices* This,HWND hwnd,DWORD idObject,DWORD idChild,BYTE **str,DWORD *string_len) {
    return This->lpVtbl->ComposeHwndIdentityString(This,hwnd,idObject,idChild,str,string_len);
}
static inline HRESULT IAccPropServices_DecomposeHwndIdentityString(IAccPropServices* This,const BYTE *str,DWORD string_len,HWND *phwnd,DWORD *pidObject,DWORD *pidChild) {
    return This->lpVtbl->DecomposeHwndIdentityString(This,str,string_len,phwnd,pidObject,pidChild);
}
static inline HRESULT IAccPropServices_SetHmenuProp(IAccPropServices* This,HMENU hmenu,DWORD idChild,MSAAPROPID idProp,VARIANT var) {
    return This->lpVtbl->SetHmenuProp(This,hmenu,idChild,idProp,var);
}
static inline HRESULT IAccPropServices_SetHmenuPropStr(IAccPropServices* This,HMENU hmenu,DWORD idChild,MSAAPROPID idProp,LPWSTR str) {
    return This->lpVtbl->SetHmenuPropStr(This,hmenu,idChild,idProp,str);
}
static inline HRESULT IAccPropServices_SetHmenuPropServer(IAccPropServices* This,HMENU hmenu,DWORD idChild,const MSAAPROPID *props,int cProps,IAccPropServer *server,AnnoScope scope) {
    return This->lpVtbl->SetHmenuPropServer(This,hmenu,idChild,props,cProps,server,scope);
}
static inline HRESULT IAccPropServices_ClearHmenuProps(IAccPropServices* This,HMENU hmenu,DWORD idChild,const MSAAPROPID *props,int cProps) {
    return This->lpVtbl->ClearHmenuProps(This,hmenu,idChild,props,cProps);
}
static inline HRESULT IAccPropServices_ComposeHmenuIdentityString(IAccPropServices* This,HMENU hmenu,DWORD idChild,BYTE **str,DWORD *string_len) {
    return This->lpVtbl->ComposeHmenuIdentityString(This,hmenu,idChild,str,string_len);
}
static inline HRESULT IAccPropServices_DecomposeHmenuIdentityString(IAccPropServices* This,const BYTE *str,DWORD string_len,HMENU *phmenu,DWORD *pidChild) {
