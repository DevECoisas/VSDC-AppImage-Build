/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/devicetopology.idl - Do not edit ***/
...
#include <ksmedia.h>
#ifndef _KS_
typedef struct __WIDL_devicetopology_generated_name_0000001E {
    ULONG FormatSize;
    ULONG Flags;
    ULONG SampleSize;
    ULONG Reserved;
...
typedef struct __WIDL_devicetopology_generated_name_0000001F {
...
typedef enum __WIDL_devicetopology_generated_name_00000020 {
    eConnTypeUnknown = 0,
...
typedef enum __WIDL_devicetopology_generated_name_00000021 {
    eGeoLocRear = 1,
    eGeoLocFront = 2,
    eGeoLocLeft = 3,
    eGeoLocRight = 4,
...
typedef struct __WIDL_devicetopology_generated_name_00000024 {
...
#endif
typedef enum __WIDL_devicetopology_generated_name_00000026 {
    In = 0,
    Out = 1
} DataFlow;
...
/*** IAudioLoudness methods ***/
static inline HRESULT IAudioLoudness_GetEnabled(IAudioLoudness* This,BOOL *pbEnabled) {
    return This->lpVtbl->GetEnabled(This,pbEnabled);
}
static inline HRESULT IAudioLoudness_SetEnabled(IAudioLoudness* This,BOOL bEnabled,LPCGUID pguidEventContext) {
...
/*** IAudioMute methods ***/
static inline HRESULT IAudioMute_SetMute(IAudioMute* This,BOOL bMute,LPCGUID pguidEventContext) {
    return This->lpVtbl->SetMute(This,bMute,pguidEventContext);
}
static inline HRESULT IAudioMute_GetMute(IAudioMute* This,BOOL *pbMute) {
...
/*** IAudioAutoGainControl methods ***/
static inline HRESULT IAudioAutoGainControl_GetEnabled(IAudioAutoGainControl* This,BOOL bEnabled,LPCGUID pguidEventContext) {
    return This->lpVtbl->GetEnabled(This,bEnabled,pguidEventContext);
}
static inline HRESULT IAudioAutoGainControl_GetMute(IAudioAutoGainControl* This,BOOL *pbEnabled) {
...
/*** IKsFormatSupport methods ***/
static inline HRESULT IKsFormatSupport_IsFormatSupported(IKsFormatSupport* This,PKSDATAFORMAT pKsFormat,DWORD cbFormat,BOOL *pbSupported) {
...
static inline HRESULT IConnector_IsConnected(IConnector* This,BOOL *pbConnected) {
...
static inline HRESULT IDeviceTopology_GetSignalPath(IDeviceTopology* This,IPart *pIPartFrom,IPart *pIPartTo,BOOL bRejectMixedPaths,IPartsList **ppParts) {
