/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/wbemcli.idl - Do not edit ***/
...
/*** IUnsecuredApartment methods ***/
#define IUnsecuredApartment_CreateObjectStub(This,object,stub) (This)->lpVtbl->CreateObjectStub(This,object,stub)
#else
/*** IUnknown methods ***/
...
/*** IUnsecuredApartment methods ***/
static inline HRESULT IUnsecuredApartment_CreateObjectStub(IUnsecuredApartment* This,IUnknown *object,IUnknown **stub) {
    return This->lpVtbl->CreateObjectStub(This,object,stub);
}
#endif
#endif
...
/*** IUnsecuredApartment methods ***/
#define IWbemUnsecuredApartment_CreateObjectStub(This,object,stub) (This)->lpVtbl->CreateObjectStub(This,object,stub)
/*** IWbemUnsecuredApartment methods ***/
#define IWbemUnsecuredApartment_CreateSinkStub(This,sink,flags,reserved,stub) (This)->lpVtbl->CreateSinkStub(This,sink,flags,reserved,stub)
#else
/*** IUnknown methods ***/
...
/*** IUnsecuredApartment methods ***/
static inline HRESULT IWbemUnsecuredApartment_CreateObjectStub(IWbemUnsecuredApartment* This,IUnknown *object,IUnknown **stub) {
    return This->lpVtbl->CreateObjectStub(This,object,stub);
}
/*** IWbemUnsecuredApartment methods ***/
static inline HRESULT IWbemUnsecuredApartment_CreateSinkStub(IWbemUnsecuredApartment* This,IWbemObjectSink *sink,DWORD flags,const WCHAR *reserved,IWbemObjectSink **stub) {
    return This->lpVtbl->CreateSinkStub(This,sink,flags,reserved,stub);
}
#endif
#endif
...
#define IWbemObjectAccess_WriteQWORD(This,lHandle,qw) (This)->lpVtbl->WriteQWORD(This,lHandle,qw)
...
static inline HRESULT IWbemObjectAccess_WriteQWORD(IWbemObjectAccess* This,LONG lHandle,UINT64 qw) {
    return This->lpVtbl->WriteQWORD(This,lHandle,qw);
}
