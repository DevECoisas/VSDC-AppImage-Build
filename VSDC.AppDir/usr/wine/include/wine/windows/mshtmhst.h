/*** Autogenerated by WIDL 11.0-rc1 from /home/runner/build_wine/wine/include/mshtmhst.idl - Do not edit ***/
...
static inline HRESULT IDocHostUIHandler_EnableModeless(IDocHostUIHandler* This,BOOL fEnable) {
    return This->lpVtbl->EnableModeless(This,fEnable);
}
static inline HRESULT IDocHostUIHandler_OnDocWindowActivate(IDocHostUIHandler* This,BOOL fActivate) {
    return This->lpVtbl->OnDocWindowActivate(This,fActivate);
}
static inline HRESULT IDocHostUIHandler_OnFrameWindowActivate(IDocHostUIHandler* This,BOOL fActivate) {
    return This->lpVtbl->OnFrameWindowActivate(This,fActivate);
}
static inline HRESULT IDocHostUIHandler_ResizeBorder(IDocHostUIHandler* This,LPCRECT prcBorder,IOleInPlaceUIWindow *pUIWindow,BOOL fRameWindow) {
...
static inline HRESULT IDocHostUIHandler_TranslateUrl(IDocHostUIHandler* This,DWORD dwTranslate,OLECHAR *pchURLIn,OLECHAR **ppchURLOut) {
...
static inline HRESULT IDocHostUIHandler2_EnableModeless(IDocHostUIHandler2* This,BOOL fEnable) {
    return This->lpVtbl->EnableModeless(This,fEnable);
}
static inline HRESULT IDocHostUIHandler2_OnDocWindowActivate(IDocHostUIHandler2* This,BOOL fActivate) {
    return This->lpVtbl->OnDocWindowActivate(This,fActivate);
}
static inline HRESULT IDocHostUIHandler2_OnFrameWindowActivate(IDocHostUIHandler2* This,BOOL fActivate) {
    return This->lpVtbl->OnFrameWindowActivate(This,fActivate);
}
static inline HRESULT IDocHostUIHandler2_ResizeBorder(IDocHostUIHandler2* This,LPCRECT prcBorder,IOleInPlaceUIWindow *pUIWindow,BOOL fRameWindow) {
    return This->lpVtbl->ResizeBorder(This,prcBorder,pUIWindow,fRameWindow);
}
...
static inline HRESULT IDocHostUIHandler2_TranslateUrl(IDocHostUIHandler2* This,DWORD dwTranslate,OLECHAR *pchURLIn,OLECHAR **ppchURLOut) {
    return This->lpVtbl->TranslateUrl(This,dwTranslate,pchURLIn,ppchURLOut);
}
...
static inline HRESULT IClassFactoryEx_LockServer(IClassFactoryEx* This,BOOL fLock) {
